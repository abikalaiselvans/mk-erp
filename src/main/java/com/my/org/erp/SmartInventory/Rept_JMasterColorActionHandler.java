...
public class Rept_JMasterColorActionHandler extends AbstractActionHandler 
{
	...
	String officename="";
	String deptname="";
	String hImageExpression=null;
	String fImageExpression=null;
	
	public String getSqlQuery()
	{
		asql="SELECT UPPER(CHR_COLORCODE) FROM inv_m_color ORDER BY CHR_COLORCODE";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterColor")) 
			{
