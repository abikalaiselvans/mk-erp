...
public class Rept_JMasterCourierActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_COURIERNAME) FROM inv_m_courier ORDER BY CHR_COURIERNAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterCourier")) 
			{
