...
public class Rept_JMasterItemGroupActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_GROUPNAME) FROM inv_m_itemgroup ORDER BY CHR_GROUPNAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterItemGroup")) 
			{
