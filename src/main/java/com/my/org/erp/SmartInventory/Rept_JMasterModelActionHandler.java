...
public class Rept_JMasterModelActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_MODELCODE) FROM inv_m_model ORDER BY CHR_MODELCODE";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterModel")) 
			{
