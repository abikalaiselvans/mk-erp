...
public class Rept_JMasterPaymentTermActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_PAYMENTNAME), CHR_DES FROM inv_m_paymentterms ORDER BY CHR_PAYMENTNAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterPaymentTerm")) 
			{
