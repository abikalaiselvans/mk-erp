...
public class Rept_JMasterProductGroupActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_NAME) FROM inv_m_productgroup ORDER BY CHR_NAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterProductGroup")) 
			{
