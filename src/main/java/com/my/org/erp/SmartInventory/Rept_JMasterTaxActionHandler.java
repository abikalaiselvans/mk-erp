...
public class Rept_JMasterTaxActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT CHR_TAXNAME,CONCAT(DOU_VALUE,' - [ % ] ')  FROM  inv_m_tax ORDER BY CHR_TAXNAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterTax")) 
			{
