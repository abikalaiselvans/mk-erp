...
public class Rept_JMasterTermsAndConditionActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT UPPER(CHR_CONDITIONNAME), CHR_DES FROM inv_m_terms_conditions ORDER BY CHR_CONDITIONNAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterTermsAndCondition")) 
			{
