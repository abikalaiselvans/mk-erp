...
public class Rept_JMasterVendorGroupActionHandler extends AbstractActionHandler 
{
	...
	{
		asql="SELECT CHR_NAME   FROM  inv_m_vendorsgroup ORDER BY CHR_NAME";
		return asql;
	}
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JMasterVendorGroup")) 
			{
