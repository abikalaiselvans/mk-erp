...
public class Rept_JProductwiseStockAgeInDaysActionHandler extends AbstractActionHandler 
{
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("INVRept_JProductwiseStockAgeInDays")) 
			{
				...
				sql = " SELECT  FUN_GET_BRANCH_NAME(a.INT_BRANCHID),b.CHR_DIVICODE,  if( a.CHR_TYPE ='I' ,'ITEM','PRODUCT' )," +
						...
						"( SELECT FUN_GET_PRODUCT_GROUP_NAME(a.CHR_ITEMID))  )  productcodegroup,  " +
						"if( a.CHR_TYPE ='I' ,    (SELECT a1.CHR_ITEMNAME FROM inv_m_item a1  " +
						"WHERE  a1.CHR_ITEMID =a.CHR_ITEMID), (SELECT a2.CHR_PRODUCTCODE FROM inv_m_produtlist a2 " +
						" WHERE  a2.CHR_PRODUCTID =a.CHR_ITEMID) ) productcode, if( a.CHR_TYPE ='I' ," +
						...
						"productdescription, a.CHR_SERIALNO ,a.CHR_WARRANTY,DATEDIFF(NOW(),a.DAT_RECIVEDDATE), " +
						" ( ( a.CHR_PURCHASE_WARRANTY*365)  > DATEDIFF(now(),a.DAT_RECIVEDDATE)  ) notexpired, " +
						"a.DOU_UNITPRICE FROM inv_t_vendorgoodsreceived a ,inv_m_division b WHERE a.INT_DIVIID=b.INT_DIVIID " +
						"AND a.CHR_FLAG='N' AND a.CHR_SERIALNO is not null ";	
				...
				sql = sql +" GROUP BY a.CHR_TYPE,a.CHR_ITEMID ORDER BY a.CHR_TYPE,a.INT_DIVIID ";
