...
public class ServiceCallAssignActionHandler extends AbstractActionHandler
{
		public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
		{
			try
			{
					...
					if(action.equals("INVServiceCallAssignAdd"))
					{					
						...
						st.close();
						con.close();    
						response.sendRedirect("Smart Inventory/servicecallassign.jsp");
					}
					else if(action.equals("INVServiceCallAssignHistoryAdd"))
					{					
						String callid  = request.getParameter("callid");
					...
					else if(action.equals("INVServiceCallAssignHistoryDELETE"))
					{					
					...
					else if(action.equals("INVServiceCallAssignHistoryCancell"))
					{					
