...
import com.my.org.erp.bean.management.Building;
import com.my.org.erp.common.CommonFunctions;
 

public class BuildingActionHandler extends AbstractActionHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		try 
		{
			...
			if ("MGTBuildingAdd".equals(action)) 
			{	
				Add(request,response);
				con.close();
				response.sendRedirect("Smart Management/Building.jsp");
			}
			else if ("MGTBuildingEdit".equals(action)) 
			{ 
			...
			else if ("MGTBuildingDelete".equals(action)) 
			{ 
