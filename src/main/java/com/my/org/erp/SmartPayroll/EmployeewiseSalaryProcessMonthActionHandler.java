...
public class EmployeewiseSalaryProcessMonthActionHandler extends AbstractActionHandler 
{ 
					...
					if(flag)
	 				{
						...
						for(int v=0;v<attdata.length;v++)
						{
							...
							pfValue = (pfValue - ((pfValue/noofdaysinamonth)*absent) );
							CompanyPF1 = (CompanyPF1 - ((CompanyPF1/noofdaysinamonth)*absent) );
							CompanyPF2 = (CompanyPF2 - ((CompanyPF2/noofdaysinamonth)*absent) );
							...
							penbasic =  ( penbasic-((penbasic/noofdaysinamonth)*absent))  ;
