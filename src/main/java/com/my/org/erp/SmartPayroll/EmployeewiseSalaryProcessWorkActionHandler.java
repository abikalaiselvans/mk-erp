...
public class EmployeewiseSalaryProcessWorkActionHandler extends AbstractActionHandler 
{ 
					...
					if(flag)
	 				{
						...
						for(int v=0;v<attdata.length;v++)
						{
							...
							pfValue = (pfValue/noofworkingdaysinamonth *totaldays);
							CompanyPF1 = (CompanyPF1/noofworkingdaysinamonth *totaldays);
							CompanyPF2 = (CompanyPF2/noofworkingdaysinamonth *totaldays);
							...
							penbasic = (penbasic/noofworkingdaysinamonth *totaldays);
