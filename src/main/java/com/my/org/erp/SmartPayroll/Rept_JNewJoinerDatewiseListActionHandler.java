...
public class Rept_JNewJoinerDatewiseListActionHandler extends AbstractActionHandler 
{
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{ 
			...
			if (action.equals("PAYRept_JNewJoinerDatewiseList")) 
			{
			System.out.println("insite PAYRept_JAdvanceAll");
				...
				asql = asql+" AND a.DT_DOJCOLLEGE >= '"+fmdate+"' ";
				asql = asql+" AND a.DT_DOJCOLLEGE <= '"+todate+"' "; 
