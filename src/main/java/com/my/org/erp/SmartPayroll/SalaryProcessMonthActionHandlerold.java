...
public class SalaryProcessMonthActionHandlerold extends AbstractActionHandler 
{ 
						...
						for(int v=0;v<attdata.length;v++)
						{
							...
							{	
								...
								{	
									...
									System.out.println(originalbasic+"/"+dbminimumpflimit+"/"+(originalbasic<dbminimumpflimit));
									if(originalbasic<dbminimumpflimit)
									{
										...
										System.out.println(pfValue+"/"+CompanyPF1+"/"+CompanyPF2);
									}
									else
									{
										System.out.println(basic+"/+"+dbpflimit+"/"+(basic<dbpflimit));
										if(basic<dbpflimit)
										{
