...
{       
	...
	{         
		...
		{             
			...
			MergePDF.splitPDF(new FileInputStream("C:\\merge.pdf"),new FileOutputStream("C:\\output1.pdf"), 1, 1);
			//MergePDF.splitPDF(new FileInputStream("C:\\merge.pdf"),new FileOutputStream("C:\\output2.pdf"), 13, 20);
