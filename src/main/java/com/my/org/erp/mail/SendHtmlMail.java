...
public class SendHtmlMail {
	...
	public static void main(String[] args) 
	{
		...
		//sendMailtoPerson("abikalaiselvan@yahoo.co.in","Test kalai","7");
		String sql ="SELECT CHR_NAME,CHR_FATHERNAME,CHR_APPLIEDPOST FROM com_m_careers WHERE INT_CAREERID=1000002";
		String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
		
		System.out.println(data.length);
		
		//sendMailtoHr("ajsureshs@yahoo.co.in","Test kalai","1000002");
	}
	...
	public static void readHTMLandSendMailtoPerson(String from,String to, String subject,String filename)
    {
    	try
    	{
    			
    		String s= "";
    		s=readTextFromhtmlFile(filename);
    		Properties props = new Properties();
  	        props.setProperty("mail.transport.protocol", "smtp");
  	        props.setProperty("mail.host", "192.168.0.5");
