...
public class PDF4 
{
  ...
  {
    PdfReader reader = new PdfReader("C:/kalaipdf/1.pdf");
    PdfStamper stamper = new PdfStamper(reader, new FileOutputStream("C:/kalaipdf/Encrypted1.pdf"));
    ...
    getEncryptionInformation("C:/kalaipdf/Encrypted1.pdf", "World");
  }
