			...
			<tbody>
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="388" align="center"
						...
						String sql ="SELECT  CHR_DESPNAME,CHR_ADDRESS,INT_PINCODE, INT_PHONE FROM com_m_dispensary ";
						sql = sql+" WHERE INT_DESPID ="+id;
					...
					%> </span></td>
								<td colspan="2" align="left"><input type="type"
									...
									maxlength=50 size='35' value="<%=data[0][0].trim()%>">
								<div id="soValid"></div>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="2" align="left" class="bolddeepblue"><textarea
									...
									id="address"><%=data[0][1].trim()%> </textarea></td>
							</tr>
							<tr>
								...
								<td colspan="2" align="left" class="bolddeepblue"><input
									...
									onKeyPress="numericValue('pincode','6')" size="15"
									maxlength="6" value="<%=data[0][2].trim()%>"></td>
							</tr>
							<tr>
								...
								<td width="207" colspan="2" align="left" class="bolddeepblue"><input
									...
									onKeyPress="numericValue('phone','16')"
									value="<%=data[0][3].trim()%>" size="15" maxlength="19"></td>
							</tr>

							<tr>
								<td height="30" colspan="3" valign="top"><input
									type="hidden" name="filename" value="Dispensary" /> <input
									type="hidden" name="actionS" value="COMDispensaryUpdate" /> <input
									name="path" type="hidden" id="path" value="<%=path%>">
								<input name="dispensaryid" type="hidden" id="dispensaryid"
									value="<%=id%>">
								<td>
							</tr>
							<tr>
