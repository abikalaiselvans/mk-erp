    ...
    <nav role="navigation" class="navbar navbar-custom">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
           <img src="dist/img/top_banner.png"/>
          </div>
          ...
          <div id="bs-content-row-navbar-collapse-5" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
				...
				<span style="color:#000000"><b>Welcome :: <%=com.my.org.erp.common.CommonFunctions.employeeName(""+session.getAttribute("EMPID") )%></b>&nbsp;&nbsp;&nbsp;&nbsp;</span>
				
				<span class="text-right">
				
				<a href="chat/login.jsp" target="_blank" ><span style="color:#000000">Chat</span>&nbsp;&nbsp;|&nbsp;&nbsp;
				<a href="Help/frame1.html" target="_blank" ><span style="color:#000000">Help</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
			    <a href="mailto:<%=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT CHR_MAILID FROM  m_institution WHERE INT_ID=1")[0][0]%>" ><span style="color:#000000">Mail</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
				 <%
				 if("F".equals(userType))
				 {
				 %>
				 <a href="sadmin.jsp" target="_parent"><span style="color:#000000">Home</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
				 <%
				 }
				 else
				 {
				 %>
				 <a href="Home.jsp" target="_parent"><span style="color:#000000">Home</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
				 <%
				 }
				 %>
				 
				<a href="Logout.jsp" target="_parent"><span style="color:#000000">Logout</span></a>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
          <div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
            <ul class="list-group panel">
                <li class="list-group-item"><i class="glyphicon glyphicon-align-justify"></i> <b>Quick Ref</b></li>
                <li class="list-group-item"><input type="text" class="form-control search-query" placeholder="Search Something"></li>
                <li class="list-group-item"><a href="#"><i class="glyphicon glyphicon-home"></i>Dashboard </a></li>
                <li class="list-group-item"><a href="#"><i class="glyphicon glyphicon-certificate"></i>Master </a></li>
                <li class="list-group-item"><a href="#"><i class="glyphicon glyphicon-th-list"></i>Attendance </a></li>
                <li class="list-group-item"><a href="#"><i class="glyphicon glyphicon-list-alt"></i>Forms</a></li>
                <li class="list-group-item"><a href="#"><i class="glyphicon glyphicon-bell"></i>Payroll</li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-indent-left"></i>Inventory</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-calendar"></i>Conveyance</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-font"></i>Marketing</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-minus"></i>Utility</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-list-alt"></i>Service</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-th-list"></i>Upload/Download</a></li>
                <li class="list-group-item"><a href="#" ><i class="glyphicon glyphicon-lock"></i>Logout</a></li>
                        ...
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
								<a href="Smart Common/commonmain.jsp"><img src="images/erp/common1.png" width="140" height="130" border="0"  title='C O M M O N   M O D U L E'  name='common'  id='common'  onmouseover=" this.style.border = '2px solid #3fb1a7'; common.src= 'images/erp/common.png'"  onmouseout=" this.style.border = '2px solid #ffffff'; common.src= 'images/erp/common1.png'"     /></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Smart HRM/HRMmain.jsp"><img src="images/erp/HRM1.png" width="140" height="130" border="0" id='HRM' name='HRM'  title='H R M   M O D U L E'   onmouseover=" this.style.border = '2px solid #3fb1a7'; HRM.src= 'images/erp/HRM.png'"  onmouseout="  this.style.border = '2px solid #ffffff'; HRM.src= 'images/erp/HRM1.png'"/></a>
                           </center> </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                             <a href="Smart Payroll/Payrollmain.jsp"><img src="images/erp/Payroll1.png" width="140" height="130" border="0"  id='Payroll1' name='Payroll1'   title='P A Y  R O L L  M O D U L E'  onmouseover="  this.style.border = '2px solid #3fb1a7'; Payroll1.src= 'images/erp/Payroll.png'"  onmouseout="   this.style.border = '2px solid #ffffff'; Payroll1.src= 'images/erp/Payroll1.png'"/></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Smart Asset/Assetmain.jsp"><img src="images/erp/Asset1.png" width="140" height="130" border="0"  id='Asset' name='Asset'  title='A S S E T   M O D U L E'   onmouseover="  this.style.border = '2px solid #3fb1a7'; Asset.src= 'images/erp/Asset.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  Asset.src= 'images/erp/Asset1.png'"/></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                             <a href="Smart Marketing/MarketingMain.jsp"><img src="images/erp/Marketing1.png" width="140" height="130" border="0"  id='Marketing' name='Marketing'   title='M A R K E T I N G   M O D U L E'  onmouseover="  this.style.border = '2px solid #3fb1a7'; Marketing.src= 'images/erp/Marketing.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  Marketing.src= 'images/erp/Marketing1.png'"/></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Smart AMC/Main.jsp"><img src="images/erp/crm1.png" width="140" height="130" border="0"  id='crm' name='crm'   onmouseover="  this.style.border = '2px solid #3fb1a7'; crm.src= 'images/erp/crm.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  crm.src= 'images/erp/crm1.png'" title='C R M   M O D U L E' /></a>
							  </center>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Smart SMS/Smsmain.jsp"><img src="images/erp/sms1.png" width="140" height="130" border="0" / id='sms' name='sms'   onmouseover="  this.style.border = '2px solid #3fb1a7'; sms.src= 'images/erp/sms.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  sms.src= 'images/erp/sms1.png'" title='S M S   M O D U L E' ></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
					   ...
					   <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Smart Debug/Debugmain.jsp"><img src="images/erp/debug1.png" width="140" height="130" border="0"  id='debug' name='debug'   onmouseover="  this.style.border = '2px solid #3fb1a7'; debug.src= 'images/erp/debug.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  debug.src= 'images/erp/debug1.png'"  title='D E B U G   M O D U L E' /></a>
                           </center> </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-2">
                        <div class="color-swatches">
                          <div class="swatches">
                            ...
                            <div class="infos"><center>
                              <a href="Logout.jsp"><img src="images/erp/Logout1.png" width="140" height="130" border="0"  id='Logout' name='Logout'   onmouseover=" this.style.border = '2px solid #3fb1a7'; Logout.src= 'images/erp/Logout.png'"  onmouseout=" this.style.border = '2px solid #ffffff';  Logout.src= 'images/erp/Logout1.png'" title='L O G O U T   M O D U L E' /></a>
                            </center></div>
                          </div>
                        </div>
                      </div>
...
*/
 ...
 <div class="container">
  ...
  <button type="button" onClick="this.parentNode.parentNode.removeChild(this.parentNode);" class="close" data-dismiss="alert"><span aria-hidden="true">W</span><span class="sr-only">Close</span></button>
  <h5>Birthday wishes!</h5><marquee><%=message%></marquee>
</div>
	</div>
</div>
