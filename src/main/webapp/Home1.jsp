...
<table width="100%"   border="0" cellpadding="1" cellspacing="1" bgcolor="#cccccc">
	...
	<tr>
	  <td  valign="top"><table border="0" align="center" cellpadding="5" cellspacing="5" >
...
*/
	...
	<tr>
	  <td height="21" valign="middle" class="copyright"><marquee> <%=message%> </marquee>  </td>
  </tr>
	<tr>
	  <td height="21" valign="middle" class="copyright">
	  <%
