...
{
	var url = "../AMC?actionS=LoadAMCPersonalinfo&id="+escape(ctr.value);
	initRequest(url);
...
function AMCPersonalinfoMessages() 
{
    	...
    	for(loop = 0; loop < batchs.childNodes.length; loop++) 
    	{
	    	...
	    	Name= batch.getElementsByTagName("Name")[0];
 			...
 			str = str+"<tr class='MRow2'><td class='boldEleven' colspan='2'><center><b>CUSTOMER INFORMATIONS</b></center>";
