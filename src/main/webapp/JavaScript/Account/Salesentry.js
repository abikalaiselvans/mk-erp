...
function LoadSales(startLetter)
 {
 	var month = document.getElementById('Financialyear').value;
 	var customer = document.getElementById('customer').value;
 	var url = "../Account?actionS=LoadSales&startLetter="+escape(startLetter)+"&month="+month+"&customer="+customer;
   	initRequest(url);
