...
function demandDetails() 
{
	...
	for(loop = 0; loop < batchs.childNodes.length; loop++) 
    {
	   ...
	   //   str=str+"<td  class='boldEleven'><a href=DemandEdit.jsp?rowid="+id+"><font class='boldEleven'><font color='blue'>"+grade+"</a></td>";
	...
	document.getElementById('noID').innerHTML="<font  class='bolddeepred'>Total no of Records :: "+loop+"</font>";
