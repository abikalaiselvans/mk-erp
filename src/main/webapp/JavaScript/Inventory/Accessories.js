...
function LoadAccessories(startLetter)
 {
 	var url = "../inventory?actionS=LoadAccessories&startLetter="+escape(startLetter);
   	initRequest(url);
	req.onreadystatechange=AccessoriesRequest;
...
{	 
    ...
    {	     
	    ...
	    var Narration = batch.getElementsByTagName("Desc")[0].childNodes[0].nodeValue;
	    if(loop%2==1)
