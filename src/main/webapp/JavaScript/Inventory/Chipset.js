...
function LoadChipset(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadChipset&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadChipsetRequest;
