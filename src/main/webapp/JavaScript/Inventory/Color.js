...
function LoadColor(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadColor&startLetter="+escape(startLetter);
		...
		initRequest(url);
		req.onreadystatechange=LoadColorRequest;
...
{	 
 try
 {
	 ...
	 str=str+"<td  class='boldEleven'><center><b>COLOR</b></center></td>";
	 str=str+"</tr>";
