...
function loadEmdViewMessages() 
{
	try 
	{
		...
		str = str + "<td class='boldEleven'><b>Ref No</b></td>";
		str = str + "<td class='boldEleven'><b>Type</b></td>";
		str = str + "<td class='boldEleven'><b>Division</b></td>";
		str = str + "<td class='boldEleven'><b>Entry</b></td>";
		str = str + "<td class='boldEleven'><b>Customer Name</b></td>";
		str = str + "<td class='boldEleven'><b>Emd Amount</b></td>";
		str = str + "<td class='boldEleven'><b>Tender Last Date</b></td>";
		str = str + "<td class='boldEleven'><b>Print</b></td>";
		str = str + "<td class='boldEleven'><b>Accept</b></td>";
		...
		for (loop = 0; loop < batchs.childNodes.length; loop++) 
		{
			...
			str = str + "<td  class='boldEleven'  > " + EmdType+ "</td>";
			...
			str = str + "<td  class='boldEleven'><a target='_blank' href='EMDPrint.jsp?Rowid="+Emdid+"'><font class='bolddeepred'>Print</font></a></td>";
		...
		tb.innerHTML = "<font  class='bolddeepred'>Total no of Records : "
