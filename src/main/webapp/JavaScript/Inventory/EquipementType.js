...
function LoadEquipementType(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadEquipementType&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadSpareProductRequest;
 ...
 function LoadSpareProductRequest() 
 {
 	try
 	{
	    if(req.readyState == 4) 
...
function LoadSpareProductMessages() 
{	 
 try
 {
