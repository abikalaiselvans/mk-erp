...
function LoadGraphics(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadGraphics&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadGraphicsRequest;
