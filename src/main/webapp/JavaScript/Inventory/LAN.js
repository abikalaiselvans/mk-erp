...
function LoadLAN(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadLAN&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadLANRequest;
