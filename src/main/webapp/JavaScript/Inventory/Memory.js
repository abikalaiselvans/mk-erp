...
function LoadMemory(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadMemory&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadMemoryRequest;
