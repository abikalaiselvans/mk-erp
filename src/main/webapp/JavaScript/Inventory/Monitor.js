...
function LoadMonitor(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadMonitor&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadMonitorRequest;
