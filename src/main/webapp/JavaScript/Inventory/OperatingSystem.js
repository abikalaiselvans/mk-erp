...
function LoadOperatingSystem(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadOperatingSystem&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadOperatingSystemRequest;
 ...
 function LoadOperatingSystemRequest() 
 {
 	try
 	{
	    if(req.readyState == 4) 
...
function LoadOperatingSystemMessages() 
{	 
 try
 {
