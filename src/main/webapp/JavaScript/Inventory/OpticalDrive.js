...
function LoadOpticalDrive(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadOpticalDrive&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadOpticalDriveRequest;
 ...
 function LoadOpticalDriveRequest() 
 {
 	try
 	{
	    if(req.readyState == 4) 
...
function LoadOpticalDriveMessages() 
{	 
 try
 {
