...
function LoadProcessor(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadProcessor&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadProcessorRequest;
...
function LoadProcessorMessages() 
{	 
 try
 {
