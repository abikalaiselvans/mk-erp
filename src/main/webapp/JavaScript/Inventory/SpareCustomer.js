...
function LoadSpareCustomer(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadSpareCustomer&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=SpareCustomerRequest;
...
function SpareCustomerMessages() 
{	 
 try
 {
