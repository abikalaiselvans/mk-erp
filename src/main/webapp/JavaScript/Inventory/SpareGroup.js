...
function LoadSpareGroup(startLetter)
{
	try
	{
	 	var url = "../Spare?actionS=LoadSpareGroup&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadSpareGroupRequest;
 ...
 function LoadSpareGroupRequest() 
 {
 	try
 	{
	    if(req.readyState == 4) 
...
function LoadSpareGroupMessages() 
{	 
 try
 {
