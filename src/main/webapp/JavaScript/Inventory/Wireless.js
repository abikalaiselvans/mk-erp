...
function LoadWireless(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadWireless&startLetter="+escape(startLetter);
	 	initRequest(url);
		req.onreadystatechange=LoadWirelessRequest;
