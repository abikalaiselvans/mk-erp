...
function LoadCourier(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadCourier&startLetter="+escape(startLetter);
		...
		initRequest(url);
		req.onreadystatechange=LoadCourierRequest;
...
{	 
 try
 {
	 ...
	 str=str+"<td  class='boldEleven'><center><b>Courier Name</b></center></td>";
	 str=str+"</tr>";
