...
function LoadCustomerGroup(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadCustomerGroup&startLetter="+escape(startLetter);
...
{	 
 try
 {
	 ...
	 {	     
		...
		str=str+"<td  class='boldEleven' width='10%'><input id='rowid' name='rowid' type='checkbox' value='"+Rowid+"' />"+(loop+1)+"</td>";
		str=str+"<td  class='boldEleven' width='60%'> "+Name+"</td>";
		str=str+"<td  class='boldEleven' width='30%'> "+Short+"</td>";
