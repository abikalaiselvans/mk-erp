...
function LoadCustomerType(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadCustomerType&startLetter="+escape(startLetter);
		...
		initRequest(url);
		req.onreadystatechange=LoadCustomerTypeRequest;
 ...
 function LoadCustomerTypeRequest() 
 {
 	try
 	{
	    if(req.readyState == 4) 
...
function LoadCustomerTypeMessages() 
{	 
 try
 {
	 ...
	 str=str+"<td  class='boldEleven' align='center'><b>Customer Type </b></td>";
	 str=str+"</tr>";
