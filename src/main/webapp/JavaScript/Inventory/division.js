...
function LoadDivision(startLetter)
{
	try
	{
		...
		var url = "../inventory?actionS=LoadDivision&startLetter="+escape(startLetter)+"&office="+office+"";
		...
		initRequest(url);
		req.onreadystatechange=LoadDivisionRequest;
...
{	 
 try
 {
	 ...
	 str=str+"<td  class='boldEleven'><center><b>Division Name</b></center></td>";
	 str=str+"<td  class='boldEleven'><center><b>Shortname</b></center></td>";
	 str=str+"<td  class='boldEleven'><center><b>Email</b></center></td>";
	 str=str+"<td  class='boldEleven'><center><b>Office</b></center></td>";
	 str=str+"<td  class='boldEleven'><center><b>Head</b></center></td>";
	 str=str+"</tr>";
	 ...
	 {	     
	    ...
	    var Shortcode = batch.getElementsByTagName("Shortcode")[0].childNodes[0].nodeValue;
	    ...
	    var Head = batch.getElementsByTagName("Head")[0].childNodes[0].nodeValue;
		...
		str=str+"<td  class='boldEleven'> "+Shortcode+"</td>";
		str=str+"<td  class='boldEleven'> "+Email+"</td>";
		str=str+"<td  class='boldEleven'> "+Cid+"</td>";
		str=str+"<td  class='boldEleven'> "+Head+"</td>";
		str=str+"</tr>";
