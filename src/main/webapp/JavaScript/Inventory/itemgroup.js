...
function LoadItemGroup(startLetter)
{
	try
	{
	 	var url = "../inventory?actionS=LoadItemGroup&startLetter="+escape(startLetter);
		...
		initRequest(url);
		req.onreadystatechange=LoadItemGroupRequest;
...
function LoadItemGroupMessages() 
{	 
 try
 {
