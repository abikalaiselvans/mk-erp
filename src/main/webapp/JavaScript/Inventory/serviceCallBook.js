...
function LoadAMCSerialNumber(control,div,tablename,fieldname,button) 
{
	var value =document.getElementById(control).value;
	{
		...
		buttonname= button;
		serialname = control;
		var url = "../inventory?actionS=LoadAMCSerialnumber&tablename="+escape(tablename);
...
function AMCSerialNumberMessages() 
{
 ...
 function  LoadAMCcustomerinfo(ctr)
 {
	...
	var url = "../inventory?actionS=LoadAMCcustomerinfo&serialnumber="+escape(serialnumber);
	alert(url);
	initRequest(url);
