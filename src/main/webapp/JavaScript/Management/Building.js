...
function loadBuilding(startLetter)
{
	var url = "../management?actionS=loadBuilding&startLetter="+escape(startLetter);  
	initRequest(url);
   	req.onreadystatechange = loadBuildingRequest;
    req.open("GET", url, true);
    req.send(null);    
}	
 

function loadBuildingRequest()
 {
