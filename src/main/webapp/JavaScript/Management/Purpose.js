...
function loadPurpose(startLetter)
{
	var url = "../management?actionS=loadPurpose&startLetter="+escape(startLetter);  
	initRequest(url);
   	req.onreadystatechange = loadPurposeRequest;
    req.open("GET", url, true);
    req.send(null);    
}	
 

function loadPurposeRequest()
 {
