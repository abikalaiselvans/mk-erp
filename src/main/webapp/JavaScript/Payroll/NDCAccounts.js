...
function LoadNDCAccounts(startLetter) 
{         
   
    var month = document.getElementById('month').value;
    var year = document.getElementById('year').value;
    var status = document.getElementById('status').value;
    var url = "../Payroll?actionS=LoadNDCAccounts&startLetter="+startLetter+"&type=1&month="+month+"&year="+year+"&status="+status;
	initRequest(url);
...
function LoadNDCAccountss() 
{         
	var startLetter = document.getElementById('search').value;
    var month = document.getElementById('month').value;
    var year = document.getElementById('year').value;
    var status = document.getElementById('status').value;
    var url = "../Payroll?actionS=LoadNDCAccounts&startLetter="+startLetter+"&type=2&month="+month+"&year="+year+"&status="+status;
	initRequest(url);
    req.onreadystatechange = LoadNDCStoreRequest;
    req.open("GET", url, true);
    req.send(null);
