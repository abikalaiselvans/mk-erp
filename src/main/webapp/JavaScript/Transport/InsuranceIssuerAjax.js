...
function LoadIssuer(startLetter)
 {
 	var url = "../Transport?actionS=LoadIssuer&startLetter="+escape(startLetter);
    initRequest(url);
	req.onreadystatechange=IssuerRequest;
