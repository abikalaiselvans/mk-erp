...
function LoadModel(startLetter)
{
 	var typeid= document.getElementById('vehiclemake').value;
 	var url = "../Transport?actionS=LoadModel&startLetter="+escape(startLetter)+"&typeid="+typeid;
 	initRequest(url);
	req.onreadystatechange=LoadModelRequest;
