...
function LoadVehicleType(startLetter)
{
 	var url = "../Transport?actionS=LoadVehicleType&startLetter="+escape(startLetter);
 	initRequest(url);
	req.onreadystatechange=VehicleTypeRequest;
    req.open("GET", url, true);
    req.send(null);
}
 

function VehicleTypeRequest() 
{
    if(req.readyState == 4) 
    {    	
