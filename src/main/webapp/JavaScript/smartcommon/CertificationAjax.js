...
function  loadCertification(str) 
{
	var url = "../SmartCommonAjax?actionS=loadCertification&str="+str;
	initRequest(url);
	req.onreadystatechange = CertificationRequest;
...
function CertificationMessages() 
{	 
