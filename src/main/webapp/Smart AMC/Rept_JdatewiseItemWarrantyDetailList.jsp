		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="250"
			...
			<tbody>
				...
				<tr>
				  ...
				  <td width="412"><table width="382" height="283" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td height="40" colspan="2"><div align="center" class="bigusername">Item Warranty    Detail List </div></td>
                    </tr>
                    <tr>
                      <td height="24" class="boldEleven">From Date <span
									class="bolddeepred">* </span></td>
                      <td><input
									tabindex="2" name="fromdate" type="text" class="formText135"
									id="fromdate" size="15" readonly="readonly">                      </td>
                    </tr>
                    <tr>
                      <td height="25" class="boldEleven">To Date <span
									class="bolddeepred">* </span></td>
                      <td><input tabindex="2"
                    ...
                    <tr>
                      ...
                      <td><span class="copyright style3">
                        <select name="servicecenter" class="formText135"  id="servicecenter"    onChange="LoadRuntimeCustomer(this)" style="width:200">
				...
				%>
                    ...
                    <tr>
                      ...
                      <td><select name="Customergroup" class="formText135"  id="Customergroup"  style="width:200">
                          <option value="0">All</option>
                          <%
				String readDatass[][] = CommonFunctions.QueryExecute("SELECT INT_GROUPID,CHR_GROUPNAME FROM inv_m_servicecustomergroup ORDER BY CHR_GROUPNAME");
				...
				%>
                    ...
                    <tr>
                      ...
                      <td><select name="sparecall" class="formText135" id="sparecall" style="width:200">
                          <option value="0">All</option>
                    ...
                    <tr>
                      <td colspan="2"><table width="112" border="0" align="center" cellpadding="1"
                        ...
                        <input name="filename" type="hidden" id="filename"
										value="Rept_JdatewiseItemWarrantyDetailList">
                        <input name="actionS"
										type="hidden" id="actionS"
										value="AMCRept_JdatewiseItemWarrantyDetailList">
                        <input name="rptfilename" type="hidden" id="rptfilename" value="datewiseItemWarrantyDetailList">
                      </span></td>
                    </tr>
                  </table></td>
