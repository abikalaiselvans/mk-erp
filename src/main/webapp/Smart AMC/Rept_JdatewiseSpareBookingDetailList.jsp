			...
			<tbody>
				...
				<tr>
				  ...
				  <td width="412"><table width="382" height="283" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                      <td height="40" colspan="2"><div align="center" class="bigusername">Spare Booking   Detail List </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span class="copyright style3">
                        <select name="servicecenter" class="formText135"  id="servicecenter" style="width:200" onChange="LoadRuntimeCustomer(this)">
				...
				%>
                        ...
                        <input name="branch" type="hidden" style="width:200" id="branch" value="<%=""+session.getAttribute("AMCBRANCH")%>">
                      </span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="boldEleven">Call Status <span
									class="bolddeepred"></span></td>
                      <td><select name="callstatus" class="formText135" id="callstatus" style="width:200">
                          <option value="0" >All</option>
                    ...
                    <tr>
                      <td colspan="2"><table width="112" border="0" align="center" cellpadding="1"
                        ...
                        <input name="filename" type="hidden" id="filename"
										value="Rept_JspareBookingDetailList">
                        <input name="actionS"
										type="hidden" id="actionS"
										value="AMCRept_JspareBookingDetailList">
                        <input name="rptfilename" type="hidden" id="rptfilename" value="spareBookingDetailList">
                      </span></td>
                    </tr>
                  </table></td>
