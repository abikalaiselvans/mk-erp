			...
			<tbody>
				...
				<tr>
				  ...
				  <td width="412"><table width="327" border="0" cellspacing="2" cellpadding="2">
                    <tr>
                      <td height="40" colspan="2"><div align="center" class="bigusername">Service Item Count Detail List </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2"><table width="112" border="0" align="center" cellpadding="1"
                        ...
                        <input name="filename" type="hidden" id="filename"
										value="Rept_JserviceItemCountInfo">
                        <input name="actionS"
										type="hidden" id="actionS"
										value="AMCRept_JserviceItemCountInfo">
                        <input name="rptfilename" type="hidden" id="rptfilename" value="serviceItemCountList">
                      </span></td>
                    </tr>
                  </table></td>
