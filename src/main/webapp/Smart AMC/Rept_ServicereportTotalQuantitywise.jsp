...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
	  <td><form name="frm" method="post" action="Rept_ServicereportTotalQunatityresponse.jsp" onSubmit="return validate()">
				  ...
				  <td width="412"><table width="500" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td><input tabindex="2"
									...
									size="15" readonly="readonly"><script language="javascript">setCurrentDate('fromdate');setCurrentDate('todate');</script>
                         </td>
                    </tr>
                    <tr>
