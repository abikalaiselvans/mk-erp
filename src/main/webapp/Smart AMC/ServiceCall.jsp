...
<script language="javascript" src="../JavaScript/AMC/serviceCallBooking.js"></script>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<table width="90%" height="189" border="0" align="center"
			...
			<tr  >
				...
				<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" class="whiteMedium">
					<tr>
					  <td height="28" colspan="6" align="center"  ><table width="500" border="0" align="center" cellpadding="3" cellspacing="4" class="whiteMedium">
                        <tr>
                          <td  >Branch </td>
                          <td  ><span  >
                            <select name="branch" id="branch"  onChange="LoadRuntimeCustomer('servicecenter')" class="formText135" onBlur="LoadAMCCallBooking('0')" style="width:200" >
                               <%
			   ...
			   %>
                            </select><script language="javascript">setOptionValue('branch','<%=branchid%>')</script>
                          </span></td>
                          <td>Search</td>
                          <td><input name="search" type="text" class="formText135" id="search" onBlur="LoadAMCCallBookings()" onKeyUp="upperMe(this),LoadAMCCallBookings()"></td>
                        </tr>
                      </table></td>
				  </tr>
					<tr>
    ...
    String readData[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(" SELECT INT_CUSTOMERID, CHR_CUSTOMERNAME from inv_m_servicecustomerinfo WHERE INT_BRANCHID="+""+session.getAttribute("BRANCHID") +"  ORDER BY CHR_CUSTOMERNAME");
								%>
                        <select name="customerid" id="customerid" class="formText135" onChange="LoadAMCCallBooking('0')" style="width:200" >
		...
		%>
					  ...
					  <td  >Booking Type</td>
					  <td><select name="bookingtype" class="formText135" id="bookingtype"  onChange="LoadAMCCallBooking('0')" style="width:200">
                        <option value="0" >All</option>
					  ...
					  <td  >Booking Under</td>
					  <td><select name="bookingunder" class="formText135" id="bookingunder"  onChange="LoadAMCCallBooking('0')" style="width:200">
                        <option value="0" >All</option>
					...
					<tr>
					  ...
					  <td><select name="callstatus" class="formText135" id="callstatus"  onChange="LoadAMCCallBooking('0')" style="width:200">
                        <option value="0" >All</option>
					  ...
					  <td><span class="boldThirteen">
					    <select name="month" class="formText135" id="month" onBlur="LoadAMCCallBooking('0')" style="width:200">
						<option value="0" >All</option>
					  ...
					  <td><span class="boldThirteen">
					    <select name="year" class="formText135"
							id="year" onBlur="LoadAMCCallBooking('0')" style="width:200">
			...
			<tr class="MRow1">
				...
				<br><div id="divscroll" style="OVERFLOW:auto;width:99%;height:400px"
							 ></div><br><div align="center" id="totRec"></div>	
				<br>
			  </td>
		  </tr>
		</table>
	...
	<tr>
		...
		<input name="actionS" type="hidden" value="AMCServiceDelete" /></td>
	</tr>
	<tr>
		<td>
	  ...
	  %>
				<td width="56"><input type="submit" class="ButtonHead"
					name="Submit" id="Delete" value="Delete"
