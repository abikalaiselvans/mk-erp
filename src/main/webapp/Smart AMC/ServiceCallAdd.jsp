...
<script language="javascript" src="../JavaScript/AMC/serviceCallBook.js"></script>
...
function Validate()
{
 ...
 function serviceSerialNumber()
 {
	...
	{
		if( checkNullSelect("select","Select Serial number",""))
			return true;
		else
		{
			alert("Kindly select the serial number");
			return false
		}	
	}
	 ...
	 function  checkcallserialno()
 {
		...
		var url = "../AMC?actionS=CustomerServiceCallSerialnumberCheck&serialno="+escape(serialno)+"&startdate="+startdate;
		initRequest(url);
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="800"
			...
			<tbody>
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="17" valign="top" class="boldEleven">Service Center <font
									color="ff0000">*</font> </td>
							  <td height="17" valign="top" class="boldEleven"><span class="copyright style3">
							    <select name="servicecenter" class="formText135"  id="servicecenter"    onChange="LoadRuntimeCustomer(this)" style="width:300"     >
				...
				%>
							    ...
							    <input name="branch" type="hidden" id="branch" value="<%=""+session.getAttribute("AMCBRANCH")%>">
							  </span></td>
    ...
    String readData[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(" SELECT INT_CUSTOMERID, CHR_CUSTOMERNAME from inv_m_servicecustomerinfo WHERE INT_BRANCHID="+""+session.getAttribute("BRANCHID") +" ORDER BY CHR_CUSTOMERNAME");
								%>
                                <select name="customerid" id="customerid" class="formText135" onBlur="LoadAMCSerialNumberCustomerwise('customerid')" style="width:300">
		...
		%>
							...
							<tr>
								<td height="17" valign="top" class="boldEleven">Call Log Date <font
									color="ff0000">*</font></td>
							  <td height="17" valign="top" class="boldEleven"><input
									name="startdate" type="text" class="formText135" id="startdate"
									onKeyPress="dateOnly(this)" size="27" maxlength="10" readonly />  
						...
						<!--			
							...
							setCurrentDateandTime('endingdateandtime'); 
						//-->
                       </script>
...
$('#startdate').datetimepicker({
	...
	minDate: -10, maxDate: "+1D" ,showOn: "button",
			...
			buttonImageOnly: true
							...
							<tr>
								<td height="17" rowspan="3" valign="top" class="boldEleven">Problems <font
									color="ff0000">*</font></td>
								<td height="17" rowspan="3" valign="top" class="boldEleven"><textarea
									name="description" cols="30" rows="5" class="formText135"
									id="description" onBlur="textArea('description','200')"  ></textarea></td>
							...
							<tr>
							  <td height="17" class="boldEleven">Mobile  <font
									color="ff0000">*</font></td>
							  <td height="17" class="boldEleven"><input name="cmobile" type="text" class="formText135" id="cmobile" size="30" onKeyPress="return numeric_only(event,'cmobile','11')" maxlength="10"></td>
							  <td align="left" class="boldEleven">Email  <font
									color="ff0000">*</font></td>
						      <td align="left" class="boldEleven"><span class="boldEleven">
							...
							<tr>
							  ...
							  <input name="actionS"
									type="hidden" value="AMCServiceAdd" />
