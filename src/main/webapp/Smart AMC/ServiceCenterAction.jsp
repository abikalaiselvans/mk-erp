                  ...
                  <td width="412"><table cellspacing="2" cellpadding="2" width="388" align="center"
                      ...
                      <tbody>
                        <tr>
                          <td height="16" colspan="3" align="center" valign="top" 	class="boldThirteen">SERVICE CENTER  
							...
							if("Add".equals(action))
							{
								...
								actionS="AMCServiceCenterAdd";
								value="Add";
								link="onKeyUp=\" CheckUnique(this,'divunitname','inv_m_servicecenter','CHR_CENTERNAME')\" ";
							}
							else
							{
								id="";Name="";shortName="";peremailid="";mobile="";
                        ...
                        <tr>
                          ...
                          <td width="229" colspan="2" align="left"><input name="ServiceCenter" type="text" class="formText135" id="ServiceCenter" value="<%=Name%>"  size="25" maxlength="50" <%=link%> onBlur="upperMe(this)">
                          <div id='divunitname'></div></td>
                        </tr>
                        <tr>
                          <td height="17" class="boldEleven">Short Name  <font
									color="ff0000">*</font></td>
                          <td colspan="2" align="left"><input name="shortName" type="text" class="formText135" id="shortName" value="<%=shortName%>" size="25" maxlength="3" onKeyUp="upperMe(this),CheckUnique(this,'divunitname1','inv_m_servicecenter','CHR_SHORTNAME')" onBlur="upperMe(this), CheckUnique(this,'divunitname1','inv_m_servicecenter','CHR_SHORTNAME')">
                            <div id='divunitname1'></div></td>
                        </tr>
                        <tr>
                          <td height="17" class="boldEleven">Email <font
									color="ff0000">*</font></td>
                          <td colspan="2" align="left"><input name="peremailid" type="text"
																class="formText135" id="peremailid"
																  value="<%=peremailid%>" size="25" maxlength="100" /></td>
                        </tr>
                        <tr>
                          <td height="17" class="boldEleven">Mobile</td>
                          <td colspan="2" align="left"><input name="mobile" type="text"
																class="formText135" id="mobile"
															onKeyPress="return numeric_only(event,'mobile','11')"  value="<%=mobile%>" size="25"
																maxlength="10" /></td>
                        </tr>
