...
<script language="javascript" src="../JavaScript/AMC/serviceCallAssign.js"></script>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table height="189" border="0" align="center"
			...
			<tr  >
				...
				<table border="0" align="center" cellpadding="3" cellspacing="3" class="whiteMedium">
					<tr>
					  ...
					  <td><select name="branch" id="branch"  class="formText135"   onChange="LoadAMCCallAssign('0')" style="width:200"  >
                          <%
			   ...
			   %>
					  ...
					  <td  ><strong>
                        <select name="servicecenter" class="formText135"  id="servicecenter"   onChange="LoadAMCCallAssign('0')"  style="width:200" >
				...
				%>
					  ...
					  <td><select name="callstatus" class="formText135" id="callstatus"  onChange="LoadAMCCallAssign('0')"  style="width:200" >
                        <option value="0" >All</option>
			...
			<tr class="MRow1">
				...
				<br>
				<div id="divscroll"  style="OVERFLOW:auto;width:99%;height:400px"
							 ></div>
				<br>
				 				</td>
		  </tr>
	...
	<tr>
		...
		<input name="actionS" type="hidden" value="AMCServiceCallAssignHistoryDELETE" /></td>
	</tr>
	<tr>
		<td>
