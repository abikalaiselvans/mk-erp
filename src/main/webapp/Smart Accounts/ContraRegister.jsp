    ...
    <td><table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="ContraRegisterResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="73%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">CONTRA REGISTER </div></td>
                </tr>
              <tr>
