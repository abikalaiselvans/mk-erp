...
<script language="javascript" src="../JavaScript/Account/Credit.js"></script> 
<script language="JavaScript">

    function GAdd()
	{ 
		document.frm.action="CreditAction.jsp";//CreditDebitGroupAction.jsp
 	}
	...
	function GEdit()
 	{		
		...
		if(count==1){			
			document.frm.action="CreditAction.jsp";
			return true;
		}
		else
		{
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="LoadCredit('0')" >
	...
	<tr>
	  <td height="19"><table width="600" height="200" border="0" align="center"
			cellpadding="0" cellspacing="0"  
			 >
        <tr class="BackGround">
          <td height="31" class="BackGround"><div align="center">Credit Entry</div></td>
        </tr>
        <tr class="BackGround">
          <td height="31" class="BackGround"><table width="475" border="0" align="center" cellpadding="0"
            ...
            <tr>
			  ...
			  <select name="customer" class="formText135" id="customer" onChange="LoadCredit('0')">
	  ...
	  <td height="19"><table width="600" border="0" align="center" cellpadding="1"
        ...
        <tr class="para">
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('0')">All</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('A')">A</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('B')">B</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('C')">C</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('D')">D</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('E')">E</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('F')">F</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('G')">G</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('H')">H</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('I')">I</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('J')">J</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('K')">K</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('L')">L</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('M')">M</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('N')">N</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('O')">O</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('P')">P</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('Q')">Q</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('R')">R</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('S')">S</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('T')">T</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('U')">U</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('V')">V</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('W')">W</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('X')">X</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('Y')">Y</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadCredit('Z')">Z</a></div></td>
        </tr>
      </table></td>
  </tr>
	<tr>
	  <td height="19"><input type="hidden" name="filename" value="Credit" />
        <input type="hidden" name="actionS" value="ACCCreditDelete" /></td>
  </tr>
	<tr>
