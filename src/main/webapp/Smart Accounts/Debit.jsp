...
<script language="javascript" src="../JavaScript/Account/Debit.js"></script> 
<script language="JavaScript">

    function GAdd()
	{ 
		document.frm.action="DebitAction.jsp";//CreditDebitGroupAction.jsp
 	}
	...
	function GEdit()
 	{		
		...
		if(count==1){			
			document.frm.action="DebitAction.jsp";
			return true;
		}
		else
		{
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="LoadDebit('0')" >
	...
	<tr>
	  <td height="19"><table width="600" height="200" border="0" align="center"
			cellpadding="0" cellspacing="0"  
			 >
        <tr class="BackGround">
          <td height="31" class="BackGround"><div align="center">Debit Entry</div></td>
        </tr>
        <tr class="BackGround">
          <td height="31" class="BackGround"><table width="475" border="0" align="center" cellpadding="0"
            ...
            <tr>
			  ...
			  <select name="customer" class="formText135" id="customer" onChange="LoadDebit('0')">
	  ...
	  <td height="19"><table width="600" border="0" align="center" cellpadding="1"
        ...
        <tr class="para">
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('0')">All</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('A')">A</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('B')">B</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('C')">C</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('D')">D</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('E')">E</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('F')">F</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('G')">G</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('H')">H</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('I')">I</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('J')">J</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('K')">K</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('L')">L</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('M')">M</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('N')">N</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('O')">O</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('P')">P</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('Q')">Q</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('R')">R</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('S')">S</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('T')">T</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('U')">U</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('V')">V</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('W')">W</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('X')">X</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('Y')">Y</a></div></td>
          <td class="boldEleven"><div align="center"><a
					href="javascript:LoadDebit('Z')">Z</a></div></td>
        </tr>
      </table></td>
  </tr>
	<tr>
	  <td height="19"><input type="hidden" name="filename" value="Debit" />
        <input type="hidden" name="actionS" value="ACCDebitDelete" /></td>
  </tr>
	<tr>
