        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="73%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> Groups </div></td>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="Name" type="text" class="formText135" id="Name" maxlength="50"     onBlur="upperMe(this)"     onKeyUp="upperMe(this)"></td>
              </tr>
              <tr>
                <td class="boldEleven">&nbsp;</td>
                <td class="boldEleven"><input type="hidden" name="filename" value="Group" />
                  <input type="hidden" name="actionS" value="ACCGroupAdd" /></td>
              </tr>
              <tr>
