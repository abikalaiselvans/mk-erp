        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="59%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Payements Add </div></td>
                </tr>
              <tr>
              ...
              <tr>
				...
				<%
					String data[][] =  com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_GROUPID,CHR_GROUPNAME FROM acc_m_group WHERE CHR_GROUP='D'  ORDER BY CHR_GROUPNAME");
	...
	%>
		...
		//-->
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="Amount" type="text" class="formText135" id="Amount" style='text-align:right' onKeyPress="doubleValue('Amount','12')"></td>
              </tr>
              <tr>
                <td class="boldEleven">&nbsp;</td>
                <td class="boldEleven"><input name="filename"
                  ...
                  <input name="actionS"
									type="hidden" value="ACCPayementsAdd" /></td>
              </tr>
              <tr>
