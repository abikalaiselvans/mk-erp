...
function Validate()
  {
	...
	if( 
	 ...
	 && checkNull( "purchaseno","Enter Purchase Number " )
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="400" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Purchase Entry  
                    <%
							...
							else
							{
								...
								sql = " SELECT INT_PURCHASEID,INT_CUSTOMERID,DOU_AMOUNT,CHR_DESC,DATE_FORMAT(DAT_DATE,'%d-%m-%Y'),CHR_PURCHASENO  FROM acc_t_purchaseentry WHERE INT_PURCHASEID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1]; 
								customer=data[0][1];desc=data[0][3];date=data[0][4];amount=data[0][2];
								purchaseno=data[0][5];
								actionS="ACCPurchaseEntryEdit";
								value="Update";
							}
              ...
              <tr>
                <td valign="top" class="boldEleven">purchase Invoice  </td>
                <td valign="top" class="boldEleven"><input name="purchaseno" type="text" class="formText135" id="purchaseno" size="30" maxlength="30" onBlur="upperMe(this), CheckUnique(this,'divunitname','acc_t_purchaseentry','CHR_PURCHASENO')"
				 onKeyUp="upperMe(this),CheckUnique(this,'divunitname','acc_t_purchaseentry','CHR_PURCHASENO')" value="<%=purchaseno%>">
		...
		//-->
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="PurchaseEntry" />
                ...
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"
											...
											onClick="redirect('PurchaseEntry.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
