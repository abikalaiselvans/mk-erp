    ...
    <td><table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="RegisterResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="73%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> REGISTER </div></td>
                </tr>
              <tr>
                <td class="boldEleven">Account Name  </td>
                <td class="boldEleven"><select name="customer" class="formText135" id="customer" >
				 <option value="0">All</option>
				 <%
				String readData[][] =  com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_LEDGERID,CHR_NAME FROM  accc_m_ledger   ORDER BY CHR_NAME");
		...
		//-->
              ...
              <tr>
				...
				<select name="order" id="order">
					<option value="b.CHR_TYPESUBSIDIARYNAME">Customer</option>
					<option value="a.DT_DATE">Date</option>
                </select>                </td>
              </tr>
              <tr>
