...
function Validate()
  {
	...
	if( 
	 ...
	 && checkNull( "salesno","Enter Sales Number " )
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="400" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Sales Entry  
                    <%
							String action=request.getParameter("action1");
							String id="",Name="",actionS="",value="";
							String customer="",salesno="",desc="",date="",amount="";
							String sql="";
							if("Add".equals(action))
							{
								id="";Name=""; customer="";desc="";date="";amount="";salesno="";
								actionS="ACCSalesEntryAdd";
								value="Add";
							}
							else
							{
								...
								sql = " SELECT INT_SALESID,INT_CUSTOMERID,DOU_AMOUNT,CHR_DESC,DATE_FORMAT(DAT_DATE,'%d-%m-%Y'),CHR_SALESNO  FROM acc_t_salesentry WHERE INT_SALESID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1]; 
								customer=data[0][1];desc=data[0][3];date=data[0][4];amount=data[0][2];
								salesno=data[0][5];
								actionS="ACCSalesEntryEdit";
								value="Update";
							}
              ...
              <tr>
                <td valign="top" class="boldEleven">Sale Invoice  </td>
                <td valign="top" class="boldEleven"><input name="salesno" type="text" class="formText135" id="salesno" size="30" maxlength="30" onBlur="upperMe(this), CheckUnique(this,'divunitname','acc_t_salesentry','CHR_SALESNO')"
				 onKeyUp="upperMe(this),CheckUnique(this,'divunitname','acc_t_salesentry','CHR_SALESNO')" value="<%=salesno%>">
				<div id='divunitname'></div>
				</td>
              </tr>
              <tr>
                <td valign="top" class="boldEleven">Description</td>
                <td valign="top" class="boldEleven"><textarea name="desc" cols="30" rows="5" class="formText135" onBlur=" textArea('desc','450')" id="desc"><%=desc%></textarea></td>
              </tr>
              <tr>
		...
		//-->
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="amount" type="text" class="formText135" id="amount" value="<%=amount%>" style="text-align:right" onKeyPress="doubleValue('amount','10')" ></td>
              </tr>
              <tr>
                <td class="boldEleven">&nbsp;</td>
                <td class="boldEleven">
				<input type="hidden" name="filename" value="SalesEntry" />
                ...
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"
											...
											onClick="redirect('SalesEntry.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
