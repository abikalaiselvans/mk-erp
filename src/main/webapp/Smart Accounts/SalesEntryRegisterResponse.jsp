	  ...
	  <td height="19"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <%
				...
				String sql = "";
				sql = " SELECT b.CHR_CUSTOMERNAME,a.CHR_SALESNO,a.CHR_DESC,DATE_FORMAT(a.DAT_DATE,'%d-%m-%Y'),a.DOU_AMOUNT ";
				sql = sql + " FROM  acc_t_salesentry a , acc_m_customer b WHERE a.INT_CUSTOMERID=b.INT_CUSTOMERID ";
				...
				if(data.length>0)
				{
					out.println("<tr bgcolor='#ffffff'><td  colspan='6'  class='boldEleven'><b><center> SALES ENTRY  REGISTER FROM : "+ fdate+" TO : "+tdate+"</center></b></td></tr>");
        ...
        <tr>
          <td><table width="184" align="center" cellpadding="15" cellspacing="0">
			...
			src="../Image/report/IE.GIF" width="15" height="14" border="0"></a></div></td>
              <td class="boldEleven"><input name="Close" type="button" class="buttonbold" id="Close"  value="Close"   accesskey="c"  onClick="redirect('SalesEntryRegister.jsp')"></td>
            </tr>
          </table></td>
        </tr>
      </table>
