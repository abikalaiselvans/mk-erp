...
function Validate()
  {
	...
	if( 
	 ...
	 && checkNull( "salesno","Enter Sales Return Number " )
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="400" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Sales ReturnEntry  
                    <%
							...
							if("Add".equals(action))
							{
								...
								actionS="ACCSalesReturnEntryAdd";
								value="Add";
							}
							else
							{
								...
								sql = " SELECT INT_SALESRETURNID,INT_CUSTOMERID,DOU_AMOUNT,CHR_DESC,DATE_FORMAT(DAT_DATE,'%d-%m-%Y'),CHR_SALESRETURNNO  FROM acc_t_salesreturnentry WHERE INT_SALESRETURNID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1]; 
								customer=data[0][1];desc=data[0][3];date=data[0][4];amount=data[0][2];
								salesno=data[0][5];
								actionS="ACCSalesReturnEntryEdit";
								value="Update";
							}
              ...
              <tr>
                <td valign="top" class="boldEleven">Sale Return no </td>
                <td valign="top" class="boldEleven"><input name="salesno" type="text" class="formText135" id="salesno" size="30" maxlength="30" onBlur="upperMe(this), CheckUnique(this,'divunitname','acc_t_salesreturnentry','CHR_SALESRETURNNO')"
				 onKeyUp="upperMe(this),CheckUnique(this,'divunitname','acc_t_salesreturnentry','CHR_SALESRETURNNO')" value="<%=salesno%>">
		...
		//-->
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="SalesReturnEntry" />
                ...
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"
											...
											onClick="redirect('SalesReturnEntry.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
