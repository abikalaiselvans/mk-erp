        ...
        <tr>
		  ...
		  <form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm" id="frm" onSubmit="return Validate()">
		    <table width="68%" border="0" align="center" cellpadding="3" cellspacing="3">
              ...
              <tr>
                <td class="boldEleven">Negative Cash   </td>
                <td class="boldEleven">
				<select name="select">
				<option value="0">Select</option>
				<option value="1">No Action </option>
				<option value="2">Warning Only</option>
				<option value="3">Not Allowed</option>
				
                </select>				                </td>
              </tr>
              <tr>
                <td valign="top" class="boldEleven">Negative Stock  </td>
                <td class="boldEleven">
				<select name="select">
				<option value="0">Select</option>
				<option value="1">No Action </option>
              ...
              <tr>
                <td class="boldEleven">Minimum Level  </td>
                <td class="boldEleven">
				<select name="select">
				<option value="0">Select</option>
				<option value="1">No Action </option>
              ...
              <tr>
                ...
                <td class="boldEleven"> 
                  <a
									href="javascript:cal2.popup();"> </a></td>
              </tr>
              <tr>
                <td class="boldEleven">&nbsp; </td>
                <td class="boldEleven">&nbsp; </td>
