...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  ...
	  <%
		...
		String sql=" SELECT date_format(a.DAT_DATE,'%d-%m-%Y'),b.CHR_GROUPNAME,a.DOU_AMOUNT FROM   acc_t_receipts   a,acc_m_group b WHERE a.INT_GROUPID=b.INT_GROUPID AND a.DAT_DATE>='"+fdate+"' AND a.DAT_DATE<='"+tdate+"' AND a.INT_BRANCHID="+branch+"  ORDER BY a.DAT_DATE";
		String data[][] =com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
		double income=0;
		double expense=0;
		out.println("<table width=600  id='myTable'  cellpadding=2 cellspacing=1 bgcolor='#9900CC'  align='center'>");
		out.println("<tr bgcolor='#ffffff'><td colspan='2' class='boldEleven' align='center'><b>CASH BOOK LIST</b>");
		out.println("<a title=\"Excel\" href=javascript:;	onClick=\"CreateExcelSheet()\"> Export</a>");
		out.println("</td></tr>");
		...
		//Income table
			...
			//Expense Table
			sql = "SELECT b.CHR_GROUPNAME,date_format(a.DAT_DATE,'%d-%m-%Y'),a.DOU_AMOUNT FROM  acc_t_payments  a,acc_m_group b WHERE a.INT_GROUPID=b.INT_GROUPID  AND a.DAT_DATE>='"+fdate+"' AND a.DAT_DATE<='"+tdate+"' AND a.INT_BRANCHID="+branch+"   ORDER BY a.DAT_DATE" ;
