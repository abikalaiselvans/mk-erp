...
<form  AUTOCOMPLETE = "off"   name="a" method="post" action="AttendanceDateView.jsp">
					...
					<table width="314" border=0  >
						...
						<tr align="center" valign="middle">
							<td height="28" colspan="2" 
								class="BackGround style9 style10">Absent Details</td>
						</tr>
						<tr>
							...
							<td width="265" align="left" valign="middle"><span
								class="style8"> <a href="AbsentDate.jsp"
						...
						<tr>
							...
							<td valign="middle"><span class="style8"> <a
								href="AbsentMonth.jsp" class="tabledata">Monthwise</a> </span></td>
						</tr>
						...
						<tr>
							...
							<td valign="middle"><a href="AbsentDesign.jsp"
						...
						<tr>
							...
							<a href="AbsentDept.jsp" class="tabledata">Departmentwise</a></span></td>
						</tr>
						<tr>
							<td colspan="2">
