...
<%
	...
	String reportheader="";
	reportheader=reportheader+" <b> Absentees Report For </b> "+umonth+"-"+year;
	String sorting = request.getParameter("sorting");
	String ss = request.getParameter("ss");
		
	String sql="SELECT  a.CHR_EMPID ,b.CHR_STAFFNAME,a.DOU_ABSENT  ";
...
<display:table   id="_table" name="table"    export="true">
					...
					<display:column title="ABSENT" sortable="true"><%=temp.elementAt(3)%></display:column>
...
<br />
									...
									<center>	<a href='AbsentMonth.jsp'> CLOSE</a></center>
