...
%>
 ...
 <display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PLACE" sortable="true"><%=temp.elementAt(5)%></display:column>
					<display:column title="REASON" sortable="true"><%=temp.elementAt(6)%></display:column>
...
<br />	<center>	<a href='AdminODMonth.jsp'> CLOSE</a></center>
