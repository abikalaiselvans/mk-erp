				...
				<table class="BackGround" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<table width="350" height="177" border="0" align="center"
								 >
								<!--DWLayoutTable-->
								<tr align="center" valign="middle" class="tabledata">
									<td height="25" colspan="2" class="BackGround"
										 >Attendance Designation Wise</td>
								</tr>
								<tr>
									<td width="162" height="22" valign="middle"
...
%>
								...
								<tr>
									...
									<td valign="middle"><span class="tabledata"> <%@ include
										...
										type="hidden" name="actionS" value="ATTADesignationList">
									</span></td>
								</tr>
								<tr>
