...
<form    name="a" action="AttendanceMonthResponse.jsp" onSubmit="return Validate()">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="412"><table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
                      ...
                      <tr align="center" valign="middle">
                        <td height="18" colspan="3"  class="BackGround">Attendance                           Report</td>
                      </tr>
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
                      ...
                      <tr class="bolddeepblue">
                        ...
                        <td width="250" valign="top" class="boldEleven"><select
								name="dept" id="dept" class="formText135"  style="width:150px">
                            <option value="0">All</option>
                            <%
	...
	%>
                      ...
                      <tr>
                        ...
                        <td class="boldEleven"><select name="sorting" class="formText135"  style="width:150px">
                      ...
                      <tr>
                        <td height="30" class="boldEleven">Sorted
                          By </td>
                        <td class="boldEleven"><select name="ss" class="formText135"  style="width:150px">
                      ...
                      <tr>
                        ...
                        <td valign="middle"><strong> <font
								size="1"><font size="1">
                          <select name="month"
								id="month" class="formText135"  style="width:150px">
                      ...
                      <tr>
                        ...
                        <td valign="middle"><strong>
                          <select name="year"
								id="year" class="formText135"  style="width:150px">
                            <option value="select">Select</option>
