...
out.println("<center><table id='myTable' cellpadding=5 cellspacing=1 bgcolor='#0099cc' border=0   class=\"table2excel\">");
	...
	for(int u=0;u<data.length;u++)
	{
		...
		for(int v=startingday;v<=((daysInMonth*2-startingday)+1);v++)//63
		{
			...
			if(x%2==0)
			{
				...
				link1= link1+"&name="+data[u][1]+"&month="+month+"&year="+year+"&date="+date+"&s=E')\"><font class='boldEleven' >"+em+"</font></a>";
				date = date+1;
			}	
			else
			{
				...
				link1= link1+"&name="+data[u][1]+"&month="+month+"&year="+year+"&date="+date+"&s=M')\"><font class='boldEleven' >"+em+"</font></a>";
			}	
			...
			out.println("<td class='newsarticlesmall' align=right title='PRESENT :: "+data[u][1]+"'><div align='right'>"+data[u][(x+1)]+"</div></td>");//64
			out.println("<td class='newsarticlesmall' align=right title='ONDUTY ::"+data[u][1]+"'><div align='right'>"+data[u][(x+2)]+"</div></td>");//65
			out.println("<td class='newsarticlesmall' align=right title='SUNDAY ::"+data[u][1]+"'><div align='right'>"+data[u][(x+3)]+"</div></td>");//66
			out.println("<td class='newsarticlesmall' align=right title='HOLIDAY ::"+data[u][1]+"'><div align='right'>"+data[u][(x+4)]+"</div></td>");//67
			out.println("<td class='newsarticlesmall' align=right title='LEAVE ::"+data[u][1]+"'><div align='right'>"+data[u][(x+5)]+"</div></td>");//68
			out.println("<td class='newsarticlesmall' align=right title='ABSENT ::"+data[u][1]+"'><div align='right'>"+data[u][(x+6)]+"</div></td>");//69
			out.println("<td class='newsarticlesmall' align=right title='LATE ::"+data[u][1]+"'><div align='right'>"+data[u][(x+7)]+"</div></td>");//70
			out.println("<td class='newsarticlesmall' align=right title='PERMISSION ::"+data[u][1]+"'><div align='right'>"+data[u][(x+8)]+"</div></td>");//71
			out.println("<td class='newsarticlesmall' align=right title='EXTRA DAYS ::"+data[u][1]+"'><div align='right'>"+data[u][(x+9)]+"</div></td>");//72
			out.println("<td class='newsarticlesmall' align=right title='TOTAL ::"+data[u][1]+"'><div align='right'>"+data[u][(x+10)]+"</div></td>");//73
