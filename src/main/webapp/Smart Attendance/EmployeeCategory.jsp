...
<script language="javascript" src="../JavaScript/Attendance/EmployeeCategoryAjax.js"></script>
...
<body  onpaste="return false;" onLoad=" loadEmployeeCategory()">
			...
			<tr>
				<td height="30" align="center"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="whiteMedium">
                  <tr>
                    ...
                    <td width="91%" style="font-weight: bold"><div align="center">CATEGORY NAME  </div></td>
                  </tr>
              </table></td>
			</tr>
			<tr>
				...
				<div id="EmployeeCategoryTable" style="OVERFLOW:auto;width:100%;height:300px"></div>	<br><br>		  </td>
			</tr>
		</table>		</td>
	</tr>
...
%>
			    ...
			    <td width="69"  ><input type="hidden" name="filename"	value="EmployeeCategory">
		        <input type="hidden" name="actionS"	value="ATTEmployeeCategoryDelete"></td>
			</tr>
		</table>		</td>
	</tr>
</table>
