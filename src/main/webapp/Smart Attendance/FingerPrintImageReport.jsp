...
<form  AUTOCOMPLETE = "off"   action="FingerPrintImageReportRespone.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="445"
			...
			<tbody>
				...
				<tr>
					...
					<td width="429">
					<table width="357" border="0" align="center" cellpadding="3" cellspacing="0"
						 >
						<!--DWLayoutTable-->
						<tr align="center" valign="middle">
							<td height="18" colspan="3" class="BackGround">FingerPrint   Staff 
							Report</td>
						</tr>
 			   ...
 			   %>
						...
						<tr class="bolddeepblue">
							<td width="117" height="29" valign="middle" class="boldEleven">Office</td>
			...
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr class="bolddeepblue">
							...
							<td width="179" valign="top" class="boldEleven"><select
	...
	%>
							...
							<td width="43" valign="top" class="boldEleven"></td>
						</tr>
						<tr>
