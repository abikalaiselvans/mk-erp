...
<script>
	...
	var dojlock= "<%=dojlock%>";
	$(function() {
		$( "#Pfromdt" ).datepicker({ minDate: -7, maxDate: <%=dtpermission%> });
	});
	$(function() {
		$( "#Lfromdate" ).datepicker({minDate: -7, maxDate: <%=dtleave%> });
	});
</script>
...
<%
 if("A".equals(leaveexceedflag))
 	leaveexceedflag = " your entry going to ABSENT due to unavailable leave balance " ;
 else
	leaveexceedflag = " your entry going to NEGATIVE leave due to unavailable leave balance" ;	
%>
 function checkleavecredit()
 {
	...
	{
		var rs=confirm("Hi, "+document.getElementById('staffid').value+"  <%=leaveexceedflag%>");
		if (rs==true)
  		 	return true;
		else
			return false;
			...
			if(f2 == true)
				{
					...
					&& checkNullSelect("staffid","Select employee id" ,"0")  
				...
				{
					if(  
						checkNull("Pfromdt","Enter the permission date")
						&& checkNullSelect("staffid","Select employee id" ,"0")
...
try
{
			...
			String Data[][] = CommonFunctions.QueryExecute("SELECT b.CHR_STAFFNAME,a.CHR_EMPID,a.CHR_TYPE FROM m_user a, com_m_staff b WHERE a.CHR_EMPID=b.CHR_EMPID  AND  a.CHR_USRNAME='"+userid+"'");
...
<form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="onlineleavefrm"
	...
	<tr>
			...
			<tbody>
				...
				<tr>
					...
					<table width="801" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100%">
							<div align="center" class="boldEleven"><strong>FORCE LEAVE / PERMISSION </strong></div>
							</td>
						</tr>
						<tr>
							<td>
							<div align="right"><span class="boldElevenlink"> * </span><span
								class="boldEleven">Mandatory</span></div>
							</td>
						</tr>
						<tr>
							<td>
							<table width="602" border="0" align="center" cellpadding="1"
								...
								<tr>
								  <td colspan="3" class="boldEleven"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td class="bold1">Employee ID </td>
                                 <td>
									  <select name="staffid" class="formText135" id="staffid"  style="width:200" onChange="ForceleaveCheck()">
									...
									String datad[][] = CommonFunctions.QueryExecute(" SELECT CHR_EMPID,CHR_STAFFNAME FROM com_m_staff WHERE CHR_TYPE !='T' AND CHR_REPTO ='"+session.getAttribute("EMPID")+"' ORDER BY CHR_STAFFNAME");
 									if(datad.length>0)
                                      ...
                                      <td><table width="184" border="0" align="center" cellpadding="0"
										cellspacing="0">
                                        <tr class="boldEleven">
                                          ...
                                          <td width="50"><input name="filename" type="hidden"
												id="filename" value="ForceLeavePermission">
                                              <input
												name="actionS" type="hidden" id="actionS"
												value="ATTForceLeaveandPermission"></td>
                                        </tr>
                                      </table></td>
                                    </tr>
									...
									<table width="318" border="0" align="center" cellpadding="1"
										...
										<tr>
											<td width="70" valign="middle" class="boldEleven"  
												>Date</td>
											<td width="241"><input name="Pfromdt" type="text"
		...
		//-->
										...
										<tr>
											<td align="left" valign="middle" class="boldEleven"  
												>To Time</td>
											<td><span > <input name="out"
												type="text" class="formText135" id="out" value="11:00:00" size="15"
												 readonly="readonly"   /> 
											(</span><span class="boldElevenlink"> * only 2-hours</span><span >) </span>
    	...
    	$(this).removeClass("error");
										...
										<tr>
											<td align="left" valign="top" class="boldEleven"  
												>Reason</td>
											<td valign="top"><textarea name="preason" cols="45" onKeyPress="textArea('preason','100')"
		...
		//-->
										...
										<tr>
											...
											<td valign="top"   class="boldEleven"><textarea
												name="lreason" cols="45" rows="5" class="formText135"
												id="lreason" onKeyPress="textArea('lreason','100')" ></textarea></td>
										</tr>
									</table>
									</fieldset>
									</td>
							...
							<table border="0" align="center" cellpadding="3" cellspacing="3">
								<tr>
									...
									<td width="56"><input name="Submit3" type="Button"
										...
										onClick="redirect('ForceLeaveandPermissionView.jsp')"></td>
								</tr>
							</table>
							</td>
						</tr>
...
function makeGetRequest(wordId) 
{
	...
	if(checkNullSelect("staffid","Select employee id" ,"0"))
	{
...
function ForceleaveCheck()
{
	try
	{
		document.getElementById('LeaveType').focus();
		setOptionValue('LeaveType','0');
