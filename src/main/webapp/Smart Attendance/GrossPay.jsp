...
<form  AUTOCOMPLETE = "off"   action="GrossPayResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">GROSS PAY </td>
						</tr>
						<tr class="bolddeepblue">
							<td width="159" height="20" valign="middle" class="boldEleven">Office</td>
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr class="bolddeepblue">
							...
							<td width="181" valign="top" class="boldEleven"><select
								name="dept" id="dept" class="formText135" onChange="init()">
								<option value="0">All</option>
								<%
	...
	%>
						...
						<tr>
							...
							<td colspan="2" class="boldEleven"><select name="sorting">
						...
						<tr>
							...
							By </span></td>
							<td colspan="2" class="boldEleven"><select name="ss">
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="2"
								...
								<tr>
									...
									<td class="boldEleven"><input name="GPay" type="checkbox"
										id="GPay" checked></td>
									<td class="boldEleven">GrossPay</td>
									<td class="boldEleven"><input name="Basic" type="checkbox"
										id="Basic" checked></td>
									<td class="boldEleven">Basic</td>
									<td class="boldEleven"><input name="Exp" type="checkbox"
										id="Exp"></td>
						...
						<tr>
							<td height="14" colspan="3" valign="middle" class="bolddeepblue"><!--DWLayoutEmptyCell-->&nbsp;</td>
						</tr>
						<tr>
							<td height="28" colspan="3" valign="middle" class="bolddeepblue">
