...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="TOTAL ALLOWANCE" sortable="true"><%=temp.elementAt((10+allData.length))%></display:column>
					<display:column title="GROSS" sortable="true"><%=temp.elementAt((11+allData.length))%></display:column>
