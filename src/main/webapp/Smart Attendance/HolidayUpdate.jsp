					...
					<tbody>
						...
						<tr>
							...
							<table width="577" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2">
									<div align="center" class="boldEleven"><strong>Holiday
							...
							String staff  = staffs[0];
						  	...
						  	String sql ="";
						sql = "SELECT CHR_EMPID, DT_HOLIDATE, CHR_HOLINAME FROM att_t_holiday ";
				...
				%>
										...
										<tr>
											<td height="30" align="left" valign="middle"
												  class="bolddeepblue">Holiday Name</td>
								...
								<tr>
									<td width="49%" height="19"><input name="filename"
										type="hidden" id="filename" value="Holiday"> <input
										name="actionS" type="hidden" id="actionS"
										value="ATTHolidayUpdate"></td>
									<td width="51%">&nbsp;</td>
								</tr>
								<tr>
									<td height="19" colspan="2">
									<table border="0" align="center" cellpadding="2"
										...
										<tr>
											...
											<td width="56"><input type="button" name="submit"
												...
												onClick="redirect('Holiday.jsp')" /></td>
										</tr>
									</table>
									</td>
								</tr>
