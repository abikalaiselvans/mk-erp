...
<script language="javascript" src="../JavaScript/Attendance/IdProofAjax.js"></script>
...
<body  onpaste="return false;" onLoad=" LoadIdProof()">
	...
	<tr>
		...
		<table width="90%" height="220" border="0" align="center" cellpadding="0" cellspacing="0" class="TableDesign"
			...
			<tr>
				...
				<div id="LoadIdProofTable" style="OVERFLOW:auto;width:100%;height:300px"></div><br><br>			  </td>
			</tr>
		</table>		</td>
	</tr>
...
%>
			    ...
			    <td width="69"  ><input type="hidden" name="filename"	value="IdProof">
		        <input type="hidden" name="actionS"	value="ATTIdProofDelete"></td>
			</tr>
		</table>		</td>
	</tr>
</table>
