          ...
          <td width="412" valign="top">
		    ...
		    <table width="86%" border="0" align="center" cellpadding="3" cellspacing="3">
              ...
              <tr>
                ...
                <td width="69%" class="boldEleven"><input name="Name" type="text" class="formText135" id="Name" onBlur="upperMe(this), CheckUnique(this,'divunitname','com_m_addressproof','CHR_PROOFNAME')"
				 onKeyUp="upperMe(this),CheckUnique(this,'divunitname','com_m_addressproof','CHR_PROOFNAME')" value="<%=Name%>" size="40" maxlength="100">
