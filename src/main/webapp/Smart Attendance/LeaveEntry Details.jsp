...
<form  AUTOCOMPLETE = "off"   method="post" name="a" action="LeaveEntryDateView.jsp">
					...
					<table width="350" border="0" align="center" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" 
								class="BackGround style9">Leave Entry Details</td>
						</tr>
						<tr>
							...
							<td width="248" valign="middle"><span class="style8"><a
								href="LeaveEntryDate.jsp" class="tabledata">Datewise</a></span></td>
						</tr>
						<tr>
							<td height="24">
							<div align="center"><img src="../Images/dot.gif" width="10"
							...
							<td valign="middle"><span class="style8"><a
								href="LeaveEntryMonth.jsp" class="tabledata">Month wise</a></span></td>
						</tr>
						<tr>
							<td height="24">
							<div align="center"><img src="../Images/dot.gif" width="10"
							...
							<td valign="middle"><span class="style8"><a
								href="LeaveTypeReport.jsp" class="tabledata">Leave Type</a></span></td>
						</tr>
						<tr>
							<td height="24">
							<div align="center"><img src="../Images/dot.gif" width="10"
							...
							<td valign="middle" class="tabledata"><a
								href="TotalReport.jsp" class="tabledata">Total Leave</a></td>
						</tr>
						<tr>
							<td colspan="2">
