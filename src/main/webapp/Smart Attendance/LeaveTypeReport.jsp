			...
			<tbody>
				...
				<tr>
					...
					<table width="350" align="center" border="0"  >
						...
						<tr align="center" valign="middle">
							<td height="27" colspan="2" class="BackGround" >Leave
							Report Based on Leave Type</td>
						</tr>
						<tr>
 			   ...
 			   %>
						...
						<tr>
							<td width="177" height="28" valign="middle" class="bolddeepblue">
							Leave Type</td>
							<td width="247"><select name="leave" id="leave"
								class="bolddeepblue" style="width:200px">
								<option value="-1">All</option>
								<%                  
     					String queryleaveType="SELECT CHR_SYMBOL,CHR_LEAVENAME FROM att_m_leavetype";
     					String	leavetype[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(queryleaveType);
     					for(int i=0;i<leavetype.length;i++)
 	 						out.println("<option value='"+leavetype[i][0]+"'>"+leavetype[i][1]+"</option>");
 			   %>
							</select></td>
						</tr>
...
%>
						...
						<tr>
							...
							<td valign="middle"><span class="style11"> <%@ include
								...
								type="hidden" name="actionS" value="COM_ATTleaveTypeReport">
							<input type="hidden" name="filename" value="Report"> </span></td>
						</tr>
						<tr>
