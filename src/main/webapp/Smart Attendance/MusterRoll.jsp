 ...
 function validate()
  {
	...
	if( checkNull("Office","Select Staff") 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="324" border="0" align="center" cellpadding="2" cellspacing="2"
						...
						<tr class="bolddeepblue">
							<td height="35" valign="middle" class="boldEleven">Office<span class="boldEleven"> <font color='red'>*</font></span></td>
 ...
 %>
	  </select><script language="javascript">setOptionValue('Office','<%=oficeid%>')</script>					
								
								 
						  </td>
						</tr>
						<tr class="bolddeepblue">
							<td height="35" valign="middle" class="boldEleven">Department <font color='red'>*</font></td>
	...
	%>
						...
						<tr>
								  <td class="boldEleven">Category <font color='red'>*</font></td>
								  <td> 
...
<script language="javascript">setOptionValue('Category','<%=category%>')</script>
						...
						<tr class="bolddeepblue">
							<td width="111" height="35" valign="middle" class="boldEleven">Month<font
								color='red'> <font color='red'>*</font></font></td>
							<td width="199" valign="top" class="bolddeepblue"><select
				...
				//-->
							...
							<input type="hidden" name="actionS" value="ATTAttendanceCalculate">
                            <input type="hidden" name="filename" value="AttendanceCalculate"></td>
						</tr>
