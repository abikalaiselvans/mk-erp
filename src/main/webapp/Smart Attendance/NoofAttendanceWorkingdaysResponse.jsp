...
<%
 ...
 String reportheader="NO OF WORKING DAYS INFORMATION "; 
...
sql = sql+ " com_m_employeecategory h,att_t_register i   ";
...
<br />	<center>	<a href='NoofAttendanceWorkingdays.jsp'> CLOSE</a></center><br /><br />
