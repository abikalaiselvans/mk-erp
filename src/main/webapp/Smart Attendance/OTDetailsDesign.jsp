	...
	<tr>
		...
		<table width="350" height="150" border="1" align="center"
			...
			<tr align="center" valign="middle">
				<td height="25" colspan="2" class="BackGround" >O.T.Details
				Designation Wise</td>
			</tr>
			...
			<tr>
				<td width="308" height="28" valign="middle" class="bolddeepblue"><span
					class="tabledata">Designation</span></td>
				<td width="294" valign="middle"><span class="style11"> <select
					name="Designation" class="tabledata">
...
%>
		...
		<table width="152" border="0" align="center" cellpadding="2"
			cellspacing="2">
			<tr>
				<td height="47" width="17"><input type="hidden" name="filename"
					value="OTDetails"> <input type="hidden" name="actionS"
					value="ATTOTDetailsDesignationList"></td>
				<td width="56"><input name="Submit" type="submit"
					class="buttonbold" value="Submit"   accesskey="s"   ></td>
				<td width="59"><input name="Button" type="Button"
	...
	<tr>
		<td height="20"><span class="style8"> <%@ include
