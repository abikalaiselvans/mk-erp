...
<script>
	...
	$(function() {
		...
		minDate: -57, maxDate: <%=dtpermission%> });
	});
	$(function() {
                                    ...
                                    <tr class="boldEleven">
                                      ...
                                      <td width="50"><input name="filename" type="hidden"
                                          ...
                                          <input
												...
												value="ATTStaffPermissionleave"></td>
                                    </tr>
                                  </table></td>
							  </tr>
							</table>
										...
										<tr>
											...
											<td><span > <input name="out"
												type="text" class="formText135" id="out" value="11:00:00" size="15"
												 readonly="readonly"   /> 
											(</span><span class="boldElevenlink"> * only 1.5-hours</span><span >) </span>
    	...
    	$(this).removeClass("error");
										...
										<tr>
											<td align="left" valign="top" class="boldEleven"  
												>Reason</td>
											<td valign="top"><textarea name="preason" cols="45" onKeyUp="textArea('preason','100')"
		...
		//-->
										...
										<tr>
											...
											<td valign="top"   class="boldEleven"><textarea
												...
												id="lreason" onKeyUp="textArea('lreason','100')" ></textarea></td>
										</tr>
									</table>
									</fieldset>
									</td>
							...
							<table border="0" align="center" cellpadding="3" cellspacing="3">
								<tr>
									...
									<td width="56"><input name="Submit3" type="Button"
										...
										onClick="redirect('Onlineleavestatus.jsp')"></td>
								</tr>
							</table>
							</td>
						</tr>
