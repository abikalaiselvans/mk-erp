...
function StaffloadPermissionLeave(startletter)
{
    ...
    var url = "../attendance?actionS=StaffPermissionLeave&month="+escape(mon)+"&year="+escape(yea)+"&Status="+Status+"&day="+day +"&leavetype="+leavetype+"&startletter="+startletter;
	initRequest(url);
    ...
    for(loop=0; loop<batchs.childNodes.length; loop++)
     {
		...
		if(Status.childNodes[0].nodeValue =="P") 
			str = str+"<td class='boldEleven'><a href='../SmartLoginAuth?filename=StaffPermission&actionS=ATTStaffPermissionLeaveDelete&rowid="+Rowid.childNodes[0].nodeValue+"'>Delete</a></td>"; 
		else
	...
	<tr>
		...
		<table width="90%" height="177" border="0" align="center"
			...
			<tr align="center" valign="middle" >
			  <td  height="28" ><span class="whiteMedium"  >PERMISSION / LEAVE STATUS </span></td>
		  </tr>
