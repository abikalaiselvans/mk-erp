...
<script language="JavaScript">
  ...
  function Edit()
 	{		
 	    ...
 	    if(count==1)
 	    {
		document.OverTimeEditfrm.action="OverTimeUpdate.jsp";
		return true;
		}
 	}
 ...
 function Delete()
 	{		
		...
		if(count>=1){			
			...
			if (name==true)
			{ 
				document.OverTimeEditfrm.action="../SmartLoginAuth";
...
<form  AUTOCOMPLETE = "off"   name="OverTimeEditfrm" method="get">
...
%> <%@ include file="index.jsp"%></td>
	...
	<table width="780" border="0" align="center" cellpadding="1"
		...
		<tr>
			...
			<%
		  		String staff  = request.getParameter("overtime");
				String staffname= com.my.org.erp.bean.Attendance.StaffRegistration.staffName(staff.trim());
				String sql ="";
				sql = "SELECT * FROM att_t_ot where CHR_EMPID = '"+staff+"'";
				...
				<tbody>
					...
					<tr>
						...
						<table width="753" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100%">
								<div align="center" class="boldEleven"><strong>Over
								Time</strong></div>
								</td>
							</tr>
							<tr>
								<td>
								<%					  		
				sql = "SELECT DT_OTDATE,INT_MINS,CHR_BATTA,CHR_WASHING,CHR_DIS FROM att_t_ot where CHR_EMPID = '"+staff+"'";
				...
				sql = sql +" AND  INT_YEAR = " + year;		
					  ...
					  %>
							...
							<tr>
								...
								<table width='101%' cellpadding="5" cellspacing="0">
									<tr class='boldEleven'>
										<td colspan="6">
										<table width="484" border="0" align="center" cellpadding="1"
											cellspacing="1">
											<tr>
					...
					for(int u=0; u<tableRow.length;u++)
					{
						...
						if(bgflag)
						{
							...
							out.print("<td width=54  class='boldEleven'>&nbsp;&nbsp;&nbsp;<input type='checkbox' name='staffid' id='staffid' value='"+staff+"~"+tableRow[u][0]+"~'>&nbsp;"+(u+1));
						}	
						else
						{
							bgflag = true;
						...
						out.println("<td width=155  class='boldEleven'>&nbsp;&nbsp;&nbsp;"+com.my.org.erp.ServiceLogin.DateUtil.FormateDateSys(tableRow[u][0]));
						out.println("<td width=155  class='boldEleven'>&nbsp;&nbsp;&nbsp;");
						out.println("<a href=OverTimeUpdate.jsp?staffid="+staff+"~"+tableRow[u][0]+">"+tableRow[u][1].trim()+"</a>");
								...
								<table border="0" align="center" cellpadding="1" cellspacing="1">
									<tr>
										...
										<td width=56><input name="Submit" type="Button"
											class="buttonbold" onClick="redirect('OverTime.jsp')"
											 value="Close"   accesskey="c" ></td>
										<td><input name="filename" type="hidden" id="filename"
											value="OverTime"> <input name="actionS" type="hidden"
											id="actionS" value="ATTovertimeDelete"></td>
									</tr>
								</table>
								</td>
							</tr>
