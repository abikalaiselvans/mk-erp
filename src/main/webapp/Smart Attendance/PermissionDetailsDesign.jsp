		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="400"
			...
			<tbody>
				...
				<tr>
					...
					<table width="100%" height="189" border="0" align="center"
						cellpadding="2" cellspacing="2"  >
						<!--DWLayoutTable-->
						<tr align="center" valign="middle">
							<td height="25" colspan="2" class="BackGround" >Permission
							Details Designation Wise</td>
						</tr>

						<tr>
							<td width="103" height="24" valign="middle" class="bolddeepblue">
							Company</td>
							<td width="268"><select name="company" id="company"
 			   ...
 			   %>
						...
						<tr>
							<td width="103" height="24" valign="middle" class="bolddeepblue">
							Branch</td>
							<td width="268"><select name="branch" id="branch"
						...
						<tr>
							<td width="103" height="24" valign="middle" class="bolddeepblue"><span
								class="tabledata">Designation</span></td>
							<td width="268" valign="middle"><span class="style11">
							<select name="Designation" class="tabledata">
...
%>
						...
						<tr>
							<td height="24" valign="middle" class="bolddeepblue"><span
						...
						<tr>
							<td height="26" valign="middle" class="bolddeepblue"><span
				...
				//-->
								...
								value="PermissionDetails"> <input type="hidden"
								name="actionS" value="ATTPermissionDetailsDesignationList">
							</span></td>
						</tr>
						<tr>
							<td height="26" colspan="2" valign="middle" class="bolddeepblue">
