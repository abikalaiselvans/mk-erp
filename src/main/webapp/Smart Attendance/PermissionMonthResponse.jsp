...
<%
	...
	reportheader=reportheader+" <b> Permission Report For </b> "+umonth+"-"+year;
	String sorting = request.getParameter("sorting");
	String ss = request.getParameter("ss");

	 String sql="SELECT  a.CHR_EMPID ,b.CHR_STAFFNAME,a.INT_PERMISSION  ";
	 sql = sql+" From att_t_register a, com_m_staff b ";
	 sql = sql+" WHERE a.INT_YEAR="+year+" AND a.CHR_EMPID = b.CHR_EMPID  AND a.INT_PERMISSION>0   ";
...
%>
	 <display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PERMISSION" sortable="true"><%=temp.elementAt(3)%></display:column>
					 
					
		 
					 
					<display:setProperty name="export.csv.filename" value="PermissionMonth.csv"/>
					<display:setProperty name="export.excel.filename" value="PermissionMonth.xls"/>
					<display:setProperty name="export.xml.filename" value="PermissionMonth.xml"/>
					<display:setProperty name="export.pdf.filename" value="PermissionMonth.pdf"/>
...
<br />
									...
									<center>	<a href='LeaveMonth.jsp'> CLOSE</a></center>