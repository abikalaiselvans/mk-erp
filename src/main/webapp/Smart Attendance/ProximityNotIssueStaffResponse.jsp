...
<%
	...
	sql=sql+" WHERE A.CHR_EMPID not in (select CHR_EMPID from att_m_proximitycardno) ";
...
%>
 ...
 <display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.csv.filename" value="ProximityNotIssueStaffInfo.csv"/>
					<display:setProperty name="export.excel.filename" value="ProximityNotIssueStaffInfo.xls"/>
					<display:setProperty name="export.xml.filename" value="ProximityNotIssueStaffInfo.xml"/>
					<display:setProperty name="export.pdf.filename" value="ProximityNotIssueStaffInfo.pdf"/>
					<display:setProperty name="export.pdf" value="true" />
					 
</display:table>     

<br />	<center>	<a href='ProximityNotIssueStaffInfo.jsp'> CLOSE</a></center>
