	...
	<tr>
		...
		%>
			...
			<tr class="bold1">
				<td colspan="12">
				<div align="center">
				<h3>Attendance Summary Report for the Month of <%=month%> - <%=year%></h3>
				</div>
				</td>
			</tr>
			<tr class="bold1">
			...
			<tr class="bold1">
				...
				<td width="13%">Department Name</td>
     ...
     String sql=" SELECT B.CHR_EMPID,B.CHR_STAFFNAME,A.CHR_DEPARTNAME,";
      sql=sql+" C.DOU_PRESENT,C.DOU_ABSENT,C.DOU_LEAVE,C.DOU_OD,C.INT_LATE,C.DOU_HOLIDAY,";
     sql=sql+" C.DOU_SUNDAY,C.INT_OTMINS FROM com_m_depart A,com_m_staff B,att_t_attendancedetail C ";
     sql=sql+"where B.INT_DEPARTID=A.INT_DEPARTID AND B.CHR_EMPID=C.CHR_EMPID AND C.LOGMONTH LIKE '"+month+"' AND C.LOGYEAR='"+year+"'";
