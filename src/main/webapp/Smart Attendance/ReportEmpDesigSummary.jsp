...
<br> <%@ include file="../PrintHeader.jsp"%><br> 
          ...
          String dept="";
      	 ...
      	 sql=sql+" and b.INT_DESIGID=a.INT_DESIGID group by a.INT_DESIGID ";
			int sum1=0;
			int sum2=0;
			int sum3=0;
        	...
        	for(int i=0;i<count.length;i++)
        	{
				...
				sql=" SELECT COUNT(*) FROM COM_M_STAFF WHERE CHR_GENDER='Male' and INT_DESIGID ="+desigid; 
				String count1[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
				sum1 = sum1+Integer.parseInt(count1[0][0]);
				 
				
				sql=" SELECT COUNT(*) FROM COM_M_STAFF WHERE CHR_GENDER='Female' and INT_DESIGID ="+desigid; 
