...
<title> :: ATTENDANCE ::</title>
	...
	<jsp:text>
		<![CDATA[
     		<center>
  			<a href='ReportLeaveFull.jsp'> Full View </a>
  			&nbsp;&nbsp;
		...
		if(fline>=3)
		{
			...
			{		
				...
				while(filecontents.hasMoreElements())
				{
					...
					if(filecontents.hasMoreElements())
						attenRep.setEmptoDate(""+filecontents.nextElement());
	...
	<display:table name="results" pagesize="15" export="true"
		...
		<display:column property="emplDate" title="From Date" />
		<display:column property="emptoDate" title="To Date" />


	</display:table>
	<jsp:text>
		<![CDATA[
      		<a href='ReportLeaveFull.jsp' target='_self'> FullView </a>
  			&nbsp;&nbsp;
