<jsp:root version="1.2" xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<jsp:directive.page import="com.my.org.erp.bean.Attendance.FingerPrint" />
...
<title> :: ATTENDANCE ::</title>
	...
	{	
		...
		if(fline>=3)
		{
			...
			{		
				FingerPrint attenRep=new FingerPrint();
				while(filecontents.hasMoreElements())
				{
					...
					if(filecontents.hasMoreElements())
						attenRep.setDepName(""+filecontents.nextElement());
					if(filecontents.hasMoreElements())
						attenRep.setDesName(""+filecontents.nextElement());
	...
	<display:table name="results" pagesize="13" export="true"
		id="currentRowObject">
		<display:caption>
		...
		<display:column property="empName" title="Name" sortable="true"
			headerClass="sortable" />
		<display:column property="depName" title="Department" sortable="true" />
		<display:column property="desName" title="Designation" sortable="true" />
	</display:table>
	<jsp:text>
		<![CDATA[
      		<a href='ReportPrint.jsp' target='_blank'> HTML Print </a>
      		<br/>
      		<a href="Finger Print Reports.jsp"> Back </a>
      		</center>
      	]]>
	</jsp:text>
</jsp:root>
