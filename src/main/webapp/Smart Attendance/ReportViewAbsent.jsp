<jsp:root version="1.2" xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<jsp:directive.page import="com.my.org.erp.bean.Attendance.AbsentReport" />
...
<title> :: ATTENDANCE ::</title>
	...
	FileReader fr = new FileReader("AbsentReport.sys");
	...
	{	
		...
		if(fline>=3)
		{
			...
			{		
				AbsentReport attenRep=new AbsentReport();
