...
<title> :: ATTENDANCE ::</title>
	...
	<jsp:text>
		<![CDATA[
     		<center>
  			<a href='ReportViewLeaveFView.jsp'> Full View </a>
  			&nbsp;&nbsp;
     		<a href='../Mainscreen.jsp' target='_self'> Home </a>
  			&nbsp;&nbsp;
      		<a href="LeaveEntry Details.jsp"> Back </a>
      		&nbsp;&nbsp;
	...
	{	
		...
		if(fline>=3)
		{
			...
			{		
				...
				//	if (empId1.equalsIgnoreCase("Record not found..."))	break;
	...
	<display:table name="results" pagesize="15" export="true"
		...
		<display:column property="empName" title="Name" sortable="true"
			headerClass="sortable" />
		<display:column property="empDepart" title="From Date" />
		<display:column property="empDesig" title="To Date" />
		<display:column property="loginDate" title="Leave Type" />
	</display:table>
	<jsp:text>
		<![CDATA[
      		<a href='ReportViewLeaveFView.jsp' target='_self'> FullView </a>
  			&nbsp;&nbsp;
