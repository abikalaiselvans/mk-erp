<jsp:root version="1.2" xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<jsp:directive.page
		import="com.my.org.erp.bean.Attendance.AttendancePermissionDetailsReport" />
...
<title> :: ATTENDANCE ::</title>
	...
	{	
		...
		if(fline>=3)
		{
			...
			{		
				...
				{
					AttendancePermissionDetailsReport attenRep=new AttendancePermissionDetailsReport();
					...
					if(filecontents.hasMoreElements())
						attenRep.setPermission(""+filecontents.nextElement());
					if(filecontents.hasMoreElements())
						attenRep.setReason(""+filecontents.nextElement());
	...
	<display:table name="results" pagesize="20" export="true"
		id="currentRowObject">
		<display:caption>
		...
		<display:column property="inTime" title=" Over Time" />
		<display:column property="outTime" title="Batta" />
		<display:column property="reason" title="Wsahing" />
	</display:table>
	<jsp:text>
		<![CDATA[
     		<a href='ReportViewLateFView.jsp'> Full View </a>
     		...
     		<a href='ReportPrint.jsp' target='_self'> HTML Print </a>
  			&nbsp;&nbsp;
      		<a href="OTDetailsDate.jsp"> Back </a>
      		</center>
      	]]>
	</jsp:text>
