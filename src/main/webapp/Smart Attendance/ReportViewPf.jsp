...
<title> :: ATTENDANCE ::</title>
	...
	<jsp:text>
		<![CDATA[
		    <center>
  			<a href='AbsentFull.jsp'> Full View </a>
  			&nbsp;&nbsp;
     		<a href='../Mainscreen.jsp' target='_blank'> Home </a>
  			&nbsp;&nbsp;
      		<a href="AbsentDetails.jsp"> Back </a>
      		&nbsp;&nbsp;
				...
				while(filecontents.hasMoreElements())
				{
					...
					if(filecontents.hasMoreElements())
					{
					     ...
					     if(grossPay.equals("0"))
					     {
					    	...
					    	attenRep.setEmplCon(""+grossPay);
					    	double emprconc=gross-pay;
					    	attenRep.setEmprCon(""+gross);
					     }
					     else
					     {
	...
	<display:table name="results" pagesize="15" export="true"
		...
		<display:column property="empName" title="Name" sortable="true"
			headerClass="sortable" />
		<display:column property="EsiNo" title="Esi No" />
		<display:column property="grossPay" title="Gross Pay" />
		<display:column property="emplCon" title="Empl Con" />
		<display:column property="emprCon" title="Empr Con" />
	</display:table>
	<jsp:text>
		<![CDATA[		      
     		<a href='AbsentFull.jsp' target='_blank'> FullView </a>
  			&nbsp;&nbsp;
