...
<script language="JavaScript" src="../JavaScript/Attendance/CommonHolidayAjax.js"></script>
 ...
 <body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  >
		...
		String reportheader = "THE FOLLOWING EMPLOYEES ARE REPORTING TO "+repto +" / " + reportingto+" " ;
 	%>
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
	 			<display:caption><%=reportheader.toUpperCase()%></display:caption>
					...
					<display:column title="REPORTING TO" sortable="true"><%=temp.elementAt(8)%></display:column>
...
<br />
									...
									<center>	<a href='ReportingTo.jsp'> CLOSE</a></center>
