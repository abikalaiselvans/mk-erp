...
<form  AUTOCOMPLETE = "off"   action="Rept_CertificationCompletedResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">Certification Completion </td>
						</tr>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">Certification Name </td>
						  <td><select name="Certification" class="formText135" id="Certification" onChange="loadCertificationTrack('0')" onBlur="loadCertificationTrack('0')">
                              <option value="0">All</option>
                              <%
				  ...
				  %>
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">Including Resigned</td>
						  <td><span class="boldEleven">
						    <input name="resigned" type="checkbox" id="resigned" value="Y">
						  </span></td>
						  <td valign="top" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
					  </tr>
						<tr>
