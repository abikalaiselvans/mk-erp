					...
					<tbody>
						...
						<tr>
							...
							<table width="577" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2">
									<div align="center" class="boldEleven"><strong>EMPLOYEE ATTENDANCE</strong><span class="bold1"></span>( Exclusive of Current Month)</div>									</td>
								</tr>
								<tr>
									<td colspan="2">
								...
								<tr>
								  <td height="33" valign="middle" class="boldEleven">Year 
								    <input name="filename"
										type="hidden" id="filename" value="StaffAttendanceGraph">
                                  <input
										name="actionS" type="hidden" id="actionS" value="ATTStaffAttendanceFinancialGraph"></td>
								  <td valign="middle"> 
								      <%@include  file="../JavaScript/accountyear.jsp" %>
							      </td>
							  </tr>
								<tr>
