...
<form name="a" action="../SmartLoginAuth" method="get" onSubmit="return Validate()">
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
                 ...
                 <input name="actionS"
										...
										value="ATTRept_JAbsent">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="absentMonthwise"></td>
				   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr> 
                      <tr>
