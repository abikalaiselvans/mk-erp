				...
				<tr>
					...
					<td width="412"><table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
                      ...
                      <tr align="center" valign="middle">
                        <td height="18" colspan="3"  class="BackGround">HOLIDAY REPORT </td>
                      </tr>
	...
	setCurrentDate('fdate');				
			...
			setCurrentDate('tdate');				
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JAdminHolidayMonth">
                 <input name="actionS"
										type="hidden" id="actionS"
										value="ATTRept_JAdminHolidayMonth">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="adminHolidayInfo"></td>
				   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr> 
