				...
				<tr>
					...
					<td width="412"><table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
                      ...
                      <tr align="center" valign="middle">
                        <td height="18" colspan="3"  class="BackGround">ON DUTY REPORT</td>
                      </tr>
	...
	setCurrentDate('fdate');				
     ...
     <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JAdminODMonth">
                 <input name="actionS"
										type="hidden" id="actionS"
										value="ATTRept_JAdminODMonth">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="adminOndutyInfo"></td>
				   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr> 
