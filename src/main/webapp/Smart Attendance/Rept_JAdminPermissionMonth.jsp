				...
				<tr>
					...
					<td width="412"><table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
                      ...
                      <tr align="center" valign="middle">
                        <td height="18" colspan="3"  class="BackGround">PERMISSION REPORT </td>
                      </tr>
...
<tr>
  ...
  <br>
   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
                      ...
                      <tr>
                        <td height="28" colspan="3" valign="middle" class="bolddeepblue"><!--DWLayoutEmptyCell-->&nbsp;</td>
                      </tr>
                      <tr>
	...
	setCurrentDate('fdate');				
     ...
     <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JAdminPermissionMonth">
                 <input name="actionS"
										type="hidden" id="actionS"
										value="ATTRept_JAdminPermissionMonth">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="adminPermissionInfo"></td>
				   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr> 
