...
<script language="JavaScript" src="../JavaScript/comfunction.js"></script>
<script language="javascript" src="../JavaScript/Attendance/ReportAjax.js"></script>	<script language="JavaScript">
function Validate()
  {
	...
	%>
                      ...
                      <tr>
                        ...
                        <td valign="middle"><strong> <font
								size="1"><font size="1">
                          <select name="month"
								id="month" class="formText135" style="width:200px">
                      ...
                      <tr>
                        ...
                        <td valign="middle"><strong>
                          <select name="year"
								id="year" class="formText135" style="width:200px">
                            <option value="">Select</option>
...
<tr>
                <td height="33" class="boldEleven">Export Type <font
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
                 ...
                 <input name="actionS"
										...
										value="ATTRept_JOT">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="overtimeMonthwise"></td>
				   <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr> 
                      <tr>
