...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	%>
                      ...
                      <tr>
                        <td height="33" valign="middle" class="boldEleven">Export Type <font
																class="bolddeepred" align="absmiddle">*
                          <input name="filename" type="hidden" id="filename"
										value="Rept_JOnDuty">
                          <input name="actionS"
										type="hidden" id="actionS"
										value="ATTRept_JOnDuty">
                          <input name="rptfilename" type="hidden" id="rptfilename" value="ondutyMonthwise">
                        </font></td>
