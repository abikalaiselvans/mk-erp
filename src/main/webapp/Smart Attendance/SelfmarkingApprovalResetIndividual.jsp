					...
					<tbody>
						...
						<tr>
							...
							<table width="577" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2">
									<div align="center" class="boldEleven"><strong> ATTENDANCE SELF MARKING APPROVAl RESET </strong><br>
									</div>
									</td>
								</tr>
								<tr>
							...
							out.println("<input name=\"syear\" type=\"hidden\"  value=\""+dat[0][3]+"\" id=\"syear\">");
							  %> </span></span></td>
										...
										<tr>
											...
											<td><span class="boldThirteen"> <select name="year" class="formText135" id="year" >
				...
				//-->
								...
								<tr>
									<td width="49%" height="19"><input name="filename"
										type="hidden" id="filename" value="AttendanceSelfMarking">
									<input name="actionS" type="hidden" id="actionS"
										value="ATTAttendanceSelfMarkingApprovalReset"></td>
									<td width="51%">
