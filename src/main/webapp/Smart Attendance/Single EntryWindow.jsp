...
<table width="100%" height="100%" border="0">
	...
	<tr align="center" valign="middle" bgcolor="#336699" height="6%">
		<td colspan="3" bgcolor="#003366"><b><font color="#AFFAFB"
			size="4">ATTENDANCE - SINGLE ENTRY </font></b></td>
	</tr>
	<tr height="60%">
	...
	<tr height="3%" bgcolor="#003366">
		<td><b><font size="5" color="#FFFFFF">Enter Your 4
		Digit pin no :</font></b> <input type="text" name="pinno" id='pinno' size="4"
			tabindex="1" onKeyPress="numericValue('pinno','4')"> <input
			type="hidden" name="tablename" value="Single"> <input
			type="hidden" name="file" value="Single EntryWindow.jsp"> <input
