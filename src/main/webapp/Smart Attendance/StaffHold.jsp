...
<script>
 $(function() {
		$( "#fromdt" ).datepicker({ minDate: -2, maxDate: "+0D" });
	});
...
function Validate()
  {
  	if( checkNull("ename","Select Staff") && checkNull("fromdt","Enter To Date")  )
		return true;
	else
		return false;
							...
							<table width="577" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td width="313" class="boldEleven"><input name="fromdt"
												type="text"  class="formText135"  id="fromdt"
												 value=""
												size="15" readonly="readonly"><script language="javascript">setCurrentDate('fromdt')</script>   </td>
										</tr>
									</table>
									</td>
								</tr>
								...
								<tr>
									...
									<table border="0" align="center" cellpadding="2"
										...
										<tr>
											<td width="56">
											<input type="submit" name="Submit" class="buttonbold" value="Submit"   accesskey="s"   /></td>
