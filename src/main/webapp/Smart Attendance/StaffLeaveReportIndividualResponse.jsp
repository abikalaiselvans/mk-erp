...
<table border="0" align="center" cellpadding="0"
              ...
              <td height="18"><table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td><span class="boldThirteen">
                    <select name="month"   class="formText135" onChange="loadAttendanceReport1( ) "  
							id="month" >
                  ...
                  <td><span class="boldThirteen">
                    <select name="year" class="formText135" onChange="loadAttendanceReport1( ) "
							id="year"    >
  ...
  <tr>
    <td><table width="56" align="center">
      <tr>
        <td><input name="Button" type="Button" class="buttonbold"  value="Close"   accesskey="c"  onClick="javascript:window.close()">
        </td>
      </tr>
    </table></td>
  </tr>
