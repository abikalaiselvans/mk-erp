...
<form  AUTOCOMPLETE = "off"   action="StaffOfficialResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">OFFICIAL REPORT </td>
						</tr>
	...
	%>
							...
							<td width="55" valign="top" class="boldEleven"></td>
						</tr>
						<tr>
