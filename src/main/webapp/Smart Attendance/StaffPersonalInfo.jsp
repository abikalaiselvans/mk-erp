...
function personalinfopdf()
{
	...
	var buffer = 0;
	//(document.all || document.layers ||documentGetElementByID) ? 30 : 48;
...
<form  AUTOCOMPLETE = "off"   action="StaffPersonalResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="445"
			...
			<tbody>
				...
				<tr>
					...
					<table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">Personal
							Report</td>
						</tr>
			  ...
			  %> <select name="Office" class="comboWidth" id="Office">
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr class="bolddeepblue">
							...
							<td width="250" valign="top" class="boldEleven"><select
								name="dept" id="dept" class="comboWidth">
								<option value="0">All</option>
								<%
	...
	%>
						...
						<tr>
							...
							<td class="boldEleven"><select name="sorting" class="comboWidth">
						...
						<tr>
							...
							By </span></td>
							<td class="boldEleven"><select name="ss" class="comboWidth">
