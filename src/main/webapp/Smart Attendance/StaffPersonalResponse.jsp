...
<%
	...
	sql = " SELECT a.CHR_EMPID,a.CHR_STAFFNAME ,a.CHR_STAFFFNAME ,  ";
  	sql = sql +" a.CHR_GENDER , DATE_FORMAT(a.DT_DOB,'%d-%b-%Y'),if(a.CHR_MARITALSTATUS='M','Married','Unarried'),   ";
	...
	out.println("<br><center><h1>STAFF PERSONAL INFORMATIONS</h1></center><br>");  
	%>
...
<br />
									...
									<center>	<a href='StaffPersonalInfo.jsp'> CLOSE</a></center>
