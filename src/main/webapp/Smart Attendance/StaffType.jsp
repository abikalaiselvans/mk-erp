...
<script language="javascript" src="../JavaScript/Attendance/StaffTypeAjax.js"></script>
...
<body  onpaste="return false;" onLoad=" loadStaffType()">
		...
		<table width="90%" height="220" border="0" align="center" cellpadding="0" cellspacing="0" class="TableDesign"
			...
			<tr>
				<td height="30" align="center"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="whiteMedium">
                  <tr>
                    <td style="font-weight: bold"><div align="center">S.No</div></td>
                    <td style="font-weight: bold"><div align="center">TYPE  NAME  </div></td>
                    <td style="font-weight: bold"><div align="center">Checked Salary Slab</div></td>
                  </tr>
              </table></td>
			</tr>
			<tr>
				...
				<div id="loadStaffTypeTable" style="OVERFLOW:auto;width:100%;height:300px"></div><br><br>			  </td>
			</tr>
		</table>		</td>
	</tr>
...
%>
			    ...
			    <td width="69"  ><input type="hidden" name="filename"	value="StaffType">
		        <input type="hidden" name="actionS"	value="ATTStaffTypeDelete"></td>
			</tr>
		</table>		</td>
	</tr>
</table>
