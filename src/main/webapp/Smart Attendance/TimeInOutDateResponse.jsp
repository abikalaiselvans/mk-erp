 ...
 try
 {
	...
	if(!"0".equals(dept))
		...
		reportheader=reportheader+" <b>Department ::</b> ALL ";
		 ...
		 String sql="SELECT  a.CHR_EMPID ,b.CHR_STAFFNAME,c.CHR_SHIFTNAME,DATE_FORMAT(a.DT_LOGIN,'%d-%m-%Y'), ";
		...
		if(!"0".equals(dept))
		 ...
		 sql=sql+"   AND C.INT_SHIFTID=A.CHR_SHIFTCODE  AND a.DT_LOGIN>='"+fdate+"'  AND a.DT_LOGIN<='"+tdate+"'";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.csv.filename" value="TimeInOutDate.csv"/>
					<display:setProperty name="export.excel.filename" value="TimeInOutDate.xls"/>
					<display:setProperty name="export.xml.filename" value="TimeInOutDate.xml"/>
					<display:setProperty name="export.pdf.filename" value="TimeInOutDate.pdf"/>
					<display:setProperty name="export.pdf" value="true" />
					 
</display:table>     

<br />	<center>	<a href='TimeInOutDate.jsp'> CLOSE</a></center> 
