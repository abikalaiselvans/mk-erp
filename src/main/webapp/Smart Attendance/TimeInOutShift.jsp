...
<form name="a" action="TimeInOutShiftResponse.jsp" onSubmit="return Validate()">
<p class="style8">&nbsp;</p>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="412"><table width="426" border="0" align="center" cellpadding="3" cellspacing="0"
                      ...
                      <tr align="center" valign="middle">
                        <td height="18" colspan="3"  class="BackGround">Time In Out Report</td>
                      </tr>
	...
	%>
                      ...
                      <tr>
                        <td height="30" class="boldEleven">Shift Name </td>
                        <td class="boldEleven"><select name="shift" id="shift" class="formText135">
                        <option value="0">All</option>
                            <%
		sq="SELECT INT_SHIFTID,CHR_SHIFTNAME FROM   att_m_shift   ORDER BY  INT_SHIFTID";
		String shiftid[][] = com.my.org.erp.common.CommonFunction.RecordSetArray(sq);
		
		for(int u=0;u<shiftid.length;u++)
			out.print("<option value='"+shiftid[u][0]+"'>"+shiftid[u][1]+"</option>"); 
	%>
                        </select></td>
