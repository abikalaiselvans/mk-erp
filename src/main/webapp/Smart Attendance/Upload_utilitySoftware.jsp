		  ...
		  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> FILE UPLOAD
                    ...
                    <input name="redirect" type="hidden" id="redirect" value="Smart Attendance/Utilitysoftwares.jsp">
                    <input name="uploadpath" type="hidden" id="uploadpath" value="uploadfiles/Utility Software/">
                </div></td>
              </tr>
