...
function Validate()
  {
	...
	if(  checkNull( "Name","Enter Country name" ) 
		 && checkNull( "sdescription","Enter Country Description" )  )
		return true;
	else
		return false;				
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> COUNTRY 
				    ...
				    <%
							...
							{
								id="";Name=""; desc="";
								actionS="GENCountryAdd";
								value="Add";
								link=" onKeyUp=\" CheckUnique(this,'divunitname','com_m_country','CHR_COUNTRYNAME')\"  onKeyUp=\" CheckUnique(this,'divunitname','com_m_country','CHR_COUNTRYNAME')\" ";
							...
							else
							{
								...
								sql = " SELECT INT_COUNTRYID,CHR_COUNTRYNAME,CHR_COUNTRYDESC FROM  com_m_country  WHERE INT_COUNTRYID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1];  desc=data[0][2]; 
								actionS="GENCountryEdit";
								value="Update";
								link=" onKeyUp=\"  CheckUnique(this,'divunitname','com_m_country','CHR_COUNTRYNAME')\"  onKeyUp=\" CheckUnique(this,'divunitname','com_m_country','CHR_COUNTRYNAME')\" ";
              ...
              <tr>
                ...
                <td width="69%" class="boldEleven"><input name="Name" type="text"   onBlur="upperMe(this)"    class="formText135" id="Name" <%=link%> value="<%=Name%>" size="40" maxlength="49">
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Country" />
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
									cellspacing="1">
                  <tr>
                    <td><input name="Submit" id="Submit" type="submit" 	class="buttonbold13" value="<%=value%>"  accesskey="s"  ></td>
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('CountryView.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
