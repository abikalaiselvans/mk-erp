              ...
              <tr>
                <td colspan="2" class="bold1"><div align="center"> Department 
				    ...
				    <%
							...
							{
								id="";Name=""; desc=""; status="";
								actionS="GENDepartmentAdd";
								value="Add";
								link=" onKeyUp=\" CheckUnique(this,'divunitname','com_m_depart','CHR_DEPARTNAME')\" ";
							...
							else
							{
								...
								sql = " SELECT INT_DEPARTID,CHR_DEPARTNAME,CHR_DEPARTDES,CHR_STATUS  FROM com_m_depart  WHERE INT_DEPARTID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1];  desc=data[0][2]; status=data[0][3]; 
								actionS="GENDepartmentEdit";
								value="Update";
								link=" onKeyUp=\" CheckUnique(this,'divunitname','com_m_depart','CHR_DEPARTNAME')\" ";
							}
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('DepartmentView.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
