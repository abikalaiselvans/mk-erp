...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><form  method="post" action="EmployeeTrackResponse.jsp" name="frm" id="frm" onSubmit="return Validate()">
      <table class="BackGround1" cellspacing="0" cellpadding="0" width="500"
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="412" valign="top"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
              ...
              <tr>
                <td colspan="5" class="boldEleven"><%@ include file="../JavaScript/ajax.jsp"%></td>
              </tr>
              <tr>
                <td colspan="5" class="boldEleven"><table width="130" border="0" align="center" cellpadding="1"
									cellspacing="1">
                  <tr>
                    <td><input name="Close2" type="submit"   class="buttonbold13" id="Close2"  value="Submit"   accesskey="s" ></td>
