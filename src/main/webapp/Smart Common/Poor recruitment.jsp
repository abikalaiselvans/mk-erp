...
<form  AUTOCOMPLETE = "off"   action="Rept_Poor recruitmentResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">Poor recruitment </td>
						</tr>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td height="19" valign="middle" class="boldEleven">Day Difference </td>
						  <td valign="top" class="boldEleven"><select name="Day" id="Day"  class="formText135">
                            <%
							for(int u=1;u<=180;u++)
						...
						<tr class="bolddeepblue">
						  ...
						  <td valign="top" class="boldEleven"><input title="dd/mm/yyyy"  name="fromdate"  id="fromdate"  type="text" class="formText135" size="15"  readonly="readonly"/><script language="javascript">setCurrentDate('fromdate')</script></td>
						  <td valign="top" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
					  </tr>
						<tr class="bolddeepblue">
							<td height="19" valign="middle" class="boldEleven">To</td>
							<td valign="top" class="boldEleven"><input title="dd/mm/yyyy"  name="todate"  id="todate"  type="text" class="formText135" size="15"  readonly="readonly"/><script language="javascript">setCurrentDate('todate')</script></td>
							<td valign="top" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
						</tr>
