...
<script language="javascript" src="../JavaScript/smartcommon/QualificationAjax.js"></script>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table width="90%" height="220" border="0" align="center" cellpadding="0" cellspacing="0" class="TableDesign"
			...
			<tr>
			  ...
			  <div id="QualificationTable" style="OVERFLOW:auto;width:100%;height:300px"></div>	<br><br>
	...
	<tr>
	  <td><input type="hidden" name="filename"	value="Qualification">
      <input type="hidden" name="actionS"	value="GENQualificationDelete"></td>
  </tr>
	<tr>
		<td>
		  <div align="center">
