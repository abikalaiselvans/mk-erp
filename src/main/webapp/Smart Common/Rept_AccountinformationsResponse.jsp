...
<%
	...
	sql = sql + " h.CHR_BANKGROUPNAME,a.CHR_IFSC,a.CHR_ACCNO , ";
	...
	sql = sql + " com_m_depart e,com_m_desig f , com_m_employeecategory g , com_m_bankgroup h  ";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="BANK" sortable="true"><%=temp.elementAt(12)%></display:column>
					<display:column title="IFSC" sortable="true"><%=temp.elementAt(13)%></display:column>
					<display:column title="ACCOUNT NUMBER" sortable="true"><%=temp.elementAt(14)%></display:column>
					<display:column title="STATUS" sortable="true"><%=temp.elementAt(15)%></display:column>
					 
					<display:setProperty name="export.excel.filename" value="Rept_Accountinformations.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_Accountinformations.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_Accountinformations.csv"/>
