...
<form  AUTOCOMPLETE = "off"   action="Rept_DOBResponse.jsp" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">STAFF DOB LIST </td>
						</tr>
	...
	%>
						...
						<tr class="bolddeepblue">
						  ...
						  <td valign="top" class="boldEleven"><select name="day" class="formText135" id="day">
