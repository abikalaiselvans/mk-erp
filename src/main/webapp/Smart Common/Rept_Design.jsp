        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">REPORTING HEAD  </div></td>
                </tr>
              <tr>
                <td width="39%" class="boldEleven">Export Type <font
...
<select name="reportType" id="reportType" style="width:170px;">
      ...
      <option value="excel" title="../DropDown - Image/icons/excel.jpg">Excel </option>
