...
<form  AUTOCOMPLETE = "off"   action="Rept_EmployeelistResponsae.jsp" method="post" name="frm">
				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">STAFF  INFORMATIONS
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">Order by</td>
							<td class="boldEleven"><select name="sorting" class="formText135">
                                <option value="a.CHR_USERID  ">Empid</option> <!--CHR_EMPID-->
