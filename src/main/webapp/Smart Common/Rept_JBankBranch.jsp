...
function Validate()
  {
   	...
   	if(  
   			checkNullSelect( "bank","Select Bank" ,'0') && checkNullSelect( "reportType","Select Export Type" ,'0') 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<table class="BackGround1" cellspacing="0" cellpadding="0" width="326"
        ...
        <tr>
          ...
          <td width="317" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> BANK BRANCH REPORTING HEAD  </div></td>
                </tr>
                <tr>
                <td class="boldEleven">Bank <font
																class="bolddeepred" align="absmiddle">*</font></td>
                <td class="boldEleven"> <select name="bank" id="bank" style="width:170"  >
                  <option value="0"> Select Bank</option>
                  
                  <%
		 			
	String BData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_BANKGROUPID,CHR_BANKGROUPNAME,CHR_SHORTNAME FROM com_m_bankgroup  ORDER BY CHR_BANKGROUPNAME");
	if (BData.length>0)
		for (int i=0; i<BData.length; i++) 
			out.println("<option value="+BData[i][0]+">"+BData[i][1] +"</option>");			
              ...
              <tr>
                <td width="38%" height="30" class="boldEleven">Export Type <font
																class="bolddeepred" align="absmiddle">*</font></td>
                <td width="62%" class="boldEleven"><script language="javascript" type="text/javascript">
