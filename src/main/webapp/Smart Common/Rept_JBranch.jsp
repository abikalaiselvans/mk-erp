        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">COMPANY BRANCH REPORTING HEAD  </div></td>
                </tr>
              <tr>
                <td height="30" class="boldEleven">Company<font
																class="bolddeepred" align="absmiddle"> *</font></td>
                <td class="boldEleven"><select name="company"
								id="company"  class="formText135"
								style="width:170px">
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
                  ...
                  <input name="actionS"
										...
										value="RPTComBranch">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="PageWidth1640">
                    </td>
              </tr>
              <tr>
