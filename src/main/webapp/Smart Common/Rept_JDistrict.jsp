...
<script language="javascript" src="../JavaScript/common/ChangeCountry.js"></script>
</head>
  ...
  <tr>
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">DISTRICT REPORTING HEAD  </div></td>
                </tr>
                <tr>
				<td class="boldEleven">
				Select Country <font
																class="bolddeepred" align="absmiddle">*</font></td>
				<td><select name="country" class="formText135" id="country"  style="width:170px;"  onChange="LoadSelectState('All')">
	...
	if (BData.length>0)
		...
		%>
				...
				Select State<font
																class="bolddeepred" align="absmiddle"> *</font></td>
				<td><select name="state" class="formText135" id="state" style="width:170px;" >
