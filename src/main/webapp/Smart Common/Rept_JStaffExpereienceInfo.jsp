...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">EXPERIENCE</td>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td height="19" valign="middle" class="boldEleven">Experience</td>
						  <td valign="top" class="boldEleven">
						  <select name="experience" class="formText135" id="experience">
						  <option value="0">All</option>
						  <%
						  	for(int u=1;u<=50;u++)
  ...
  <select name="reportType" class="formText135" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="StaffExperienceInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="RPTStaffExperienceInfo">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="PageWidth1040"></td>
              </tr> 
						<tr>
