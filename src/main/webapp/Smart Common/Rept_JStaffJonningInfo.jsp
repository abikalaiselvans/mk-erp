				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">JOINING REPORT </td>
	...
	%>
						...
						<tr class="bolddeepblue">
							...
							<td width="181" valign="top" class="boldEleven"><select
								name="year" id="year" class="formText135" style="width:170px;" >
								<option value="0">All</option>
  ...
  <select name="reportType" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="StaffJoiningInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="RPTStaffJoiningInfo">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="PageWidth1640"></td>
              </tr> 
						<tr>
