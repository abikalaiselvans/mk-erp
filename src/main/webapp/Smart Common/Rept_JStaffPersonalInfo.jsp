				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">PERSONAL INFORMATIONS </td>
						...
						<tr class="bolddeepblue">
						  <td valign="middle" class="boldEleven">Department</td>
							<td width="296" valign="top" class="boldEleven"><select
								name="dept" id="dept" class="formText135" style="width:170px;" >
                                <option value="0">All</option>
                                <%
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">Order by</td>
							<td class="boldEleven"><select name="sorting" class="formText135" style="width:170px;" >
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven"><span class="boldEleven">Sorted
						    By </span></td>
						  <td class="boldEleven"><select name="ss" class="formText135" style="width:170px;" >
						...
						<tr>
                <td width="39%" height="30" class="boldEleven">Export Type <span class="boldred">*</span> </td>
                <td width="61%" class="boldEleven">
	...
	$(document).ready(function() 
	{
		...
		catch(e) 
		{
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="StaffPersonalInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="RPTStaffPersonalInfo">
