...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">QUALIFICATION INFORMATIONS </td>
	...
	%>
						...
						<tr class="bolddeepblue">
							<td height="19" valign="middle" class="boldEleven">Qualification</td>
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="StaffQualificationInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="RPTStaffQualificationInfo">
