...
function Validate()
  {
   	...
   	if(  
		checkNullSelect( "repto","Select Employee id" ,'0') 
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">REPORTING TO </td>
                ...
                <tr>
                  ...
                  <td align="left" valign="middle" class="boldEleven"><select name="repto" class="formText135" id="repto" style="width:170px;" >
  ...
  <select name="reportType" class="formText135" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="StaffReportingToInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="RPTStaffReportingToInfo">
