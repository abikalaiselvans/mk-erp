...
function Validate()
  {
	 if(  
			 checkNullSelect( "countryId","Select Country" ,'a') && checkNullSelect( "reportType","Select Export Type" ,'0')   
	  )
		return true;
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">STATE REPORTING HEAD  </div></td>
                </tr>
                <tr>
				<td class="boldEleven">
				Select Country <span class="bolddeepred">*</span> </td>
				<td><select name="countryId" class="formText135" id="countryId" style="width:100">
	<option value="a">Select Country</option>
	<option value="0">All</option>
                  <%
		 			
	String BData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_COUNTRYID ,CHR_COUNTRYNAME FROM  com_m_country ORDER BY CHR_COUNTRYNAME");
	if (BData.length>0)
