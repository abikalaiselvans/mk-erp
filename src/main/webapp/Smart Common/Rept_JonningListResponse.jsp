...
<%
	 ...
	 sql = sql +" DATE_FORMAT(a.DT_DOJCOLLEGE,'%d-%b-%Y'),FLOOR(PERIOD_DIFF(EXTRACT(YEAR_MONTH FROM NOW()),EXTRACT(YEAR_MONTH FROM a.DT_DOJCOLLEGE))/ 12), a.INT_SALARY,a.INT_GROSSSALARY ,MONTHNAME(a.DT_DOJCOLLEGE),YEAR(a.DT_DOJCOLLEGE) ";
	...
	if(!"0".equals(dept))
	 ...
	 if(!"0".equals(year))
	 	sql = sql +" AND YEAR(a.DT_DOJCOLLEGE)="+year;
