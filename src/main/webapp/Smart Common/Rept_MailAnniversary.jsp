...
<form  AUTOCOMPLETE = "off"   action="../SmartLoginAuth" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">STAFF ANNIVERSARY LIST 
							  <input type="hidden" name="filename" value="MailAnniversary" />
                              <input
			type="hidden" name="actionS" value="GENMailAnniversary" /></td>
						</tr>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td height="19" valign="middle" class="boldEleven">Day</td>
						  <td valign="top" class="boldEleven">
						  <select name="day" class="formText135" id="day">
						  <%
						  for(int u=1;u<32;u++)
