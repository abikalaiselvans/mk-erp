...
<%
 	 ...
 	 String reportheader="STAFF MAILID  ";
...
sql = sql +"  A.CHR_MOBILE,A.CHR_PERMAILID ,A.CHR_EMAILID,A.CHR_PASSPORT,A.CHR_DRIVING,A.CHR_PAN"; 
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="MOBILE" sortable="true"><%=temp.elementAt(8)%></display:column>
					<display:column title="PER-MAILID" sortable="true"><%=temp.elementAt(9)%></display:column>
					<display:column title="OFF-MAILID" sortable="true"><%=temp.elementAt(10)%></display:column>
					
					<display:setProperty name="export.excel.filename" value="Rept_Mailids.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_Mailids.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_Mailids.csv"/>
					<display:setProperty name="export.pdf"  value="true" />
					 
</display:table> 
</center>			
<br />	<center>	<a href='Rept_Mailids.jsp'> CLOSE</a></center>
