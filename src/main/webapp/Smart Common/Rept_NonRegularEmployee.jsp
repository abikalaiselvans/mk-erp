...
<%
	...
	sql = sql +" IF(a.CHR_EMPLOYEE ='R','REGULAR','NON REGULAR') ";
	...
	sql = sql +" AND a.CHR_BG=b.INT_BLOODGROUPID  AND  a.CHR_EMPLOYEE = 'N' ";
	...
	<display:table   id="_table" name="table"   export="true" pagesize="25">
	 <display:caption><%="STAFF  IMFORMATION"%></display:caption>
					...
					<display:column title="TYPE" sortable="true"><%=temp.elementAt(11)%></display:column>
					 
					 
					
					<display:setProperty name="export.csv.filename" value="Rept_NonRegularEmployee.csv"/>
					<display:setProperty name="export.excel.filename" value="Rept_NonRegularEmployee.xls"/>
					<display:setProperty name="export.xml.filename" value="Rept_NonRegularEmployee.xml"/>
					<display:setProperty name="export.pdf.filename" value="Rept_NonRegularEmployee.pdf"/>
...
<br />
									...
									<center>	<a href='Rept_Staff.jsp'> CLOSE</a></center><br /><br />
 <%
 }
 catch(Exception e)
 {
