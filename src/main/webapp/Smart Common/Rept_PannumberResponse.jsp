...
<%
 	 ...
 	 String reportheader="STAFF PAN NUMBER ";
...
sql = sql +"  A.CHR_MOBILE,A.CHR_PAN,A.CHR_PASSPORT,A.CHR_DRIVING,A.CHR_PERMAILID "; 
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PAN NUMBER" sortable="true"><%=temp.elementAt(9)%></display:column>
					
					<display:setProperty name="export.excel.filename" value="Rept_Pannumber.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_Pannumber.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_Pannumber.csv"/>
					<display:setProperty name="export.pdf"  value="true" />
					 
</display:table> 
</center>			
<br />	<center>	<a href='Rept_Pannumber.jsp'> CLOSE</a></center>
