...
<%
 	 ...
 	 String reportheader="STAFF PASSPORT ";
...
sql = sql +"  A.CHR_MOBILE,A.CHR_PASSPORT,A.CHR_DRIVING,A.CHR_PAN,A.CHR_PERMAILID "; 
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PASSPORT" sortable="true"><%=temp.elementAt(9)%></display:column>
					
					<display:setProperty name="export.excel.filename" value="Rept_Passport.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_Passport.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_Passport.csv"/>
					<display:setProperty name="export.pdf"  value="true" />
					 
</display:table> 
</center>			
<br />	<center>	<a href='Rept_Passport.jsp'> CLOSE</a></center>
