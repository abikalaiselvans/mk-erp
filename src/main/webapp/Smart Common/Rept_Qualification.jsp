...
<%
 ...
 String reportheader="QUALIFICATION INFORMATION "; 
...
String sql="";
	 ...
	 sql = " SELECT CHR_QUALIFICATIONNAME,CHR_QUALIFICATIONDES  FROM  com_m_qualification ORDER BY CHR_QUALIFICATIONNAME ";
