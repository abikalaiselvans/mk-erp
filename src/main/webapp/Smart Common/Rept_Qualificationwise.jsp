...
function validate()
{
	try
	{
		...
		if(checkNull('qualification','Select Qualification'))
			return true;
		else
			return false;
...
<form  AUTOCOMPLETE = "off"   action="Rept_QualificationwiseResponse.jsp" method="post" name="frm" onSubmit="return validate()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">STAFF QUALIFICATION </td>
						</tr>
	...
	String empcategoryData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_EMPLOYEECATEGORYID,CHR_CATEGORYNAME  FROM   com_m_employeecategory   ORDER BY CHR_CATEGORYNAME ");
	...
	%>
						...
						<tr class="bolddeepblue">
							<td height="19" valign="middle" class="boldEleven">Qualification<span class="errormessage"> * </span></td>
							<td valign="top" class="boldEleven"><select name="qualification"  id="qualification"
								class="formText135" multiple="multiple" size="5" style="width:200px">
								<option value="0">All</option>
								 <%
	 
	String qualdata[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(" SELECT INT_QUALIFICATIONID,CHR_QUALIFICATIONNAME FROM com_m_qualification ORDER BY CHR_QUALIFICATIONNAME  ");
	if (qualdata.length>0)
		for (int i=0; i<qualdata.length; i++) 
			out.println("<option value="+qualdata[i][0]+">"+qualdata[i][1] +"</option>");			
						...
						%>
						 ...
						 <tr class="bolddeepblue">
						   <td height="19" valign="middle" class="boldEleven">Resigned &amp; Hold </td>
						   <td valign="top" class="boldEleven"><table width="100" border="0" cellpadding="0" cellspacing="0" class="boldEleven">
                             <tr>
                               <td><input name="resigned" type="checkbox" id="resigned" value="Y"></td>
                               <td>Resigned</td>
                               <td><input name="hold" type="checkbox" id="hold" value="Y"></td>
                               <td>Hold</td>
                             </tr>
                           </table></td>
						   <td valign="top" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
