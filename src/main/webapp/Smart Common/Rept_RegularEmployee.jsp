...
<%
	...
	sql = sql +" AND a.CHR_BG=b.INT_BLOODGROUPID  AND  a.CHR_EMPLOYEE = 'R' ";
	...
	<display:table   id="_table" name="table"   export="true" pagesize="25">
	 <display:caption><%="STAFF  IMFORMATION"%></display:caption>
					...
					<display:setProperty name="export.csv.filename" value="Rept_RegularEmployee.csv"/>
					<display:setProperty name="export.excel.filename" value="Rept_RegularEmployee.xls"/>
					<display:setProperty name="export.xml.filename" value="Rept_RegularEmployee.xml"/>
					<display:setProperty name="export.pdf.filename" value="Rept_RegularEmployee.pdf"/>
