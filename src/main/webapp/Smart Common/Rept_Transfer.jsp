...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		<td height="371">
		<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_TransferResponse.jsp" onSubmit="return Validate()">
					...
					<tbody>
						...
						<tr>
							...
							<table width="577" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2">
									<div align="center" class="boldEleven"><strong>EMPLOYEE TRANSFER </strong></div>
									</td>
								</tr>
								<tr>
									<td colspan="2">
