...
<%
	...
	sql = sql +" AND a.CHR_BG=b.INT_BLOODGROUPID  AND  a.CHR_APPROVED = 'N' ";
	...
	<display:table   id="_table" name="table"   export="true" pagesize="25">
	 <display:caption><%="WAITING FOR APPROVAL"%></display:caption>
					...
					<display:setProperty name="export.csv.filename" value="Rept_WaitingforApprovalEmployee.csv"/>
					<display:setProperty name="export.excel.filename" value="Rept_WaitingforApprovalEmployee.xls"/>
					<display:setProperty name="export.xml.filename" value="Rept_WaitingforApprovalEmployee.xml"/>
					<display:setProperty name="export.pdf.filename" value="Rept_WaitingforApprovalEmployee.pdf"/>
