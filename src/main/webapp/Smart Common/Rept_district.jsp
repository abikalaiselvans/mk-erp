...
function Validate()
  {
	...
	if(  checkNullSelect( "country","Select Country" ) 
		   )
		return true;
	else
		return false;				
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	 <form  AUTOCOMPLETE = "off"   action="Rept_DistrictResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td width="100%" colspan="2" class="bold1"><div align="center">DISTRICT </div></td>
                </tr>
              <tr>
                <td class="boldEleven">Country<font
																class="bolddeepred" align="absmiddle">*</font></td>
                <td class="boldEleven"><select name="country" id="country" style="width:170" onChange="LoadSelectStates()">
	 ...
	 %>
              ...
              <tr>
                ...
                <td class="boldEleven"><table width="150" border="0" cellspacing="0"
																cellpadding="0">
                    <tr>
                      <td><select name="state" id="state" style="width:170" >
