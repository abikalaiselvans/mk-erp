...
<form  AUTOCOMPLETE = "off"   action="Rept_getCurrentRevisionlistResponse.jsp" method="post" name="frm">
				...
				<tr>
					...
					<table width="450" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">REVISIOPN LIST  INFORMATIONS </td>
						</tr>
	...
	%>
						...
						<tr class="bolddeepblue">
						  ...
						  <td valign="top" class="boldEleven"><select
                            ...
                            <jsp:include page="../JavaScript/years.jsp" flush="true" />                          
</select>
