...
<script language="javascript" src="../JavaScript/smartcommon/Staff_Photo_Resume_Upload_Search.js"></script>
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="loadStaff('0'),document.getElementById('searchstaff').focus()">
		...
		<table border="0" align="center" cellpadding="2" cellspacing="2">
			<tr>
				...
				<td width="56"><input class="ButtonHead" type="button"
					name="Button"  value="Close"   accesskey="c"  onClick="redirect('commonmain.jsp')"></td>
