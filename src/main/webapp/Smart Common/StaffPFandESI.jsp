...
<form  AUTOCOMPLETE = "off"   action="StaffPFandESIResponse.jsp" method="post" name="frm">
	...
	<tr>
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<table width="519" border="0" cellspacing="0" cellpadding="3"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="3"  class="BackGround">PF NUMBER </td>
						</tr>
			  ...
			  %> <select name="Office" class="formText135" id="Office" style="width:175">
								<option value="0">All</option>
								<%
						...
						<tr class="bolddeepblue">
						  <td valign="middle" class="boldEleven">Department</td>
							<td width="250" valign="top" class="boldEleven"><select
								name="dept" id="dept" class="formText135" style="width:175">
                                <option value="0">All</option>
                                <%
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">Order by</td>
							<td class="boldEleven"><select name="sorting" class="formText135" style="width:175">
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven"><span class="boldEleven">Sorted
						    By </span></td>
						  <td class="boldEleven"><select name="ss" class="formText135" style="width:175">
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">PF</td>
						  <td class="boldEleven"><select name="pf" class="formText135" id="pf" style="width:175" tabindex="48">
                            <option value="0">All </option>
						...
						<tr class="bolddeepblue">
						  ...
						  <td class="boldEleven"><select name="esi" class="formText135" id="esi" style="width:175" tabindex="53">
                            <option value="0">All </option>
                            <option value="Y">Yes</option>
                            <option value="N">No</option>
                            <option value="C">Common</option>
						...
						<tr class="bolddeepblue">
						  <td class="boldEleven">With Resigned</td>
