	...
	$(function() {
	 ...
	 $(function() {
		$( "#pfesidate" ).datepicker({
			changeMonth: true,
			changeYear: true,minDate: -60, maxDate: "+10D" ,
			showOn: "button",
			buttonImage: "../JavaScript/jquery/images/calendar.gif",
			buttonImageOnly: true
		});
					...
					<TBODY>
						...
						<TR>
							...
							<table width="707" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td colspan="2">
									<div align="center"><span class="boldThirteen">STAFF REGISTRATION</span></div>
									</td>
								</tr>
								<tr>
									<td colspan="2">
														...
														<tr>
															<td class="boldEleven">Date Of Birth 
															 ...
															 <font class="errormessage"
																align="absmiddle">*</font>														   															</td>
															<td class="boldEleven">
<input name="dob" id="dob" type="text" class="formText135" size="22" value="<%=staffData[0][9] %>" title=" dd/mm/yyyy ( For e.g 21-10-1977)" readonly='readonly' /> </td>
														</tr>
														...
														<tr>
															<td class="boldEleven">Actual Date Of Birth <font class="errormessage"
																align="absmiddle">*</font> </td>
															<td class="errormessage"><input name="adob" id="adob" type="text" class="formText135" size="22" value="<%=staffData[0][90] %>" title=" dd/mm/yyyy ( For e.g 21-10-1977)"  readonly='readonly'   /></td>
														</tr>
...
<input name="marry" id="marry"  type="radio" class="formText135" onClick='changeState()' value="U" <%=grd1%> /> </td>
                                        ...
                                        <input name="mtype"  id="mtype"  type="hidden" value="<%=staffData[0][18]%>" />																	</td>
														...
														<tr id="cwd">
															...
															<td class="boldEleven">
<input name="wedding" type="text" class="formText135" id="wedding" size="22" value="<%=staffData[0][19] %>"  readonly='readonly' /> </td>
														</tr>
...
%>
				...
				<input name="attendancecycle"   id="attendancecycle" type="hidden" value="<%=staffData[0][85]%>">											 </td>
												...
												<option value="WRK">Working Days (Daily Wages) - Based</option>
                                                      ...
                                                      <tr>
															<td width="129"class="boldEleven">PF Calculation Type</td>
															<td width="170"class="boldEleven"><%=staffData[0][93] %></td>
													  </tr>
													</table>
													</td>
													<td class="boldEleven">
...
<input name="pfnomineerelationship" id="pfnomineerelationship" type="hidden" value="<%=staffData[0][88]%>">														  </td>
														...
														<tr>
															...
															<td class="errormessage"><%=staffData[0][95]%> </td>
														</tr>
													</table>													</td>
...
<input name="dispensary" id="dispensary" type="hidden" value="<%=staffData[0][48]%>">									</td>
												...
												<tr>
												  <td class="boldEleven">Date of Reivision<font
																class="errormessage" align="absmiddle"> *</font> </td>
												  <td class="boldEleven"><input title="dd/mm/yyyy"  name="revisiondate" id="revisiondate" type="text" class="formText135" size="15" maxlength="10" value="<%=staffData[0][80]%>"  readonly='readonly'   /></td>
												  <td class="boldEleven">Date of PF &amp; ESI Registration </td>
												  <td class="boldEleven"><input title="dd/mm/yyyy"  readonly='readonly'   name="pfesidate" id="pfesidate" type="text" class="formText135" size="15" maxlength="10" value="<%=staffData[0][54]%>" /></td>
											  </tr>
												<tr>
												  <td class="boldEleven">Date of Resign </td>
												  <td class="boldEleven"><input title="dd/mm/yyyy"  readonly='readonly'    name="resigndate" id="resigndate" type="text" class="formText135" size="15" maxlength="10" value="<%=staffData[0][55]%>"  /></td>
												  <td class="boldEleven">&nbsp;</td>
											      <td class="boldEleven">&nbsp;</td>
											  </tr>
												<tr>
												...
												<tr>
												  <td colspan="2" class="boldEleven"><table width="330" border="0" align="center">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="boldEleven"><input name="aadharnumber" type="text" class="formText135" id="aadharnumber"  tabindex="60"   onBlur="upperMe(this)" onKeyUp="upperMe(this), LoadUniqueCheck('aadharnumber', 'aadhardiv', 'com_m_staff', 'CHR_AADHARNO ', 'Submit')" value="<%=("-".equals(staffData[0][94])? "" :staffData[0][94] ) %>" size="30" maxlength="20"   /></td>
                                                    </tr>
                                                  </table></td>
												...
												<tr>
                                                  ...
                                                  <%
												  if("Y".equals(staffData[0][91]))
												  {
													  out.println("<tr>");
													  out.println("<td colspan='4' class='formTableOuterDesign'>");
													  out.println("<center>"+ staffData[0][92]+"</center>");
													  out.println("</td>");
													  out.println("</tr>");
													  out.println("");
...
%>
			  ...
			  <td width="27%" valign="top">
				<table width="113" border="0" align="center" cellpadding="1"
					...
					<tr>
						<td class="boldEleven">
						<%
			String staffphoto = request.getRealPath("")+"/uploadfiles/StaffPhoto/"+staffid.trim() +".jpg";
			String defaul = "../uploadfiles/StaffPhoto/default.jpg" ;
			String photo="";
			...
			%>						</td>
					  ...
					  <td class="boldEleven">
					    <div align="center">
						      ...
						      <%
									...
									if (f.exists())
										photo ="../uploadfiles/StaffPhoto/"+staffid.trim() +".jpg";
									else
										photo =defaul;
				
							%>
						        <img src="<%=photo%>" title="<%=photo%>" width="120" height="150" border="1" name="Photo" id="Photo" />
					...
					<tr>
					  ...
					  <input type="image" src="../images/uploadphoto.png" onClick="return PhotoUpload('<%=staffid%>')"/>
				...
				<table width="100%" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    <td class="boldEleven"> <div align="center"><a  download href="<%=photo%>">Download Photo</a></div>
                    
                    <!--<a target="_blank" href="../DownloadStaffImage?myid=<%=staffid.trim()%>">Download Photo</a>
                    -->
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
					...
					<div align="center">
					 ...
					 <input type="image" src="../images/uploadresume.png" onClick="return ProfileUpload('<%=staffid%>')"/>
                    </div>
					</td></tr></table>					</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="boldEleven"><div align="center">Sample Format <a target="_blank" href='../Staff Resume/Employment Application Form.doc'><img src="../Image/report/news_info.gif" width="16" height="16" border="0"></a></div></td>
                  </tr>
                  <tr>
                    <td class="boldEleven">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="boldEleven">
					  ...
					  <div align="center">
					    <%
			String profile = request.getRealPath("/")+"/uploadfiles/Staff Resume/"+staffid.trim() +".doc";
			f = new File(profile);
			if (f.exists())
			{
				%>
					           Profile view <a href='<%="../uploadfiles/Staff Resume/"+staffid.trim()+".doc"%>'><img src="../Image/report/news_info.gif" width="16" height="16" border="0"></a>
			            <%
			}
			%>					
			        </div></td>
                  ...
                  <tr>
					...
					<table width="200" align="center"><tr><td>
					<div align="center">
                     <input type="image" src="../images/addressproof.png" onClick="return AddressProofUpload('<%=staffid%>')"/>
                    </div>
					</td></tr></table>					</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
					...
					<table width="200" align="center">
					  <tr><td align="center">
					<input type="image" src="../images/addressproofview.png"   onClick="return ViewAddressProof('<%=staffid%>')"/>
					 				 					</td></tr></table>					</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="boldEleven" align="center">
                    <input type="image" src="../images/aadhaar.png"   onClick="return aadharUpload('<%=staffid%>')"/> </td>
                  </tr>
                  <tr>
                    <td class="boldEleven" align="center">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="boldEleven" align="center"><table width="200" align="center">
                      <tr>
                        <td align="center">
						
						<input type="image" src="../images/qualification.png"  onClick="return certificateUpload('<%=staffid%>')"/>                      </td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                 ...
                 <tr>
                    <td class="boldEleven" align="center"><table width="200" align="center">
                      <tr>
                        <td align="center">
<input type="image" src="../images/allinone.png"  onClick="return fullFileUpload('<%=staffid%>')"/>                       </td>
                      </tr>
                    </table></td>
                  </tr> 
                  <tr>
			...
			profile = request.getRealPath("/")+"/uploadfiles/Staff_full_informations/"+staffid.trim() +".pdf";
			f = new File(profile);
			if (f.exists())
			{
				%>
				              View <a target='_blank' href='<%="../uploadfiles/Staff_full_informations/"+staffid.trim()+".pdf"%>' download='<%=staffid.trim()%>.pdf' ><img src="../Image/report/pdfv.gif" width="54" height="52" border="0"></a>
			                  <%
			}
			%>					
			        </div>
...
if(mm == "M")
	...
	function PhotoUpload(staffid)
	{
		...
		else
		{
			...
			newWindow = window.open(f,"subWind",",,height=350,width=500,top=150,left=150");
			newWindow.focus( );
			return false;
		}
		//return true 	
	...
	function ProfileUpload(staffid)
	{
		...
		else
		{
			...
			newWindow = window.open(f,"subWind",",,height=250,width=500,top=150,left=150");
			newWindow.focus( );
			return false;
		}
	...
	function aadharUpload(staffid)
	{
		...
		{
			var f ="aadharUpload.jsp?staffid="+document.a.id.value;
			newWindow = window.open(f,"subWind",",,height=300,width=450,top=0,left=0");
			newWindow.focus( );
			return false;
		}
