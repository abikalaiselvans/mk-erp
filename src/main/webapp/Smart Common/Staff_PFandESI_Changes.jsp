...
<script language="javascript" src="../JavaScript/smartcommon/Staff_PFandESI_Changes.js"></script>
...
function  Edit()
 	{		
		...
		if(count==1){			
			document.frm.action="Staff_PFandESI_ChangesAction.jsp";
			document.frm.submit();
			return true;
		}
		else
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="loadStaffPFESI('0'),document.getElementById('bank').focus()">
	...
	<tr>
		...
		<table width="90%" height="327" border="0" align="center"
			...
			<tr align="center" valign="middle" 
			 background="">
				<td height="14" class="boldgre"   > <div align="center" class="whiteMedium">STAFF PF AND ESI INFORMATIONS </div></td>
			</tr>
