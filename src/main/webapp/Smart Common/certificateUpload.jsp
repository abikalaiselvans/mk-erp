...
<BODY> <FORM name="frm"  ENCTYPE="multipart/form-data" ACTION= "certificateCopy.jsp?staffid=<%=request.getParameter("staffid")%>" METHOD="POST" onSubmit="return Load()">
                <br><br><br>
           
		   
		   <table border="0" align="center" cellpadding="2" cellspacing="2"  >
          	   <tr> <td colspan="2"><p align= "center"><B>  UPLOADING STAFF CERTIFICATE </B></td></tr>
			   <tr>
