...
try 
{
	...
	sql = sql + " ORDER BY a.CHR_CITYNAME LIMIT 10  ";
	...
	if(picodedata.length>0)
	{
		...
		{
		out.println("<li onclick=\"cfill('"+picodedata[u][0]+"/"+picodedata[u][1]+"/"+picodedata[u][2]+"/"+picodedata[u][3]+"/"+picodedata[u][4]+"/"+picodedata[u][5]+"/"+picodedata[u][6]+"/"+picodedata[u][7]+"/"+picodedata[u][8]+"')\">"+picodedata[u][3] +" / "+picodedata[u][5] +" / " +picodedata[u][7] +"  / " +picodedata[u][8]+"</li>");
		}
	}
}
catch(Exception e)
