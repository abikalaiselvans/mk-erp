...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="DisapprovalofConveyanceResponse.jsp"
					...
					<table width="374" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><span
								class="boldThirteen">CONVEYANCE DISAPPROVAL </span></td>
						</tr>
					  ...
					  String empid =""+session.getAttribute("EMPID");
   		 			...
   		 			String sql="select a.CHR_EMPID,a.CHR_STAFFNAME from  com_m_staff a WHERE   a.CHR_TYPE!='T' AND a.CHR_HOLD!='Y'  AND a.CHR_REPTO='"+empid+"'  ORDER BY a.CHR_STAFFNAME ";
// out.println(sql);				
String Data[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(sql);	
   		 		 
   		 		
					%> <select name="empid" id="empid" class="boldEleven" style="width:200">
