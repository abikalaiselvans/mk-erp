...
try
{
	...
	String pdata[][]= CommonFunctions.QueryExecute(sql);
   	...
   	sql ="SELECT INT_CONID,DATE_FORMAT(DAT_CONDATE,'%d-%m-%Y'),CHR_FROM,CHR_TO,DOU_KM,DOU_TRAVEL,DOU_TRAIN,DOU_AUTO,DOU_LUNCH,";
	...
	//AND CHR_STATUS='Y' AND CHR_ACCEPT='Y'  AND CHR_ACCSTATUS='Y' 
	...
	double sum=0;
		...
		child.addElement(com.my.org.erp.common.CommonFunctions.Round(sum));
		child.addElement("");
		child.addElement("");
		child.addElement("");
		mn.add(child); 
...
<br />	<center>	<a href='ListConveyancee.jsp'> CLOSE</a>
</center>
