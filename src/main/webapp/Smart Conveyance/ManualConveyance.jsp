...
-->
 ...
 <script language="javascript" src="../JavaScript/Conveyance/ConveyanceManual.js"></script>

<script language="JavaScript">
	function Add()
	{
		document.frm.action="ManualConveyanceAction.jsp";
	}
 	function Edit()
	{	
		...
		for(i=0;i<chkbox.length;i++)
		{
			...
			else if(len==0)
			{
				if(chkbox.checked)
				{
					document.frm.action="ManualConveyanceEdit.jsp";
					return true;
				}
				else
				{
...
<table width="100%" height="150" border="0" align="center"
	...
	<tr>
		...
		<table height="218" border="0" align="center"
			...
			<tr  >
				<td height="31"  >
				<div align="center" class="boldThirteen">MANUAL CONVEYANCE </div>				</td>
			</tr>
			<tr  >
 ...
 %>
	...
	<tr>
	  <td><input type="hidden" name="filename" value="ManualConveyance" />
	    <input
			type="hidden" name="actionS" value="CONManualConveyanceDelete" /></td>
	</tr>
	<tr>
		<td>
		  <div align="center">
