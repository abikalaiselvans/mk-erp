...
function validate()
{
	if(checkNullSelect('date','Select date','0'))
		return true;
	else
		return false;
}
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="PaidConveyanceresponse.jsp" onSubmit="return validate() ">
...
<select name="date" class="formText135" id="date">
