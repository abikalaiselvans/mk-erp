...
<script>
	$(function() {
		$( "#paiddate" ).datepicker({changeMonth: true,
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="ReptConveyanceresponse.jsp">
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				%>
								...
								<tr>
									<td class="boldEleven">Paid Date<span class="style4"> *</span> </td>
									<td class="boldEleven"><input name="paiddate" type="text"
										class="formText135" id="paiddate"
										  size="12" readonly="readonly"> <script
										language="JavaScript">			
