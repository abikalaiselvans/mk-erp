...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_DetaiConveyances_Response.jsp" onSubmit="retrun validate()">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><span
								class="boldThirteen">Detailed Conveyance</span></td>
						</tr>
				...
				%>
								...
								<tr>
									...
									<td class="boldEleven"><span class="demo">
									  <input name="fromdate" type="text" id="fromdate" maxlength="12" class="formText135" readonly />
									  <script language="javascript">setCurrentDate('fromdate')</script>
									</span></td>
								</tr>
								<tr>
								  <td class="boldEleven">To Date </td>
								  <td class="boldEleven"><input name="todate" type="text" id="todate" maxlength="12" class="formText135" readonly  />
