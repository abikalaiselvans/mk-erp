...
try
{
 ...
 %>
	...
	<tr>
		<td>
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="588"
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><span
								class="boldThirteen">CONVEYANCE DETAILS FOR ALL EMPLOYEE </span></td>
						</tr>

						 
						<tr >
							<td height="22" colspan="2" valign="middle" ><table width="80%" border="0" align="center" cellpadding="3" cellspacing="4">
                               
                              <tr  >
                                <td height="28" valign="middle" class="boldEleven">From <span class="boldred">*</span> </td>
                                <td> 
								
								<input readonly="readonly" name="fromdate" type="text" id="fromdate" maxlength="12" size="15" class="formText135"/><script language="javascript">setCurrentDate('fromdate')</script>                                </td>
                              </tr>
                              <tr  >
                                <td height="28" valign="middle" class="boldEleven">To <span class="boldred">*</span> </td>
                                <td> 
								<input  readonly="readonly" name="todate" type="text" id="todate" maxlength="12"  size="15" class="formText135"/><script language="javascript">setCurrentDate('todate')</script></td>
                              </tr>
                              <tr  >
		...
		for (int i=0; i<empcategoryData.length; i++) 
			out.println("<option value="+empcategoryData[i][0]+">"+empcategoryData[i][1] +"</option>");			
						...
						%>
                              ...
                              <tr  >
                                <td class="boldEleven">Including Resigner's </td>
						...
						<tr>
							<td height="28" colspan="2" valign="middle" >
							  ...
							  <input name="filename" type="hidden" id="filename"
										value="Rept_JAllEmployeeListConveyanceAll">
                              <input name="actionS"
										type="hidden" id="actionS"
										value="CONRept_JAllEmployeeListConveyanceAll">
                              <input name="rptfilename" type="hidden" id="rptfilename" value="PageWidth1800">
							  </span>
							  <table width="141" border="0" align="center" cellpadding="3"
								cellspacing="3">
								<tr>
								  <td width="60"><input name="Submit2" type="submit" class="buttonbold14" value="Submit"></td>
									<td width="60"><input class="buttonbold14" type="button"
										name="Submit"  value="Close"   accesskey="c" 
										onClick="redirect('Rept_JListConveyance.jsp')"></td>
								</tr>
						  </table>							</td>
						</tr>
						<tr>
