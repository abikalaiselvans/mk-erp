...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_Tally_conveyance_Response.jsp" >
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><span
								class="boldThirteen">Tally Export  Conveyance</span></td>
						</tr>
						...
						<tr class="bolddeepblue">
							...
							<table width="346" border="0" align="center" cellpadding="3"
								...
								<tr>
								  ...
								  <td class="boldEleven">Date <span class="style4">*</span> </td>
								  <td class="boldEleven"><select name="date" class="formText135" id="date">
...
%>
								...
								<!--<tr>
								  ...
								  <td width="52" class="boldEleven">From <span class="errormessage">*</span> </td>
								  <td width="198" class="boldEleven"><input name="fromdate" type="text" class="formText135" id="fromdate"   size="12" readonly="readonly" ></td>
