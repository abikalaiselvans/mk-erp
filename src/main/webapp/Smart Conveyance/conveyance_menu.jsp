...
<% 	
		 ...
		 str="select CHR_MENUCONVEYANCE from  m_user  where CHR_USRNAME='"+uname+"'" ;
	     rs=st.executeQuery(str); 
	     if(rs.next())
	     {		
	    	 mnuList=rs.getString("CHR_MENUCONVEYANCE");
		     str="Select * from  m_menu_conveyance  where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
