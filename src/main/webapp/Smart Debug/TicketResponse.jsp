		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="600"
			...
			<tbody>
				...
				<tr>
					...
					<td width="412">
					<table width="607" height="247" border="0" align="center"
						...
						<tbody>
							...
							<tr>
								<td height="17" colspan="3" class="copyright">Your problems
								has been sent, The ticket Id :: &nbsp;&nbsp;<span
									class="tMLAscreenHead"> &nbsp;&nbsp;<%=request.getParameter("id")%>&nbsp;&nbsp;</span>&nbsp;&nbsp;is
								for your future reference.</td>
							</tr>

							<tr>
								<td width="153" height="17" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
								<td colspan="2" align="left"><!--DWLayoutEmptyCell-->&nbsp;
								</td>
							</tr>
							<tr>
								...
								<table width="56" border="0" align="center" cellpadding="1"
									...
									<tr>
										...
										<td><input name="Close" type="button"
											...
											onClick="redirect('Debugmain.jsp')"></td>
									</tr>
								</table>
								</td>
							</tr>
