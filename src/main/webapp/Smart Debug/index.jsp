  ...
  <tr>
    <td><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
          <tr   class="headerBackground" >
            <td width="258" height="25" align="center" valign="middle"><span class="boldgre">DEBUG </span></td>
...
%>
  ...
  <tr   class="headerBackground" >
    <td height="27"   class="headerBackground"   id="menutd"><%@ include file="Debug_menu.jsp"%></td>
  </tr>
</table>
