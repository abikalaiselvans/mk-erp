 ...
 function validate()
  {
	...
	&& checkNullSelect("demandacceptedby","Select the demand accepted by","0")
	&& checkNull("acceptdescription","Enter the Accept Description")
        ...
        <TR>
          ...
          <TD width=425 valign="top"><table width="425" border="0" class="BackGround"   align="center" cellpadding="2" cellspacing="2"  >
              ...
              <tr align="center" valign="middle">
                ...
                <td height="28" colspan="2" >DEMAND ACCEPT     
				  <%  
  
  String rowid=request.getParameter("rowid");
  String sql="SELECT INT_JOBDEMANDID,CHR_JOBGRADE,INT_JOBID,INT_OFFICEID,INT_DEMAND,DAT_REGISTERDATE,CHR_DEMANDRAISEDBY,CHR_DEMANDDESC  FROM hrm_m_jobdemand  WHERE INT_JOBDEMANDID="+rowid ; 
...
%>
				...
				<script language="javascript">setOptionValue('demandraisedby','<%=job[0][6].trim()%>')</script>				</td>
              </tr>
              <tr class="bolddeepblue">
                <td height="29" valign="top" class="boldEleven"><div align="left">Description <font color='red'> *</font></div></td>
                <td valign="top"><textarea name="demandescription" cols="37" rows="5" class="formText135" id="demandescription" onKeyUp="textArea('demandescription','1900')"><%=job[0][7].trim()%> </textarea></td>
              </tr>
              <tr class="bolddeepblue">
                <td height="29" valign="top" class="boldEleven">Demand Accept By <font color='red'> *</font></td>
                <td valign="top"><select name="demandacceptedby" id="demandacceptedby" class="formText135"  style="width:200" >
                  <option value="0">Select</option>
                  <%
...
%>
              ...
              <tr class="bolddeepblue">
                <td height="29" valign="top" class="bolddeepblue">Accept Description <span class="boldEleven"> <font color='red'> *</font></span></td>
                <td valign="top"><textarea name="acceptdescription" cols="37" rows="5" class="formText135" id="acceptdescription" onKeyUp="textArea('demandescription','1900')"><%=job[0][7].trim()%> </textarea></td>
              </tr>
              <tr class="bolddeepblue">
                <td height="29" valign="top" class="bolddeepblue">Status</td>
                <td valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="boldEleven"><input name="demandstatus" type="radio" value="Y" checked></td>
                    <td class="boldEleven">Accept</td>
                    <td class="boldEleven"><input name="demandstatus" type="radio" value="R"></td>
                    <td class="boldEleven">Reject</td>
                    <td class="boldEleven"><input name="demandstatus" type="radio" value="N"></td>
              ...
              <tr class="bolddeepblue">
                ...
                <td valign="top"><input name="demand" type="text" class="formText135" id="demand"  onKeyPress="numeric_only(event,'demand','5')" value="<%=job[0][4].trim()%>" size=20 maxlength="3"  >
                    <input name="filename" type="HIDDEN" id="filename" value="Demand">
                    <input name="actionS" type="hidden" id="actionS" value="HRMdemandAccept">
                ...
                <td colspan="2" valign="middle" class="bolddeepblue">&nbsp;
                    <table align="center" cellpadding="3" cellspacing="3">
                      <tr>
                        ...
                        <td width="56" valign="top"><input class="tMLAscreenHead" type="button" name="Submit2"  value="Close"   accesskey="c"  onClick="redirect('Demand.jsp')"></td>
                      </tr>
                  </table></td>
              </tr>
          </table></TD>
