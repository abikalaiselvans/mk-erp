...
<title><%=CommonFunctions.QueryExecute("SELECT CHR_MODULETITLE FROM m_projectmodule WHERE CHR_SHORTNAME='HRM' ")[0][0]%></title>
...
%>
          ...
          <tr>
            <td height="19"><div align="center">
              <input class="ButtonHead" type="button" name="Button"  value="Close"   accesskey="c"  onClick="redirect('HRMmain.jsp')">
            </div></td>
          </tr>
        </table>
      <br><br></td>
