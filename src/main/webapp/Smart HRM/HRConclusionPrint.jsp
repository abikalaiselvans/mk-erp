...
%>
            ...
            <tr>
              <td height="19"><table width='90%' align="center"    cellpadding=2 cellspacing=1 bgcolor='#9900CC'  class='boldEleven'  id='myTable' >
                  <tr class="MRow1">
                    <td colspan="2" class="boldEleven"><div align="center" class="copyright">FIRST INTERVIEW  </div></td>
                    <td colspan="2"><div align="center" class="copyright">SECOND INTERVIEW   </div></td>
                  </tr>
                  <tr class="MRow2">
                    <td width="270" class="boldEleven"><strong>Interviewed By </strong></td>
                    ...
                    <td width="379"><strong>Interviewed By </strong></td>
                  ...
                  <tr class="MRow1">
                    <td class="boldEleven"><strong>Date and Time </strong></td>
                    <td><%=rowdata[0][22]%></td>
                    <td><strong>Date and Time</strong></td>
                    <td><%=rowdata[0][31]%></td>
                  </tr>
                  <tr class="MRow2">
                    <td class="boldEleven"><strong>Comments and suggesstions </strong></td>
                    <td><%=rowdata[0][23]%></td>
                    <td><strong>Comments and suggesstions </strong></td>
                    <td><%=rowdata[0][26]%></td>
                  </tr>
              </table></td>
            </tr>
            ...
            <tr>
              <td height="19"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="2">
                  <tr>
                    <td width="270" class="boldEleven"><strong>Candidate Status </strong></td>
                    <td width="379"><%
						  if("S".equals(rowdata[0][27]))
						  	out.println("SHORTLIST ");
						 else if("H".equals(rowdata[0][27]))
						  	out.println("HOLD ");
						else if("R".equals(rowdata[0][27]))
                  ...
                  <tr>
                    <td class="boldEleven"><strong>Final Salary </strong></td>
                    <td><img src="../Image/report/Rupee.gif" width="10" height="10">.<%=rowdata[0][29]%></td>
                  </tr>
                  <tr>
                    <td class="boldEleven"><strong>Salary Fixation
                      <%
								s1="";
								s2="";
								if("G".equals(rowdata[0][28] ))
									s1 = " Gross ";
								
								if("T".equals(rowdata[0][28] ))
									s2 = "Take Home ";
								%>
                    </strong></td>
                    <td><%=s1%> <%=s2%> </td>
                  ...
                  <tr>
                    <td class="boldEleven"><strong>Final Comments and suggesstions</strong></td>
                    <td><%=rowdata[0][30]%></td>
                  </tr>
              </table></td>
            </tr>
