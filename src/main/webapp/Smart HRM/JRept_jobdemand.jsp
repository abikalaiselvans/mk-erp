...
<p>
  <input type="hidden" name="pageAction" value="JobDemand" />
</p>
<p>&nbsp;</p>
<table class="BackGround1" cellspacing="0" cellpadding="0" width="300"
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="412" valign="top"><table align="center">
        <tr>
          <td class="boldEleven">Location</td>
          <td><select name="location" class="formText135" style="width:100">
            <option>All</option>
            <%
...
%>
        ...
        <tr>
          ...
          <td><select name="grade" class="formText135"  style="width:100">
            <option>All</option>
        ...
        <tr>
          ...
          <td>
          <select name="year"  id="year" style="width:150">
