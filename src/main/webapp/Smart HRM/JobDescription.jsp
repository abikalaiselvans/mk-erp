...
<%
 	 ...
 	 String reportheader="JOB DESCRIPTION "; 
     String sql=" SELECT  CHR_JOBTITLE,CHR_JOBCODE,CHR_JOBGRADE FROM hrm_m_jobdesign WHERE INT_JOBID >=1  ORDER BY CHR_JOBTITLE"; 
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="JOB TITLE" sortable="true"><%=temp.elementAt(1)%></display:column>
					<display:column title="JOB CODE" sortable="true"><%=temp.elementAt(2)%></display:column>
