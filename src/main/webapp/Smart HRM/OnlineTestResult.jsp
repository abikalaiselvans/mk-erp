...
//out.println(ssql);
String AppDatails[][] =  CommonFunctions.QueryExecute(ssql);
...
String TestData[][] =  CommonFunctions.QueryExecute(sql);
			...
			sql ="";
			if(list.contains("false"))
				sql = "UPDATE hrm_m_application SET CHR_ONLINETESTSTATUS ='Y' ,CHR_RESULT='F'   WHERE INT_APPID="+applicantid;
			else
				sql = "UPDATE hrm_m_application SET CHR_ONLINETESTSTATUS ='Y' ,CHR_RESULT='P'   WHERE INT_APPID="+applicantid;
			...
			out.println("<tr class='MRow1'>");
			out.println("<td  class='boldEleven' colspan='10' align='right' > <a target='_blank'  href='OnlineTestResultPrint.jsp?applicantid="+applicantid+"'>Print</a></td>");
			out.println("</tr>");
