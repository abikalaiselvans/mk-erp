...
function Validate()
  {
	...
	if(  checkNull( "Name","Enter Test Name" ) && checkNull( "desc","Enter Description" ) )
		return true;
	else
		return false;				
          ...
          <td width="412" valign="top">
		    ...
		    <table width="86%" border="0" align="center" cellpadding="3" cellspacing="3">
                ...
                <td colspan="2" class="bold1"><div align="center"> TEST TYPE
				    ...
				    <%
							...
							else
							{
								...
								sql = " SELECT INT_TESTTYPEID,CHR_TESTNAME,CHR_DESC FROM hrm_m_testtype  WHERE INT_TESTTYPEID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1]; desc=data[0][2]; 
								actionS="HRMTestTypeEdit";
								value="Update";
							}
              ...
              <tr>
                ...
                <td width="69%" class="boldEleven"><input name="Name" type="text" class="formText135" id="Name" onBlur="upperMe(this), CheckUnique(this,'divunitname','hrm_m_testtype','CHR_TESTNAME')"
				 onKeyUp="upperMe(this),CheckUnique(this,'divunitname','hrm_m_testtype','CHR_TESTNAME')" value="<%=Name%>" size="40" maxlength="100">
