...
<html>
<head>
<title><%=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT CHR_MODULETITLE FROM m_projectmodule WHERE CHR_SHORTNAME='HRM' ")[0][0]%></title>
...
<%
	String ddata[][]=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_SERVICEITEMID,CHR_SERVICEITEMNAME FROM  inv_m_serviceitems ORDER BY CHR_SERVICEITEMNAME");
	String datas="";
...
<script language="javascript" src="../JavaScript/Inventory/serviceamcpersonalinfo.js"></script>
...
var row =1;
	...
	function insRow()
	{
		...
		x.insertCell(2).innerHTML="<textarea   name='"+s2+"' id ='"+s2+"'  cols='30' rows='5' class='formText135'  ></textarea>";
              ...
              <tbody>
				...
				%>
						...
						<script language="javascript">setOptionValue('customerid','<%=cid%>')</script>												  </td>
                          <td align="left" valign="top"><div id='infos'></div>&nbsp;</td>
                        </tr>
