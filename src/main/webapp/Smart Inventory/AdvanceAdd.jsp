					  ...
					  %>
							...
							<tr id="chk2">
								...
								<td colspan="2" align="left"><input name="Challanno"
									type="text" class="formText135" id="Challanno" size="31" maxlength="50"></td>
							</tr>
							<tr id="chk3">
						...
						//-->
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="Advanceamount"
									...
									id="Advanceamount" maxlength="15" onKeyUp="extractNumber(this,2,true) " onKeyPress="return blockNonNumbers(this, event, true, true);"  onpaste="return false;"
									 >
