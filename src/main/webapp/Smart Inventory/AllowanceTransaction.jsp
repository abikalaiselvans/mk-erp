...
<body    leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
	class="body">
<form  AUTOCOMPLETE = "off"   name="a"><%@ include file="indexinv.jsp"%>
<table width="1000" height="408" border="0" cellpadding="0"
	...
	<tr valign="top">
		...
		<table width="216" border="0" cellpadding="5" cellspacing="5"
			...
			<tr>
				<td height="25" align="center" valign="middle"><a
					href="../error.jsp">hfhf</a></td>
			</tr>
			<tr>
				<td height="25" align="center" class="boldEleven"></td>
			</tr>
			<tr>
				<td height="25" align="left" class="boldEleven"><a
					target="searchMain" href="../Smart Inventory/IFrameVendor.jsp">
				Vendor Wise </a></td>
			</tr>
			<tr>
				<td height="21" align="left" class="boldEleven"><a
					target="searchMain" href="../Smart Inventory/IFramePurchase.jsp">Purchase
				Details</a></td>
			</tr>
			<tr>
				<td height="21" align="left" class="boldEleven"><a
					target="searchMain" href="../Smart Inventory/IFramePayment.jsp">Payment
				Details</a></td>
			</tr>
			<tr>
				<td height="21" align="left" class="boldEleven">&nbsp;</td>
			</tr>
			<tr>
