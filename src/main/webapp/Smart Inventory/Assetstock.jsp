...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="Assetstock.xls"/>
					<display:setProperty name="export.pdf.filename" value="Assetstock.pdf"/>
					<display:setProperty name="export.csv.filename" value="Assetstock.csv"/>
