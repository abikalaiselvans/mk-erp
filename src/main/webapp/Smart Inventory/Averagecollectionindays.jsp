...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="AveragecollectionindaysResponse.jsp"  >
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="19" colspan="2" align="right" valign="top"><div align="center"><strong>AVERAGE COLLECTION  </strong><span class="boldEleven">
							    <%
