         ...
         <tbody>
           ...
           <tr>
             ...
             <td width="412"><table width="800" border="0" align="center" cellpadding="1"
                 ...
                 <tr>
                   <td><div align="center"><strong>SALE ORDER VERIFICATION 
                         <%
String sql ="";
sql ="";
...
%>
                 ...
                 <tr>
                   <td><table width="100%" border="0" align="center" cellpadding="1"
                       ...
                       <tr>
                         <td class="bold1"><div align="left">Quotaion Ref No</div></td>
                       ...
                       <tr>
                         <td class="bold1"> P.O Ref No</td>
                         <td class="boldEleven"><%=cpodata[0][1]%>
                           <input name="ponumber" type="hidden" id="ponumber" value="<%=cpodata[0][1]%>"></td>
                       ...
                       <tr>
                         <td valign="top" class="boldEleven"><span class="bold1"> P.O date </span></td>
                       ...
                       <tr>
                         <td valign="top" class="boldEleven"><span class="bold1">Payment Terms<span class="ui-state-error-text"> </span></span></td>
                         <td class="boldEleven">
                       ...
                       <tr>
                         <td valign="top" class="boldEleven"><span class="bold1">Delivery Date </span></td>
                       ...
                       <tr>
                         ...
                         <td class="boldEleven"><%=cpodata[0][22]+"- Days"%>                          </td>
                       ...
                       <tr>
                         <td valign="top" class="bold1">Installation / Implementation Required</td>
                         ...
                         <input name="divisionid"  id="divisionid" type="hidden" value="<%=cpodata[0][32]%>"><%=cpodata[0][5]%>                          </td>
                       </tr>
                       <tr>
                         <td valign="top" class="boldEleven"><span class="bold1">Billed in Multiple Location</span></td>
                         <td class="boldEleven"><%=cpodata[0][31]%></td>
                         <td class="bold1">Tax Type</td>
                         <td align="left" valign="top" class="boldEleven"><%=cpodata[0][28]%></td>
                       </tr>
                       <tr>
                         <td valign="top" class="bold1"> <span class="boldElevenlink">PURCHASE REQUEST </span></td>
                       ...
                       <tr>
                         <td align="left" valign="top" class="boldEleven"><span class="bold1"> <span class="boldElevenlink">Accept</span></span></td>
                         <td align="left" valign="top" class="boldEleven"><input name="saleorderapproval" type="checkbox" id="saleorderapproval" value="Y"></td>
                         <td width="160" align="left" valign="top" class="bold1"><span class="boldElevenlink">Description</span></td>
                         <td width="174" align="left" valign="top" class="boldEleven"><textarea name="saleorderdescription" cols="30" rows="5" class="formText135" id="saleorderdescription"></textarea></td>
                       </tr>
				...
				sql = sql +" FIND_A_VENDOR_NAME(a.INT_PR_VENDOR_ID),";
				
				//  a.DOU_PR_PRICE
				sql = sql +"  IF( a.CHR_PR_FLAG ='Y' ,(a.DOU_PR_PRICE),   ";
				sql = sql +"    IF( a.CHR_TYPE ='I' ,   ";
				sql = sql +"  		(SELECT FUN_INV_BRANCH_STOCK_AVERAGEPRICE(a.CHR_TYPE,a.CHR_ITEMID,a.INT_BRANCHID)),  ";
				sql = sql +"  			if( (SELECT sa4.CHR_PTYPE FROM inv_m_produtlist sa4 WHERE sa4.CHR_PRODUCTID =a.CHR_ITEMID)= 'S',  ";
				sql = sql +"  			   (SELECT FUN_GET_OVERALL_AVERAGEPRICE(a.CHR_ITEMID )) ,   ";
				sql = sql +"  			   (SELECT FUN_INV_BRANCH_STOCK_AVERAGEPRICE(a.CHR_TYPE,a.CHR_ITEMID,a.INT_BRANCHID))  "; 
				sql = sql +"  				)   ";
				sql = sql +"    )   ";
			    sql = sql +"   )      pprice ,  ";
			 
				sql = sql +"  a.CHR_PR_DESC , ";
				...
				out.println("<td  class='boldEleven' >&nbsp;</td>");
				out.println("<td  class='boldEleven' >&nbsp;</td>");
				out.println("<td  class='boldEleven'  colspan='3' ><b>APPROXIMATE CONTRIBUTION  PERCENTAGE </b></td>");
				out.println("<td  class='boldEleven' align='right'><b>"+MathFunction.keep2Digit( ((salesprice-purchaseprice) / purchaseprice )*100 ) +" % </td>");
				out.println("<td  class='boldEleven' >&nbsp;</td>");
				out.println("<td  class='boldEleven' >&nbsp;</td>");
				out.println("<td  class='boldEleven' >&nbsp;</td>");
                   ...
                   <td valign="top" class="boldEleven"><table width="100%" border="0" align="center" cellpadding="1"
                       ...
                       <tr>
                         <td class="boldEleven"><div align="left" class="bold1">Reference
                             ...
                             <input name="actionS"  type="hidden" value="INVCPOVerificationSaleOrder" />
                         </div></td>
                       ...
                       <tr>
                         <td colspan="4" class="boldEleven"><table width="211" border="0" align="center" cellpadding="3"
										cellspacing="3">
                             <tr>
                               <td width="95"><input name="Submit" id="Submit"  type="submit" class="tMLAscreenHead"
												value="Submit"  /></td>
