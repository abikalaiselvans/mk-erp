...
sql = sql+ " AND a.INT_PAYMENTTERMID =c.INT_PAYMENTTERMID AND  a.CHR_SALESORDERNO = '"+cporefnumber +"'";
//out.println(sql);
...
%>
                 ...
                 <tr>
                   <td><table width="100%" border="0" align="center" cellpadding="1"
                       ...
                       <tr>
                         ...
                         <td width="174" align="left" valign="top" class="boldEleven"><%=cpodata[0][5]%>                          </td>
                       </tr>
                       <tr>
				...
				sql = sql +"   a.CHR_PR_DESC , a.INT_WARRANTY, a.INT_PR_WARRANTY,  ";
