...
<script language="JavaScript">
    ...
    function Add()
	{ 
		document.frm.action="CashSaleAdd.jsp";
 	}
	...
	function Edit()
 	{		
		...
		if(count==1){			
			document.frm.action="CashSaleEdit.jsp";
			return true;
		}
		else
		{
	...
	function Print()
 	{		
		...
		if(count==1){			
			document.frm.action="CashSalePrint.jsp";
			return true;
		}
		else
		{
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		<td>
		<table width="296" border="0" align="center" cellpadding="1"
			cellspacing="1">
			<!--DWLayoutTable-->
			<tr>
				...
				<td width="56" valign="top"><input name="Submit" type="submit"
					class="buttonbold13" value="Print" onclick="return Print()"></td>
