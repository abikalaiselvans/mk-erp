...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
	  <td>
		<form name="frm" method="post" action="CommitmentDetailsResponse.jsp" onSubmit=" return Validate()">
			...
			<tbody>
				...
				%></td>
							...
							<tr>
							  ...
							  <%
							   	...
							   	if("C".equals(salestype))
							   		...
							   		out.println("Direct Billing");
								else if("S".equals(salestype))
									out.println("Service Billing");
									
							
							  %>  <input name="salestype"  id="salestype" type="hidden" value="<%=salestype%>">
							  </td>
						  </tr>
							<tr>
							...
							<tr>
							  ...
							  <td align="right" valign="top" class="boldEleven"><div align="left">
                                <%
								  String divisiondata[][] = com.my.org.erp.common.CommonFunctions.QueryExecute("Select INT_DIVIID,CHR_DIVICODE from inv_m_division WHERE  INT_DIVIID="+division);
								  out.print(divisiondata[0][1]);
								 %>
								 <input name="division"  id="division" type="hidden" value="<%=division%>">  
