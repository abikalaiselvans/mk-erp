...
<script language="javascript" src="../JavaScript/Inventory/customergroup.js"></script>
...
<body onLoad="LoadCustomerGroup('0')" >
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table width="90%" height="200" border="0" align="center"
			...
			<tr  >
				<td height="31"  >
				<div align="center" class="whiteMedium">Customer </div>				</td>
			</tr>
			<tr  >
				<td height="31"  >
				<div align="center">
				<table width="100%" border="0" cellpadding="1" cellspacing="1" class="whiteMedium">
					<tr  >
						...
						<td width="60%" align="center">Customer  Name</td>
						<td width="30%" align="center">SHORT</td>
					</tr>
				</table>
			  </div>				</td>
			</tr>
	...
	<tr>
		<td><input type="hidden" name="filename" value="CustomerGroup" />
          <input type="hidden" name="actionS" value="INVcusGroupDelete" /></td>
	</tr>
	<tr>
		<td><div align="center">
		  <%
