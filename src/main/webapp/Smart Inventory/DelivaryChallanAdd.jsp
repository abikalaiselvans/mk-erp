	...
	<tr>
			...
			<tbody>
				...
				<tr>
					...
					<table width="663" border="0" align="center" cellpadding="1"
						...
						<tr>
							<td align="center" class="boldEleven">Delivary Challan</td>
						</tr>
						<tr>
							<td>
							...
							%>
								...
								<tr>
									...
									<td class="boldEleven"><input tabindex="2"
										name="delivaryNO" type="text" class="formText135"
										id="delivaryNO" size="25" /></td>
							...
							%>
								...
								<tr>
									...
									<div align="left"><input name="delivaryDate" type="text"
										class="formText135" id="delivaryDate" size="21"
										readonly="readonly" tabindex="7" /> <a
		...
		//-->
									...
									<div align="left"><input tabindex="2" name="recivedBy"
										type="text" class="formText135" id="recivedBy" size="25" />
									</div>
									</div>
									</td>
								</tr>
						...
						<tr>
							...
							<table width="100%" border="1" cellpadding="1" cellspacing="1">
								...
								<%
						sql ="SELECT CHR_ITEMID,CHR_DESC,INT_QUANTITY, DOU_UNITPRICE,DOU_DISCOUNT,";
						sql = sql +" DOU_UNITDISCOUNT,DOU_TOTAL  from  inv_t_customerquotationitem  where INT_QUOTATIONID="+poId;
						String ddata[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
						out.println("<tr>");
						for(int u=0; u<ddata.length;u++)
						{
							out.println("<td width='200px' class='boldEleven'>"+ddata[u][0]+"</td>");
							out.println("<td width='150px' class='boldEleven'>"+ddata[u][1]+"</td>");
							out.println("<td width='75px' class='boldEleven'>"+ddata[u][2]+"</td>");
							out.println("<td width='75px' class='boldEleven'>"+ddata[u][3]+"</td>	");					
							out.println("<td width='75px' class='boldEleven'>"+ddata[u][4]+"</td>");
							out.println("<td width='100px' class='boldEleven'>"+ddata[u][5]+"</td>");
							out.println("<td width='100px' class='boldEleven' align='right'>"+ddata[u][6]+"</td>");
							out.println("<td width='54px' class='boldEleven'></td>");
							out.println("<tr>");
						}
