 ...
 function  Print(query)
	{
		...
		var f ="DelivaryChallanPrint.jsp?itemId="+query;
			...
			<tbody>
				...
				<tr>
					...
					<table width="663" border="0" align="center" cellpadding="1"
						...
						<tr>
							<td>
							<div align="center"><strong>Delivary Challan View
							</strong></div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
							<%
					    out.println("<table width='770' border=1  cellpadding='1' cellspacing='1'>");
						...
						for(int i=0;i<purchaseItem.length;i++){
							...
							out.println("<td class='boldEleven'>"+purchaseItem[i][7]);
						}
						out.println("</table>");
						...
						<tr>
							...
							<table width="688" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<div align="left"><%=salesOrder[0][13]%></div>
									</td>
								</tr>
								<tr>
									<td valign="top" class="boldEleven">
									...
									<td width="169" valign="top" class="boldEleven"
										id="totaldiscount1">
									<div align="left"><%=salesOrder[0][14]%></div>
									</td>
								</tr>
								<tr>
									<td valign="top" class="boldEleven">
							 ...
							 %>
								...
								<tr>
									...
									<div align="left"><%=salesOrder[0][15] %></div>
									</td>
								</tr>
								<tr>
									<td class="boldEleven">
									...
									<div align="left"><%=salesOrder[0][16] %></div>
									</td>
								</tr>
								<tr>
