...
<script language="javascript" src="../JavaScript/Inventory/DeliveryChallan.js"></script>
<script language="JavaScript">
	 

    function Add()
	{ 
		document.frm.action="DeliverychallanAdd.jsp";		
 	}
				...
				else
				{
					...
					else
					{
					 for(int u=0; u<shipids.length; u++)
                      ...
                      <td><input name="search" type="text" class="formText135" id="search" maxlength="10" onKeyUp="loadDirectDeliveryChallans(this)" ></td>
                      </tr>
                    <tr>
                      <td   height="31"  >DC Status </td>
                        <td  >
                          <select id="dcstatus" name="dcstatus" onChange="loadDirectDeliveryChallan('0')" style="width:150">
                            <option value="2">All</option>
                            <option value="Y">Closed</option>
                            <option value="N">Not-Closed</option>
                          </select>					</td>
                        <td>Day</td>
                        <td><select name="day" id="day"  onBlur="loadDirectDeliveryChallan('0') ">
                            <option value="0">All</option>
                            <%
						for(int u=1;u<32;u++)
                        ...
                        <td width="150"><select name="month" id="month" onChange="loadDirectDeliveryChallan('0')" style="width:150">
                          <option value="0">All</option>
                        ...
                        <td width="150">
                          ...
                          <select name="year" id="year"
							 onChange="loadDirectDeliveryChallan('0')" style="width:150">
...
<td  ><div align="center">Closed</div></td>
	...
	<tr>
	  <td><input name="filename" type="hidden" value="DeliveryChallan" />
        <input
			name="actionS" type="hidden" value="INVDeliveryChallanDelete" /></td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
    </tr>
