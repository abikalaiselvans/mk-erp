...
try{
	...
	sql = sql +" DOU_PAIDAMOUNT,CHR_PAYMENTSTATUS,INT_DIVIID,CHR_VENDORPO,DOU_FRIEGHT_CHARGE,CHR_POREQUESTNO from inv_t_directpurchase WHERE CHR_PURCHASEORDERNO ='"+salesid+"'";
	//out.println(sql);
						...
						<tr>
							...
							<table width="673" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<div align="left"><%=cashdata[0][1]%> 
                                    <input name="ponumber" type="hidden" id="ponumber"	value="<%=cashdata[0][1]%>">
                                    <input name="filename"	type="hidden" value="DirectPurchase" /> 
                                    <input name="actionS"	type="hidden" value="INVDirectPurchaseRefModify" /> 
                                        </div>									</td>
...
<%=CommonFunctions.QueryExecute("SELECT  CHR_DIVICODE FROM inv_m_division WHERE INT_DIVIID="+cashdata[0][14].trim())[0][0]%>
			...
			%>									</td>
								...
								<tr>
								  ...
								  <td valign="top" class="boldEleven">                               
								    <input name="vendorerefno" type="text" id="vendorerefno" value="<%=cashdata[0][15]%> " maxlength="30">
...
%> <input name="seriallength" type="hidden" id="seriallength" value="<%=stockdata.length%>"></td>
  ...
  %> <%=taxs[0][0]%></div>									</td>
								...
								<tr>
								  ...
								  <td class="boldEleven">&nbsp;</td>
								  <td class="boldEleven"><strong>Freight Charge </strong></td>
							...
							<table width="100" border="0" align="center" cellpadding="3"
								...
								<tr>
									<td width="56"><input name="Submit2" type="submit"
										class="tMLAscreenHead" value="Modify"
										 /></td>
...
function  validate()
{
	if( CheckNull('vendorerefno','Enter the vendor ref number'))
		return true;
	else
		return false;
}
