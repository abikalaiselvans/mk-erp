...
<script type="text/javascript"><!--
	...
	function insRow()
	{
		...
		x.insertCell(3).innerHTML="<input type='text' size=10    onblur=\"calculateValue('"+s3+"')\" title='Quantity' class='formText135'  name='"+s3+"' id ='"+s3+"' " +vf1+" style='text-align:right' value='1'  maxlength='5' />";
...
%>
								...
								<tr>
									<td valign="top" class="boldEleven">Division <span class="boldred">*<%=session.getAttribute("INVOFFICEID")%></span></td>
