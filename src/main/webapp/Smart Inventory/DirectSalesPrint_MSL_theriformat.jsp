			  ...
			  <td height="45" colspan="4" valign="top"  >
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					if(datas.length>0 )
					{
						...
						out.println("<th  width='50' class='boldElevenPrint'><strong >Unit Rate</strong></th>");
						...
						{	
							out.println("<tr><td   class='boldEleven' >"+(v+1)+".</td>"); //S.No
							out.println("<td valign='top'   class='boldEleven' >"+datas[v][8] +"</td>");//Description
							out.println("<td valign='top'   class='boldEleven' align='center'>"+datas[v][15] +"</td>");//HSN/<br>SAC
							out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][10]+" % </td>"); //Tax (%)
							out.println("<td valign='top'   class='boldEleven'  align='center' >"+datas[v][3] +"</td>");//QTY
							out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][4]+"</td>");//Unit Price
							//out.println("<td valign='top'   class='boldEleven'  align='center' >"+datas[v][17]+"</td>");//UOM
							//out.println("<td valign='top'   class='boldEleven'  align='center'>"+datas[v][18] +"</td>");//Warranty
							
							if(Discount.equals("Y")) {
								out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][5] +"</td>");//Discount(%)
								out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][6]+"</td>");//Unit Discount
							}
							
							//out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][11]+"</td>");//Tax Amount
							out.println("<td valign='top'   class='boldEleven'  align='right' >"+datas[v][7] +"</td>");//Total<br>(INR)
							out.println("</tr>");
						...
						if(taxSplit.length>0) {
							...
							out.println("<td colspan='6'>Subtotal</td>");
							out.println("<td>"+taxSplit[0][0]+"</td>");
							out.println("</tr>");
							if("D".equals(perdata[0][66])) {
								out.println("<tr class='boldEleven' align='right'>");	
								out.println("<td colspan='6'>IGST</td>");
								out.println("<td>"+taxSplit[0][2]+"</td>");
								out.println("</tr>");
							} else {							
								out.println("<tr class='boldEleven' align='right'>");	
								out.println("<td colspan='6'>CGST</td>");
								out.println("<td>"+taxSplit[0][3]+"</td>");
								out.println("</tr>");
								out.println("<tr class='boldEleven' align='right'>");	
								out.println("<td colspan='6'>SGST</td>");
								out.println("<td>"+taxSplit[0][4]+"</td>");
								out.println("</tr>");
							
							}
							out.println("<tr class='boldEleven' align='right'>");	
							out.println("<td colspan='6'>Round Off</td>");
							out.println("<td>0.0</td>");
							out.println("</tr>");
							out.println("<tr class='boldEleven' align='right'>");	
							out.println("<td colspan='6'><b>Net Total&nbsp;<img src='../Image/report/Rupee.jpeg' width='10' height='10'>&nbsp;&nbsp;</b></td>");
...
%> </div> 						</td>
                            ...
                            <tr>
							 ...
							 <tr>
								...
								<%
										...
										sql = sql + " a.DOU_TAX_AMOUNT , a.DOU_TAX_PERCENTAGE taxpercentage ";
										...
										if(splitTaxData.length>0) {
											...
											out.println("<th rowspan='2' class='boldElevenPrint'>Tax (%) </td>");
											...
											for(int v=0;v<splitTaxData.length; v++)
											{
												...
												out.println("<td align='right'>"+splitTaxData[v][9]+"</td>");
												if(splitTaxData[0][0].equals("D")) {
			...
			<tr>
			  <td width="154" height="24" valign="top" class="boldEleven"  ><span class="boldElevenPrint">Company's GST No </span></td>
			...
			<tr>
			  <td height="20" valign="top" class="boldEleven"  ><span class="boldElevenPrint">Company's PAN No </span></td>
...
2. Mishandling or Physical Damage will not be covered under warranty.</td>
			...
			<tr>
			  ...
			  <td height="20" valign="top" class="boldEleven"  >Adyar & <%=BankDetails[0][2]%></td>
		    </tr>
			<tr>
