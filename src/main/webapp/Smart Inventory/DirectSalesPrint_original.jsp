...
sql = sql +" DT_UPDATEDATE,CHR_UPDATESTATUS,CHR_GST_TYPE ,UPPER(CHR_SHIPPING), CHR_DES  ";
...
<div align="center" class="pagebreak"> 
 <table width="700" height="950" border="1" align="center" cellpadding="2"
			...
			<tr>
			  ...
			  <td colspan="2" rowspan="3" valign="top"  ><%
									...
									%></td>
			  <td width="150"   height="20" valign="top"  ><span class="boldElevenPrint">Invoice No </span> <br>
                <%=perdata[0][3]%><%qrcode = qrcode+"INVOICE : "+perdata[0][3]+"\n";
										%>                </td>
			  <td width="170" valign="top"  ><span class="boldElevenPrint">Invoice
									  Date </span><br>;<%=com.my.org.erp.ServiceLogin.DateUtil.FormateDateSys(perdata[0][4])%></td>
		    </tr>
			<tr>
			  <td height="20" valign="top"  ><span class="boldElevenPrint">PO
									  Reference </span><br><%=perdata[0][19]%></td>
			  <td valign="top"  ><span class="boldElevenPrint">Payment Term <br><%=com.my.org.erp.common.CommonFunctions.QueryExecute("Select INT_PAYMENTTERMID,CHR_PAYMENTNAME from inv_m_paymentterms WHERE INT_PAYMENTTERMID="+perdata[0][5])[0][1]%></span></td>
		    </tr>
			<tr>
			  <td height="20" valign="top"  ><span class="boldElevenPrint">Despatch
									  Through </span><br><%=perdata[0][21]%></td>
			  <td valign="top"  ><span class="boldElevenPrint">Destination<br></span><%=perdata[0][22]%></td>
		    </tr>
			<tr>
			  ...
			  <%
						...
						if(!"-".equals(vendor[0][12]))	
							out.println(" GST : "+vendor[0][12]+".<br>");	
						out.println("<span>");	
			...
			<tr>
			  <td height="24" colspan="2" valign="top"  ><span class="boldElevenPrint">Remarks</span>&nbsp;<%=perdata[0][68]%></td>
			  <td valign="top"  ><span class="boldElevenPrint">Contact
		      Person</span><br> <%=perdata[0][24]%></td>
	          <td valign="top"  ><span class="boldElevenPrint">Contact Phone</span><br><%=perdata[0][25]%></td>
	  </tr>
			  ...
			  <td height="45" colspan="4" valign="top"  >
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					if(datas.length>0 )
					{
						...
						out.println("<th class='boldElevenPrint'><strong >Warranty</strong></th>");
						...
						{	
							...
							out.println("<td valign='top'   class='boldEleven' align='center'>"+datas[v][15] );
							//out.println("<td valign='top'   class='boldElevenPrint' >&nbsp;");
							out.println("<td valign='top'   class='boldEleven'  align='center' >"+datas[v][3] );
							...
							out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][10]+" % </td>");//+ "&nbsp;(&nbsp;"+datas[v][10]+"&nbsp;% &nbsp;)"
							//com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT CHR_TAXNAME,DOU_VALUE FROM inv_m_tax WHERE INT_TAXID ="+datas[v][9])[0][0] 
							out.println("<td valign='top'   class='boldEleven'  align='right'>"+datas[v][11] );
							
							
							out.println("<td valign='top'   class='boldEleven'  align='right' >"+datas[v][16] );
							out.println("</tr>");
							
							/*out.println("<tr   bgcolor='#ffffff'>");
							out.println("<td valign='top'   class='boldElevenPrint'  colspan='7' align='justify'><b>Description : &nbsp;&nbsp;</b><br>"+datas[v][8]+"</td>");
							out.println("</tr>");*/
						}	
					  ...
					  %>
						...
						if("D".equals(perdata[0][66]))
						{
							sql = "  select  b.CHR_TAXNAME,ROUND((a.DOU_TAX_AMOUNT),2),ROUND((a.DOU_TAX_AMOUNT),2),a.DOU_TAX_AMOUNT, ROUND(b.CHR_PERCENTAGE,1) ";
							sql = sql+ "  FROM inv_t_swapsalesitem a, inv_m_tax b  ";
							sql = sql+ "  WHERE a.INT_TAXID = b.INT_TAXID ";
							sql = sql+ "  AND a.CHR_SALESNO ='"+salesno+"' ";
							String tData[][] =  CommonFunctions.QueryExecute(sql);
							if(tData.length>0)
							{
								//out.println("<table border='1' cellpadding='2' cellspacing='0' bordercolor='#CCCCCC' width='100%' class='boldEleven'>");								out.println("<tr   bgcolor='#ffffff'>");
								...
								if(tData.length>0)
								{
									...
									{
										//out.println("<tr   bgcolor='#ffffff'>");
										//out.println("<td class='boldEleven'  align='center' >"+(k+1)+".</td>");
										//out.println("<td class='boldEleven' >"+tData[k][0]+"</td>");
										//out.println("<td class='boldEleven' align='center'>"+tData[k][4]+"</td>");
										//out.println("<td class='boldEleven'  align='right' >"+tData[k][1]+"</td>");
										//out.println("<td class='boldEleven'  align='right' >"+tData[k][3]+"</td>");
										tvalue = tvalue +Double.parseDouble(tData[k][3]);
										igstvalue = igstvalue +Double.parseDouble(tData[k][3]);
										//out.println("</tr>");
									}
								}
								//out.println("</table>");
						...
						{
							sql="SELECT SUM(a.DOU_UNITPRICE*a.INT_QUANTITY),b.CHR_TAXNAME,a.DOU_TAX_PERCENTAGE,ROUND(SUM(a.DOU_TAX_AMOUNT)/2,2),ROUND(SUM(a.DOU_TAX_AMOUNT)/2,2),SUM(a.DOU_TAX_AMOUNT)";
							sql = sql + " FROM inv_t_swapsalesitem a, inv_m_tax b ";
							...
							sql = "  select  b.CHR_TAXNAME,ROUND((a.DOU_TAX_AMOUNT/2),2),ROUND((a.DOU_TAX_AMOUNT/2),2),a.DOU_TAX_AMOUNT, ROUND(b.CHR_PERCENTAGE/2,1) ";
							sql = sql+ "  FROM inv_t_swapsalesitem a, inv_m_tax b  ";
							sql = sql+ "  WHERE a.INT_TAXID = b.INT_TAXID ";
							sql = sql+ "  AND a.CHR_SALESNO ='"+salesno+"' ";
							//out.println(sql);
							...
							if(tData.length>0 || taxvalues>0)
							{
								...
								if(tData.length>0)
								{
									for(int k=0; k<tData.length;k++)
									{
										...
										//out.println("<td class='boldEleven'  align='right' >"+tData[k][1]+"</td>");
										//out.println("<td class='boldEleven' align='center'>"+tData[k][4]+"</td>");
										//out.println("<td class='boldEleven'  align='right' >"+tData[k][2]+"</td>");
										//out.println("<td class='boldEleven'  align='right' >"+tData[k][3]+"</td>");
										tvalue = tvalue +Double.parseDouble(tData[k][3]);
										
										// calculate SGST and GST 
										sgtvalue = sgtvalue +Double.parseDouble(tData[k][1]);
										gstvalue = gstvalue +Double.parseDouble(tData[k][2]);
								...
								if(taxvalues>0)
								{
									...
									//out.println("<td class='boldElevenPrint'  align='right' >&nbsp;</td>");
									//out.println("<td class='boldElevenPrint'  align='right' >&nbsp;</td>");
									//out.println("<td class='boldElevenPrint'  align='right' >&nbsp;</td>");
									tvalue = tvalue +Double.parseDouble(perdata[0][12]);
									//out.println("</tr>");
								}	
								//out.println("</table>");
							}	
...
%> </div> 						</td>
			...
			<tr>
			  <td width="83" height="24" valign="top" class="boldEleven"  ><span class="boldElevenPrint">GST</span></td>
			  <td width="271" valign="top" class="boldEleven"  ><%=cpydata[0][21]%></td>
			...
			<tr>
			  ...
			  <td height="20" valign="top" class="boldEleven"  >INDUSIND BANK, Adyar Branch</td>
		    </tr>
			<tr>
...
2. Mishandling or Physical Damage will not be covered under warranty.</td>
			  ...
			  <td height="20" valign="top" class="boldEleven"  >250126012701</td>
		    </tr>
			<tr>
			  <td height="20" valign="top" class="boldEleven"  ><span class="boldElevenPrint">IFSC code </span></td>
			  <td height="20" valign="top" class="boldEleven"  >INDB0000051</td>
		    </tr>
			<tr>
			...
			<tr>
			  <td height="20" colspan="4" valign="top"  ><div align="center" class="boldEleven"><b>Head office</b> : GF-A, Mahalakshmi Flats, 20/11, Vinayagam Street, West Mambalam, Chennai-600033<br>
		Phone Number : 044-48586833; Website : www.mslinfotech.com ; GSTIN : 33AAKCM7953M1ZU<br>
		<b>Branches : Coimbatore - Madurai - Trichy </b>
...
<table width="99%" border="1" cellpadding="1" cellspacing="0"   class="boldEleven" bordercolor='#CCCCCC'>
                        <tr>
                          <td width="32%"><div align="left" class="boldEleven">
                              <div align="right">Sub Total</div>
                          </div></td>
                          <td width="19%"><div align="right"><%=perdata[0][62]%></div></td>
                        </tr>
                        <%
						...
						{
							out.println("<tr>");
							out.println("<td><div align='right'>CGST</div></td>");
							out.println("<td align='right'>");
							if(tvalue>0)
						  		out.println(""+com.my.org.erp.Math.MathFunction.keep2Digit(gstvalue));
							out.println("</td>");
							out.println("</tr>");  
							
							out.println("<tr>");
							out.println("<td><div align='right'>SGST</div></td>");
							out.println("<td align='right'>");
							if(tvalue>0)
						  		out.println(""+com.my.org.erp.Math.MathFunction.keep2Digit(sgtvalue));
							out.println("</td>");
							out.println("</tr>");
						}
						%>
                        ...
                        <tr>
                          <td class="boldEleven"><div align="right">Rounded</div></td>
                          <td class="boldEleven"><div align="right">0.0</div></td>
                        </tr>
                        <tr>
                          <td class="boldElevenPrint"><div align="right">Nett Total</div></td>
                          <td class="boldElevenPrint"><b>

                            <div align="right"><%="<img src='../Image/report/Rupee.jpeg' width='10' height='10'>&nbsp;"+perdata[0][13]%> </div>
                          </b></td>
                        </tr>
                        <% 
