...
{
	if(
		checkNullSelect('division','Select Sivision','0') 
                ...
                <tbody>
                  ...
                  <tr>
                    <td height="17" class="boldEleven"><table width="153" border="0" align="center" cellpadding="5" cellspacing="0">
                        <tr>
                          <td class="boldEleven">DIVISION / TEAM </td>
                          <td class="boldEleven"><select name="division" class="formText135 style5"	id="division" tabindex="1"  >
...
<input type="submit" name="Submit"	id="submit_btn" class="buttonbold" value="Submit"   accesskey="s"    /></td>
                        <td width="56">
<input type="button" name="submit" class="buttonbold"  value="Close"   accesskey="c" 	onClick="redirect('DivisionTargetAssign.jsp')" /></td>
                      </tr>
                    </table></td>
                  </tr>
                </tbody>
