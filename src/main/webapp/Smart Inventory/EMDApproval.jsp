...
<script language="javascript" src="../JavaScript/Inventory/EmdApproval.js"></script>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
	  <td><table align="center" cellpadding="0" cellspacing="0"   class="TableDesign">
        <tr>
          <td><div align="center" class="whiteMedium"><strong>DEPOSIT</strong><strong> &nbsp;&nbsp;APPROVAL</strong> </div>
            <%!String alert;%><%
 ...
 if(OfficeData.length>0)
 	for(int u=0;u<OfficeData.length;u++)
		...
		<tr>
			...
			<table width="100%"
					...
					<tr >
						<td width="36" align="">
						  <div align="center">S.No						</div></td>
						<td width="63" align="">
						  <div align="center">Emd Type						</div></td>
						<td ><div align="center">Division</div></td>
						<td ><div align="center">Entry</div></td>
						<td   width="141" >
						  <div align="center">Customer Name						</div></td>
						<td width="155" ><div align="center">Emd Amount	</div></td>
	...
	<tr>
	  <td valign="top"><table width="57" border="0" align="center" cellpadding="1"
			cellspacing="1">
