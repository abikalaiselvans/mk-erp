...
%>
              ...
              <tr>
                ...
                <td width="217" class="boldEleven"><div align="left">Type<span class="bolddeepred"> </span></div></td>
              ...
              <tr>
                <td width="23">&nbsp;</td>
                <td width="217" class="boldEleven"><div align="left">Deposit Amount </div></td>
              ...
              <tr>
                <td width="23">&nbsp;</td>
                <td width="217" class="boldEleven"><div align="left">Bank<span class="bolddeepred">*</span>&nbsp;</div></td>
                <td width="202" class="boldEleven" align="center"><div align="left">
              ...
              <tr>
                ...
                <td class="boldEleven" align="left"><input name="ddnumber" type="text" class="formText135"  id="ddnumber"   size ="20" maxlength="10" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td width="23">&nbsp;</td>
                <td width="217" class="boldEleven"><div align="left">Description<span class="bolddeepred"> </span></div></td>
                <td width="202" class="boldEleven" ><div align="left"><%=data[0][4]%></div></td>
                <td width="12">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td class="boldEleven">Approval
                  <%
				String ss1="";
                ...
                <td class="boldEleven" ><table width="100" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><input name="approval" type="radio" value="Y"  <%=ss%>></td>
                      <td class="boldEleven">Accept</td>
                      <td class="boldEleven"><input name="approval" type="radio" value="R"  <%=ss1%>></td>
              ...
              <tr>
                <td width="23">&nbsp;</td>
                <td width="217" align="left" valign="top" class="boldEleven"><div align="left"> Description<span class="bolddeepred">*</span>&nbsp;</div></td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td><input type="hidden" name="actionS" value="INVEmdAssignApproval"/>
              ...
              <tr>
                <td colspan="4"><table border="0" align="center" cellpadding="2"
										cellspacing="2">
                    <tr>
                      <td width="56"><input type="submit" name="Submit"	id="submit_btn" class="buttonbold" value="Approval" /></td>
