...
<body >
<form  AUTOCOMPLETE = "off"   name="frm" method="get" onload="loadCustomerPayment()">
<table width="100%" height="375" border="0" cellspacing="1"
	...
	<tr>
		...
		<table width="600" height="250" border="1" align="center"
			...
			<tr class="BackGround">
				...
				<div align="center" class="boldThirteen">Vendor Name: <select
					name="customer" id="customer" onblur="loadCustomerPayment()">
        ...
        %>
					...
					onBlur="loadCustomerPayment()">
					<%@ include file="../JavaScript/Inventory/month.jsp"%>
				</select> Year : <select name="year" id="year" onBlur="loadCustomerPayment()">
			...
			<tr class="BackGround">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr class="BackGround">
						...
						<div align="center">PurOrder No.</div>
						</td>
				...
				<table width="100%">
					...
					<tr>
						...
						<div id="divscroll" style="OVERFLOW:auto;width:600px;height:130px"
							class="boldEleven">
						<div id="customerPaymentTable"></div>
						</div>
						</td>
					</tr>
				</table>
