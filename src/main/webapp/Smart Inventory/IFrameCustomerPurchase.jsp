...
<body >
<form  AUTOCOMPLETE = "off"   name="frm" method="get" onload="loadCustomerOrder()">
	...
	<tr>
		...
		<table width="600" height="250" border="1" align="center"
			...
			<tr class="BackGround">
				...
				<div align="center" class="boldThirteen">Customer Name: <select
					name="customerid" id="customerid" onblur="loadCustomerOrder()">
					<option value="all">All</option>
					<%
           Connection con=conbean.getConnection();  
           Statement st=con.createStatement();
           String str="SELECT INT_CUSTOMERID,CHR_CUSTOMERNAME FROM INV_M_CUSTOMERINFO";
           ResultSet rs=null;
           rs=st.executeQuery(str);
        	 while(rs.next())
 	 			 { 	 	 	
 	 	 			out.println("<option value='"+rs.getString("INT_CUSTOMERID")+"'>"+rs.getString("CHR_CUSTOMERNAME")+"</option>");
 	 	 		 }
        %>
				</select> Month : <select name="month" id="month"
					onBlur="loadCustomerOrder()">
					<%@ include file="../JavaScript/Inventory/month.jsp"%>
				</select> Year : <select name="year" id="year" onBlur="loadCustomerOrder()">
			...
			<tr class="BackGround">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr class="BackGround">
						...
						<div align="center">PurchaseOrder No.</div>
						</td>
				...
				<table width="100%">
					...
					<tr>
						...
						<div id="divscroll" style="OVERFLOW:auto;width:600px;height:130px"
							class="boldEleven">
						<div id="purchaseCustomerTable"></div>
						</div>
						</td>
					</tr>
				</table>
