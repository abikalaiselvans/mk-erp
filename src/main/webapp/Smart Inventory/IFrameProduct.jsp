	...
	<tr>
		...
		<table width="600" height="250" border="1" align="center"
			...
			<tr class="BackGround">
				...
				<div align="center" class="boldThirteen">Product Group Name: <select
					name="selProduct" id="selProduct" onChange="loadProductSearch()">
					<%
           Connection con=conbean.getConnection();  
           Statement st=con.createStatement();
           String str="SELECT INT_PRODUCTGROUPID,CHR_NAME FROM INV_M_PRODUCTGROUP";
           ResultSet rs=null;
           rs=st.executeQuery(str);
         while(rs.next())
 	 	 {
 	 	 	
 	 	 	out.println("<option value='"+rs.getString("INT_PRODUCTGROUPID")+"'>"+rs.getString("CHR_NAME")+"</option>");
 	 	 }
        %>
				</select> Search Product Name :: <input type="text" name="txtSer" id="txtSer"
					maxlength="10" size="5" class="formText135"
					onKeyUp="loadProductSearch()"></div>
				</td>
			</tr>
			<tr class="BackGround">
				<td height="31" class="BackGround">
