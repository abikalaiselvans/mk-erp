...
<body >
<form  AUTOCOMPLETE = "off"   name="frm" method="get" onLoad="loadVendorSearch()">
	...
	<tr>
		...
		<table width="600" height="250" border="1" align="center"
			...
			<tr class="BackGround">
				...
				<div align="center" class="boldThirteen">Vendor Group Name: <select
					name="OptVendor" id="OptVendor" onChange="loadVendorSearch()">
					<option value="all">All</option>
					<%
           Connection con=conbean.getConnection();  
           Statement st=con.createStatement();
           String str="SELECT INT_GROUPID,CHR_NAME FROM INV_M_VENDORSGROUP";
           ResultSet rs=null;
           rs=st.executeQuery(str);
          	while(rs.next())
 	 	  	{ 	 	 	
 	 	 		out.println("<option value='"+rs.getString("INT_GROUPID")+"'>"+rs.getString("CHR_NAME")+"</option>");
 	 	  	}
        %>
				</select> Search Vendor Name :: <input type="text" name="txtSer" id="txtSer"
					maxlength="10" size="5" class="formText135"
					onKeyUp="loadVendorSearch()"></div>
				</td>
			</tr>
			<tr class="BackGround">
				<td height="31" class="BackGround">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr class="BackGround">
						...
						<div align="center">Vendor Id</div>
						</td>
