...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Indentaccept.jsp"
					...
					<table width="374" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><span
								class="boldThirteen">Indent Approval </span></td>
						</tr>
						...
						<tr class="bolddeepblue">
							...
							<table width="100%" border="0" align="center" cellpadding="2"
								cellspacing="2">
								<tr>
									<td width="28%" class="style3">Emp Id/Name</td>
									<td width="72%">
									<%
									String aval="";
					  String empid =""+session.getAttribute("EMPID");
					String sql="select a.CHR_INDENTRAISEFROM,b.CHR_STAFFNAME from inv_t_purchaseindent a, com_m_staff b  WHERE a.CHR_INDENTRAISEFROM in(SELECT CHR_EMPID FROM ";
sql=sql+ " com_m_staff WHERE CHR_REPTO='"+empid+"' AND CHR_TYPE!='T'  order by CHR_STAFFNAME ) ";
sql=sql+" AND a.CHR_INDENTRAISEFROM =b.CHR_EMPID AND a.CHR_ACCEPT='N'  group by a.CHR_INDENTRAISEFROM ORDER BY  b.CHR_STAFFNAME ";
