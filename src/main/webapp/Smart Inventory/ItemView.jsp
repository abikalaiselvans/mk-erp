...
<script language="javascript" src="../JavaScript/Inventory/InventItemloadAJAX.js"></script>
<script language="JavaScript">

    function Add()
	{ 
		document.frm.action="ItemActions.jsp";
 	}
		...
		<table height="220" border="0" align="center"
			...
			<tr  >
			  <td height="31" align="center"  ><table width="598" border="0" align="center" cellpadding="0" cellspacing="0" class="whiteMedium">
                <tr>
                  <td class="boldThirteen">ITEM GROUP </td>
                  <td>
				  <select name="itemgroup" class="formText135"   id="itemgroup" onChange="callloaditem()">
				 	<option value="0">All</option>
				  <%
				  String Data[][] = CommonFunctions.QueryExecute("SELECT INT_ITEMGROUPID,CHR_GROUPNAME FROM  inv_m_itemgroup  ORDER BY CHR_GROUPNAME");
                  ...
                  <td><span class="boldThirteen">Search Item Name</span></td>
                  <td><span class="boldThirteen">
<input type="text" name="search" id="search" maxlength="20" size="20" class="formText135" onKeyUp="callloaditem()" >
                  </span></td>
                </tr>
              </table></td>
		  </tr>
			...
			<tr  >
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1" class="whiteMedium">
					<tr  >
					  <td width="133"  >Group</td>
						<td width="255" height="0"  >
						<div align="left">Name</div>						</td>
						<td   width="199">Description</td>
						<td   width="96">
						<div align="left">Warranty(Yrs)</div>						</td>
						<td   width="116">Purchase Price</td>
						<td   width="93">
	...
	<tr>
		<td><input type="hidden" name="filename" value="Items" /> 
		<input
