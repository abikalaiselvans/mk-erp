...
function Validate()
  {
	...
	if(  checkNull( "make","Enter The Make" ) 
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen">MAKE</span>
                    <%
							...
							if("Add".equals(action))
							{
								...
								actionS="INVMakeAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_make','CHR_MAKENAME')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_make','CHR_MAKENAME')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_MAKEID,CHR_MAKENAME,CHR_DESC FROM inv_m_make WHERE INT_MAKEID= "+id;
              ...
              <tr>
                <td width="31%" class="boldEleven">Make<span class="boldred"> *</span> </td>
                <td width="69%" class="boldEleven"><input name="make" type="text" class="formText135" id="make" <%=link%>     onBlur="upperMe(this)"      value="<%=name%>" size="40" maxlength="60">
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Make" />
