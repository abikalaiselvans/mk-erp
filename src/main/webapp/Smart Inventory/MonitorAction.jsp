...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The Monitor Name" ) &&  checkNull( "desc","Enter The description" ) )
		return true;
	else
		return false;				
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen"> Monitor </span>
                    <%
							...
							{
								id="";name=""; desc="";
								actionS="INVMonitorAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_monitor','CHR_MONITOR')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_monitor','CHR_MONITOR')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_MONITORID,CHR_MONITOR,CHR_DESC FROM inv_m_monitor WHERE INT_MONITORID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="INVMonitorEdit";
								value="Update";
              ...
              <tr>
                <td width="31%" class="boldEleven">Monitor  <span class="boldred">*</span> </td>
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Monitor" />
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('Monitor.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
