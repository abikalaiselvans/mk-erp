          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="412"><table cellspacing="2" cellpadding="2" width="100%" align="center"
                  ...
                  <tbody>
                    <tr>
                      <td height="17" class="boldEleven"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
...
if(data.length>0)
{
	...
	out.println("<td class='boldEleven' align='center'><b>Transaction</b></td>");
	...
	for(int u=0;u<data.length;u++)
	{
	   ...
	   for(int tt=0; tt<transactiontypedata.length;tt++)
		...
		out.println("<option value='4'>CashDiscount</option>");
		out.println("<option value='5'>Payments</option>");
		out.println("</select>");
		out.println("</td>");
