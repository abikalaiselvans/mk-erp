							    ...
							    <table width="100%" border="0" cellspacing="0" cellpadding="0">
							      <tr>
							        <td colspan="6" align="center" class="copyright"><span class="bolddeepred">
							          <input name="filename" type="hidden" id="filename" value="PurchasePaymentMultiple">
                                      <input name="actionS"
									type="hidden" value="INVPurchasePaymentMultipleinvoice" />
									...
									String ids=" AND a.CHR_PURCHASEORDERNO IN (" ;
								    ...
								    sql = sql + "a.DOU_TOTALAMOUNT,FUN_INV_GET_VENDORBALANCEAMOUNT_DIRECT(a.CHR_PURCHASEORDERNO),a.INT_VENDORID  ";
...
if(data.length>0)
{
	...
	out.println("<td class='boldEleven' align='center'><b>Vendor</b></td>");
	out.println("<td class='boldEleven' align='center'><b>PO Date</b></td>");
	out.println("<td class='boldEleven' align='center'><b>PO Amount</b></td>");
	...
	for(int u=0;u<data.length;u++)
	{
		...
		out.println("<input name='vendorid'  id='vendorid' type='hidden' value='"+data[u][5]+"'>");
		out.println("<input name='checkboxs"+(u)+"'  id='checkboxs"+(u)+"' type='hidden' value='"+data[u][5]+"'>");
		out.println("</td>");
	...
	%>                                    
					  ...
					  %>
									...
									class="bolddeepred">* </span></td>
							            <td><select name="Bank" id="Bank" style="width: 200">
					  ...
					  for(int u=0; u<banks.length;u++)
						...
						//-->
							          ...
							          <tr>
							            <td class="boldEleven">Payment  Date <span
									class="bolddeepred">* </span></td>
