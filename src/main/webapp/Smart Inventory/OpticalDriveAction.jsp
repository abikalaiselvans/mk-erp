...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The OpticalDrive Name" ) &&  checkNull( "desc","Enter The description" ) )
		return true;
	else
		return false;				
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen"> OpticalDrive </span>
                    <%
							...
							{
								id="";name=""; desc="";
								actionS="INVOpticalDriveAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_opticaldrive','CHR_OPTICAL')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_opticaldrive','CHR_OPTICAL')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_OPTICALID ,CHR_OPTICAL, CHR_DESC FROM inv_m_opticaldrive WHERE INT_OPTICALID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="INVOpticalDriveEdit";
								value="Update";
              ...
              <tr>
                <td width="31%" class="boldEleven">OpticalDrive  <span class="boldred">*</span> </td>
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="OpticalDrive" />
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('OpticalDrive.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
