...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="PaymentCollectionResponse.jsp" onSubmit="return Validate()">
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="19" colspan="2" align="right" valign="top"><div align="center"><strong>PAYMENT COLLECTIONS </strong><span class="boldEleven">
							    <%
