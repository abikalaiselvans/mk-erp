						...
						if(shipids[u][0].equals(branchid))
							...
							<tr>
								...
								<td colspan="2" align="left"><select name="payType"
									...
									<option value="ALL">All Sale Payment</option>
							...
							<tr>
								...
								<table width="100" border="0" cellspacing="2" cellpadding="2">
									<tr>
										...
										<td class="boldEleven">
										<select name="From"  id="From" class="formText135" onChange="checkCday()">
										<%
											for(int u=0;u<100;u++)
										...
										<td class="boldEleven">
										<select name="To"  id="To" class="formText135"  onChange="checkCday()">
										<%
...
function Validate()
  {
	if(
		...
		&& checkNull( "From","Enter Starting Day" )
		&& checkNull( "To","Enter Ending Day" )
	)
		return true;
	else
		return false;				
...
function checkCday()
{
	var d1 = parseInt(document.getElementById('From').value);
	var d2 = parseInt(document.getElementById('To').value);
	if(d1>d2)
	{
		alert("Kindly change the To day.")
