		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
				...
				else
				{
					 for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
							  <td align="right" valign="top" class="boldEleven"><div align="left"><span class="boldEleven">From Date <span
				...
				setCurrentDate('fromdate'); 
							...
							<tr>
							  <td align="right" valign="top" class="boldEleven"><div align="left"><span class="boldEleven">To Date <span
									class="bolddeepred">* </span></span></div></td>
							  <td colspan="2" align="left"><div align="left">
                                <input tabindex="2"
				...
				setCurrentDate('todate'); 
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><input name="filename"
									...
									type="hidden" value="INVPaymentPending1" /></td>
							</tr>
							<tr>
