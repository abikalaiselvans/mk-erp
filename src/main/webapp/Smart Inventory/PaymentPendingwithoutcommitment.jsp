...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="PaymentPendingwithoutcommitmentResponse.jsp" onSubmit="return Validate()">
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Payment Pending Without Commitment </td>
							</tr>
				...
				else
				{
					 for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
							  <td height="17" class="boldEleven"><strong>Marketing Executive </strong></td>
								...
								<table width="112" border="0" align="center" cellpadding="1"
									...
									<tr>
										...
										<td><input name="Close" type="button"
											...
											onClick="redirect('ReptPayment.jsp')"></td>
									</tr>
								</table>								</td>
							</tr>
							<tr>
