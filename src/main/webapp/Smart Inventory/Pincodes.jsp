	  ...
	  <td bgcolor="#FFFFFF"><table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td class="boldEleven"><table width="80" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><input   name="search" type="radio" value="N" onClick="document.getElementById('searchvalue').value='N'" /></td>
                <td>&nbsp;Name</td>
                <td><input  name="search" type="radio" onClick="document.getElementById('searchvalue').value='C'" value="C" checked/></td>
                <td>Code</td>
                <td><input name="searchvalue" type="hidden" id="searchvalue" value="C" /></td>
              </tr>
          </table></td>
        </tr>
        <tr>
