...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="PurchaseandSalesQuantityResponse.jsp" onSubmit="return Validate()"  >
		...
		<table width="400" border="0"
			...
			<tbody>
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="19" colspan="2" align="right" valign="top"><div align="center"><strong>PURCHASE &amp; SALES  QUANTITY   </strong><span class="boldEleven">
							    <%
				...
				%>
							...
							<tr>
							  <td width="156" height="19" align="right" valign="top" class="boldEleven"><div align="left">Company</div></td>
							  <td width="216" align="right" valign="top" class="boldEleven"><div align="left">
					...
					for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
						   ...
						   <tr>
								...
								<td  align="left"><select class='formText135'
