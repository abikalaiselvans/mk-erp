...
<table width="80%" border="0" cellpadding="1" cellspacing="1">
	...
	sql="SELECT INT_QUOTATIONID,CHR_QUOTATIONNO,INT_CUSTOMERID,DATE_FORMAT(DAT_QUOTATIONDATE,'%d-%m-%Y')"+
				...
				" DOU_TOTALAMOUNT,CHR_STATUS,CHR_ADDRESSID1,CHR_ADDRESSID2 ,DOU_AMOUNT ,INT_DIVIID,CHR_CONTACTDETAILS,CHR_CONTACTNO,FIND_A_CUSTOMER_ADDRESS(INT_CUSTOMERID),CHR_ADDRESSFLAG  "+
				" from  inv_t_customerquotation  where CHR_QUOTATIONNO='"+quotationnumber+"'";
	 //out.println(sql);
							...
							<table width="100%" border="0" align="center" cellpadding="1"
							 ...
							 %>
								...
								<tr>
								    ...
								    <input name="filename"
										type="hidden" value="QuotationOrder" /> <input name="actionS"
										type="hidden" value="INVQuotationEdit" /> <input name="param"
...
sql = sql +" FROM inv_t_customerquotationitem a  where a.CHR_QUOTATIONNO ='"+quotationnumber+"' ";
