					...
					<table width="663" border="0" align="center" cellpadding="1"
						...
						<tr>
							...
							<table width="673" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<div align="left"><strong>Quo.No </strong></div>
									</td>
                        ...
                        %>
							...
							%>
								...
								<tr>
									<td class="boldEleven">
									<div align="left"><strong>Quo Date </strong></div>
									</td>
									<td class="boldEleven">
							...
							<table width="688" border="0" align="center" cellpadding="1"
							 ...
							 %>
								...
								<tr>
									...
									<td class="boldEleven">&nbsp;</td>
									<td class="boldEleven"><strong>Net Total</strong></td>
									<td width="169" class="boldEleven" id="nettotal1">
									<div align="right"><%=purchaseInfo[0][12] %></div>
									</td>
								</tr>
								<tr>
									<td colspan="4" valign="top" class="boldEleven">
									<hr width="98%" size="1" />
									</td>
								</tr>
								<tr>
									<td valign="top" class="boldEleven"><strong>Description
									:: </strong></td>
									<td colspan="3" valign="top" class="boldEleven"><%=purchaseInfo[0][7] %></td>
								</tr>
								<tr>
									<td class="boldEleven">&nbsp;</td>
									<td class="boldEleven">&nbsp;</td>
									...
									<table width="100" border="0" cellspacing="3" cellpadding="3">
										<tr>
											<td><input name="Button" type="button"
												...
												onClick="SalesOrderPrint(<%=poId%>)"></td>
