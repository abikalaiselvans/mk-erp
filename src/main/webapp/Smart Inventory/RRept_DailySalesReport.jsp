		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Daily Report ( Sales )
									<%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td width="77" height="19" align="right" valign="top" class="boldEleven"><div align="left">Company <span class="bolddeepred">*</span></div></td>
							  <td width="201" align="right" valign="top" class="boldEleven"><div align="left">
				...
				else
				{
					for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
							  <td height="17" class="boldEleven">Sales Type <span class="bolddeepred">*</span></td>
							  <td colspan="2" align="left"><span class="boldEleven">
							    <select name="type" id="type" style="width:200" >
                                  <option value="0">All</option>
								  <option value="1" selected="selected">Direct Sales</option>
                                  <option value="2">Direct Billing</option>
                                  <option value="3">Service Billing</option>
                              </select>
							  </span></td>
						  </tr>
							<tr>
							  <td height="17" class="boldEleven">Detail <span class="bolddeepred">*</span></td>
							  <td colspan="2" align="left"><input name="detail" type="checkbox" id="detail" value="Y"></td>
						  </tr>
							<tr>
								...
								<td width="292" colspan="2" align="left"><input
									...
									id="saleDate" size="15" readonly="readonly">  <script language='JavaScript'
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="Reports" />
								<input name="actionS"
									type="hidden" value="INVDaysaless" /></td>
							</tr>
							<tr>
