...
*/ 
  function Validate()
  {
	...
	*/	
 	...
 	function mainPage()
 {
 	document.frm.action="ReportVendorInfo.jsp";
 }
</script>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="400"
			...
			<tbody>
				...
				<tr>
					...
					<td width="412">
					<table width="400" height="163" border="0" align="center"
						cellpadding="1" cellspacing="1"  >
						<tr class="BackGround">
							<td width="393" height="31" class="BackGround">
							<div align="center" class="boldThirteen">
						...
						<tr>
							...
							<table width="400" border="0" align="center" cellpadding="4"
								...
								<tr>
									<td width="91">From</td>
									<td width="152"><input name="fromdate" type="text"
										class="formText135" id="fromdate" size="15" /> <a
		...
		//-->
								...
								<tr>
									...
									<td><input name="todate" type="text" class="formText135"
										id="todate" size="15" /> <a href="javascript:cal1.popup();">
									<img src="../JavaScript/img/cal.gif" width="16" height="16"
										border="0" /> </a> <script language='JavaScript'
										type="text/javascript">
		<!--			
				var cal1 = new calendar1(document.forms['frm'].elements['todate']);
				cal1.year_scroll = true;
				cal1.time_comp = false;
		...
		//-->
									...
									<table border="0" align="center" cellpadding="1"
										...
										<tr>
											...
											<div align="center"><input name="Submit" type="submit"
												class="buttonbold13" value="Submit"   accesskey="s"   ></div>
											</td>
											<td width="56">
											<div align="center"><input name="button" type="submit"
												class="buttonbold13"  value="Close"   accesskey="c"  onClick="redirect( 'InventoryMains.jsp')">
											</div>
											</td>
										</tr>
									</table>
								...
								<tr>
									<td>&nbsp;</td>
									<td><a href="#" class="boldEleven"> <input
										name="type" type="hidden" id="type" value="<%=type%>">
									<input name="filename" type="hidden" id="filename"
										value="VendorReport"> <input name="actionS"
										type="hidden" id="actionS" value="INVVendorReportDate">
									</a></td>
								</tr>
							</table>
							</td>
