...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_ConsumableStockInandOutResponse.jsp" onSubmit="return Validate()" >
								...
								<table width="112" border="0" align="center" cellpadding="1"
									...
									<tr>
										...
										<td><input name="Close" type="button"
											...
											onClick="redirect('Rept_Stockinout.jsp')"></td>
									</tr>
								</table>								</td>
							</tr>
							<tr>
