...
<form method="post" action="Rept_ConsumablesStocksAnalysisResponse.jsp" >
              ...
              <tbody>
                <tr>
                  <td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Consumables Stock
                    <input name="filename"
										type="hidden" value="Display" />
                    <input name="actionS"
										type="hidden" value="INVConsumableStock" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><select name="division" class="formText135" id="division" tabindex="1"  style="width:200">
                    <option value='0'>All</option>
                    <%
                 ...
                 <tr>
                  ...
                  <td colspan="2" align="left"><select name="product" class="formText135" id="product" tabindex="1"  style="width:200">
                    <option value='0'>All</option>
                    <%
