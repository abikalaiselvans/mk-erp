...
<%
			...
			if("1".equals(salestype) || "0".equals(salestype) )	
			{
				...
				sql = sql + " FIND_A_EMPLOYEE_NAME_ONLY(a.CHR_EMPID),a.CHR_EMPID, ";
				sql = sql + " FIND_A_CUSTOMER_NAME(c.INT_CUSTOMERID) , ";
				sql = sql + " FUN_INV_DIVISION(c.INT_DIVIID), ";
				...
				if(!"0".equals(salesref))
					 sql = sql + " AND a.CHR_EMPID='"+salesref+"' "; //sql = sql + " AND c.CHR_REF='"+salesref+"' ";
