...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action=" Rept_CumulativeSalesResponse.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Financial Sales Report ( Sales )
									<%
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								<td height="17" class="boldEleven">Split MOnth &amp; Year </td>
							  <td colspan="2" align="left"><input name="split" type="checkbox" id="split" value="Y">							  </td>
							</tr>
							<tr>
