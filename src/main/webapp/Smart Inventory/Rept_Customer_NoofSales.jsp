...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_Customer_NoofSalesResponse.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">CUTOMER REPORT 
									<%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td width="77" height="19" align="right" valign="top" class="boldEleven"><div align="left">Company</div></td>
...
<select name="customer"	id="customer" class="formText135"  style="width:200"  >
	<option value="0">All</option>
<%
String customerd[][] =  CommonFunctions.QueryExecute("SELECT  INT_CUSTOMERGROUPID,CHR_NAME FROM  inv_m_customergroup  ORDER BY CHR_NAME");
if(customerd.length>0)
{
  for(int u=0; u<customerd.length; u++)
	out.print("<option value='"+customerd[u][0]+"'>"+ customerd[u][1]+"</option>");
}
%>
