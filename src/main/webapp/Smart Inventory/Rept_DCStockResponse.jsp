...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="Rept_DCStockResponse.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_DCStockResponse.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_DCStockResponse.csv"/>
