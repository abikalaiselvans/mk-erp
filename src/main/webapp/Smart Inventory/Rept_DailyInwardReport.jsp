						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Daily Report ( INWARD )</td>
							</tr>
							...
							<tr>
								<td width="153" height="17" class="boldEleven">Date <span
									class="bolddeepred">* </span></td>
								<td width="221" colspan="2" align="left"><input
									tabindex="2" name="saleDate" type="text" class="formText135"
									id="saleDate" size="15" readonly="readonly"> <a
		...
		//-->
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									...
									type="hidden" value="INVDayinward" /></td>
							</tr>
							<tr>
