...
function itemproductMessages() 
{
   ...
   s1 ='item';
	var str="<select name='"+s1+"'  id='"+s1+"'  style='width:200' size='1' class='formText135'  )\"><option value=0>All"; 
 ...
 function validate()
 {
 	if(
		...
		&& checkNull('division','Select division')
		&& checkNull('itype','Select Product type')
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_DeliveryChallanResponse.jsp"   >
	...
	<tr>
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">DELIVERY CHALAN REPORT </td>
							</tr>
			...
			%>
							...
							<tr>
								<td width="173" height="17" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
								<td width="201" colspan="2" align="left"><!--DWLayoutEmptyCell-->&nbsp;
								</td>
							</tr>
							<tr>
