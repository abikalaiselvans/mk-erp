...
function validate()
{
	if(
		...
		&& checkNullSelect('itype','Select Type','')
		)
		return true;
	else
		return false
...
<form action="Rept_DetailedSalesRespones.jsp" method="post"   name="frm" onSubmit="return validate()"  AUTOCOMPLETE = "off">
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">DETAILED SALES REPORT </td>
							</tr>
