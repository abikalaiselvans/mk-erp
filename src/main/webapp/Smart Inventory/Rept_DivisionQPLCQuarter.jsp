...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_DivisionQPLCQuarterResponse.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">DIVISION WISE QPLC 
								  <%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td height="17" class="boldEleven">Branch <span class="bolddeepred">*</span></td>
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><span class="boldEleven">
							    <select name="type" id="type" style="width:200" >
                                 ...
                                 <option value="2">Service Billing</option>
                              </select>
							  </span></td>
						  </tr>
							<tr>
                              <td height="17" class="boldEleven">Quarter <span class="bolddeepred">*</span></td>
							  <td colspan="2" align="left"><select name="quarter" class="formText135" id="quarter" >
                                  
								  <option value="1">First [ APR -JUN ]</option>
                                  <option value="2">Second [ JUL - SEP ]</option>
                                  <option value="3">Third [ OCT - DEC ]</option>
                                  <option value="4">Fourth [ JAN  - MAR ]</option>
                                </select>                              </td>
						  </tr>
							<tr>
							  <td height="17" class="boldEleven">Financial Year <span class="bolddeepred">*</span></td>
