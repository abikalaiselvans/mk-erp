...
<script>
 ...
 $(function() {
		var dates = $( "#frmdate, #todate" ).datepicker({
			defaultDate: "+1w",
			changeYear: true,changeMonth: true,maxDate: "+30D" ,
			showOn: "button",
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_EddResponse.jsp"  >
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">EXPECT DATE OF DELIVERY  
									<%
