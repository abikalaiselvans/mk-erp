...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		String empname="";
		empname = CommonFunctions.QueryExecute("SELECT FIND_A_EMPLOYEE_ID_NAME('"+empid+"') ")[0][0];
		...
		final double[][] data = data1;  
            ...
            final CategoryDataset dataset = DatasetUtilities.createCategoryDataset("STAFF ", "", data);

            JFreeChart chart = null;
            BarRenderer renderer = null;
            CategoryPlot plot = null;

            final CategoryAxis categoryAxis = new CategoryAxis("MONTH - [ APR MAY JUN JUL AUG SEP OCT NOV DEC JAN FEB MAR ]");
