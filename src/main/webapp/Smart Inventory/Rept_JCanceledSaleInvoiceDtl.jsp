		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Canceled Sale Invoice Detail
							      <%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							id="Branch" tabindex="6" style="width:260"  >
						...
						if(shipids[u][0].equals(branchid))
							...
							<tr>
								...
								<td colspan="2" align="left"><select name="division"
									class="formText135" id="division" tabindex="1"  style="width:260" >
									<option value='0'>All</option>
									<%
							...
							<tr>
								<td height="17" class="boldEleven"><span class="boldEleven">Customer<span class="bolddeepred">*</span></span></td>
								<td colspan="2" align="left"><select name="customer"
									id="customer" class="formText135"  style="width:260" >
									<option value="0">All</option>
							...
							<tr>
								<td height="17" class="boldEleven">Sale Reference<span class="bolddeepred">*</span></td>
								<td colspan="2" align="left"><select name="ref" id="ref"
									class="formText135" size="1"  style="width:260" >
									<option value="0">All</option>
				...
				setCurrentDate('saleDate'); 
							...
							<tr>
								...
								<td colspan="2" align="left"><input tabindex="2"
									name="todate" type="text" class="formText135" id="saleDate2"
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								...
								<td colspan="2" align="left"><select name="invoice"  id="invoice"   class="formText135" >
                                  <option value="0">All</option>
							...
							<tr>
							  ...
							  <td colspan="2" align="left"> <%@include file="loadJasperReportType.jsp" %>
</td>
						  </tr>
							<tr>
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JCanceledSaleInvoice" />
                                  <input name="actionS"
									type="hidden" value="INVRept_JCanceledSaleInvoice" />
                                <span class="boldEleven">
                                <input name="rptfilename" type="hidden" id="rptfilename" value="AllInvoiceTypeCanceledSaleDetail">
                                <input name="rptfilename1" type="hidden" id="rptfilename1" value="customerSaleTypeCanceledSaleDetail">
                                <input name="rptfilename2" type="hidden" id="rptfilename2" value="serviceInvoiceTypeCanceledSaleDetail">
                                </span></td>
							</tr>
						</tbody>
