              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JConsaumableStockAnalysis" />
                    <input name="actionS"
									type="hidden" value="INVRept_JConsaumableStockAnalysis" />
                    <span class="boldEleven">
                    <input name="rptfilename" type="hidden" id="rptfilename" value="consumableStockAnalysis">
                    </span></td>
                </tr>
              </tbody>
