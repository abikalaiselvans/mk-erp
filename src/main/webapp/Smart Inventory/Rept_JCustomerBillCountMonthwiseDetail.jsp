		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<td width="412">
					<table width="369" height="252" border="0" cellpadding="2" cellspacing="0"
						 >
						<!--DWLayoutTable-->
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">Monthwise Customer Bill Count Detail </td>
						</tr>
 			   ...
 			   %>
						...
						<tr class="bolddeepblue">
						  <td height="24" valign="middle" class="boldEleven">Month <span class="bolddeepred">*</span></td>
						  <td valign="top" class="bolddeepblue"><select name="month" id="month" onChange="loadResignation('0')">
						    <option value="0">All</option>
						...
						<tr class="bolddeepblue">
						  <td height="24" valign="middle" class="boldEleven">Year <span class="bolddeepred">*</span></td>
						  <td valign="top" class="bolddeepblue"><select name="year" id="year" onChange="loadResignation('0')">
						    <option value="0">All</option>
						...
						<tr>
							<td height="28" colspan="2" valign="middle" class="bolddeepblue"><span class="boldEleven">
							  <input name="filename" type="hidden" id="filename"
										value="Rept_JCustomerBillCountMonthwise">
                              <input name="actionS"
										type="hidden" id="actionS"
										value="INVRept_JCustomerBillCountMonthwise">
                              <input name="rptfilename" type="hidden" id="rptfilename" value="PageWidth900">
                            </span></td>
						</tr>
						<tr>
