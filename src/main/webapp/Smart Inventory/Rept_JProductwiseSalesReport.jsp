						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Materialwise Sale Detail </td>
							</tr>
...
<script language='JavaScript' type="text/javascript">setCurrentDate('todate');</script></td>
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JmaterialwiseSaleWiseReport" />
                                  <input name="actionS"
									type="hidden" value="INVRept_JmaterialwiseSaleWiseReport" />
                                  <span class="boldEleven">
                                  <input name="rptfilename" type="hidden" id="rptfilename" value="materialwiseSaleReport">
                                  </span></td>
							</tr>
						</tbody>
