		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">ALL PRODUCT TYPES SALE REPORT  </td>
							</tr>
			...
			%>								<span class="bolddeepred">*</span></td>
								<td colspan="2" align="left"><select name="Branch"
									...
									onChange="loadItem('0')" style="width:260">
							...
							<tr>
							  <td height="30" class="boldEleven">From Date <span class="bolddeepred">*</span></td>
		...
		//-->
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JdivisionwiseSaleDetail" />
                                  <input name="actionS"
									type="hidden" value="INVRept_JdivisionwiseSaleDetail" />
                                <span class="boldEleven">
                                <input name="rptfilename" type="hidden" id="rptfilename" value="AllMaterialTypesSaleReport">
                                </span></td>
							</tr>
						</tbody>
