		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">DELIVERY INFORMATIONS
									<%
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								<td height="17" class="boldEleven">Delivery</td>
								<td colspan="2" align="left">
								<select name="delivery"  id="delivery" class="formText135"   style="width:110" >
								<option value="0">All</option>
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JdeliveryInfo" />
                                  <input name="actionS"
									type="hidden" value="INVRept_JdeliveryInfo" />
                                  <span class="boldEleven">
                                  <input name="rptfilename" type="hidden" id="rptfilename" value="deliveryInfo">
                                  </span></td>
							</tr>
						</tbody>
