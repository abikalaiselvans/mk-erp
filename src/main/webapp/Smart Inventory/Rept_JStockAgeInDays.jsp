						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen"> Stock Age </td>
							</tr>
							...
							<tr>
							  <td width="156" height="17" class="boldEleven">Company 
						      <%
...
<td height="17" class="boldEleven">Product Type <span class="boldred">*</span></td>
							...
							<tr>
							  <td height="17" class="boldEleven">Days <span class="boldred">*</span></td>
							  <td height="19" colspan="2" align="center" valign="top" class="boldEleven">
							    
			                    <div align="left">
			                      <table id="s2" width="249" border="0" align="left" cellpadding="0" cellspacing="0">
			                        <tr>
                                      <td class="boldEleven">&gt;=</td>
                                      <td class="boldEleven"><input name="from" type="text" class="formText135" id="from" onKeyPress="numericValue('from','6')" size="10" maxlength="6" value="1"></td>
                                      <td class="boldEleven">&lt;=</td>
                                      <td class="boldEleven"><input name="to" type="text" class="formText135" id="to" onKeyPress="numericValue('to','6')" size="10" maxlength="6" value="999"></td>
                                    </tr>
		                          </table>
		                      </div></td>
						  </tr>
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="Rept_JProductwiseStockAgeInDays" />
                                  <input name="actionS"
									type="hidden" value="INVRept_JProductwiseStockAgeInDays" />
                                  <span class="boldEleven">
                                  <input name="rptfilename" type="hidden" id="rptfilename" value="FindStockAgeAndCheckWarranty">
                                  </span></td>
							</tr>
						</tbody>
