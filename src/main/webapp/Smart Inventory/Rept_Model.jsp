...
try
{
 		String reportheader="MODEL"; 
		String sql ="SELECT UPPER(CHR_MODELCODE) FROM inv_m_model ORDER BY CHR_MODELCODE";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="MODEL"   sortable="true"><%=temp.elementAt(1)%></display:column>
