		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="400"
			...
			<tbody>
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td width="138" height="19" align="right" valign="top" class="boldEleven"><div align="left">Company<span class="bolddeepred">*</span></div></td>
							  <td width="248" align="right" valign="top" class="boldEleven"><div align="left">
				...
				else
				{
					for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
								<td height="17" class="boldEleven">With details<span class="bolddeepred">*</span></td>
								<td colspan="2" align="left"><input name="withdetails"
									type="checkbox" id="withdetails" value="checkbox"></td>
							</tr>
							<tr>
						  	...
						  	<tr>
								<td width="138" height="17" class="boldEleven">From Date <span
									class="bolddeepred">* </span></td>
								<td width="248" colspan="2" align="left"><input
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									...
									type="hidden" value="INVMyDaysales" /></td>
							</tr>
							<tr>
