...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_MyProductwiseSalesReportResponse.jsp" onSubmit="return Validate()" >
...
function Validate()
  {
	...
	if(checkNullSelect( "Branch","Select Branch","0" )&& checkNullSelect( "itype","Select Item/Product","" ) && checkDate('fromdate','todate'))
		return true;
	else
		return false;				
