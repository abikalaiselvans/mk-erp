...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="TOTAL" sortable="true"><%=temp.elementAt(12)%></display:column>
					<display:column title="TAX" sortable="true"><%=temp.elementAt(13)%></display:column>
					<display:column title="NET TOTAL" sortable="true"><%=temp.elementAt(14)%></display:column>
					 
					<display:setProperty name="export.excel.filename" value="Rept_MyProductwiseSalesReport.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_MyProductwiseSalesReport.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_MyProductwiseSalesReport.csv"/>
