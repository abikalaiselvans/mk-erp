...
try
{
 		String reportheader="PAYMENT CONDITION"; 
		String sql =" SELECT UPPER(CHR_PAYMENTNAME), CHR_DES FROM inv_m_paymentcondition ORDER BY CHR_PAYMENTNAME";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PAYMENT CONDITION"   sortable="true"><%=temp.elementAt(1)%></display:column>
