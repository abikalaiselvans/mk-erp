...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_ProductwiseContributionResponse.jsp" onSubmit="return Validate()" >
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen"> PRODUCT WISE CONTRIBUTION </td>
							</tr>
			...
			%> 
				...
				String shipids[][] =  CommonFunctions.QueryExecute(sql);
							...
							<tr>
								<td height="17" class="boldEleven">Division  
							    <span class="boldred">*</span></td>
							...
							<tr>
								...
								<td colspan="2" align="left"><select class='formText135'
									name='itype' id='itype' onChange="LoaditemproductGroup(this)"  style="width:200">
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><select class='formText135'
									name='pgroup' id='pgroup' style="width:200" onChange="LoaditemproductdependsGroup()">
							    <option value="0">All</option>
							...
							<tr>
								...
								<td colspan="2" align="left"><select class='formText135'
									name='item' id='item'  style="width:200">
								  <option value="0">All</option>
								  </select>
							  </td>
							</tr>
							<tr>
							  <td height="17" class="boldEleven">From Date  
							  <span class="boldred">*</span></td>
		...
		//-->
							...
							<tr>
							  <td height="17" class="boldEleven">To Date  
							  <span class="boldred">*</span></td>
							  <td colspan="2" align="left"><span class="boldEleven">
							    <input  
...
function Validate()
  {
	...
	if( checkNullSelect( "itype","Select Item/Product","" ) && checkDate('fromdate','todate'))
		return true;
	else
		return false;				
