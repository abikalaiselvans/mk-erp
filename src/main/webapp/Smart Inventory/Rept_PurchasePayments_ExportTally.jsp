...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_PurchasePayments_ExportTallyResponse.jsp">
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">EXPORT TO TALLLY [ PURCHASE PAYMENTS]
									<%
				...
				else
				{
					for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
							  <td height="17" class="boldEleven">Purchase Type </td>
