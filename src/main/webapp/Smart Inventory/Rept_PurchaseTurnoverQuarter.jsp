...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_PurchaseTurnoverQuarterResponse.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">PURCHASE TURNOVER QUARTER WISE
								  <%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td height="17" class="boldEleven">Purchase Type <span class="bolddeepred">*</span></td>
							  <td colspan="2" align="left"><span class="boldEleven">
							    <select name="type" id="type" style="width:200" >
                                 ...
                                 <option value="2">Vendor Purchase</option>
                              </select>
							  </span></td>
						  </tr>
							<tr>
							  ...
							  <td colspan="2" align="left"><select name="quarter" class="formText135" id="quarter" >
                                  <option value="0" >All[ APR - MAR ]</option>
							...
							<tr>
							  <td height="17" class="boldEleven">Year <span class="bolddeepred">*</span></td>
