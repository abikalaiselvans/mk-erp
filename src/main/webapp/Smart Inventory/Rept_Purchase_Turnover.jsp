...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_Purchase_TurnoverResponse.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">PURCHASE TURN OVER 
									<%
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td height="17" class="boldEleven">Quarter</td>
							  <td colspan="2" align="left">
							  <select name="quarter" class="formText135" id="quarter" >
