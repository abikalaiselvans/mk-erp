...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_Quotationresponse.jsp" onSubmit="return Validate()" >
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">CUSTOMER QUOTATION </td>
							</tr>
...
<%
				...
				String shipids[][] =  CommonFunctions.QueryExecute(sql);
							...
							<tr>
							  <td height="17" class="boldEleven">Customer <span class="bolddeepred">*</span></td>
							  <td   class="boldEleven"><select name="customer"
							...
							<tr>
							  ...
							  <td   class="boldEleven"><select name="ref" id="ref"
							...
							<tr>
							  <td height="17" class="boldEleven">Status <span class="bolddeepred">*</span></td>
							  <td   class="boldEleven">
							  <select name="status" class="formText135" id="status">
							  <option value="0" selected="selected">All</option>
							  <option value="N">Pending</option>
							  <option value="Y">Execute</option>
							  
							    </select>
							  </td>
						  </tr>
						  <tr>
							  <td height="17" class="boldEleven">Cancel <span class="bolddeepred">*</span></td>
							  <td   class="boldEleven">
							  <select name="cancel" class="formText135" id="cancel">
							  <option value="0" selected="selected">All</option>
