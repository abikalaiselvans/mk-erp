...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_SalesDeliveryResponse.jsp">
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Goodes Shipping &amp; Delivery informations
									<%
			...
			String sql ="Select a.INT_BRANCHID,a.CHR_BRANCHNAME ,b.CHR_COMPANYNAME from  com_m_branch  a  ,com_m_company b where  a.INT_COMPANYID = b.INT_COMPANYID ";	
					...
					for(int u=0; u<shipids.length; u++)
						if(shipids[u][0].equals(branchid))
							...
							<tr>
						  	...
						  	<tr>
						  	  <td height="17" class="boldEleven">Type  <span class="bolddeepred">*</span></td>
						  	  <td colspan="2" align="left">
                              <select name="deliveryinformations" class="formText135" id="deliveryinformations">
					  	      <option value="0">All</option>
                              <option value="S">Shipped Information</option>
                              <option value="D">Delivered Information</option>
				...
				setCurrentDate('saleDate2'); 
							...
							<tr>
								...
								<td colspan="2" align="left">
								<select name="delivery"  id="delivery"   class="formText135" >
								<option value="0">All</option>
