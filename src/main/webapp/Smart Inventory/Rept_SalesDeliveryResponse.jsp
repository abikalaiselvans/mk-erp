...
try
{
		...
		String deliveryinformations = request.getParameter("deliveryinformations");
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
                    ...
                    <%
					if("0".equals(deliveryinformations) || "S".equals(deliveryinformations) )
					{
					%>
					...
					if("0".equals(deliveryinformations) || "D".equals(deliveryinformations) )
					{
					%>
					...
					%> 
					<display:setProperty name="export.excel.filename" value="Rept_Delivery.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_Delivery.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_Delivery.csv"/>
