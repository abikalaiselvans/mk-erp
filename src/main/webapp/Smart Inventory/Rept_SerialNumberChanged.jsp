						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Serial Number Changing </td>
							</tr>
...
<input name="SerialNumber" type="text" class="formText135" id="SerialNumber" tabindex="2" size="35" maxlength="50" onBlur="fill();"   onkeyup="upperMe(this),lookup(this.value);">																  </td>
							...
							<tr>
							  <td height="17" class="boldEleven">Enter New Serial Number  <span class="bolddeepred">* </span></td>
							  <td colspan="2" align="left"><input name="SerialNumber2" type="text" class="formText135" id="SerialNumber2" tabindex="2" size="35" maxlength="50" value=""   onkeyup="upperMe(this) "></td>
						  </tr>
							<tr>
								<td height="17" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="Reports" /> <input name="actionS"
									type="hidden" value="INVSerialNumberChanging" /></td>
							</tr>
							<tr>
...
function Validate()
  {
	if(checkNull( "SerialNumber","Enter Serial Number" ) && checkNull('SerialNumber2','Enter the New Serial Number'))
		return true;
	else
		return false;				
