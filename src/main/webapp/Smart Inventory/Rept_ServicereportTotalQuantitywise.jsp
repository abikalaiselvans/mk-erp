				...
				%>
                    ...
                    <tr>
                      ...
                      <td><select name="Customergroup" class="formText135"  id="Customergroup" >
                         <option value="0">All</option>
                          <%
				String readDatass[][] = com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT INT_GROUPID,CHR_GROUPNAME FROM inv_m_servicecustomergroup ORDER BY CHR_GROUPNAME");
