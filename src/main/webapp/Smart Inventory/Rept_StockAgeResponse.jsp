		...
		String itemname=""; 
		 if("D".equals(Agetype))
		 {
			...
			if("I".equals(Item))
			{
				...
				sql = sql+ " AND a.DAT_RECIVEDDATE  >='"+com.my.org.erp.ServiceLogin.DateUtil.FormateDateSQL(fdate)+"' ";
				sql = sql+ "AND a.DAT_RECIVEDDATE  <='"+com.my.org.erp.ServiceLogin.DateUtil.FormateDateSQL(tdate)+"' ";
				if(!"0".equals(Branch))
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="Purchase Warranty(Yrs)" sortable="true"><%=temp.elementAt(13)%></display:column>
					<display:column title="Change Warranty(Yrs)" sortable="true"><%=temp.elementAt(14)%></display:column>
					<display:column title="Purchase Number" sortable="true"><%=temp.elementAt(15)%></display:column>
