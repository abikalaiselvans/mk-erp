...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_StockBookDateViewresponse.jsp">
			...
			%>
				...
				String shipids[][] =  CommonFunctions.QueryExecute(sql);
				  ...
				  <select name="Branch"
								...
								String seq=" Select a.INT_BRANCHID,a.CHR_BRANCHNAME ,b.CHR_COMPANYNAME from  com_m_branch  a  ,com_m_company b where  a.INT_COMPANYID = b.INT_COMPANYID  ";
 
								String shipidse[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(seq);
								for(int u=0; u<shipidse.length; u++)
									out.print("<option value='"+shipidse[u][0]+"'>"+shipidse[u][2]+ "  @  " +shipidse[u][1] +"</option>");
							%>
						</select><script language="javascript">setOptionValue('Branch','<%=session.getAttribute("INVBRANCH")%>')</script>				  </td>
                </tr>
							<tr>
								<td width="173" height="17" class="boldEleven">From Date </td>
		...
		//-->
							...
							<tr>
								...
								<td colspan="2" align="left"><select class='formText135'
									name='itype' id='itype' onChange="Loaditemproduct(this,'code')">
							...
							<tr>
							  <td height="17" class="boldEleven">Filtered By </td>
							  <td colspan="2" align="left">
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									type="hidden" value="StockBookDatewise" /> 
								<input name="actionS"
									type="hidden" value="INVStockBookDatewise" /></td>
							</tr>
							<tr>
