...
<form method="post" action="Rept_StockDateAnalysisResponse.jsp" >
        ...
        <tr>
          ...
          <td width="412"><table cellspacing="2" cellpadding="2" width="298" align="center"
              ...
              <tbody>
                ...
                <tr>
                  <td height="17" class="boldEleven">With Dc Material </td>
                  <td colspan="2" align="left"><input name="Dc" type="checkbox" id="Dc" value="Y"></td>
                </tr>
                <tr>
                  <td height="17" class="boldEleven">Condition-1 </td>
                  <td colspan="2" align="left"><table width="100" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="boldEleven">&lt;</td>
                      <td class="boldEleven"><select name="qty1" class="formText135" id="qty1" onChange="stockCall1(this)">
                        <%
				  	for(int u=0;u<50;u++)
                ...
                <tr>
                  <td height="17" class="boldEleven">Condition-2</td>
                  <td colspan="2" align="left"><table width="100" border="0" cellpadding="0" cellspacing="0" class="boldEleven">
                    <tr>
                      <td>&gt;=</td>
                      <td><select name="qty2" class="formText135" id="qty2"  onChange="stockCall2(this)">
                        <%
				  	for(int u=0;u<90;u++)
						out.println("<option value='"+u+"'>"+(u)+" - Days</option>");
				  ...
				  %>
                      ...
                      <td>&lt;</td>
                      <td><select name="qty3" class="formText135" id="qty3"   onChange="stockCall3(this)">
                        <%
				  	for(int u=0;u<180;u++)
						out.println("<option value='"+u+"'>"+(u)+" - Days</option>");
                ...
                <tr>
                  <td height="17" class="boldEleven">Condition-3</td>
                  <td colspan="2" align="left"><table width="100" border="0" cellpadding="0" cellspacing="0" class="boldEleven">
                    <tr>
                      <td>&gt;=</td>
                      <td><select name="qty4" class="formText135" id="qty4" onChange="stockCall4(this)">
                        <%
				  	for(int u=0;u<180;u++)
						out.println("<option value='"+u+"'>"+(u)+" - Days</option>");
				  ...
				  %>
					  ...
					  setOptionValue('qty1','45');
					  setOptionValue('qty2','45');
					  setOptionValue('qty3','90');
					  setOptionValue('qty4','90');
					  
					  function stockCall1(ctr)
					  {
					  	try
						{
							var v =ctr.value;
							setOptionValue('qty2',v);
						}
						catch(err)
						{
							alert(err)
					  ...
					  function stockCall2(ctr)
					  {
					  	try
						{
							var v = parseInt(ctr.value);
							setOptionValue('qty1',v);
							setOptionValue('qty3',(v+45));
							setOptionValue('qty4',(v+45));
						}
						catch(err)
						{
							alert(err)
					  ...
					  function stockCall4(ctr)
					  {
					  	try
						{
							var v = parseInt(ctr.value);
							setOptionValue('qty3',v);
						}
						catch(err)
						{
							alert(err)
