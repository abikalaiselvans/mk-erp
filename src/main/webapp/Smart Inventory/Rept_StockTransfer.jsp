		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="250"
			...
			<tbody>
				...
				<tr>
					...
					<td width="412">
					<table cellspacing="2" cellpadding="2" width="209" align="center"
						border="0">
						<!--DWLayoutTable-->
						<tbody>
							<tr>
							...
							<tr>
							  <td height="17" class="boldEleven"><table width="98%" border="0" align="center" cellpadding="5" cellspacing="0">
                                <tr>
                                  <td><div align="left"><a href="Rept_StockTransferallmonth.jsp" target="_blank">Stock Transfer </a></div></td>
                                </tr>
                                <tr>
                                  <td><div align="left"><a href="Rept_StockTransferBranchwise.jsp" target="_blank">Stock Transfer Branch wise </a></div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                </tr>
