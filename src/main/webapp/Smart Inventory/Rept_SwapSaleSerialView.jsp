...
{ 
	...
	boolean f =com.my.org.erp.common.CommonFunction.RecordExist("SELECT count(*) FROM inv_t_directsales WHERE CHR_SALESNO='"+salesno+"'");
	String perdata[][]=com.my.org.erp.common.CommonInfo.RecordSetArray("SELECT * FROM inv_t_directsales WHERE CHR_SALESNO='"+salesno+"'");
	String sql="";
	if(f)
	{
%>
...
<table  class="BackGround1"   cellspacing="0" cellpadding="0" width="424"		align="center" border="0">
			<tbody>
				<tr>
