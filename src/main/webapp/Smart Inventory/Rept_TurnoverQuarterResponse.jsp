...
try
{
		...
		if("1".equals(type)   )
		{
			if("1".equals(quarter))
			{
				...
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'April' ,'"+fyear+"') APRC, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'May' ,'"+fyear+"') MAY, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'May' ,'"+fyear+"') APRM, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'June' ,'"+fyear+"') JUN, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'June' ,'"+fyear+"') APRj, "; 
				...
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'April' ,'"+fyear+"') +FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'May' ,'"+fyear+"') +FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'June' ,'"+fyear+"'))  Q1C    ";
			...
			else if("2".equals(quarter))
			{
				...
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'July' ,'"+fyear+"') APj, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'August' ,'"+fyear+"') AUG, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'August' ,'"+fyear+"') APRA, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'September' ,'"+fyear+"') SEP, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'September' ,'"+fyear+"') APRS, ";
				...
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'July' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'August' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'September' ,'"+fyear+"')) Q2  ";
			...
			else if("3".equals(quarter))
			{
				...
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'October' ,'"+fyear+"') APO, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'November' ,'"+fyear+"') NOV, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'November' ,'"+fyear+"') APN, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'December' ,'"+fyear+"') DECb, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'December' ,'"+fyear+"') APD, ";
				...
				sql = sql + " ( FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'October' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'November' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'December' ,'"+fyear+"')) Q3  ";
			...
			else if("4".equals(quarter))
			{
				...
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'January' ,'"+(fyear+1)+"') JANc, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'February' ,'"+(fyear+1)+"') FEB, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'February' ,'"+(fyear+1)+"') JANf, ";
				sql = sql + " FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'March' ,'"+(fyear+1)+"') MAR, ";
				sql = sql + " FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'March' ,'"+(fyear+1)+"') JANc, ";
				...
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'January' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'February' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'March' ,'"+(fyear+1)+"')) Q4c  ";
				sql = sql + " FROM inv_m_division a WHERE a.CHR_DIVICODE IS NOT NULL ";
				if(!"0".equals(division))
					sql = sql + " AND a.INT_DIVIID = "+division;
				sql = sql + " ORDER BY a.CHR_DIVICODE ";
			...
			else
			{
				...
				sql = sql + " (FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'April' ,'"+fyear+"') +FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'May' ,'"+fyear+"') +FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'June' ,'"+fyear+"'))  Q1C ,  ";
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'April' ,'"+fyear+"') +FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'May' ,'"+fyear+"') +FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'June' ,'"+fyear+"'))  Q1C ,  ";
				
				
				sql = sql + " (FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'July' ,'"+fyear+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'August' ,'"+fyear+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'September' ,'"+fyear+"')) Q2,  ";
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'July' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'August' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'September' ,'"+fyear+"')) Q2c,  ";
				
				sql = sql + " ( FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'October' ,'"+fyear+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'November' ,'"+fyear+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'December' ,'"+fyear+"')) Q3,  ";
				sql = sql + " ( FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'October' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'November' ,'"+fyear+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'December' ,'"+fyear+"')) Q3c,  ";
				
				
				sql = sql + " (FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'January' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'February' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_SALES(a.INT_DIVIID,'March' ,'"+(fyear+1)+"')) Q4,  ";
				sql = sql + " (FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'January' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'February' ,'"+(fyear+1)+"')+FUN_INV_TURNOVER_CONTRIBUTION(a.INT_DIVIID,'March' ,'"+(fyear+1)+"')) Q4  ";
				sql = sql + " FROM inv_m_division a WHERE  a.CHR_DIVICODE IS NOT NULL ";
				if(!"0".equals(division))
					sql = sql + " AND a.INT_DIVIID = "+division;
				sql = sql + " ORDER BY a.CHR_DIVICODE ";
...
<display:table   id="_table" name="table"   export="true" pagesize="25"  style="text-align:center" >
	...
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(4)%></display:column>
	<display:column title="MAY" style="text-align:right"   sortable="true"><%=temp.elementAt(5)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(6)%></display:column>
	<display:column title="JUN" style="text-align:right"   sortable="true"><%=temp.elementAt(7)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(8)%></display:column>
	<display:column title="APR -JUN" style="text-align:right"   sortable="true"><%=temp.elementAt(9)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(10)%></display:column>
		<%
	...
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(4)%></display:column>
	<display:column title="AUG" style="text-align:right"   sortable="true"><%=temp.elementAt(5)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(6)%></display:column>
	<display:column title="SEP" style="text-align:right"   sortable="true"><%=temp.elementAt(7)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(8)%></display:column>
	<display:column title="JUL - SEP" style="text-align:right"   sortable="true"><%=temp.elementAt(9)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(10)%></display:column>
		<%
	}
	else if("3".equals(quarter))
	...
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(4)%></display:column>
	<display:column title="NOV" style="text-align:right"   sortable="true"><%=temp.elementAt(5)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(6)%></display:column>
	<display:column title="DEC" style="text-align:right"   sortable="true"><%=temp.elementAt(7)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(8)%></display:column>
	<display:column title="OCT - DEC" style="text-align:right"   sortable="true"><%=temp.elementAt(9)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(10)%></display:column>
		<%
	}
	else if("4".equals(quarter))
	...
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(4)%></display:column>
	<display:column title="FEB" style="text-align:right"   sortable="true"><%=temp.elementAt(5)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(6)%></display:column>
	<display:column title="MARCH" style="text-align:right"   sortable="true"><%=temp.elementAt(7)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(8)%></display:column>
	<display:column title="JAN-MAR" style="text-align:right"   sortable="true"><%=temp.elementAt(9)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(10)%></display:column>
		<%
	...
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(4)%></display:column>
	<display:column title="JUL - SEP" style="text-align:right"   sortable="true"><%=temp.elementAt(5)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(6)%></display:column>
	<display:column title="OCT - DEC" style="text-align:right"   sortable="true"><%=temp.elementAt(7)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(8)%></display:column>
	<display:column title="JAN-MAR" style="text-align:right"   sortable="true"><%=temp.elementAt(9)%></display:column>
	<display:column title="CON" style="text-align:right"   sortable="true"><%=temp.elementAt(10)%></display:column>
		<%
	...
	<display:setProperty name="export.excel.filename" value="Rept_TurnoverQuarter.xls"/>
	<display:setProperty name="export.pdf.filename" value="Rept_TurnoverQuarter.pdf"/>
	<display:setProperty name="export.csv.filename" value="Rept_TurnoverQuarter.csv"/>
	<display:setProperty name="export.pdf"  value="true" />
	 
	 
</display:table> 
    
<br />	<center>	<a style="text-align:right" href='Rept_TurnoverQuarter.jsp'> CLOSE</a></center>
