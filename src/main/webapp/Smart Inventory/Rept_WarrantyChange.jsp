...
<form  AUTOCOMPLETE = "off"   name="frm" method="get" action="Rept_WarrantyChangeresponse.jsp" >
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			%>								 <span class="boldred">*</span></td>
								<td colspan="2" align="left"><select name="Branch"
									...
									onChange="loadItem('0')" style="width:150">
				...
				String shipids[][] =  CommonFunctions.QueryExecute(sql);
							...
							<tr>
							  <td height="17" class="boldEleven">All Branch <span class="boldred">*</span> </td>
							  <td colspan="2" align="left"><input name="AllBranch" type="checkbox" id="AllBranch" value="Y"></td>
						  </tr>
							<tr>
							...
							<tr>
								<td width="173" height="17" class="boldEleven">Including Sales  <span class="boldred">*</span></td>
								<td width="201" colspan="2" align="left"><label>
								  <input name="Salesflag" type="checkbox" id="Salesflag" value="Y">
								</label></td>
							</tr>
							<tr>
