...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_WarrantyChangeinSaleWiseresponse.jsp" onSubmit="return Validate()" >
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">Warranty Changes </td>
							</tr>
...
function Validate()
  {
	if(
		...
		&& checkNullSelect( "itype","Select Item/Product" ,"")
