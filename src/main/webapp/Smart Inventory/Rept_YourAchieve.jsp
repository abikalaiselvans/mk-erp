...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Rept_YourAchieveChart.jsp">
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
				...
				String user= ""+session.getAttribute("USRID"); 
							...
							<tr>
							  <td width="191" height="17" class="boldEleven">Financial Year <span class="bolddeepred">*</span></td>
							  <td width="295" colspan="2" align="left">
