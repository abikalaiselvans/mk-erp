...
try
{
 		String reportheader="PAYMENT TERMS"; 
		String sql =" SELECT UPPER(CHR_PAYMENTNAME), CHR_DES FROM inv_m_paymentterms ORDER BY CHR_PAYMENTNAME";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="PAYMENT TERMS"   sortable="true"><%=temp.elementAt(1)%></display:column>
