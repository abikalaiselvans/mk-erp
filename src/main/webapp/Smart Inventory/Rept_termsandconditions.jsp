...
try
{
 		String reportheader="TERMS & CONDITIONS "; 
		String sql =" SELECT UPPER(CHR_CONDITIONNAME), CHR_DES FROM inv_m_terms_conditions ORDER BY CHR_CONDITIONNAME";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="TERMS AND CONDITION"   sortable="true"><%=temp.elementAt(1)%></display:column>
