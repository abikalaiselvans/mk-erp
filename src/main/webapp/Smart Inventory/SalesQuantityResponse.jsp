...
sql = sql +"FROM inv_t_directsales a ,inv_t_swapsalesitem b, inv_m_division c   ";
sql = sql +"WHERE a.CHR_SALESNO =b.CHR_SALESNO   ";
sql = sql +"AND a.INT_SALESSTATUS =1 AND a.CHR_CANCEL='N'   ";
...
sql = sql +"ORDER BY  a.INT_DIVIID,b.CHR_TYPE,b.CHR_ITEMID   ";
				...
				String reportheader="DIRECT SALE QUANTITY  [ FROM -"+fromdate +"  TO-  "+ todate +" ] "; 
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="SalesQuantity.xls"/>
					<display:setProperty name="export.pdf.filename" value="SalesQuantity.pdf"/>
					<display:setProperty name="export.csv.filename" value="SalesQuantity.csv"/>
