		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="424"
			...
			<tbody>
				...
				<tr>
				  ...
				  +" CHR_ITEMID,CHR_SERIALNO,CHR_WARRANTY,"
				  +" CHR_NEWSERIALNO,CHR_NEWWARRANTY FROM   inv_t_customersalesreturn  "
							...
							<tr>
								...
								<table width="343" border="0" align="center" cellpadding="1"
									...
									<tr>
										...
										<input name="returnType" type="hidden" id="returnType"
											value="<%=returnType%>">
									</tr>
									<tr>
						...
						%>
									...
									<tr>
										...
										<td class="boldEleven"><input tabindex="2"
											...
											id="replacementdt" size="15" readonly="readonly" /> <a
		...
		//-->
									...
									<tr>
										...
										<td class="boldEleven"><input name="newserial"
											type="text" class="formText135" id="newserial"></td>
									</tr>
									<tr>
										<td class="boldEleven">New Warranty</td>
										<td class="boldEleven"><input name="newwarranty"
											type="text" class="formText135" id="newwarranty"></td>
									</tr>
									<tr>
