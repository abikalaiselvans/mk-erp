...
<br><br><%
	...
	sql = "SELECT INT_DIVIID,CHR_SCRABNO,DATE_FORMAT(DAT_SCRABDATE,'%d-%b-%Y'),INT_CUSTOMERID,CHR_REF,CHR_DES,";
	sql = sql+" CHR_STATUS,CHR_SHIPPING,CHR_SHIPPINGADDRESS,CHR_OTHERREF,	CHR_DELIVERYNOTE,";
	sql = sql+" CHR_DESPATCHTHRU,CHR_DESTINATION,CHR_TERMSOFDELIVERY,CHR_CONTACTDETAILS,CHR_CONTACTNO";
	sql = sql+" FROM inv_t_scrab WHERE CHR_SCRABNO='"+dcno+"'";
...
if(!"-".equals(vendor[0][7]))
 ...
 %></td>
	...
	//sql = sql + "  ";
	sql = sql + ",INT_QTY  FROM inv_t_scrabitem  a WHERE a.CHR_SCRABNO='"+dcno+"'";
