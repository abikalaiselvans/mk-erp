							...
							<tr>
							  ...
							  <td class="boldEleven"><input name="cdetails" type="text"
										class="formText135" id="cdetails"
										    onBlur="upperMe(this)" value=" " maxlength="100"     /></td>
						  </tr>
							<tr>
...
<input name="cnumber" type="text" class="formText135" id="cnumber" maxlength="11"   onKeyPress="return numeric_only(event,'cnumber','15')"/></td>
							...
							<tr>
							  <td height="17" valign="top" class="boldEleven">HSN</td>
							  <td colspan="3" align="left"><span class="boldEleven">
							    <input name="hsncode" type="text"
										class="formText135" id="hsncode"
										    onBlur="upperMe(this)" value=" " maxlength="100"     />
							  </span></td>
						  </tr>
							<tr>
...
<input name="totals" type="text" class="formText135" id="totals" style='text-align:right' tabindex="11" onBlur="assigntotal()" value="0" maxlength="10"  onkeyup="extractNumber(this,2,true);" onKeyPress="return blockNonNumbers(this, event, true, true);" />
							...
							<tr>
							  ...
							  <td align="left"><input name="servicetaxflag" type="hidden" id="servicetaxflag" onClick="assigntotal()" value="N">
						      <input name="servicetax12" type="hidden" class="formText135" id="servicetax12" onKeyPress="return blockNonNumbers(this, event, true, true);"    onKeyUp="extractNumber(this,2,true);" value="12"  maxlength="10" style="text-align:right"  readonly="readonly">
						      <span class="boldEleven">
						      <input name="st12" type="hidden" class="formText135" id="st12" style='text-align:right'  readonly="readonly"/>
						      <input name="servicetax2" type="hidden" class="formText135" id="servicetax2" onKeyPress="return blockNonNumbers(this, event, true, true);"    onKeyUp="extractNumber(this,2,true);" value="2"  maxlength="10" style="text-align:right"   readonly="readonly">
						      <input name="st2" type="hidden" class="formText135" id="st2" style='text-align:right'  readonly="readonly"/>
						      <input name="servicetax1" type="hidden" class="formText135" id="servicetax1" onKeyPress="return blockNonNumbers(this, event, true, true);"    onKeyUp="extractNumber(this,2,true);" value="1"  maxlength="10" style="text-align:right"   readonly="readonly">
						      <input name="st1" type="hidden" class="formText135" id="st1" style='text-align:right'  readonly="readonly"/>
						      <input name="totals2" type="hidden" class="formText135" id="totals2" style='text-align:right' tabindex="11" onBlur="assigntotal()" value="0" maxlength="10"  onKeyUp="extractNumber(this,2,true);" onKeyPress="return blockNonNumbers(this, event, true, true);"  readonly="readonly"/>
						      </span></td>
							  <td valign="top" class="boldEleven"> </td>
							  <td valign="top" class="boldEleven"> </td>
						  </tr>
