						...
						<tbody>
							<tr>
								<td height="16" colspan="4" align="center" valign="top"
									class="boldThirteen">Service Billing PO EDIT 
                                    
<%
String rowid = request.getParameter("salesid");
sql ="";
sql = " SELECT INT_BRANCHID,INT_DIVIID,CHR_SERVICEPOREF,DATE_FORMAT(DAT_PODATE,'%d-%m-%Y'),  INT_CUSTOMERID,CHR_SHIPPING,CHR_SHIPPINGADDRESS,CHR_REF, CHR_DES,DOU_AMOUNT,DATE_FORMAT(DAT_POENDDATE,'%d-%m-%Y'),CHR_USRNAME,DT_UPDATEDATE,CHR_UPDATESTATUS,INT_SERVICEPOID FROM inv_t_servicebillingpo WHERE INT_SERVICEPOID="+rowid;
...
<select name="divis" class="formText135" id="divis" tabindex="1" style="width:200" >
                  ...
                  <script language="javascript">setOptionValue('divis','<%=data[0][1]%>')</script>
                  							</td>
							    <td width="105" class="boldEleven">PO Ref No. </td>
							    <td width="148" class="boldEleven"><%=data[0][2]%></td>
							</tr>
							
							<tr>
							  <td valign="top" class="boldEleven">P.O start date <span class="boldred">* </span></td>
							  <td align="left"><span class="boldEleven">
							    <input tabindex="2"  value="<%=data[0][3]%>" 
							...
							<tr>
							  ...
							  <td class="boldEleven"><input tabindex="2"  value="<%=data[0][10]%>" 
...
%>
 ...
 <script language="javascript">setOptionValue('customer','<%=data[0][4]%>')</script>								  
							...
							<tr>
							  ...
							  <td rowspan="2" valign="top" class="boldEleven"><div align="left">
							    <textarea name="shippingaddress"
										cols="35" rows="4" class="formText135" id="shippingaddress"><%=data[0][6]%></textarea>
                              </div></td>
							  <td class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp; </td>
							  <td class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp; </td>
						  </tr>
...
</select>							     <script language="javascript">setOptionValue('ref','<%=data[0][7]%>')</script>	</td>
					      </tr>
							<tr>
							  ...
							  <td colspan="3" align="left"><textarea name="memo" cols="35" style="width:150"
										rows="5" class="formText135" id="memo" tabindex="9"><%=data[0][8]%></textarea>
							    <div align="left"></div></td>
					      </tr>
							<tr>
								<td height="17" valign="top" class="boldEleven">P.O. Amount   <span class="boldred">* </span></td>
								<td align="left"><span class="boldEleven">
<input name="totals" type="text" class="formText135" id="totals" style='text-align:right' tabindex="11" onBlur="assigntotal()" value="<%=data[0][9]%>" maxlength="10"  onkeyup="extractNumber(this,2,true);" onKeyPress="return blockNonNumbers(this, event, true, true);" />
						  ...
						  <tr>
							  ...
							  <td colspan="3" align="left"><input name="filename" type="hidden" value="ServiceBillingPO" />
							    ...
							    <input name="rowid" type="hidden" id="rowid" value="<%=data[0][13]%>"></td>
							</tr>
							<tr>
