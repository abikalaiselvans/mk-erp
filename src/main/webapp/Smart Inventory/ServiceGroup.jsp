...
<script language="javascript" src="../JavaScript/Inventory/ServiceGroup.js"></script>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
			...
			cellpadding="0" cellspacing="0" class="TableDesign"  
			 >
        <tr >
          <td height="22" class="whiteMedium" > Service Customer Group </td>
        </tr>
        <tr >
          <td height="22" ><div align="right">
            <table width="500" border="0" align="center" cellpadding="3" cellspacing="4" class="whiteMedium">
              <tr>
                <td	 >Branch </td>
                <td>
    ...
    <tr>
      <td height="10"><input name="filename" type="hidden" value="ServiceGroup" />
        <input name="actionS" type="hidden" value="INVServiceGroupDelete" /></td>
    </tr>
    <tr>
	  ...
	  {
	  %>
          <td width="56" valign="top"><input type="submit" 	class="ButtonHead" name="Submit3" id="Submit3" value="Delete"
					onclick="return Delete()" /></td>
          <% 
		}
		%>
          <td width="56"><input type="button" class="ButtonHead"
					name="submit" id="submit" value="Close"   accesskey="c"  onClick="redirect( 'InventoryMains.jsp')" /></td>
        </tr>
      </table></td>
    </tr>
</table>
