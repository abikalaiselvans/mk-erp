              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="412"><table cellspacing="2" cellpadding="2" width="388" align="center"
                      ...
                      <tbody>
                        <tr>
                          <td height="16" colspan="3" align="center" valign="top" 	class="boldThirteen">SERVICE CUSTOMER GROUP  
						    <%
                        ...
                        <tr>
                          <td width="145" height="17" class="boldEleven">Service Customer Group  Name <font
									color="ff0000">*</font></td>
                          <td width="229" colspan="2" align="left"><input name="ServiceGroup" type="text" class="formText135" id="ServiceGroup" value="<%=Name%>" size="40" maxlength="200" onKeyUp="upperMe(this),CheckUnique(this,'divunitname','inv_m_servicecustomergroup','CHR_GROUPNAME')" onBlur="upperMe(this), CheckUnique(this,'divunitname','inv_m_servicecustomergroup','CHR_GROUPNAME')">
