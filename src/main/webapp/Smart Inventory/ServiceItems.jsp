...
<script language="javascript" src="../JavaScript/Inventory/ServiceItems.js"></script>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
			...
			cellpadding="0" cellspacing="0" class="TableDesign"  
			 >
        <tr >
          <td height="22" ><div align="center"><span class="whiteMedium"><strong> Service Peripherals</strong></span></div>
    ...
    <tr>
      <td height="10"><input name="filename" type="hidden" value="ServiceItem" />
        <input name="actionS" type="hidden" value="INVServiceItemDelete" /></td>
    </tr>
    <tr>
