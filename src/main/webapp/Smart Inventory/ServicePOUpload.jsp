...
function Load()
{
	...
	try
	{  		 // &&  findSize('F1','File should be less than 700Kb')
...
<BODY> <FORM name="frm"  ENCTYPE="multipart/form-data" ACTION= "ServicePOUploadCopys.jsp?staffid=<%=request.getParameter("pono")%>&fileExtn=.pdf" METHOD="POST" onSubmit="return Load()">
                <br><br><br>
           
		   
		   <table border="0" align="center" cellpadding="2" cellspacing="2"  >
          	   <tr> <td colspan="2"><p align= "center"><B>  UPLOADING PO </B></td></tr>
			   <tr>
			     <td><b>P.O. Ref Number </b></td>
