...
<%@ include file="indexinv.jsp"%>
 <form action="SingleEntryMultipleInvoiceAction.jsp" method="post" name="frm" id="frm"  onSubmit="return Validate()">
...
%>
 									...
 									<input name="reqpagerepeat" type="hidden" id="reqpagerepeat" value="N"></td>
						          </tr>
							      <tr>
							        <td colspan="6">&nbsp;</td>
						          </tr>
