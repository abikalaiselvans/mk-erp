...
function Validate()
{
	try
	{
			...
			if( 
				 ...
				 checkNull( "sparename","Enter The sparename ..." ) 
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> SPARE 
				
				    <%
							String action=request.getParameter("action1");
							String id="",actionS="",value="";
							String link="";
							String sparename="",pprice="",sprice="",active="",sparegroup="";
							...
							if("Add".equals(action))
							{
								...
								sparename="";pprice="";sprice="";active="";sparegroup="0";
							   	model="0";color="0";division="0";tax="Select";description="";
							  	pdescription="";sdescription="";warranty="Select"; 
								link=" onBlur=\"upperMe(this), CheckUnique(this,'inv_m_spare','inv_m_item','CHR_SPARENAME')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_spare','CHR_SPARENAME')\" ";
							...
							else
							{
								...
								sql =  "SELECT INT_SPAREID, CHR_SPARENAME,DOU_PURCHASEPRICE,DOU_SALESPRICE,INT_ACTIVE  "+
	  	",INT_GROUPID,INT_MODELCODE ,INT_COLORCODE,INT_DIVIID,INT_TAXID,CHR_DES,CHR_PURCHASEDES,CHR_SALESDES,CHR_WARRANTY "+
	  	"  FROM inv_m_spare WHERE INT_SPAREID=" +id;
              ...
              <tr>
                <td class="boldEleven">Spare Name <span
									class="bolddeepred">* </span></td>
                <td class="boldEleven">
				<input name="sparename"
									value="<%=sparename %>" size="30" type="text"
									class="formText135" id="sparename" maxlength="50" <%=link%>>
									<div id='divunitname'></div></td>
              </tr>
              <tr>
                <td class="boldEleven">Purchase Price <span
									class="bolddeepred">*</span></td>
                <td class="boldEleven"><input name="pprice"  id="pprice" value="<%=pprice %>" size="30" type="text" class="formText135" maxlength="7" onKeyPress="return numeric_only(event,'pprice','10')"  ></td>
              </tr>
              <tr>
                <td class="boldEleven">Sales Price <span
									class="bolddeepred">*</span></td>
                <td class="boldEleven">
<input name="sprice" id="sprice" value="<%=sprice %>" size="30" type="text" class="formText135" maxlength="7" onKeyPress="return numeric_only(event,'sprice','10')"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td valign="top" class="boldEleven">Spare Group <span class="bolddeepred">* </span></td>
                <td class="boldEleven">
<select name="sparegroup" id="sparegroup" style="width: 200" class="newsarticlesmall">
  <option value="0">Select spare Group </option>
  <%
 
String itemgroupData1[][] =  CommonFunctions.QueryExecute("SELECT INT_GROUPID,CHR_GROUPNAME FROM  inv_m_sparegroup  ORDER BY CHR_GROUPNAME");
for(int i=0;i<itemgroupData1.length;i++)
	out.println("<option value='"+itemgroupData1[i][0]+"'>"+itemgroupData1[i][1]+"</option>");
	
	%>
</select>
<script language="javascript">setOptionValue('sparegroup','<%=sparegroup%>')</script>
...
<option value="Select" selected="selected">Select Tax</option>
<%
...
<script language="javascript"> setOptionValue("tax","<%=tax%>")  </script></td>
              ...
              <tr>
                <td valign="top" class="boldEleven">Spare
                  Description <span
									class="bolddeepred">*</span></td>
                <td class="boldEleven">
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Spare" />
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('Spare.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
