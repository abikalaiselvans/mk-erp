	...
	<tr>
		...
		<table class="BackGround1" cellspacing="0" cellpadding="0" width="800"
			...
			<tbody>
				...
				String    sql =   " SELECT a.INT_ROWID, FIND_A_CUSTOMER_NAME(a.INT_CUSTOMERID), CONCAT(b.CHR_STATENAME,' [ ', b.CHR_SHORTNAME, ' ]' ),c.CHR_EQUIPEMENTTYPENAME,e.CHR_MODEL,a.CHR_CATEGORY, ";
                ...
                <td width="236"   valign="top"><input type="text" size ="25" class="formText135"  name="callno" value="" id="callno" maxlength="11" onKeyPress="return numeric_only(event,'callno','13')" required /></td>
			   ...
			   <tr>
			     ...
			     <td valign="top">
                  <input name="startdate" type="text" class="formText135" id="startdate"
									onKeyPress="dateOnly(this)" size="20" maxlength="10" readonly ='readonly' />  
                         <input name="endingdateandtime" type="hidden" id="endingdateandtime" value="">
...
$('#startdate').datetimepicker({
	...
	minDate: -10, maxDate: "+1D" ,showOn: "button",
			...
			buttonImageOnly: true
			   ...
			   <tr>
			     <td height="22"><strong>Priority Type<span class="boldred"> *</span></strong></td>
			     <td   valign="top"><table width="100" border="0">
			       <tr class="boldEleven">
			         <td width="20"><input name="prioritytype" type="radio" id="radio" value="RESP" checked></td>
			         <td width="20">Response</td>
			         <td width="30"><input type="radio" name="prioritytype" id="radio2" value="RESO"></td>
               ...
               <tr>
                 ...
                 <td align="left" valign="top"><input name="cperson" type="text" onKeyUp="upperMe(this)" class="formText135" id="cperson" size="30" maxlength="100" required></td>
                 <td align="left" valign="top"><strong>Phone</strong></td>
                 <td align="left" valign="top"><input name="phone" type="text" class="formText135" id="phone" size="30" onKeyPress="return numeric_only(event,'phone','12')" maxlength="10"></td>
               </tr>
               <tr>
                 <td height="22" align="left" valign="top"><strong>Email</strong></td>
                 <td align="left" valign="top"><input name="email" type="text" class="formText135" id="email" size="30" maxlength="100"></td>
                 <td align="left" valign="top"><strong>Mobile</strong></td>
                 <td align="left" valign="top"><input name="mobile" type="text" class="formText135" id="mobile" size="30" onKeyPress="return numeric_only(event,'mobile','11')" maxlength="10"></td>
               </tr>
               <tr>
                 <td height="22" align="left" valign="top"><strong>Remarks <span class="boldred">*</span></strong></td>
                 <td colspan="3" align="left" valign="top"><textarea type="text" name="description"   cols="90" id="description" rows="3" class="formText135" required onKeyUp="textArea('description','2000')"></textarea></td>
               </tr>
               <tr>
               ...
               <tr>
                 <td height="22" align="left" valign="top"><strong>Engineer name <span class="boldred">*</span></strong></td>
                 <td colspan="3" align="left" valign="top">
                 <table width="100%" border="1"  cellspacing="0" cellpadding="0" bordercolor="#000000" >
  <tr >
    <td> <%@ include file="../JavaScript/ajax.jsp"%></td>
  </tr>
</table>
               ...
               <tr>
                ...
                <td><input type="hidden" name="filename" value="SpareCallAssign" />
                  <input type="hidden" name="actionS" value="INVSpareCallAssignAdd"/></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
