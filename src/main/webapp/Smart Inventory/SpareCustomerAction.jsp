...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The Customer name" ) 
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
                ...
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen">SPARE CUSTOMER</span>
                    <%
							...
							else
							{
								...
								sql = "SELECT INT_CUSTOMERID,CHR_CUSTOMERNAME,CHR_DESC FROM inv_m_sparecustomer WHERE INT_CUSTOMERID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="INVSpareCustomerEdit";
								value="Update";
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="SpareCustomer" />
