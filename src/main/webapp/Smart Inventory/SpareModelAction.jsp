...
function Validate()
  {
	if(  
		 checkNull( "unittype","Select Unit type" ,'' ) 
		 && checkNull( "model","Enter The Spare Model" ) 
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen">SPARE MODEL</span>
                    <%
							...
							{
								id="";name=""; desc=" ";unitid=""; 
								actionS="INVSpareModelAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_spareunitmodel','CHR_MODEL')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_spareunitmodel','CHR_MODEL')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_MODELID,INT_SPAREUNITID,CHR_MODEL,CHR_DESC FROM inv_m_spareunitmodel WHERE INT_MODELID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];unitid=data[0][1]; name=data[0][2];  desc=data[0][3]; 
								actionS="INVSpareModelEdit";
								value="Update";
              ...
              <tr>
                <td class="boldEleven">Spare Unit <span class="boldred"> *</span></td>
...
for(int u=0;u<typeData.length;u++)
	out.println("<option value='"+typeData[u][0]+"'>"+typeData[u][1]+"</option>");
                ...
                <script language="javascript">setOptionValue('unittype','<%=unitid%>')</script>
                </td>
              </tr>
              <tr>
                <td width="31%" class="boldEleven">Model</td>
                <td width="69%" class="boldEleven"><input name="model" type="text" class="formText135" id="model" <%=link%>     onBlur="upperMe(this)"      value="<%=name%>" size="40" maxlength="60">
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="SpareModel" />
