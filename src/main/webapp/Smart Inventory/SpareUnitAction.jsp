...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The Spare Product" ) 
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen">SPARE UNIT</span>
                    <%
							...
							{
								id="";name=""; desc=" ";
								actionS="INVSpareUnitAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_spareunit','CHR_SPAREUNITNAME')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_spareunit','CHR_SPAREUNITNAME')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_SPAREUNITID,CHR_SPAREUNITNAME,CHR_DESC FROM inv_m_spareunit WHERE INT_SPAREUNITID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="INVSpareUnitEdit";
								value="Update";
              ...
              <tr>
                <td width="31%" class="boldEleven">Spare Unit <span class="boldred"> *</span> </td>
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="SpareUnit" />
