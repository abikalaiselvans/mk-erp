...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Staffemd_reports_response.jsp">
						...
						if(shipids[u][0].equals(branchid))
							...
							<tr>
							  ...
							  <td colspan="2" align="left"><span class="boldEleven">
							     <select name="EmdType" class="formText135 style5" id="EmdType" tabindex="1" onChange="loadEmd('0')">
                <option value="0">All</option>
                ...
                <option value="S">Security Deposit</option>
						  	...
						  	<tr>
								...
								<td width="313" colspan="2" align="left"><input
									...
									id="fromdate" size="15" readonly="readonly"> <script language='JavaScript'
