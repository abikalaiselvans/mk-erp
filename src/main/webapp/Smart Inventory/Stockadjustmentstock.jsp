...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="Stockadjustmentstock.xls"/>
					<display:setProperty name="export.pdf.filename" value="Stockadjustmentstock.pdf"/>
					<display:setProperty name="export.csv.filename" value="Stockadjustmentstock.csv"/>
