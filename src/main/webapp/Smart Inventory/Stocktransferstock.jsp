...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="Stocktransferstock.xls"/>
					<display:setProperty name="export.pdf.filename" value="Stocktransferstock.pdf"/>
					<display:setProperty name="export.csv.filename" value="Stocktransferstock.csv"/>
