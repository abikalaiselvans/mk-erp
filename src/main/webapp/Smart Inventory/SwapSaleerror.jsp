...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		<td height="200" class="bolddeepred">
		<div align="center">Can't delete. <%
		String data = (""+request.getParameter("er")) ;
		out.println("<br>"+data +" Serial no  sold");
	%>
		</div>
		</td>
	</tr>
		...
		<table border="0" align="center" cellpadding="3" cellspacing="3">
			...
			<tr>
				...
				<td width="56"><input type="button" class="buttonbold13"
					name="submits"  value="Close"   accesskey="c" 
