...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="TDSReportResponse.jsp" onSubmit="return Validate()">
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="19" colspan="2" align="right" valign="top"><div align="center"><strong>TDS RECEIVABLE REPORT </strong><span class="boldEleven">
							    <%
