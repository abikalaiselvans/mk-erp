...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="TDS_Payable_PaymentUpdate.jsp" onSubmit="return Validate()">
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="100%" align="center"
						...
						<tbody>
							...
							<tr>
							  <td height="19" colspan="2" align="right" valign="top"><div align="center"><strong>TDS PAYABLE UPDATE </strong><span class="boldEleven">
							    <%
							...
							<tr>
							  ...
							  <td colspan="2" align="left">
                               ...
                               <option value="" selected="selected" >Select</option>
								<%
					   sql = "SELECT INT_DEPOSITID, CHR_DEPOSITNAME FROM com_m_deposit_to WHERE CHR_STATUS !='N' AND CHR_TDS='Y' ORDER BY CHR_DEPOSITNAME";
...
function Validate()
  {
	if( checkNullSelect("creditto","Select credited to",'') )
		return true;
	else
		return false;				
