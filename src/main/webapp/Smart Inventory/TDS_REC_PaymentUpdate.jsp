 ...
 %>
	...
	if(data.length>0)
	{
		...
		for(int u=0;u<data.length;u++)
		{
			...
			out.println("<input name='opendate"+u+"' type='text' class='formText135' id='opendate"+u+"' onKeyPress='numericHypenOnly('opendate"+u+"',10)' size='12' maxlength='10' readonly='readonly'>");
