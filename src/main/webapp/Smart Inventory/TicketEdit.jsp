			...
			<tbody>
				...
				<tr>
				  ...
				  %> <input name="Ticketid" type="hidden" id="Ticketid"
						...
						if("A".equals(pack))
							out.println("<option value='A' selected >Attendance");
						else
							out.println("<option value='A' >Attendance");
							
						if("P".equals(pack))
							out.println("<option value='A' selected >Payroll");
						else
							out.println("<option value='A' >Payroll");
						
						if("I".equals(pack))
							out.println("<option value='A' selected >Inventory");
						else
							out.println("<option value='A' >Inventory");	
						
						if("U".equals(pack))
							out.println("<option value='A' selected >Utility");
						else
							out.println("<option value='A' >Utility");	
					...
					%>
							...
							<tr>
								...
								<td colspan="2" align="left"><input name="filename"
									...
									type="hidden" value="INVTicketUpdate" /></td>
							</tr>
							<tr>
