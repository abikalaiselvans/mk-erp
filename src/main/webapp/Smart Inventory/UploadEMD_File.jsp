...
<title><%=CommonFunctions.QueryExecute("SELECT CHR_MODULETITLE FROM m_projectmodule WHERE CHR_SHORTNAME='INV' ")[0][0]%></title><BODY> <FORM name="frm"  ENCTYPE="multipart/form-data" ACTION= "CopyUploadEMD_File.jsp?staffid=<%=request.getParameter("Rowid")%>" METHOD="POST" onSubmit="return Load()">
                <br><br><br>
		   ...
		   <table border="0" align="center" cellpadding="2" cellspacing="2"  >
			   ...
			   <tr>
			     <td colspan="2"><div align="center" class="boldElevenlink">( file size should be   &lt;=700 Kb ) </div></td>
		     </tr>
			   <tr>
