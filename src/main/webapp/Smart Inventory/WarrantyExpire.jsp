...
{		 
	...
	sql = sql + " AND  DATE_ADD( a.DAT_SALESDATE, INTERVAL (b.CHR_WARRANTY*365) DAY )  >=  (SELECT DATE_SUB( now() , INTERVAL 10 DAY )   ) ";
	sql = sql + " AND  DATE_ADD( a.DAT_SALESDATE, INTERVAL (b.CHR_WARRANTY*365) DAY )  <=  (SELECT DATE_ADD( now() , INTERVAL 10 DAY )   ) ";
