...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="WarrantyExpireDateRangeResponse.jsp">
						...
						<tbody>
							<tr>
								<td height="16" colspan="3" align="center" valign="top"
									class="boldThirteen">SALES WARRANTY EXPIRE 
									<%
								...
								<table width="112" border="0" align="center" cellpadding="1"
									...
									<tr>
										...
										<td><input name="Close" type="button"
											...
											onClick="redirect('WarrantyExp.jsp')"></td>
									</tr>
								</table>								</td>
							</tr>
							<tr>
