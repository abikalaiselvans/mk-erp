...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The Wireless Name" ) &&  checkNull( "desc","Enter The description" ) )
		return true;
	else
		return false;				
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen"> Wireless </span>
                    <%
							...
							{
								id="";name=""; desc="";
								actionS="INVWirelessAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','inv_m_wireless','CHR_WIRELESS')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','inv_m_wireless','CHR_WIRELESS')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_WIRELESSID ,CHR_WIRELESS, CHR_DESC  FROM inv_m_wireless WHERE INT_WIRELESSID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="INVWirelessEdit";
								value="Update";
              ...
              <tr>
                <td width="31%" class="boldEleven">Wireless  <span class="boldred">*</span> </td>
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Wireless" />
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('Wireless.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
