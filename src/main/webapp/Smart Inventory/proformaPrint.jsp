...
<%
	...
	String poId=request.getParameter("proformanumber");
		...
		<td align="center" valign="middle">
		  <table width="95%" border="0" align="center" cellpadding="1"
			...
			<tr>
				...
				<div align="center" class="style4"><span class="bold1">PROFORMA</span>
				  <%
				String ssql=" " ;
			...
			<tr>
				...
				<table width="99%" border="0" align="center" cellpadding="5"
					...
					<tr>
						...
						<div align="left"><strong>Proforma No</strong></div>						</td>
					...
					<tr>
						...
						<div align="left"><strong>Proforma Date</strong></div>						</td>
						<td align="left" valign="top" class="boldEleven">
