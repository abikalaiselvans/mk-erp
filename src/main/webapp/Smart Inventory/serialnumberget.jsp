...
String qsql="SELECT CHR_SERIALNO FROM  inv_t_vendorgoodsreceived WHERE CHR_SERIALNO is not null ";
if("1".equals(itype))
	qsql = qsql+" AND CHR_TYPE='I' ";
else	
	qsql = qsql+" AND CHR_TYPE='P' ";

if(!"0".equals(item))
	qsql = qsql+" AND CHR_ITEMID='"+item+"' ";
