...
function Validate()
  {
	...
	if(  checkNull( "name","Enter The Building Name" ) 
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"><span class="boldThirteen">BUILDING</span>
                    <%
							...
							{
								id="";name=""; desc=" ";
								actionS="MGTBuildingAdd";
								value="Add";taxValue="";
								link=" onBlur=\"upperMe(this), CheckUnique(this,'divunitname','mgt_m_buildingname','CHR_BUILDINGNAME')\"  onKeyUp=\"upperMe(this),CheckUnique(this,'divunitname','mgt_m_buildingname','CHR_BUILDINGNAME')\" ";
							...
							else
							{
								...
								sql = "SELECT INT_BUILDINGID,CHR_BUILDINGNAME,CHR_DESC FROM mgt_m_buildingname WHERE INT_BUILDINGID= "+id;
								String data[][]=CommonFunctions.QueryExecute(sql);
								id=data[0][0];name=data[0][1];  desc=data[0][2]; 
								actionS="MGTBuildingEdit";
								value="Update";
              ...
              <tr>
                <td width="43%" class="boldEleven">Building <span class="boldred"> *</span> </td>
              ...
              <tr>
                ...
                <td class="boldEleven">
				<input type="hidden" name="filename" value="Building" />
