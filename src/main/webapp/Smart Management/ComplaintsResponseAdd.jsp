...
function Validate()
  {
	...
	if(   checkNull( "desc","Enter the description ..." )
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              ...
              <tr>
                <td width="31%" class="boldEleven">Subject</td>
                <td width="69%" class="boldEleven"><%=name%></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left" valign="top" class="boldEleven">Solution Given <span class="errormessage">* </span></td>
                <td class="boldEleven"><textarea name="desc" cols="45" rows="10" class="formText135"
									id="desc" onKeyUp="textArea('desc','1900')"></textarea></td>
              </tr>
              <tr>
