...
<%
	...
	sql = sql + " DATE_FORMAT(a.DAT_INCOME,'%d-%b-%Y'), a.CHR_DESC,a.DOU_AMOUNT  ";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
                    ...
                    <display:column title="VOPUCHER NO" sortable="true"><%=temp.elementAt(1)%></display:column>
					...
					<display:setProperty name="export.excel.filename" value="Rept_PettycashIncomes.xls"/>
					<display:setProperty name="export.pdf.filename" value="Rept_PettycashIncomes.pdf"/>
					<display:setProperty name="export.csv.filename" value="Rept_PettycashIncomes.csv"/>
