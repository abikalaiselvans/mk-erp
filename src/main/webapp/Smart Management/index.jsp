 ...
 <%@ include file="../JavaScript/dynamicStylesheet.jsp" %><table width="100%" border="0" cellspacing="0" cellpadding="0"  id="header"> 
  ...
  <tr>
    <td><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
          <tr   class="headerBackground" >
            <td width="205" height="25" align="center" valign="middle"><span class="boldgre">MANAGEMENT </span></td>
            <td width="371" class="text_0">&nbsp;
			<%
	...
	if( "S".equals(""+session.getAttribute("USRTYPE"))) 
            ...
            <td width="16" align="right"   class="headerBackground" ><div align="center"><span class="bold1">
  ...
  <tr   class="headerBackground" >
    <td height="25"  id="menutd"><%@ include file="management_menu.jsp"%></td>
  </tr>
</table>
