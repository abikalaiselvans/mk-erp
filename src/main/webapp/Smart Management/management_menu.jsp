...
<% 	
		 ...
		 str="select CHR_MENUMANAGEMENT from  m_user  where CHR_USRNAME='"+uname+"'" ;
	     rs=st.executeQuery(str); 
	     if(rs.next())
	     {		
	    	 mnuList=rs.getString("CHR_MENUMANAGEMENT");
		     str="Select * from  m_menu_management  where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
