...
function Validate()
  {
	...
	if( 
		...
		&& chkemail("email")
		&& checkNull( "verification","Select verification" )
		//salute="0",areacode="";
  ...
  <%
			...
			if(gd.length>0)
				googlelink=gd[0][0];
                        ...
                        <input name="address3" type="hidden" class="formText135" id="address3" value="<%=address3%>" >
			  ...
			  %>
                      ...
                      <td class="boldEleven">Account Name <span class="errormessage">*</span></td>
                      <td class="boldEleven">
                      <%=CommonFunctions.QueryExecute("SELECT INT_CUSTOMERNAMEID,CHR_NAME FROM mkt_m_customername WHERE INT_CUSTOMERNAMEID= "+cname+" ORDER BY CHR_NAME")[0][1]%>
...
%>
                      </select><script language="javascript">setOptionValue('cname','<%=cname%>')</script> 
                    ...
                    <tr>
                      ...
                      <tr>
                      <td class="boldEleven">Contact Person -1 <span class="errormessage">*</span></td>
                    ...
                    <tr>
                      <td class="boldEleven">Department-1  <span class="errormessage">*</span></td>
                    ...
                    <tr>
                      <td width="16%" class="boldEleven">Desgination-1 <span class="errormessage">*</span></td>
                    ...
                    <tr>
                      <td class="boldEleven">Address1 <span class="errormessage">*</span></td>
                    ...
                    <tr>
                      <td class="boldEleven"> Location <span class="bolddeepred"> * </span></td>
                      <td class="boldEleven"><span class="bolddeepblue">
                        <select name="city" class="formText135" id="city" style="width:200" onChange="AssignPincode('pincode')"  >
				...
				if(cityData.length>0)
					...
					%>
                      ...
                      <td class="boldEleven">&nbsp;</td>
                      <td class="boldEleven"><span class="bolddeepblue">Extn 1 </span></td>
                      <td class="boldEleven"><span class="bolddeepblue">
                        <input name="extn1" type="text" class="formText135" id="extn1" value="<%=extn1%>" size="30" maxlength="4" onKeyPress="return numeric_only(event,'extn1','6')" title="5005">
                      </span></td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td   align="left" class="bolddeepblue"><select name="state" class="formText135" id="state" style="width:200" onChange="LoadSelectDistrict()">
                        <option value="0" selected="selected">Select</option>
                        <%
					...
					%>
                      ...
                      <td   align="left" class="bolddeepblue"><input name="extn2" type="text" class="formText135" id="extn2" value="<%=extn2%>" size="30" maxlength="4" onKeyPress="return numeric_only(event,'extn2','6')" title="5005"></td>
                    </tr>
                    <tr>
                      <td height="17" valign="top" class="boldEleven">Country<span class="bolddeepred"> * </span></td>
                      <td   align="left" valign="top">
                      <select name="country" class="formText135" id="country" style="width:200" onChange="LoadSelectState()">
	 ...
	 %>
			...
			setOptionValue('city',"<%=city%>");
                      ...
                      <td   align="left" valign="top"><span class="bolddeepblue"><span class="boldEleven">Mobile 1</span></span></td>
                      <td   align="left" valign="top"><span class="bolddeepblue"><span class="boldEleven">
                    ...
                    <tr>
                      ...
                      <td   align="left"><input name="pincode" type="text" class="formText135" id="pincode" onKeyPress="return numeric_only(event,'pincode','7') "    onKeyUp="lookup(this.value);" value="<%=pincode%>" size="10" 									maxlength="6" />
                          <br />
                      ...
                      <td   align="left">&nbsp;</td>
                      <td   align="left"><span class="boldEleven"><span class="bolddeepblue">Mobile 2 </span></span></td>
                      <td   align="left"><span class="boldEleven"><span class="bolddeepblue">
                    ...
                    <tr>
                      <td height="17" valign="top" class="boldEleven">Email<span class="spc"></span></td>
                      <td   align="left" valign="top" class="bolddeepblue"><input  title="test@test.net" name="email" type="email" class="formText135" id="email" value="<%=email%>" size="30" maxlength="99" > 
					  				                        </td>
                    ...
                    <tr>
                      ...
                      <td class="boldEleven"><span class="bolddeepblue">
                        <input name="website" title="http://www.test.net" type="url" class="formText135" id="website" value="<%=website%>" size="30" maxlength="30">
                      </span></td>
                    </tr>
                    ...
                    <%
					 	if(  "F".equals(""+session.getAttribute("USERTYPE")) || "B".equals(""+session.getAttribute("USERTYPE"))  )
						{
							...
							out.println("<option value='' selected='selected' >Select Status</option>");
