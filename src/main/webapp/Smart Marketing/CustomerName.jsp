...
<script language="javascript" src="../JavaScript/Marketing/CustomerName.js"></script>
<script language="JavaScript">

    function Add()
	{ 
		document.frm.action="CustomerNameAction.jsp";
 	}
	...
	<tr>
		...
		<table width="90%" height="220" border="0" align="center"
			cellpadding="0" cellspacing="0" class="TableDesign"  
			 >
			<tr  >
			  <td height="31"  ><div align="center" class="whiteMedium">Customer 
			    <input name="status" type="hidden" id="status" value="0">
			  </div></td>
		  </tr>
			<tr  >
				<td height="31" align="center" valign="middle"  ><table width="700" border="0" align="center" class="whiteMedium">
				  <tr>
