...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	 <form  AUTOCOMPLETE = "off"   action="DailyCallsEmployeeWiseGraphResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1" cellspacing="1">
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="tMLAscreenHead" id="Close"  value="Close"   accesskey="c"  onClick="redirect('Rept_DailyCallsGraph.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
