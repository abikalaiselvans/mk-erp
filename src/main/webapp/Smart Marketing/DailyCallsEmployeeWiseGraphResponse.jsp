...
todate = DateUtil.FormateDateSys(todate);
		  ...
		  sql = sql+ " GROUP BY   a.CHR_CALLTYPE ORDER BY  c.CHR_CALLTYPE  ";
			...
			JFreeChart chart = ChartFactory.createPieChart("Pie Chart for  "+CommonFunctions.QueryExecute(sql)[0][0], data, true, true, false);
			try 
			{
		...
		<td><table width="70" border="0" align="center" cellpadding="1"
          ...
          <tr>
           <td width="56"><input type="Button" class="ButtonHead" 
					name="submit"  value="Close"   accesskey="c"  onClick="redirect('DailyCallsEmployeeWiseGraph.jsp')" /></td>
          </tr>
        </table></td>
	</tr>
</table>
