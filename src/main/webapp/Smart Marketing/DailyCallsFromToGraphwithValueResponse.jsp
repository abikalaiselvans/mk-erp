...
todate = DateUtil.FormateDateSys(todate);
		  ...
		  String sql = "";
		  sql = " SELECT  c.CHR_CALLTYPE, SUM(DOU_VALUE) FROM mkt_t_daillycalls a, mkt_k_calltype c ";
		  ...
		  sql = sql+ " GROUP BY   a.CHR_CALLTYPE ORDER BY  c.CHR_CALLTYPE  ";
			...
			JFreeChart chart = ChartFactory.createPieChart("Pie Chart with value ", data, true, true, false);
			try 
			{
		...
		<td><table width="70" border="0" align="center" cellpadding="1"
          ...
          <tr>
           <td width="56"><input type="Button" class="ButtonHead" 
					name="submit"  value="Close"   accesskey="c"  onClick="redirect('DailyCallsFromToGraphwithValue.jsp')" /></td>
          </tr>
        </table></td>
	</tr>
</table>
