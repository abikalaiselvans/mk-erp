...
function Validate()
  {
	...
	if(  checkNull( "Name","Enter Department name" ) 
		 && checkNull( "sdescription","Enter Department Description" )  )
		return true;
	else
		return false;				
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center"> Department 
				    ...
				    <%
							...
							{
								id="";Name=""; desc="";
								actionS="MKTDepartmentAdd";
								value="Add";
								link=" onKeyUp=\"CheckUnique(this,'divunitname','mkt_m_depart','CHR_DEPARTNAME')\" ";
							}
							else
							{
								id="";Name=""; 
								id=request.getParameter("id");
								sql = " SELECT INT_DEPARTID,CHR_DEPARTNAME,CHR_DESC,CHR_STATUS FROM mkt_m_depart WHERE INT_DEPARTID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1];desc=data[0][2];status=data[0][3]; 
								actionS="MKTDepartmentEdit";
								value="Update";
								//link="";
								link=" onKeyUp=\"CheckUnique(this,'divunitname','mkt_m_depart','CHR_DEPARTNAME')\" ";
							}
			  ...
			  <tr>
                      ...
                      <td class="boldEleven"><label>
					  				<%
									String active=status.trim();
									if ("Y".equals(active))
										dbvalue=" checked='checked' ";
									else
										dbvalue=" ";
									%>	
                        <input name="active" type="checkbox" id="active" value="" <%=dbvalue%> >
                                        </label></td>
                    </tr>
              <tr>
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('MktDepartmentView.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
