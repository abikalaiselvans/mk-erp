              ...
              <tr>
                <td colspan="2" class="bold1"><div align="center"> DESIGNATION 
				    ...
				    <%
							...
							{
								id="";Name=""; desc="";status="";
								actionS="MKTDesignationAdd";
								value="Add";
								link="onKeyUp=\"CheckUnique(this,'divunitname','mkt_m_desig','CHR_DESIGNAME')\" ";
							}
							else
							{
								id="";Name=""; 
								id=request.getParameter("id");
								sql = " SELECT INT_DESIGID,CHR_DESIGNAME,CHR_DESC,CHR_STATUS  FROM mkt_m_desig  WHERE INT_DESIGID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0];Name=data[0][1];  desc=data[0][2]; status=data[0][3];
								actionS="MKTDesignationEdit";
								value="Update";
								//link="";
								link=" onKeyUp=\"CheckUnique(this,'divunitname','mkt_m_desig','CHR_DESIGNAME')\" ";
							}
              ...
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                    ...
                    <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('MktDesignationView.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
