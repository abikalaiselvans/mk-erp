...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	 <form  AUTOCOMPLETE = "off"   action="../UploadFunnels"  method="post" enctype="multipart/form-data" name="frm" id="frm" >
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">FUNNEL UPLOAD  
                    			<input type="hidden" name="filename" value="FunnelUpload" />
                  <input type="hidden" name="actionS"  value="MKTFunnelUpload" />
              ...
              <tr>
                ...
                <td class="boldEleven"> <input type="file" name="excelFile" accept=".xls" required size="50"/>
        <input type="submit" value="Upload Funnel"/></td>
              </tr>
