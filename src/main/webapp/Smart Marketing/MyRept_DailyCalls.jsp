...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	 <form  AUTOCOMPLETE = "off"   action="MyRept_DailyCallsResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              ...
              <tr>
                <td width="38%" class="boldEleven">Call Type </td>
                <td width="62%" class="boldEleven"><select name="calltype" class="formText135" id="calltype"   style="width:250">
              ...
              <tr>
                ...
                <td class="boldEleven"><select name="customer" class="formText135" id="customer"  style="width:250">
                  <option value="0">All</option>
                  <%
...
String cdata[][]= CommonFunctions.QueryExecute(sql); //AND  a.CHR_VERIFY='Y' 
if(cdata.length>0)
...
%>
              ...
              <tr>
                ...
                <td class="boldEleven"><select name="close" id="close"  class="formText135"  style="width:250" >
