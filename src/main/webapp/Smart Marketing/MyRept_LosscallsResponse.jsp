...
String reportheader="LOSS CALLS REPORT"; 
...
sql = sql + " AND  a.CHR_ADDEDTO_FUNNEL ='Y'  AND a.CHR_STATUS ='Y'   AND a.CHR_WINLOST ='L' ";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:setProperty name="export.excel.filename" value="MyRept_Losscalls.xls"/>
					<display:setProperty name="export.pdf.filename" value="MyRept_Losscalls.pdf"/>
					<display:setProperty name="export.csv.filename" value="MyRept_Losscalls.csv"/>
					<display:setProperty name="export.pdf"  value="true" />
					 
					 
</display:table>     
<br />	<center>	<a href='MyRept_Losscalls.jsp'> CLOSE</a>
</center>
