...
<script language="javascript" src="../JavaScript/comfunction.js"></script>
 <script language="javascript" src="../JavaScript/Marketing/MarketingQuotation.js"></script>
		...
		if (r==true)
	  	{
  			...
  			{
	  			var d ="../SmartLoginAuth?filename=MarketingQuotation&actionS=MKTQuotationSendMail&email="+reason+"&qid="+Quotationnumber;
	  			location = d;
...
<body onselectstart="return false" onpaste="return false;" onCopy="return false"     onLoad="loadQuotation('0')">
				...
				<div align="center">
				  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="whiteMedium">
                    <tr>
					  ...
					  <td>Day</td>
                <td><select name="day" id="day"  onBlur="loadQuotation('0') " style="width:50">
                  ...
                  <%
                      ...
                      <td >Month</td>
                      <td ><select name="month" id="month" onChange="loadQuotation('0')">
                        <option value="0">All</option>
			...
			<tr >
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="whiteMedium">
					<tr >
						...
						<td   width="100">
						<div align="left">Req Date</div>						</td>
						<td   width="200">
						<div align="left">Quotation Amount</div>						</td>
						<td   width="10">
