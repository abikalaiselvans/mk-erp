...
<script language="javascript" src="../JavaScript/Marketing/LoadCustomerContactPersoninQuotation.js"></script>
...
<!--
	...
	function insRow()
	{
		...
		x.insertCell(1).innerHTML="<input type='text' size=10 value='1'    onblur='calculateValue(this)' title='Quantity' class='formText135'  name='"+s3+"' id ='"+s3+"' " +vf1+" style='text-align:right' maxlength='5' />";
		...
		x.insertCell(3).innerHTML="<input type='text' size=10 value='0' onblur='calculateDiscount(this)' title='Discount' class='formText135'  name='"+s5+"' id ='"+s5+"' " +vf3+"  style='text-align:right'  maxlength='3' />";
		x.insertCell(4).innerHTML="<input type='text' size=10 value='0' title='UnitDiscount' class='formText135'  name='"+s6+"' id ='"+s6+"' " +vf4+" readonly='readonly' style='text-align:right'  maxlength='3' />";
		
		x.insertCell(5).innerHTML="<select class='formText135'   style='width:100'  name='"+s13+"' id ='"+s13+"'   ><%=warrantyinsert%></select>";
		
		
		x.insertCell(6).innerHTML="<select class='formText135'   style='width:100'  name='"+s10+"' id ='"+s10+"' onBlur=assignTaxValue('"+s10+"') ><%=optiontaxname%></select>";
		...
		x.insertCell(10).innerHTML="<input type='hidden' name='"+s8+"' id ='"+s8+"' /><input class='buttonbold'  type='button' value='Delete' onclick='deleteRow(this.parentNode.parentNode.rowIndex,"+r+")'>";
...
function assignTaxValue(ctr)
	...
	function valid()
	{
		...
		if(parseInt(checkArray.length-1)<1)
		{
   		...
   		for(u=0; u<checkArray.length-1;u++)
   			svalue =svalue+"qty"+checkArray[u]+","+"uprice"+checkArray[u]+","+"discount"+checkArray[u]+","+"unitdiscount"+checkArray[u]+"," +"stax"+checkArray[u]+","   +"total"+checkArray[u]+",";
					...
					<table width="100%" border="0" align="center" cellpadding="1"
						...
						<tr>
							<td height="38" align="center" valign="top"><div align="center" class="bold1">
							  <div align="center">QUOTATION /TENDER </div>
						  </div></td>
						</tr>
						<tr>
							<td>
...
ssql = ssql + "  ORDER BY f.CHR_NAME";
			...
			String custData[][] =  CommonFunctions.QueryExecute(ssql);
 			%> 
<select name="customerId" id="customerId" class="formText135"   onchange="loadAddress('customerId','order') "  onBlur="LoadCustomerContactPerson()"  style="width:170">
...
%>
								    ...
								    <td width="107" valign="top" class="boldEleven">Order From<span class="ui-state-error-text"> * </span></td>
								    <td width="201" align="left" valign="top" class="boldEleven"><textarea name="order" cols="25" rows="5" class="formText135" id="order" onKeyPress="textArea('order','450')"></textarea></td>
								</tr>
								<tr>
									<td height="14" valign="top" class="boldEleven">Quotation Date<span class="ui-state-error-text"> * </span></td>
		...
		//-->
							...
							%>
									...
									<div align="left"><textarea name="ship" cols="25"
										rows="5" class="formText135" id="ship"  onKeyPress="textArea('ship','450')"></textarea>
									</div>									</td>
								</tr>
								<tr>
									<td valign="top" class="boldEleven"><div align="left">Contact Person<span class="ui-state-error-text"> * </span></div></td>
								...
								<tr>
								  <td valign="top" class="boldEleven"><div align="left">Contact No.<span class="ui-state-error-text"> * </span></div></td>
								  <td class="boldEleven"><div align="left">
								...
								<tr>
									<td valign="top" class="boldEleven">Kind Attention * </td>
									<td class="boldEleven"><input name="attention" type="text"
										class="formText135" id="attention"
										    onBlur="upperMe(this)" size="35" maxlength="500"     /></td>
							...
							%>
								...
								<tr>
								  <td class="boldEleven">Subject<span class="ui-state-error-text"> * </span></td>
								  <td class="boldEleven"><input name="subject" type="text"
										class="formText135" id="subject"
										    onBlur="upperMe(this)" size="35" maxlength="500"     /></td>
								  <td valign="top" class="boldEleven">Terms &amp; Conditions<span class="ui-state-error-text"> * </span></td>
								  <td rowspan="3" valign="top" class="boldEleven"><textarea name="terms" cols="25"
										rows="5" class="formText135" id="terms"  onKeyPress="textArea('terms','1000')"></textarea></td>
							  </tr>
								 
								<tr>
								  <td class="boldEleven">Office <span class="ui-state-error-text"> * </span></td>
								  <td class="boldEleven"><select name="office"
										class="formText135" id="office" tabindex="3"   style="width:150">
								     
								    <%
								String oficeData[][] =  CommonFunctions.QueryExecute("Select INT_OFFICEID,CHR_OFFICENAME from com_m_office ORDER BY CHR_OFFICENAME");
								for(int u=0; u<oficeData.length; u++){
									if(oficeData[u][0].equals(""+session.getAttribute("OFFICEID")))
									 out.print("<option value='"+oficeData[u][0]+"' selected>"+oficeData[u][1]+"</option>");
									else
									 out.print("<option value='"+oficeData[u][0]+"'>"+oficeData[u][1]+"</option>");									
								}	
							%>
							      </select></td>
							...
							<table width="100%" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<div align="left"><textarea name="memo" cols="25"
										rows="5" class="formText135" id="memo"  onKeyUp="textArea('memo','200')" > </textarea></div>
									</td>
								...
								<tr>
									...
									<div align="left"><input name="totaldiscount" type="text"
										...
										onblur="assignGrandTotal()" value="0" maxlength="3"></div>
									</td>
								</tr>
								<tr>
									<td valign="top" class="boldEleven">
							...
							%>
								...
								<tr>
									...
									<div align="left">Reference <span class="ui-state-error-text">  </span>
									  ...
									  <input name="actionS"
										type="hidden" value="MKTQuotationAdd" /> 
									  <input name="param"
										type="hidden" id="param" value='0,'></div>
								  </td>
									<td class="boldEleven">
									<div align="left"><input name="ref" id="ref" type="hidden" value="<%=session.getAttribute("EMPID")%>"><%=session.getAttribute("EMPID")%>
								...
								<tr>
									...
									&nbsp;&nbsp; <input name="Submit2" type="button"
										...
										onclick="redirect('Quotation.jsp')"  />
									 </div>
