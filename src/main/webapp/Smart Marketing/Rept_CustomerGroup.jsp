...
<%
 ...
 String reportheader="CUSTOMER GROUP LIST REPORT "; 
 
String sql="";

 

	 sql="  select CHR_GROUPNAME,date_format(DAT_REGISTER,'%d-%b-%Y'),CHR_ACTIVE from  mkt_m_customergroup order by CHR_GROUPNAME ";
...
<display:table   id="_table" name="table"   export="true" pagesize="25">
					...
					<display:column title="ACTIVE" sortable="true" ><%=temp.elementAt(3)%></display:column>
