        ...
        <tr>
          ...
          <td valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              ...
              <tr>
                <td width="13%" class="boldEleven">1</td>
                <td width="87%" class="boldEleven"><a href="DailyCallsFromToGraphwithValue.jsp" target="_parent">All</a></td>
              </tr>
              
               
              <tr>
                <td valign="top" class="boldEleven">2</td>
                <td class="boldEleven"><a href="DailyCallsEmployeeWiseGraphwithValue.jsp" target="_parent">Employee Wise</a></td>
              </tr>
              <tr>
