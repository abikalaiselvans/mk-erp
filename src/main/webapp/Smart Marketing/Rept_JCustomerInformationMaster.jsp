        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">ACCOUNT INFORMATIONS </div></td>
                </tr>
              <tr>
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JCustomerInfo">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="MKTRept_JCustomerInfo">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="CustInfo"></td>
              </tr>
              <tr>
