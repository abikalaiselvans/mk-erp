        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Daily Calls </div></td>
                </tr>
              <tr>
...
%>
              ...
              <tr>
                ...
                <td class="boldEleven"><select name="status" id="status"  class="formText135"  style="width:175" >
...
<script language="javascript">setCurrentDate('fromdate')</script>                                    
              ...
              <tr>
                <td class="boldEleven">Export To </td>
                <td class="boldEleven"><select name="reportType" id="reportType" style="width:170px;" >
                  <option value="0" selected="selected">Export Type</option>
                  ...
                  <input name="filename" type="hidden" id="filename"
										value="Rept_JDailyCalls">
                  <input name="actionS"
										type="hidden" id="actionS"
										value="MKTRept_JDailyCalls">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="DailyCalls"></td>
              </tr>
              <tr>
