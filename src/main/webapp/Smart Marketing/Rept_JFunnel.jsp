        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">Funnel</div></td>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="boldEleven"><input name="filename" type="hidden" id="filename"
                  ...
                  <input name="actionS"
										...
										value="MKTRept_JFunnel">
                  <input name="rptfilename" type="hidden" id="rptfilename" value="Funnel"></td>
              </tr>
              <tr>
                <td colspan="2" class="boldEleven"><table width="112" border="0" align="center" cellpadding="1"
                  ...
                  <tr>
                     ...
                     <td><input name="Close" type="button"   class="buttonbold13" id="Close"  value="Close"   accesskey="c"  	onClick="redirect('MarketingMain.jsp')"></td>
                  </tr>
                </table></td>
                </tr>
            </table>
