...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	 <form  AUTOCOMPLETE = "off"   action="Rept_MyFunnelResponse.jsp" method="post" name="frm" id="frm" onSubmit="return Validate()">
        ...
        <tr>
          ...
          <td width="412" valign="top">
		    ...
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="2" class="bold1"><div align="center">FUNNEL REPORT  
                    			
				
				</div></td>
                </tr>
              <tr>
                <td width="23%" class="boldEleven">Location </td>
                <td width="77%" class="boldEleven"> 
              ...
              <tr>
                <td valign="top" class="boldEleven">Account Type </td>
                <td class="boldEleven">
				<select name="accouttype" id="accouttype">
                <option value="0" selected="selected">All</option>
...
<script language="javascript">setCurrentDate('fromdate')</script>                                    </td>
              </tr>
              <tr>
