  ...
  <tr>
    <td><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
          <tr   class="headerBackground" >
            <td width="199" height="25" align="center" valign="middle"><span class="boldgre">MARKETING </span></td>
...
<%
	...
	response.setHeader("Cache-Control","no-store"); //HTTP 1.1 %> 
            ...
            <td width="205" align="right"   class="headerBackground" ><div align="center"><span class="bold1">
  ...
  <tr   class="headerBackground" >
    <td height="27"  id="menutd"><%@ include file="Marketing_menu.jsp"%></td>
  </tr>
</table>
