...
%>
<%
	desid=request.getParameter("OptDesignation");
...
<table width="1000">
	...
	<tr>
   	    ...
   	    try
        {
   	    ...
   	    sql="SELECT A.CHR_EMPID,A.CHR_STAFFNAME,B.CHR_DESIGNAME,C.DT_DATE,C.INT_ADVAMT,C.INT_NOOFINS,C.INT_BALAMT,C.INT_BALINS";
   		sql=sql+" FROM  com_m_staff  A, com_m_desig  B,PAY_M_ADVANCE C WHERE A.CHR_EMPID=C.CHR_EMPID AND A.INT_DESIGID=B.INT_DESIGID AND A.INT_DESIGID="+desid;
