...
<form  AUTOCOMPLETE = "off"   method="post" action="AdvDesView.jsp">
...
<table width="1002">
	<!--DWLayoutTable-->
	<tr>
		<td width="280" height="68">&nbsp;
		<td colspan="3" valign="top">
		<table align="center" border="1"  >
			<!--DWLayoutTable-->
			<tr align="center">
				<td height="26" colspan="4" valign="top" 
					class="tablehead">Advance Details - Designation Wise</td>
			</tr>
			<tr>
				<td width="168" height="32" align="center" valign="middle"
					class="tabledata">Select the Designation</td>
				<td width="229" colspan="2" valign="top"><select
					name="OptDesignation">
					<%
              try
