...
<table width="1000">
	...
	<tr>
		...
		<table width="867" border="1" cellpadding="0" cellspacing="1"
			...
			<!--DWLayoutTable-->
			<tr>
				<td height="29" colspan="8" align="center" valign="middle"
					  class="tablehead">Advance Details -
				Department Wise</td>
			</tr>
			<tr>
				<td colspan="2" width="69" height="26" align="center"
					valign="middle" bgcolor="6E8FBC" class="tablehead">Month</td>
				<td colspan="2" width="103" align="center" valign="middle"
					bgcolor="6E8FBC" class="tablehead"><%=month%></td>
				<td width="69" height="26" align="center" valign="middle"
					bgcolor="6E8FBC" class="tablehead">Year</td>
				<td colspan="2" width="103" align="right" valign="middle"
					bgcolor="6E8FBC" class="tablehead"><%=year%></td>
			</tr>
			<tr>
				<td width="69" height="27" align="center" valign="middle"
   	    ...
   	    try
        {
   	    ...
   	    sql="SELECT A.*,B.* FROM  com_m_staff  A,PAY_M_ADVANCE B WHERE A.CHR_EMPID=B.CHR_EMPID AND B.CHR_MONTH='"+month+"' AND B.INT_YEAR="+year;
