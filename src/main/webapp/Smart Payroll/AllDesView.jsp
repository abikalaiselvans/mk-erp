...
<%!
	...
	String sql,sqlrec,recid;
	String driver,allsql;
	String url;
	int i,desigid;	
%>
<%
...
<table width="1000">
	...
	<tr>
		...
		<table width="867" border="1" cellpadding="0" cellspacing="1"
			...
			<tr>
				<td height="24" colspan="11 align=" center" valign="middle"
					  class="tablehead">
				<CENTER>Allowance Details - Designation Wise</CENTER>
				</td>
			</tr>
			<tr>
		...
		sql=sql+" AND A.INT_DESIGID=D.INT_DESIGID AND A.INT_DEPARTID=C.INT_DEPARTID AND A.INT_DESIGID="+desigid;
...
%>
        ...
        try
        {
	         ...
	         while(recrs.next())
		     {
	        	...
	        	recid=recrs.getString("CHR_ACODE");
