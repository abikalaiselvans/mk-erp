				...
				<table class="BackGround" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<table width="407" height="124" border="0" align="center"
								cellpadding="2" cellspacing="2"  >
								<!--DWLayoutTable-->
								<tr align="center" valign="middle">
									<td height="28" colspan="2" 
										class="BackGround style9">Allowance Details</td>
								</tr>
								<tr align="left" valign="middle">
									...
									<td height="28" align="left" valign="middle"><a
										href="AllMonthWise.jsp">Monthwise</a></td>
								</tr>
								<tr align="left" valign="middle">
									...
									<a
										href="../SmartLoginAuth?filename=Department&actionS=COM_PAYREPdepartList&view=Allowance">
									Departmentwise </a></td>
								</tr>
								<tr align="center" valign="middle">
									<td height="28" align="center" valign="middle">
									...
									<td height="28" align="left" valign="middle"><span
										class="style8"> <a
										href="../SmartLoginAuth?filename=Designation&actionS=COM_PAYREPdesigList&view=Allowance">
									Designationwise </a> </span></td>
								</tr>
								<tr>
									<td colspan="2">
