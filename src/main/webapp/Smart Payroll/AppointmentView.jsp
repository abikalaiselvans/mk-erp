 ...
 function Validate()
  {
  	...
  	&& checkNullSelect("intial","Select Intial...","0")
...
<!--PaySlipView.jsp-->
<form  AUTOCOMPLETE = "off"   name="payslipfrm" method="post" action="Appointment.jsp" onSubmit="return Validate()">
					...
					<table width="400" height="124" border="0" align="center"
						...
						<tr>
							...
							<table width="92%" border="0" align="center" cellpadding="3"
								...
								<tr>
									<td width="42%" class="boldEleven"><div align="left"><span class="style13">Grade </span></div></td>
									<td width="58%" colspan="2" class="boldEleven"><select name="intial" class="boldEleven" id="intial">
									  <option value="0">Select</option>
									  <%
									   String stafftypeData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT CHR_GRADE FROM pay_m_salaryband ORDER BY CHR_GRADE");
										if (stafftypeData.length>0)
											for (int i=0; i<stafftypeData.length; i++) 
												out.println("<option value='"+stafftypeData[i][0]+"'>"+stafftypeData[i][0] +"</option>");		
									%>			
								      </select></td>
								</tr>
