...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="EmpESInumberResponse.jsp"
			...
			<tbody>
				...
				<tr>
					...
					<table width="500" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >ESI  Number </td>
						</tr>
						<tr>
							<td width="189" height="28" valign="middle" class="boldEleven">
							Company</td>
							<td width="266"><select name="company" id="company"
 			   ...
 			   %>
						...
						<tr>
							<td width="189" height="28" valign="middle" class="boldEleven">
							Branch</td>
							<td width="266"><select name="branch" id="branch"
								class="formText135" style="width:200px">
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr align="center" valign="middle">
						  <td height="28" align="left" valign="middle" class="boldEleven">Order by </td>
