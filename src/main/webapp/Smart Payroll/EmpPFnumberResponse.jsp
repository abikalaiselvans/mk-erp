...
try
{
	...
	sql = sql +" b.CHR_COMPANYNAME,c.CHR_BRANCHNAME,d.CHR_OFFICENAME,a.CHR_EMAILID,a.CHR_MOBILE,a.CHR_PFNO  ";
	...
	if(data.length>0)
	{
		...
		out.println("<tr bgcolor='#ffffff'><td class=\"boldEleven\" colspan=13><b><center> PF NUMBER REPORT </center>");
