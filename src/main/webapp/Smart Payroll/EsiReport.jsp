...
<table width="1002" border=0>
			...
			<tbody>
				...
				<tr>
					...
					<table width="390" border="0" align="center" cellpadding="2"
						...
						<!--DWLayoutTable-->
						<tr align="center">
							<td height="28" colspan="2" class="tablehead1 style16">ESI
							Report</td>
						</tr>
						<tr>
 			   ...
 			   %>
						...
						<tr>
							<td height="30" colspan="2" valign="middle" class="bolddeepblue"><!--DWLayoutEmptyCell-->&nbsp;</td>
						</tr>
					</table>
					<div align="center">
	...
	<tr>
		<td><input type="hidden" name="actionS" value="PAYESIREPORT">
		<input type="hidden" name="filename" value="PfEsiTrans"></td>
		<td>&nbsp;</td>
