...
-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="ExistEmployeeResponse.jsp"	onSubmit="return Validate()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<table width="600" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">Exist
							Employee List</td>
						</tr>
 			   ...
 			   %>
						...
						<tr>
                          <td height="28" valign="middle" class="boldEleven"> Branch</td>
						...
						<tr class="bolddeepblue">
							<td width="132" height="35" valign="middle" class="boldEleven">Office</td>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td height="35" valign="middle" class="boldEleven">With Resigned </td>
