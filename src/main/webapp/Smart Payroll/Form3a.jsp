 ...
 <br /><table width="80%" height="900" align="center"  cellpadding=2 cellspacing=1 bgcolor='#9900CC'  id='myTable' >
  <tr bgcolor="#FFFFFF">
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="0">
      ...
      <tr>
        <td><span class="boldEleven"><strong>Name and address of the Establishment:</strong><br /><b> <%= datac[0][0] %>,<br /><b>
            <%= datac[0][1] %>,<br /><b> <%= datac[0][2] %>-<%= datac[0][3] %></span></td>
      </tr>
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boldEleven">
          <tbody>
            <tr>
              <th width="213" height="34" class="boldEleven" scope="col"> <div align="left">1. Account No. </div></th>
              <th width="121" class="boldEleven" scope="col"> <div align="left"><%= data[i][1]%></div></th>
              <th width="393" class="boldEleven" scope="col"> <div align="left">4.Statutory rate of Contribution</div></th>
              <th scope="col" width="28" class="boldEleven">12%</th>
            </tr>
            <tr>
...
out.println(form4bt);
	...
	out.println(form4t);
      ...
      <tr>
        <td><div align="justify"><span class="boldEleven">Certified that the total amount of   contribution (both shares) indicated in this card i.e, Rs. <%= (form3t+form4t) %> has already been remitted in full in EPF A/C No. 1 and pension   Fund A/C No. 10 R <%= form4bt %> vide below 
        </span></div></td>
      </tr>
      <tr>
        <td><div align="justify"><span class="boldEleven">Certified that the difference   between the total of the contributions shown under columns(3) and 4(a) &amp;   4(b) of the above table and that arrived at on the total wages shown in col(2)   at the prescribed rate is sloely due to rounding off of contribution to the   nearest rupee under the rules.</span></div></td>
      </tr>
      <tr>
        <td class="boldEleven"><div align="right"><strong>For Networking Solutions (India) Pvt Ltd.,</strong></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        <td><span class="boldEleven">(See paragraphs 35 and 42 of the employee'   Provident Funds Scheme, 1952)</span></td>
      </tr>
      <tr>
        <td><span class="boldEleven">(See paragraph 19 of the Employee's Pension   Scheme 1995)</span></td>
      </tr>
      <tr>
        <td><div align="justify"><span class="boldEleven">Note:- In respect of Form 3(A) sent to the   Regional Office during the course of the Currency period for the purpose of   final settlement of the accounts of the member who had left service details of   date and reason for leaving service.</span></div></td>
      </tr>
      <tr>
        <td><div align="justify"><span class="boldEleven">Should be furnished under column   7(A)(B)</span></div></td>
      </tr>
      <tr>
        <td><div align="justify"><span class="boldEleven">In respect of those who are not members of the Pension Fund the   employers share of contribution to the EPF will be 8-1/3 or 10% as the may be   and is to be shown under Column   4(a)</span></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
