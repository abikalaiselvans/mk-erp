...
<script language="JavaScript" src="../JavaScript/Payroll/LoanDebitAjax.js"></script>
<script language="javascript">
	...
	{		
 	    ...
 	    if(count==0)
		{
 	    ...
 	    if(count==1)
 	    {
			document.frm.action="LoanDebitEdit.jsp";
			document.frm.submit();
			return true;
		}
 } 
 ...
 function Delete()
	...
	function  Add()
 	{		
		document.frm.action="LoanDebitAdd.jsp";
		document.frm.submit();
	...
	<tr>
		...
		<table height="120" align="center"
			...
			<tr align="center" valign="middle"   background="">
				<td height="28"    
					 ><div align="center" class="whiteMedium">Loan Debit </div></td>
			</tr>
			<tr>
 ...
 if(OfficeData.length>0)
 	for(int u=0;u<OfficeData.length;u++)
		out.println("<option value='"+OfficeData[u][0]+"'>"+OfficeData[u][1]+"</option>");
					  ...
					  <td width="10%">Loan Type</td>
					  <td width="30%"> <select name="loantype"  id="loantype" class="formText135" onChange="loadloanCredit('0')" > 
	 	...
	 	if(loandata.length>0)
			...
			<tr>
				...
				<table width="100%" border="0" class="whiteMedium" cellpadding=2 cellspacing=1>
					<tr>
					  <td  width='5%' ><div align="center"><strong> </strong>S.No<strong></strong></div></td>
						<td  width='17%' ><div align="center">Emp Id</div></td>
						<td  width='17%' ><div align="center">Emp Name</div></td>
						<td  width='17%' ><div align="center">Date</div></td>
						<td  width='17%' ><div align="center">Loan Name</div></td>
						<td  width='17%' ><div align="center">Debit Amount</div></td>
					</tr>
				</table></td>
			</tr>
			<tr bgcolor="#FFFFFF">
	...
	<tr>
		...
		</table>						<input name="filename" type="hidden" id="filename" value="StaffLoanDebit"/>
				<input name="actionS" type="hidden" id="actionS" value="PAYStaffLoanDebitDELETE"/> 
				</td>
	</tr>
