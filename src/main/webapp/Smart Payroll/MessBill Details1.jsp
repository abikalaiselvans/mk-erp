...
<form  AUTOCOMPLETE = "off"   name="a" method="post" action="MessBill View1.jsp"
	...
	<tr>
		...
		<table width="372" border="1" cellspacing="2" cellpadding="2">
			...
			<tr align="center" valign="middle">
				<td height="25" colspan="3">Mess Bill Details</td>
			</tr>
			<tr>
				<td width="144" height="36" valign="middle">Department</td>
