...
<form  AUTOCOMPLETE = "off"   name="a" method="post" action="MessBill View4.jsp"
	...
	<tr>
		...
		<table width="372" border="1" cellspacing="2" cellpadding="2">
			...
			<tr align="center" valign="middle">
				<td height="25" colspan="2">Advance Details</td>
			</tr>
			<tr>
				<td width="147" height="36" valign="middle">Designation</td>
				<td width="205" valign="middle"><select name="des">
			...
			<tr>
				<td height="30" align="right" valign="top"><input type="submit"
					name="Submit" value="Submit"   accesskey="s"   ></td>
				<td align="left" valign="top"><input type="reset"
