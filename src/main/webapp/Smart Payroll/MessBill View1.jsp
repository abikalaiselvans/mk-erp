...
<%
	...
	try
	{
		...
		sql="select m_staff.CHR_EMPID,m_staff.CHR_STAFFNAME,m_advance.Chr_Month,m_advance.Int_year,m_advance.Int_Advamt,m_depart.CHR_DEPARTNAME from m_staff,m_advance,m_depart WHERE m_advance.Chr_Month='"+month+"' and m_advance.Int_year="+year+" and m_depart.CHR_DEPARTNAME='"+dept+"'";
