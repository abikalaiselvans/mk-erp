...
<%
	...
	try
	{
		...
		sql="select m_staff.CHR_EMPID,m_staff.CHR_STAFFNAME,m_advance.Chr_Month,m_advance.Int_Advamt,m_desig.CHR_DESIGNAME from m_staff,m_advance,m_desig WHERE m_advance.Chr_Month='"+month+"' and m_desig.CHR_DESIGNAME='"+des+"'";
