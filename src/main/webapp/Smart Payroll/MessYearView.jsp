...
<table width="1000">
	...
	<tr>
		...
		<table width="730" border="1" cellpadding="0" cellspacing="1"
			...
			<tr>
				<td width="101" height="24" bgcolor="6E8FBC" class="tablehead"
					align="center">Emp Id</td>
				<td width="198" bgcolor="6E8FBC" class="tablehead" align="center">Name</td>
				<td width="284" bgcolor="6E8FBC" class="tablehead" align="center">Year</td>
				<td width="132" bgcolor="6E8FBC" class="tablehead" align="center">Cheque
				No</td>
				<td width="132" bgcolor="6E8FBC" class="tablehead" align="center">Amount</td>
				<td width="132" bgcolor="6E8FBC" class="tablehead" align="center">Total</td>
			</tr>
			<%
	try
	{
        ...
        st=con.createStatement(); 
      	str="SELECT A.CHR_EMPID,A.CHR_STAFFNAME,C.INT_YEAR,C.CHR_CHEQUENO,C.INT_CASHAMT FROM  com_m_staff  A,PAY_M_MESSBILL C WHERE A.CHR_EMPID=C.CHR_EMPID AND C.INT_YEAR="+year;
