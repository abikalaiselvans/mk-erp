...
<!--PaySlipView.jsp-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Migrateallowancechangesget.jsp"
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<table width="400" height="125" border="0" align="center"
						  class="bolddeepblue">
						<!--DWLayoutTable-->
						<tr align="center" valign="middle">
							<td   height="28" colspan="3" align="center"
								valign="middle" class="boldgre">
							<div align="center">MIGRATE ALLOWANCE &amp; RECOVERY CHANGES </div>							</td>
						</tr>
						<tr align="center" valign="middle">
						...
						<tr>
						  <td height="29" valign="middle" class="bolddeepblue"><table width="92%" border="0" align="center" cellpadding="3"
								cellspacing="2">
                            <tr>
                              <td width="30%" class="boldEleven"><span class="style13">Month</span></td>
                              <td width="37%" class="boldEleven"><%@ include
										file="../JavaScript/monthName.jsp"%></td>
                              <td width="33%" class="boldEleven">&nbsp;</td>
                            </tr>
                            <tr>
                              <td class="boldEleven"><span class="style13">Year</span></td>
                              <td colspan="2" class="boldEleven"><span class="style11" width="97">
                                ...
                                <input
										type="hidden" name="filename" value="Attendance" />
                                <strong><font
										color="#000000"><font size="1">
                                <input
