...
function Validate()
{
	...
	if(  checkNullSelect('branch','Select branch','Select')  
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="MonthlyesireportResponse.jsp"
				...
				<tr>
					...
					<table width="455" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >Month
							ESI Report</td>
						</tr>
						<tr>
