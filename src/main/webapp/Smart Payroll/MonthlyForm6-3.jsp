...
function Validate()
{
	if(checkNullSelect('month','Select Month','Select') && checkNullSelect('year','Select Year','0')  )
		return true;
	else
		return false;
}
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Form6-3.jsp">
<br>
  ...
  <tr> 
	...
	<table width="455" border="0" align="center" cellpadding="0" cellspacing="0"  >
        ...
        <tr align="center" valign="middle"> 
          <td height="30" colspan="3" class="BackGround" > ESI FORM 6 Report </td>
        </tr>
		<tr>
