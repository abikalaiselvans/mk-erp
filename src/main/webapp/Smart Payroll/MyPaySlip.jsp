...
<form  AUTOCOMPLETE = "off"   name="a" method="post" action="ifPaySlipView.jsp"
					...
					<table align="center" border="0"  >
						...
						<tr>
							<td width="135" height="32" valign="middle" class="bolddeepblue"><span
								class="bolddeepblue">Month<span class="boldEleven"> <span class="boldred">*</span></span></span></td>
							<td width="199" align="left" valign="middle"><strong>
							<font size="1"><font size="1"> <%@ include
								file="../JavaScript/month.jsp"%> </font></font> </strong></td>
						</tr>
						<tr>
							<td height="33" valign="middle" class="bolddeepblue">Year<span class="boldEleven"> <span class="boldred">*</span></span></td>
