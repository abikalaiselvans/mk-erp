					...
					<table width="549" border="0" cellspacing="0" cellpadding="0">
						<tr class="boldEleven">
							...
							<div align="center" class="boldEleven"><span
								class="boldEleven"><strong>NDC</strong></span><strong> BUSINESS </strong></div>							</td>
						</tr>
						<tr>
							<td colspan="2">
						...
						<tr>
							<td height="19" colspan="2">
							 <%
							  ...
							  String sql = " SELECT FIND_A_EMPLOYEE_ID_NAME(CHR_EMPID),DATE_FORMAT(DAT_GENERAL_DATE,'%d-%m-%Y %H:%m:%s'),CHR_GENERAL_DESC,CHR_GENERAL,CHR_EMPID ,DOU_GENERAL  FROM   pay_t_emp_ndc   WHERE INT_NDCID ="+rowid;
...
%>
						...
						<tr>
							...
							<input name="actionS"
								type="hidden" id="actionS" value="PAYNDCGeneralAccept" />
							</div>							</td>
						</tr>
						<tr>
							<td height="19" colspan="2">
...
%>
									...
									<td width="56"><input type="button" name="submit"
										...
										onClick="redirect('NDC_Business.jsp')" /></td>
								</tr>
							</table>							</td>
						</tr>
					</table>
