...
String Data[][] = com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
	...
	out.println("<br><center><h3> JOINNER LIST FROM "+request.getParameter("frmdate")+" TO "+request.getParameter("todate")+"  </h3></center><br>");
...
<br />	<center>	<a href='NewJoinners.jsp'> CLOSE</a>
</center>
