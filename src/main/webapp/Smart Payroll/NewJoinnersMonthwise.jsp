...
function validate()
{
	if(checkNullSelect('Month','Select Month','0')    )
		return true;
	else
		return false;
}
...
-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="NewJoinnersMonthwiseResponse.jsp" onSubmit=" return validate()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="374" border="0" cellspacing="2" cellpadding="2"
						...
						<tr class="bolddeepblue">
							<td width="135" height="24" valign="middle" class="boldEleven">Office<span class="boldEleven"> <span class="boldred">*</span></span></td>
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr class="bolddeepblue">
							<td height="24" valign="middle" class="boldEleven">Department<span class="boldEleven"> <span class="boldred">*</span></span></td>
	...
	%>
						...
						<tr class="bolddeepblue">
						  <td height="24" valign="middle" class="boldEleven">Order by<span class="boldEleven"> <span class="boldred">*</span></span></td>
						...
						<tr class="bolddeepblue">
							<td height="24" valign="middle" class="boldEleven">Excluding Resigner <span class="boldEleven"> <span class="boldred">*</span></span></td>
						...
						<tr align="center" valign="middle">
						  <td height="28" align="left" valign="middle"
								class="boldEleven">Day <span class="boldred">*</span></td>
