...
function Validate()
{
	if( checkNullSelect('year','Select Year','Select')  )
		return true;
	else
		return false;
}
...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Form12A.jsp" onSubmit="return Validate()" >
<br>
  ...
  <tr> 
	...
	<table width="259" border="0" align="center" cellpadding="0" cellspacing="0"  >
        ...
        <tr align="center" valign="middle"> 
          <td height="30" colspan="2" class="BackGround" > Form 12A Report </td>
        </tr>
<tr>
