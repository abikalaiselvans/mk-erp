...
function Validate()
{
	...
	checkNullSelect('company','Select Company','0') && checkNullSelect('branch','Select branch','Select') 
...
<br>
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Form3aView.jsp" onSubmit="return Validate()" >
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
	...
	<table width="455" border="0" align="center" cellpadding="3" cellspacing="3"  >
        <!--DWLayoutTable-->
        <tr align="center" valign="middle"> 
          <td height="30" colspan="2" class="BackGround"> FROM3A Report </td>
        </tr>
		<tr>
