...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td><form  AUTOCOMPLETE = "off"   name="frm" method="post" action="Form5.jsp" onSubmit="return Validate()" >
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  >
        ...
        <tr align="center" valign="middle"> 
          <td height="30" colspan="2" class="BackGround" > FORM 5 [ <a href="Form5-Datewise.jsp" target="_blank">Date-Wise</a>] </td>
        </tr>
<tr>
