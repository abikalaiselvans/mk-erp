				...
				<tr>
					...
					<table width="455" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >PF CLIAM STATUS </td>
						</tr>
						<tr>
							<td width="162" height="28" valign="middle" class="boldEleven">
							Employee id/name </td>
							<td width="178">
							<select name="empid" class="formText135" id="empid">
						    <option value="0">Select</option>
							<%
							String empiddata[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(" SELECT CHR_EMPID, CHR_STAFFNAME FROM com_m_staff WHERE CHR_TYPE='T' AND CHR_PFCLAIMSTATUS='N' AND  CHR_PF !='N' ORDER BY CHR_STAFFNAME ");
							for(int c=0;c<empiddata.length;c++)
								 out.println("<option value='"+empiddata[c][0]+"'  >"+empiddata[c][1]+" / "+empiddata[c][0]+"</option>");	
							%>
							</select></td>
						</tr>
						<tr>
						  <td class="boldEleven">PF Cliam Date </td>
						  <td><input  title="dd/mm/yyyy"   name="pfdate"  id="pfdate" type="text" class="formText135" size="22" maxlength="10" />
                    ...
                    <td><textarea name="comments" cols="50"
						...
						<tr>
						  ...
						  <td><input name="filename" type="hidden" id="filename" value="PFCliamStatus">
                            <input name="actionS" type="hidden" id="actionS" value="PAYPFCliamStatusAdd"></td>
					  </tr>
						<tr>
