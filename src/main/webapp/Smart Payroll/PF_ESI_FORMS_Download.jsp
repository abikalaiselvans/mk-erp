...
String dirname = request.getRealPath("/")+"/uploadfiles/ESI";
...
if (f1.isDirectory()) 
{
	...
	for (int i=0; i < s.length; i++) 
	{
		...
		if (f.isDirectory()) 
		{
			...
			out.println("<td class='boldEleven'><a href='PF_ESI_FORMS_DownloadFiles.jsp?path=" + s[i]+"'>click</a></td>");
			out.println("</tr>");
...
for (int i = 0; i < listOfFiles.length; i++) 
	if (listOfFiles[i].isFile()) 
	{
		...
		out.println("<td class='boldEleven'><a target='_blank' href='../FORMS/"+listOfFiles[i].getName()+"'>");
                  ...
                  <td colspan="2" align="left" valign="middle" class=""><table align="center" cellpadding="3" cellspacing="3">
                      <tr align="center">
                        <td width="56"><input class="buttonbold" type="button"
										name="Submit"  value="Close"   accesskey="c"  onClick="redirect('Payrollmain.jsp')">
                        </td>
                      </tr>
                    </table>
                </tr>
