...
<script language="JavaScript" src="../JavaScript/Payroll/PayrollRevisionAccept.js"></script>
...
<script language="javascript">
	...
	function Add()
 	{		
		...
		obj = findObj("Apparaisalid"); 
		if(obj == null)
		{
			alert("Accept not available");
			return false;
		}
		
		var count;
		count=0;
		coffee1=document.forms[0].Apparaisalid;
		...
		if(count==0)
		{
			if (document.forms[0].Apparaisalid.checked) 
			{ 
			count=1;
			}
		}
		...
		if(count==1)
		{			
			document.frm.action="PayRollRevisionAccepted.jsp";
			return true;
		}
		else
		{
		...
		<td height="151" align="center">
		  ...
		  <table height="120" align="center"
			...
			<tr align="center" valign="middle" >
				<td height="28"  
					class="whiteMedium">REVISION ACCEPT </td>
			</tr>

			<tr  >
			  <td height="31" align="center" valign="middle"  ><table width="57%" border="0" align="center" cellpadding="0" cellspacing="0" class="whiteMedium">
                <tr>
                  <td width="60" align="left" valign="middle">Status</td>
                  <td width="60" align="left" valign="middle">
                  <select name="status" id="status"  onChange="loadPayrollRevision('0')">
                  <option value="0">All</option>
                  <option value="Y">Accept</option>
                  <option value="N">Pending</option>
                  </select></td>
                  <td width="60" height="20" align="left" valign="middle">Month</td>
				  <td width="105" align="left" valign="middle" class="boldEleven">
								<select	name="month" 	id="month"  class="formText135" onChange="loadPayrollRevision('0')">
								 <option value="0">All</option>
								<%@ include file="../JavaScript/months.jsp" %>
							</select>				  </td>
                 <td width="62" height="20" align="left" valign="middle">Year</td>
				  <td width="121" valign="top" class="boldEleven">
				...
				//-->
				  ...
				  <td width="64">Search</td>
                  <td width="272"><input name="search" type="text" class="formText135" id="search" onKeyUp="loadPayrollRevisions('0')"  ></td>
                </tr>
              </table></td>
		  </tr>
  ...
  <tr>
	  <td height="17" align="center"> 
		...
		<table border="0" cellspacing="1" cellpadding="1">
			<tr>
				<td width="56"><input class="ButtonHead" name="submit2" type="submit" value="Accept"    onClick="return Add()" ></td>
