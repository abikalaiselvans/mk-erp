...
<table width="1002" border=0>
	<!--DWLayoutTable-->
	<tr>
		<td width="296" height="133">&nbsp;</td>
		<td width="373" valign="top" background="../if">
		<table width="372" border="1" cellspacing="2" cellpadding="2">
			<!--DWLayoutTable-->
			<tr align="center">
				<td height="25" colspan="4">Pay Slip</td>
			</tr>
			<tr>
				<td height="33" colspan="2" valign="top">Year</td>
			...
			<tr>
				<td width="108" height="31">&nbsp;</td>
				<td width="57" valign="top"><input type="submit" name="Submit"
					value="Submit"></td>
				<td width="50" valign="top"><input type="reset" name="Submit2"
					value="Reset"></td>
				<td width="121">&nbsp;</td>
			</tr>
		</table>
