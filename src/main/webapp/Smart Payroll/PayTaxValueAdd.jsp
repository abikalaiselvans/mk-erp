				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
						  ...
						  <td><span class="boldEleven">
						    <select name="Taxid" class="formText135" id="Taxid"  >
							  ...
							  %>
							  <script language="javascript">
							  	var r=confirm("Atleast add one tax ...");
								if (r==true)
								  redirect('PayTax.jsp');
								else
								  redirect('PayTaxValue.jsp');
								</script>
							  <%
							  }			
						  %>
						...
						<tr>
							...
							<td width="178">
	<input name="GT" type="text" class="formText135" id="GT"  onKeyPress="return numeric_only(event,'GT','10')"    value="0" size="10" maxlength="9" style="text-align:right">
							<div id="soValid"></div>							</td>
						</tr>
						<tr>
						  <td height="28" valign="middle" class="boldEleven">Less than or equal to<span class="boldred"> * </span></td>
						  <td>
<input name="LT" type="text" class="formText135" id="LT"   onKeyPress="return numeric_only(event,'LT','10')"    value="0" size="10" maxlength="9" style="text-align:right">                        
					  </tr>
						<tr>
						  <td height="28" valign="middle" class="boldEleven">Percentage<span class="boldred"> * </span></td>
						  <td>
	<input name="Percentage" type="text" class="formText135" id="Percentage"    onKeyPress="return numeric_only(event,'Percentage','7')"   value="0" size="10" maxlength="5" style="text-align:right">                        
					  </tr>
						<tr>
						  <td height="28" valign="middle" class="boldEleven">Amount<span class="boldred"> * </span></td>
						  <td>
	<input name="Amount" type="text" class="formText135" id="Amount" onKeyPress="return numeric_only(event,'Amount','7')" value="0" size="10" maxlength="5" style="text-align:right">                        
					  </tr>
						<tr>
                        ...
                        <input type="hidden" name="actionS" value="PAYPayTaxAdd">						</tr>
						<tr>
