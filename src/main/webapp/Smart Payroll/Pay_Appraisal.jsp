...
<script language="javascript">
 function Validate()
  {
  	if(  checkNull("ename","Select Staff") && checkNullSelect("appraisal","Select Appraisal","0") )
		return true;
	else
		return false;
  }
				...
				<tr>
					...
					<table width="400" height="124" border="0" align="center"
						...
						<tr align="center" valign="middle">
							...
							<div align="center">APPRAISAL</div>
							</td>
						</tr>
						<tr align="center" valign="middle">
						...
						<tr>
							<td height="28" valign="middle" class="bolddeepblue"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="boldEleven">Appraisal % </td>
                                <td>
								<select name="appraisal" class="formText135" id="appraisal">
								...
								<input name="filename" type="hidden" value="Appraisal" />
                                <input name="actionS"
									type="hidden" value="PAYAppraisalAdd" />                                </td>
                              </tr>
                            </table>							</td>
						</tr>
						<tr>
