...
<script language="javascript">
 ...
 function demailCheck()
 {
 	try
	{
		...
		{
			var email = prompt("Enter the Emailid","abikalaiselvan@gmail.com");	
			if(email !="")
			{
				document.getElementById('demailid').value=email;
				if(chkemail("demailid"))
					return true;
				else
					return false;
			}
			...
			<tbody>
				...
				<tr>
					...
					<table width="400" height="124" border="0" align="center"
						...
						<tr align="center" valign="middle">
							...
							<div align="center">PAY SLIP SEND TO MAIL </div>
							</td>
						</tr>
						<tr align="center" valign="middle">
						...
						<tr>
							...
							<table width="92%" border="0" align="center" cellpadding="3"
								...
								<tr>
								    ...
								    <td width="33%" class="boldEleven"> 
							          <input name="email" type="checkbox" id="email" value="Y">
						            Email different </td>
								</tr>
								<tr>
				...
				//-->
									...
									<span class="style13"><font size="1"><strong><font
										...
										type="hidden" name="filename" value="PDF_Payslip" /> 
									<strong><font
										color="#000000"><font size="1"> <input
										type="hidden" name="actionS" value="PAYMonthlyPayslip_sent_to_mail" />
									<input name="demailid" type="hidden" id="demailid" value="test@test.net">
									</font></font></strong></font></font></strong></font></font></strong></font></span></span></td>
								</tr>
								<tr>
								  <td class="boldEleven">Format <span class="boldred">*</span></td>
								  <td colspan="2" class="boldEleven">
								  <select name="format" id="format" class="formText135">
