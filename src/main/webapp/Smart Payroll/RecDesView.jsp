...
%>
<%
	desigid=Integer.parseInt(request.getParameter("Designation"));
...
<table width="1000">
	...
	<tr>
		...
		<table width="867" border="1" cellpadding="0" cellspacing="1"
			...
			<!--DWLayoutTable-->
			<tr>
				<td height="24" colspan="11 align=" center" valign="middle"
					  class="tablehead">
				<CENTER>Recovery Details - Department Wise</CENTER>
				</td>
			</tr>
			<tr>
		...
		sql="SELECT A.CHR_EMPID,A.CHR_STAFFNAME,B.R001,B.R002,B.R003,B.R003,B.R004,B.R005,B.R006,B.R007,C.CHR_DESIGNAME ";
		sql=sql+" FROM  com_m_staff  A,PAY_T_SALARYRECOVERY B, com_m_desig  C WHERE A.CHR_EMPID=B.CHR_EMPID";
		sql=sql+" AND A.INT_DESIGID=C.INT_DESIGID AND A.INT_DESIGID="+desigid;
