...
<%
	...
	try
	{
		...
		sql="select m_staff.CHR_EMPID,m_staff.CHR_STAFFNAME,m_advance.Chr_Month,m_advance.Int_year,m_advance.Int_Advamt,m_desig.CHR_DESIGNAME from m_staff,m_advance,m_desig WHERE m_advance.Chr_Month='"+month+"' and m_advance.Int_year="+year+" and m_desig.CHR_DESIGNAME='"+des+"'";
...
<table width="1000">
	...
	<tr>
		...
		<table width="818" border="1" cellpadding="0" cellspacing="1">
			<!--DWLayoutTable-->
			<tr>
				<td height="39" colspan="8" align="center" valign="middle">DesignationWise
				Recovery View</td>
			</tr>
			<tr>
				...
				<div align="center">Designation Name</div>
				</td>
				<td width="110">
...
%>
			<tr>
				...
				<% out.println(rs.getString("Int_year")); %> </span></td>
				<td align="center" valign="top""><span class="style54 style52">
