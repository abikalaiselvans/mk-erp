...
<title> :: PAYROLL ::</title>
	...
	<jsp:text>
		<![CDATA[
		    <center>
  			<a href='ReportViewMBFView.jsp'> Full View </a>
  			&nbsp;&nbsp;
     		<a href='../Mainscreen.jsp' target='_self'> Home </a>
  			&nbsp;&nbsp;
      		<a href="MessBill%20Details.jsp"> Back </a>
      		&nbsp;&nbsp;
	...
	<display:table name="results" pagesize="10" export="true"
		...
		<display:column property="loginDate" title="Cheque No" />
		<display:column property="inTime" title="Amount" />
	</display:table>
	<jsp:text>
		<![CDATA[		      
     		<a href='ReportViewMBFView.jsp'> FullView </a>
  			&nbsp;&nbsp;
