...
<title> :: PAYROLL ::</title>
	...
	<jsp:text>
		<![CDATA[
		    <center>
  			<a href='ReportViewSalaryPFESIFull.jsp'> Full View </a>
  			&nbsp;&nbsp;
     		<a href='../Mainscreen.jsp' target='_self'> Home </a>
  			&nbsp;&nbsp;
      		<a href="PayBill%20Details.jsp"> Back </a>
      		&nbsp;&nbsp;
	...
	<display:table name="results" pagesize="15" export="true"
		...
		<display:column property="empId" title="SNO" sortable="true"
			headerClass="sortable" />
		<display:column property="empName" title=" EmpId " sortable="true"
			headerClass="sortable" />
		<display:column property="present" title=" Emp Name " sortable="true" />
		<display:column property="absent" title="BasicSalary" />
		<display:column property="leave" title="WDays" />
		<display:column property="od" title=" E/LD " />
		<display:column property="late" title=" E/LPay " />
		<display:column property="day1" title="Late" />

		<display:column property="day2" title="Allow" href="ReportSalary.jsp"
			paramId="empId" paramProperty="empName" />
		<display:column property="day3" title="GPay" />
		<display:column property="day4" title="Recv" />
		<display:column property="day5" title="PF" />
		<display:column property="day6" title="ESI" />
		<display:column property="day7" title="Mess" />
		<display:column property="day8" title="AdvTotal" />
		<display:column property="day9" title="AdvDec" />
		<display:column property="day10" title="AdvLeft" />
		<display:column property="day11" title="Dect" />
		<display:column property="day12" title="NetPay" />
	...
	<jsp:text>
		<![CDATA[
     		<br>	      
     		<a href='ReportViewSalaryPFESIFull.jsp'> FullView </a>
  			&nbsp;&nbsp;
