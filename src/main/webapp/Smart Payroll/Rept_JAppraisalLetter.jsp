				...
				<tr>
					...
					<table width="280" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >Appraisal Letter </td>
						</tr>
						<tr>
  ...
  <select name="reportType" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
						...
						<tr>
						  ...
						  <td valign="middle"><input type="hidden" name="filename" value="Rept_JAppraisalLetter" />
                            <input type="hidden" name="actionS" value="PAYRept_JAppraisalLetter" />
                            <input name="staffid" type="hidden" id="staffid" value=<%=request.getParameter("staffid")%> />
                            <input name="month" type="hidden" id="month" value=<%=request.getParameter("month")%> />
                            <input name="year" type="hidden" id="year" value=<%=request.getParameter("year")%> />
                            <input name="apparaisalid" type="hidden" id="apparaisalid" value=<%=request.getParameter("apparaisalid")%> />
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JAppraisalLetter" />
                          <input name="subrptfilename1" type="hidden" id="subrptfilename1" value="Rept_JAppraisalLetterSub1" /></td>
					  </tr>
						<tr>
