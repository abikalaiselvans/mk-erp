				...
				<tr>
					...
					<table width="300" height="329" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="3" class="BackGround" >ESI Form 6-1  </td>
						</tr>
						<tr>
						...
						<tr>
						  <td valign="middle" height="19" class="bold1"><span class="boldEleven">
						    <input name="filename" type="hidden" id="filename"
										value="Rept_JESIForm_6_1">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JESIForm_6_1">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JESIFormNew-6-1">
						  </span></td>
