...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="../SmartLoginAuth" onSubmit="return Validate()">
		  <img height="7"
						src="../Image/Smart Inventory/TRCorner.gif" width="7" />
				...
				<tr>
					...
					<table width="300" height="329" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="3" class="BackGround" >ESI Form 6-3  </td>
						</tr>
						<tr>
...
<select name="branch" id="branch" class="formText135"  style="width:150px">
	<option value="0">All</option>
						...
						<tr align="center" valign="middle">
							...
							<td colspan="2" align="left" valign="middle" class="boldEleven"><span
								class="bolddeepblue"> 
<%
	...
	for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr align="center" valign="middle">
						  <td  height="28" align="left" valign="middle" class="boldEleven">Department   <span class="bolddeepred">*</span></td>
						  <td colspan="2" align="left" valign="middle" class="boldEleven"><span class="bolddeepblue">
						    <select name="department" class="formText135" id="department" style="width:150px">
						      <option value="0">All </option>
						      <%
String department[][] =  CommonFunctions.QueryExecute(" select INT_DEPARTID,CHR_DEPARTNAME from  com_m_depart  order by CHR_DEPARTNAME");
	for(int u=0; u<department.length; u++)
			out.print("<option value='"+department[u][0]+"'>"+department[u][1] +"</option>");
							%>
					      </select>
						  </span></td>
					  </tr>
						<tr align="center" valign="middle">
						  <td  height="28" align="left" valign="middle" class="boldEleven">Category  <span class="bolddeepred">*</span></td>
						  <td colspan="2" align="left" valign="middle" class="boldEleven"><span class="bolddeepblue">
						    <select name="Category" class="formText135" id="Category" style="width:150px">
						      <option value="0">All[ It's take time]</option>
						      <%
String Category[][] =  CommonFunctions.QueryExecute(" select INT_EMPLOYEECATEGORYID,CHR_CATEGORYNAME from  com_m_employeecategory  order by CHR_CATEGORYNAME");
	for(int u=0; u<Category.length; u++)
			out.print("<option value='"+Category[u][0]+"'>"+Category[u][1] +"</option>");
						...
						<tr align="center" valign="middle">
                          <td  height="28" align="left" valign="middle" class="boldEleven">Month <span class="bolddeepred">*</span> </td>
						  <td width="132" align="left" valign="middle" class="boldEleven"><input name="type" type="radio" value="O" checked>
					      OCT-MAR</td>
						  <td width="156" align="left" valign="middle" class="boldEleven"><input name="type" type="radio" value="A">
					      APRIL-SEP</td>
					  </tr>
						<tr>
							<td valign="middle" height="28" class="boldEleven">Year <span class="bolddeepred">*</span> </td>
							<td colspan="2" valign="middle" class="boldEleven"><%@ include
						...
						<tr>
						  <td valign="middle" height="19" class="bold1"><span class="boldEleven">
						    <input name="filename" type="hidden" id="filename"
										value="Rept_JESIForm_6_3">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JESIForm_6_3">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JESI_NewForm6-3">
						  </span></td>
						  <td colspan="2" valign="middle" class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
					  </tr>
						<tr>
