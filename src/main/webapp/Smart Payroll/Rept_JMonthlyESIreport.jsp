...
<table width="900" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<table width="300" border="0" align="center" cellpadding="0"
						...
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >Monthly
							ESI Report</td>
						</tr>
						<tr>
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				//-->
						...
						<tr>
						  <td valign="middle" height="28" class="bolddeepred"><span class="boldEleven">Export Type</span> *  </td>
  ...
  <select name="reportType" id="reportType" style="width:150px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
						...
						<tr>
						  <td valign="middle" height="19" class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JESIMonthly">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JESIMonthly">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JESIMonthly"></td>
