...
<script language="javascript">
	...
	function Validate()
  {
  	...
  	if(checkNullSelect('Month','Select Month','0') && checkNullSelect( "reportType","Select Export Type" ,'0') )	
		return true;
	else
	return false;
}
				...
				<tr>
					...
					<table width="328" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">NEW JOINNER MONTHWISE LIST </td>
						</tr>
	...
	%>
						...
						<tr align="center" valign="middle">
                          <td height="28" align="left" valign="middle"
								class="boldEleven"><span class="style3">Month</span> <span class="bolddeepred">*</span> </td>
						  <td align="left" valign="middle" class="boldEleven"><%@ include file="../JavaScript/month.jsp"%></td>
					  </tr>
						<tr align="center" valign="middle">
						  <td height="28" align="left" valign="middle"
								class="boldEleven"><span class="style3">Day</span> <span class="bolddeepred">*</span> </td>
						...
						<tr class="bolddeepblue">
						  <td height="23" colspan="2" valign="middle" class="style3"><span class="boldEleven">
						    <input name="filename" type="hidden" id="filename"
										value="Rept_JNewJoinerMonthwiseList">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JNewJoinerMonthwiseList">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JNewJoinerMonthWiseList">
						  </span></td>
						</tr>
						<tr>
