				...
				<tr>
					...
					<table width="150" border="0" align="center" cellpadding="2" cellspacing="2"
						...
						<tr class="bolddeepblue">
						  <td height="24" colspan="2" valign="middle" class="style3"><a href="Rept_JNewJoinerDatewise.jsp" class="bold">Date Wise </a></td>
					  </tr>
						<tr class="bolddeepblue">
							<td height="24" colspan="2" valign="middle" class="style3"><a href="Rept_JNewJoinerMonthwise.jsp" class="bold">Month Wise</a> 							</td>
						</tr>
						<tr>
