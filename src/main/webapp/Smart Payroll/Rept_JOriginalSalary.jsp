...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
			...
			<tbody>
				...
				<tr>
					...
					<td width="412">
					<table width="369" height="317" border="0" cellpadding="2" cellspacing="0"
						 >
						<!--DWLayoutTable-->
						...
						<tr>
						<td width="125" height="28" valign="middle" class="boldEleven">
							Company <span class="bolddeepred">*</span> </td>
							<td width="228"><select name="company" id="company"
								onBlur="loadBranch()" 
 			   ...
 			   %>
						...
						<tr>
							...
							<td width="228"><select name="branch" id="branch"
								class="formText135" style="width:200px">
						...
						<tr class="bolddeepblue">
							<td width="125" height="24" valign="middle" class="style3"><span class="boldEleven">Office</span> <span class="bolddeepred">*</span> </td>
							<td width="228" valign="top" class="bolddeepblue">
							<%
	...
	%>
						...
						<tr>
								  <td height="27" class="boldEleven">Category <span class="bolddeepred">*</span> </td>
	...
	if (empcategoryData.length>0)
		for (int i=0; i<empcategoryData.length; i++) 
			out.println("<option value="+empcategoryData[i][0]+">"+empcategoryData[i][1] +"</option>");			
						...
						<tr class="bolddeepblue">
							<td height="24" valign="middle" class="style3"><span class="boldEleven">Order
							By</span> <span class="bolddeepred">*</span> </td>
						...
						<tr>
							<td height="28" colspan="2" valign="middle" class="bolddeepblue"><span class="boldEleven">
							  <input name="filename" type="hidden" id="filename"
										value="Rept_JOriginalSalary">
                              <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JOriginalSalary">
                              <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JOriginalSalaryInfo">
                            </span></td>
						</tr>
						<tr>
