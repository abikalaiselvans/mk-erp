...
function Validate()
{
	...
	if(checkNullSelect( "company","Select Company" ,'0') && checkNullSelect('Month','Select Month','0') 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  >
        ...
        <tr align="center" valign="middle"> 
          <td height="30" colspan="2" class="BackGround" > FORM 10 </td>
        </tr>
		<tr>
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
                ...
                <tr align="center" valign="middle"> 
          <td width="162"  height="28" align="left" valign="middle" class="boldEleven">Month <span class="bolddeepred">*</span> </td>
  ...
  <select name="reportType" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
        ...
        <tr>
          <td  valign="middle"  height="28"  class="boldEleven"><!--DWLayoutEmptyCell-->&nbsp;</td>
          <td valign="middle" class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JPFForm_10">
            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JPFForm_10">
            <input name="rptfilename" type="hidden" id="rptfilename" value="PF_Form-10">
            <input name="subRptfilename1" type="hidden" id="subRptfilename1" value="PF_Form-10_subreport1"></td>
        </tr>
        <tr> 
