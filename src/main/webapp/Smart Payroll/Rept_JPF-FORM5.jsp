...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  >
        ...
        <tr align="center" valign="middle"> 
          <td height="29" colspan="2" class="BackGround" > FORM 5 </td>
        </tr>
        <tr>
  ...
  <select name="reportType" id="reportType" style="width:170px;" >
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
        ...
        <tr>
          <td  valign="middle"  height="19"  class="bold1"><!--DWLayoutEmptyCell-->&nbsp;</td>
        ...
        <tr> 
          ...
          <tr>
            ...
            <td height="6"><spacer height="1" width="1" type="block" /> <span class="boldEleven">
              <input name="filename" type="hidden" id="filename"
										value="Rept_JPFForm_5">
              <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JPFForm_5">
              <input name="rptfilename" type="hidden" id="rptfilename" value="PF_Form-5">
              <input name="subRptfilename1" type="hidden" id="subRptfilename1" value="PF_Form-5_subreport1">
            </span></td>
