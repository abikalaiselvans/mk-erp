	...
	for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr>
						  <td valign="middle" height="28" class="boldEleven">Department <span class="bolddeepred">*</span></td>
						  <td valign="middle" class="boldEleven"><span class="bolddeepblue">
...
String department[][] =  CommonFunctions.QueryExecute(" select INT_DEPARTID,CHR_DEPARTNAME from  com_m_depart  order by CHR_DEPARTNAME");
	for(int u=0; u<department.length; u++)
			out.print("<option value='"+department[u][0]+"'>"+department[u][1] +"</option>");
						...
						<tr>
						  <td valign="middle" height="28" class="boldEleven">Category <span class="bolddeepred">*</span></td>
						  <td valign="middle" class="boldEleven"><span class="bolddeepblue">
						...
						<tr>
						  <td valign="middle" height="19" class="bold1"><span class="boldEleven">
						    <input name="filename" type="hidden" id="filename"
										value="Rept_JPF_AnnualReturn">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JPF_AnnualReturn">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JPF_AnnualReturn">
                          </span></td>
