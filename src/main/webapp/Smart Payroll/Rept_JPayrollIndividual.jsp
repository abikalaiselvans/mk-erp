...
<script language="javascript">
 function Validate()
  {
  	if(checkNull("ename","Select Staff")&& checkNullSelect("Month","Select Month","0")&& checkNullSelect("Year","Select Year","0") && checkNullSelect( "reportType","Select Export Type" ,'0'))
		return true;
	else
		return false;
  }
...
<table width="108%" height="412" border="0" align="center"
			...
			<tbody>
					...
					<table width="400" height="124" border="0" align="center"
						...
						<tr>
							...
							<table width="92%" border="0" align="center" cellpadding="3"
								cellspacing="2">
								<tr>
									<td width="30%" class="boldEleven"><span class="style13">Month </span><span class="bolddeepred">*</span> </td>
								...
								<tr>
									<td class="boldEleven"><span class="style13">Year </span><span class="bolddeepred">*</span> </td>
				...
				//-->
									...
									<span class="style13"><font size="1"><strong><font
										...
										color="#000000"><font size="1"><span class="style11" width="97"><font size="1"><strong><font
										color="#000000"><font size="1"><strong><font
										color="#000000"><font size="1">
									<input
										type="hidden" name="filename" value="Rept_JPaySlip" />
									</font></font></strong></font></font></strong></font></span><strong><font
										color="#000000"><font size="1"><span class="style11" width="97"><font size="1"><strong><font
										color="#000000"><font size="1"><strong><font
										color="#000000"><font size="1"><strong><font
										color="#000000"><font size="1">
									<input
										type="hidden" name="actionS" value="PAYRept_JPaySlip" />
									</font></font></strong></font></font></strong></font></font></strong></font></span><strong><font
										color="#000000"><font size="1"><strong><font
										color="#000000"><font size="1"><strong><font
										color="#000000"><font size="1">
									<input name="rptfilename"
										type="hidden" id="rptfilename" value="Rept_JPaySlp_new7" />
								...
								<tr>
								  ...
								  <td colspan="2" class="boldEleven"><select name="reportType" id="reportType">
