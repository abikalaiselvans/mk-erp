...
</script><%@ include file="../JavaScript/dynamicStylesheet.jsp" %></head>
...
<table width="124%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td height="200">
		<table class="BackGround" cellspacing="0" cellpadding="0" width="320"
				...
				<tr>
					...
					<table width="99%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround">RESIGNNER LIST </td>
						</tr>
						...
						<tr class="bolddeepblue">
							<td width="114" height="23" valign="middle" class="boldEleven"><span class="style4">Office</span> <span class="bolddeepred">*</span> </td>
							<td width="177" valign="top" class="boldEleven">
							<%
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven"><span class="style4">Department</span> <span class="bolddeepred">*</span> </td>
	...
	%>
						...
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven"><span class="style4">Order by</span>	<span class="bolddeepred">*</span> </td>
							<td valign="top" class="boldEleven"><select name="orderby"
								class="formText135" id="orderby" style="width:170px;">
								<option value="a.CHR_STAFFNAME">Staff Name</option>
								<option value="b.DT_TERM_DATE">Joinning Date</option>
							</select></td>
						</tr>
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven"><span class="style4">From</span> <span class="bolddeepred">*</span> </td>
							<td valign="top" class="boldEleven"><input name="frmdate"
								type="text" class="formText135" id="frmdate"
								onKeyPress="dateOnly('frmdate')" size="15">  </td>
						</tr>
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven"><span class="style4">To</span> <span class="bolddeepred">*</span> </td>
							<td valign="top" class="boldEleven"><input name="todate"
								type="text" class="formText135" id="todate"
								onKeyPress="dateOnly('todate')" size="15">  
<script language="JavaScript">			
			...
			setCurrentDate('todate');			
						...
						<tr class="bolddeepblue">
						  <td height="22" valign="middle" class="boldEleven"><span class="style4">Export Type</span> <span class="bolddeepred">*</span> </td>
    ...
    <option value="xml" title="../DropDown - Image/icons/xml.jpg">Xml </option>
						...
						<tr class="bolddeepblue">
						  ...
						  <td valign="top" class="boldEleven"><input name="filename" type="hidden" id="filename"
										value="Rept_JResignedEmpList">
                            <input name="actionS"
										type="hidden" id="actionS"
										value="PAYRept_JResignedEmpList">
                            <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JResignnerInfo"></td>
					  </tr>
						<tr>
