...
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="RivisionReportResponse.jsp"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
		<table width="376" height="283" border="0"
			...
			<tbody>
				...
				<tr>
					...
					<table width="351" height="266" border="0" align="center" cellpadding="0"
						cellspacing="0"  >
						<!--DWLayoutTable-->
						<tr align="center" valign="middle">
							<td height="30" colspan="2" class="BackGround" >Revision Report</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="105" height="28" valign="middle" class="boldEleven">							<span class="style5">Company</span> <span class="bolddeepred">*</span> </td>
							<td width="231">
 			   ...
 			   %>
						...
						<tr>
							<td width="105" height="28" valign="middle" class="boldEleven">
							<span class="style4">Branch</span> <span class="bolddeepred">*</span> </td>
							<td width="231"><select name="branch" id="branch"
								class="formText135" style="width:200px">
								<option value="0">All</option>
						  </select></td>
						</tr>
						<tr align="center" valign="middle">
							<td height="28" align="left" valign="middle" class="boldEleven"><span class="style5">Office</span> <span class="bolddeepred">*</span> </td>
		...
		for(int u=0; u<shipids.length; u++)
			if(shipids[u][0].trim().equals(oficeid.trim()))
				...
				out.print("<option value='"+shipids[u][0]+"'>"+shipids[u][1] +"</option>");
						...
						<tr align="center" valign="middle">
							<td width="105" height="28" align="left" valign="middle"
								class="boldEleven"><span class="style5">Month</span> <span class="bolddeepred">*</span> </td>
							<td width="231" align="left" valign="middle" class="boldEleven">
						  <%@ include file="../JavaScript/month.jsp"%></td>
						</tr>
						<tr>
							<td valign="middle" height="28" class="boldEleven"><span class="style5">Year</span> <span class="bolddeepred">*</span> </td>
				...
				//-->
						...
						<tr>
						  <td valign="middle" height="28" class="boldEleven"><span class="style5">Export Type</span> <span class="bolddeepred" >*</span> </td>
