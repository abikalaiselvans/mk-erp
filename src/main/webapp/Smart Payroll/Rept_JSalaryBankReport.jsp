	...
	if (empcategoryData.length>0)
		for (int i=0; i<empcategoryData.length; i++) 
			out.println("<option value="+empcategoryData[i][0]+">"+empcategoryData[i][1] +"</option>");			
						...
						<tr class="bolddeepblue">
							<td width="158" height="22" valign="middle" class="boldEleven">Month <span class="bolddeepred">*</span> </td>
							<td width="288" valign="top" class="bolddeepblue"><%@ include file="../JavaScript/month.jsp"%>&nbsp;</td>
						</tr>
						<tr>
							<td class="boldEleven">Year <span class="bolddeepred">*</span> </td>
						    <td><%@ include
				...
				//-->
								...
								value="Rept_JSalaryBankStatement" /> 
          <input name="actionS" type="hidden"
								id="actionS" value="PAYSalaryBankReport" />
          </span><span class="boldEleven">
          <input name="rptfilename" type="hidden" id="rptfilename" value="Rept_JTransSalaryBankStatement">
          </span></td>
						</tr>
						<tr>
