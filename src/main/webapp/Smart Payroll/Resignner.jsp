...
-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="ResignnerResponse.jsp">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
							<td height="18" colspan="2"  class="BackGround"><p>RESIGNED LIST </p> 
						    </td>
						</tr>

						<tr class="bolddeepblue">
							<td width="132" height="23" valign="middle" class="boldEleven">Office</td>
							<td width="268" valign="top" class="boldEleven">
							<%
	...
	%>
						...
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven">Order by
							</td>
							<td valign="top" class="boldEleven"><select name="orderby"
								...
								<option value="b.DT_TERM_DATE">Resigned Date</option>
								 
							</select></td>
						</tr>
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven">From</td>
							<td valign="top" class="boldEleven">
                            <input name="frmdate" type="text" class="formText135" id="frmdate"  readonly="readonly" size="15">  </td>
						</tr>
						<tr class="bolddeepblue">
							<td height="22" valign="middle" class="boldEleven">To</td>
							<td valign="top" class="boldEleven">
                            <input name="todate" type="text" class="formText135" id="todate" readonly="readonly"  size="15">  
