...
-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="SalaryReportResponse1.jsp" onSubmit="return  validate()">
					...
					<table width="600" border="0" cellspacing="2" cellpadding="2"
						...
						<tr align="center" valign="middle">
						  <td height="18" colspan="2"  class="BackGround">Salary
							...
							out.println(reqmonth);
							%> &nbsp;&nbsp;
							<label>Check All
							<input id="chall" name="chall"  type="checkbox"  onClick="checkAll()">
							<script language="javascript">
							function checkAll() {
...
<select name="type"   id="type"  class="formText135" style="width:200px">
	<option value="0">All</option>
	 ...
	 <option value="2">WITHOUT CONSOLIDATE EMPLOYEE</option>
						...
						<tr>
							...
							<td><select name="year"  id="year" class="formText135" style="width:200px">
								<option value="0">Select</option>
		   ...
		   <input name="filename" type="hidden" id="filename"
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td><input name="ctc" type="checkbox" id="ctc" value="Y" checked></td>
					...
					%>									
						...
						for(int a=0;a<rname.length;a++)
						{
							...
							i=i+1;	
							if(rname[a][0].equals("Advance"))
								out.println("<td  class=\"boldEleven\"><input type=\"checkbox\" name=\"Rcheckbox\" checked value=\""+rname[a][0]+"\">"+rname[a][1] +"</td>");
							else
								out.println("<td  class=\"boldEleven\"><input type=\"checkbox\" name=\"Rcheckbox\"   value=\""+rname[a][0]+"\">"+rname[a][1]+"</td>");
						}
 						out.println("</table>");
					%>									</td>
								</tr>
