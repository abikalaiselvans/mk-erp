...
-->
<form  AUTOCOMPLETE = "off"   name="frm" method="post" action="SalaryBankReportResponse.jsp" onSubmit="return validate()">
		...
		for (int i=0; i<empcategoryData.length; i++) 
			out.println("<option value="+empcategoryData[i][0]+">"+empcategoryData[i][1] +"</option>");			
				...
				//-->
						...
						<tr>
							<td height="28" colspan="2" valign="middle" class="bolddeepblue"><!--DWLayoutEmptyCell-->&nbsp;
							</td>
						</tr>
						<tr>
