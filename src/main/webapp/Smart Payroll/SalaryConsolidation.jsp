...
function validate()
{
	if(checkNullSelect('Month','Select Month','0')  && checkNullSelect('Year','Select Month','0')    )
		return true;
	else
		return false;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form  AUTOCOMPLETE = "off"   method="post" action="SalaryConsolidationResponse.jsp" onSubmit="return validate()" >
            ...
            <tr>
              ...
              <td width="412"><table width="455" border="0" align="center" cellpadding="0"
                  ...
                  <tr align="center" valign="middle">
                    <td height="30" colspan="2" class="BackGround">SALARY CONSOLIDATION </td>
                  </tr>
                  <tr>
