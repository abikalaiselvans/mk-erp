...
<form action="SalaryIssueReportResponse.jsp" method="post"   name="salfrm" onSubmit="return validate()"  AUTOCOMPLETE = "off">
<p>&nbsp;</p>
		...
		for (int i=0; i<empcategoryData.length; i++) 
			out.println("<option value="+empcategoryData[i][0]+">"+empcategoryData[i][1] +"</option>");			
						...
						%>
								...
								<tr>
									<td class="boldEleven">Select Month <span
									class="bolddeepred">*</span></td>
									<td>
								...
								<tr>
									<td class="boldEleven">Select Year <span
									class="bolddeepred">*</span></td>
