...
<%
	...
	sql = sql + " a.CHR_STAFFNAME,d.CHR_OFFICENAME, "; //b.CHR_COMPANYNAME,c.CHR_BRANCHNAME,e.CHR_DEPARTNAME,f.CHR_CATEGORYNAME,a.CHR_TYPE,
	...
	sql = sql + " g.DOU_ADVANCE,g.DOU_TOTALRECOVERY,g.DOU_MONTHSAL, ";//g.DOU_MESS,g.DOU_NETSAL,
	sql = sql + " FIND_A_BANKGROUP_NAME(a.CHR_BANK),CONCAT('A/c No . ', a.CHR_ACCNO) ";//g.DOU_CPYPF1,g.DOU_CPYPF2,g.DOU_CPYESI,g.DOU_CTC,
	sql = sql + " ,'"+repmon+"' ,'"+year+"' ";
	...
	sql = sql + "  GROUP BY a.CHR_STAFFNAME  ";
	//out.println(sql);
...
sql = " S.NO,EMP ID, STAFF NAME,OFFICE, ";//COMPANY,BRANCH, ,DEPARTMENT,CATEGORY,STAFF TYPE,
sql = sql+ " NO-OF-WORKING DAYS,BASIC, GROSS ALLOWANCE,OTHER ALLOWANCE,GROSS PAY , ";//"+allowancename+"
sql = sql+  "TOTAL RECOVERY,   PROFESSIONAL TAX ,  "; // PF/ESI DOJ,  PF NUMBER, PF AMOUNT,ESI NUMBER,ESI AMOUNT, recoveryname +
sql = sql+ "ADVANCE,TOTAL RECOVERY,MONTH SALARY, ";//  NET SALARY,MESS,COMPANY PF -1, COMPANY PF -2, COMPANY ESI,CTC, 
