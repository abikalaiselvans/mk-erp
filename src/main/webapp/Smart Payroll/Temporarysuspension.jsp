...
<script language="javascript" src="../JavaScript/Payroll/Temporarysuspension.js"></script> 
<script language="javascript">
	...
	function Add()
 	{		
		document.frm.action="TemporarysuspensionAdd.jsp";		
 	}		
	...
	<tr>
		...
		<table width="90%" height="120" align="center"
			...
			<tr align="center" valign="middle"  >
				<td height="28"    
					class="whiteHead">TEMPORARY SUSPENSION </td>
			</tr>
 ...
 %>
	...
	<tr>
		<td height="17"><input name="filename" type="hidden"
			id="filename" value="Temporarysuspension"> 
		<input name="actionS"
			type="hidden" id="actionS" value="PAYTemporarysuspensionDelete"></td>
	</tr>
	<tr>
		<td height="17">
