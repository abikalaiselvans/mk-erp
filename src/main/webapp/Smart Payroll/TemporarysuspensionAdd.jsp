 ...
 function Validate()
  {
  	if(
		...
		&& checkNull("authorisedby","Select Authorised By ...")
		&& checkNull("low","Enter the Last Working Day...")
	)
		return true;
	else
		return false;
		...
		<table class="BackGround" cellspacing="0" cellpadding="0" width="500"
			...
			<tbody>
				...
				<tr>
					...
					<table width="100%" height="124" border="0" align="center"
						...
						<tr align="center" valign="middle">
							...
							<div align="center">Temporary suspension </div>
							</td>
						</tr>
						<tr align="center" valign="middle">
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="3"
								cellspacing="2">
								<tr>
									<td width="36%" class="boldEleven"><span class="style13">Month</span><span class="boldred"> *</span> </td>
									<td width="31%" class="boldEleven"><%@ include
				...
				//-->
									...
									<strong><font
										color="#000000"><font size="1"> <input
										type="hidden" name="actionS" value="PAYTemporarysuspensionAdd" />
									</font></font></strong></font></font></strong></font></font></strong></font></span></span></td>
								</tr>
								<tr>
								  <td class="boldEleven">Last Working day<span class="boldred"> *</span> </td>
								  <td colspan="2" class="boldEleven"><input title="dd/mm/yyyy" name="low"  id="low"  type="text" class="formText135" size="15" maxlength="10"  readonly="readonly"/><script language="JavaScript" type="text/javascript">setCurrentDate('low'); </script></td>
							  </tr>
								<tr>
								  <td class="boldEleven">Authorised By <span class="boldred"> *</span></td>
								  <td colspan="2" class="boldEleven"><select name="authorisedby" id="authorisedby" class="formText135" size="5">
										<option value="">Select</option>
										<%
										 
	String empdata[][]= CommonFunctions.QueryExecute("SELECT UPPER(CHR_EMPID),CHR_STAFFNAME  FROM com_m_staff  WHERE   CHR_HOLD!='Y'  AND CHR_TYPE!='T' AND CHR_REP='Y' ORDER BY CHR_STAFFNAME");
...
%>
								...
								<tr>
								  <td class="boldEleven">Description<span class="boldred"> *</span>
								  <p>&nbsp;</p></td><td colspan="2" class="boldEleven"><textarea name="description" cols="25"
							...
							<table border="0" align="center" cellpadding="3" cellspacing="3">
								<tr>
									...
									<td width="56"><input name="Button" type="Button"
										...
										onClick="redirect('Temporarysuspension.jsp')"></td>
								</tr>
							</table>
							</td>
						</tr>
