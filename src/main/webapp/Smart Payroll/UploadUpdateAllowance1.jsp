...
<script language="javascript">
    function Validate()
  		...
  		if(
			...
			&& checkNull('sheetname','Enter the Sheet name')
...
<form name="frm" enctype="multipart/form-data" action="UploadUpdateAllowanceCopy1.jsp" method="post" onSubmit="return Validate()">
...
<table class="BackGround" cellspacing="0" cellpadding="0" width="390"
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="412"><table width="500" border="0" cellspacing="2" cellpadding="2"
        ...
        <tr align="center" valign="middle">
          <td height="18" colspan="2"  class="BackGround">UPLOAD ALLOWANCE </td>
        </tr>
        <tr>
	...
	String allowanceData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(allowanceSql);
	if (allowanceData.length>0)
        ...
        <tr class="bolddeepblue">
		  ...
		  <span class="boldEleven">UploadUpdate</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="file" name="file" id="file"  />
            ...
            <input name="actionS" type="hidden" id="actionS" value="PAYUploadUpdateAllowance"></td>
        </tr>
         <tr>
          <td class="boldEleven">Sheet Name</td>
          <td><input name="sheetname" type="text" class="boldEleven" id="sheetname" maxlength="15"></td>
        </tr>
        <tr>
