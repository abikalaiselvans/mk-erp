...
<form  AUTOCOMPLETE = "off"   method="post" action="YearView.jsp">
...
<table width="1002">
	...
	<tr>
		...
		<table align="center" border="1">
			<!--DWLayoutTable-->
			<tr align="center">
				<td height="26" colspan="7" valign="top">Allowance Details
				YearWise</td>
			</tr>
			<tr>
				<td height="32" colspan="4" align="center" valign="middle"
					class="style8">Select Year</td>
				<td colspan="3" valign="top"><select name="year">
			...
			<tr>
				<td width="93" height="74" valign="top"><a href="../Home.jsp"><img
