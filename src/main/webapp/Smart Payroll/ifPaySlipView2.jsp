...
try
{
	...
	boolean f=CommonFunction.RecordExist(psql);
	 
	if(f)
	{
		out.println("<br><br><center>Please contact to reporting head...</center>");
	}
	else
	{
        ...
        <table width="700"  border=1 align="center"  cellpadding=3 cellspacing=1 
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="boldThirteen"><div align="center">EMPLOYEE NAME:: <%=staffname%></div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="3" class="boldEleven"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="boldEleven"><strong>Employee ID </strong></td>
                          <td class="boldEleven"><%=staffid%></td>
                          <td class="boldEleven">&nbsp;</td>
                          <td class="boldEleven"><strong>Bank Name </strong></td>
                          <td width="4%" class="boldEleven"><%=bank.split("-")[0]%></td>
                          <td width="1%" class="boldEleven">&nbsp;</td>
                          <td width="25%" class="boldEleven"><strong>Account  No </strong></td>
                          <td width="4%" class="boldEleven"><%=bank.split("-")[1]%></td>
                        </tr>
                        <tr>
                          <td class="boldEleven"><strong>Designation</strong></td>
                          <td class="boldEleven"><%=desig%></td>
                          <td class="boldEleven">&nbsp;</td>
                          <td class="boldEleven"><strong>PF Number</strong></td>
                          <td class="boldEleven"><%=basicdata[0][9]+basicdata[0][6]%></td>
                          <td class="boldEleven">&nbsp;</td>
                          <td class="boldEleven"><strong>UAN Number </strong></td>
                          <td class="boldEleven">&nbsp;</td>
                        </tr>
                        <tr>
                          <td width="21%" class="boldEleven"><strong>Location</strong></td>
                          <td width="27%" class="boldEleven"><%=office%></td>
                          <td width="4%" class="boldEleven">&nbsp;</td>
                          <td width="14%" class="boldEleven"><strong>ESI
                            Number </strong></td>
                          <td colspan="4" class="boldEleven"><%=basicdata[0][7]%></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          %>                          </td>
                          <td class="boldEleven">&nbsp;</td>
                          <td colspan="5" valign="top" class="boldEleven">
                          <%
