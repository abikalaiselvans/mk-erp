...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="header"  class="headerImgBackground" > 
  ...
  <tr>
    <td><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
          <tr   class="" >
            <td width="258" height="25" align="center" valign="middle"><span class="boldgre"> PAYROLL </span></td>
...
%>
  ...
  <tr   class="headerBackground" >
    <td height="27"   class="headerBackground"   id="menutd"><%@ include file="payroll_menu.jsp"%></td>
  </tr>
</table>
