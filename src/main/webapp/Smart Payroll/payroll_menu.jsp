...
<table width="100" >
	<tr>
		...
		<!-- menu script itself. you should not modify this file --> <script
			language="JavaScript" src="../JavaScript/menu.js"></script> 
			<script language="JavaScript">
...
<% 	
	     ...
	     {		
		     ...
		     str="Select * from  m_menu_payroll  where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
...
var MENU_POS = [{
	...
	// document.getElementById("header").width="<%=twidth%>";
</script></td>
	</tr>
</table>
