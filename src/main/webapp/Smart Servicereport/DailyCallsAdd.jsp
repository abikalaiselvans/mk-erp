...
function validate()
{
	if(
		...
		&& (checkNullSelect('hours','Select hand on hours','0') || checkNullSelect('minutes','Select hand on minutes','0'))
...
//-->
                ...
                <tr>
                  ...
                  <td width="64%" class="boldEleven"><input name="callnumber" type="text" class="formText135" id="callnumber"  tabindex="2" size="50" maxlength="10" onKeyPress="return numeric_only(event,'callnumber','25')"></td>
                  <td width="6%">&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
			...
			%>
                ...
                <tr>
                  ...
                  <td class="boldEleven"><table width="74" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="20" class="boldEleven"><input name="dayclosed" id="dayclosed"  type="radio" value="N" checked  tabindex="14">
                        </td>
                ...
                <tr>
                  <td colspan="4"><table width="120" border="0" align="center" cellpadding="3" cellspacing="4">
                      <tr>
                        <td valign="top"><input type="submit" class="buttonbold13" name="add"  id="add"  value="Add"   accesskey="s"      tabindex="15"/></td>
