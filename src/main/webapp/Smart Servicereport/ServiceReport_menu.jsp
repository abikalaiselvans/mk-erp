...
<% 	
		 ...
		 str="select CHR_MENUSERVICEREPORT from  m_user  where CHR_USRNAME='"+uname+"'" ;
	     rs=st.executeQuery(str); 
	     if(rs.next())
	     {		
	    	 mnuList=rs.getString("CHR_MENUSERVICEREPORT");
		     str="Select * from  m_menu_servicereport    where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
