...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="480"><table width="600" border="0" align="center" cellpadding="0"
      ...
      <tbody>
        ...
        <tr>
          ...
          <td   valign="top"><form action="StaffDailyCallsDaterangeReportResponse.jsp" method="post" name="frm" id="frm">
...
//-->
                ...
                <tr>
                  ...
                  <td class="boldEleven"><input name="tdate" type="text" class="formText135" id="tdate" onKeyPress="numericHypenOnly('tdate',10)" size="12" maxlength="10" readonly="readonly" tabindex="1">
                      <a
