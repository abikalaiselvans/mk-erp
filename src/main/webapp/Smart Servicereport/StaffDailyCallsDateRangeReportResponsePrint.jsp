...
try
{
	...
	out.println("<table width='60%' border='1'  class='boldEleven'  id='myTable'     cellpadding=2 cellspacing=1 bgcolor='#9900CC' >");
	 out.println("<tr class='MRow1'> <td colspan='9' class='boldEleven' ><center><img src=\"../images/logo.jpg\"></center> </b>&nbsp;&nbsp;&nbsp;<center><center> <b>ENGINEER WEEKLY REPORT FOR [ "+CommonFunctions.QueryExecute("SELECT CHR_EMPID,CHR_STAFFNAME FROM  com_m_staff  WHERE CHR_EMPID='"+empid+"'")[0][1]+" ]  FROM : "+fdate+"  TO : "+tdate+"</center> </b></td> </tr>");
