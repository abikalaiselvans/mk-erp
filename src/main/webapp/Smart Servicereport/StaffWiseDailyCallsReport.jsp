	  ...
	  <table width="600" border="0" align="center" cellpadding="0"
        ...
        <tbody>
          ...
          <tr>
            ...
            <td   valign="top"><form action="StaffWiseDailyCallsReportResponse.jsp" method="post" name="frm" id="frm">
...
//-->
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2" class="boldEleven">Date</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="2" class="boldEleven"><jsp:include page="../JavaScript/ajax.jsp" flush="true" />      
                      Date Range </td>
                    <td>&nbsp;</td>
                  </tr>
                  <!--<tr>
