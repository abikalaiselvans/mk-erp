...
try
{
	...
	out.println("<tr class='MRow1'><td  class='boldEleven' ><b><a href='"+plink+"'> <img border='0' src=\"../Image/report/left.png\"> </a></b></td><td colspan='9' class='boldEleven' ><center> <b>ENGINEER WEEKLY REPORT FOR [ "+CommonFunctions.QueryExecute("SELECT CHR_EMPID,CHR_STAFFNAME FROM  com_m_staff  WHERE CHR_EMPID='"+empid+"'")[0][1]+" ] </center> </b></td><td  class='boldEleven' ><b><a href='"+nlink+"'><img  border='0' src=\"../Image/report/right.png\"> </a></b></td></tr>");
...
%> 
 <p> 
 <p align="center"><a href="javascript:Print('StaffWiseDailyCallsReportResponsePrint.jsp?fdate=<%=fdate%>&ename=<%=empid%>')">Print</a>
