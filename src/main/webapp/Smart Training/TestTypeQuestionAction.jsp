...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="document.getElementById('type').focus()" >
		    ...
		    <table width="86%" border="0" align="center" cellpadding="3" cellspacing="3">
              <tr>
                <td colspan="3" class="bold1"><div align="center"> TEST TYPE
				    ...
				    <%
							...
							{
								id="";Name=""; 
								actionS="TRATestTypeQuestionADD";
								value="Add"; 
								  type="0"; 
								  question=""; 
								  answer1=""; 
							...
							else
							{
								...
								sql = " SELECT INT_ROWID,INT_TESTTYPEID,CHR_QUESTION,CHR_ANSWER1,CHR_ANSWER2,CHR_ANSWER3,CHR_ANSWER4,CHR_ACTUAL_ANSWER  FROM internal_training_m_testquestion  WHERE INT_ROWID= "+id;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								id=data[0][0]; 
								actionS="TRATestTypeQuestionEdit";
								  type=data[0][1];
								  question=data[0][2];
								  answer1=data[0][3]; 
								  answer2=data[0][4];
              ...
              <tr>
                ...
                <td width="69%" colspan="2" class="boldEleven"><select name="type" class="formText135" id="type">
                  ...
                  <%
					  sql = " SELECT INT_TESTTYPEID,CHR_TESTNAME,CHR_DESC FROM internal_training_m_testtype ORDER BY CHR_TESTNAME   " ;
				      String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
              ...
              <tr>
                <td valign="top" class="boldEleven">Question<span class="boldred"> * </span></td>
