...
<% 	
		 ...
		 str="select CHR_MENUTRAINING from  m_user  where CHR_USRNAME='"+uname+"'" ;
	     rs=st.executeQuery(str); 
	     if(rs.next())
	     {		
	    	 mnuList=rs.getString("CHR_MENUTRAINING");
		     str="Select * from  m_menu_training  where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
