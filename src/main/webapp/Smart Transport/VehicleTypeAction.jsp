...
<script language="javascript">
 function validate()
  {
  	if(	checkNull('name','Enter  Vehicle Type')	)
		return true;
	else
		return false;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td height="80">
		<% 
		 String vehiclename,sql;
		 String msg,action,actionS;
		 String vechicletypeid="";
				...
				if(action.equals("Add"))
				{
					...
					actionS="TRSVehicleTypeAdd";
					vehiclename="";
					
				}
				else
				{
					vechicletypeid=request.getParameter("id");	
					actionS="TRSVehicleTypeEdit";
					sql="SELECT INT_VEHICLETYPEID,CHR_VEHICLETYPENAME FROM   veh_m_vehicletype  WHERE INT_VEHICLETYPEID="+vechicletypeid;
					String	readData[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
					vechicletypeid=readData[0][0];
					vehiclename=readData[0][1];
			  }
			...
			<tbody>
				...
				<tr>
					...
					<table cellspacing="2" cellpadding="2" width="437" align="center"
						...
						<tbody>
						<tr>
                    <td height="16" colspan="3" align="center" valign="top" class="boldThirteen">VEHICLE TYPE </td>
                  </tr>
					<tr>
                    <td height="19" colspan="3" align="right" valign="top"><span class="bolddeepred">* </span><span class="fairyHead"><span class="changePos">- Mandatory</span> </span> </td>
							...
							<tr>
								<td height="29" valign="middle" class="bolddeepblue">Vehicle Type <span class="bolddeepred">*</span></td>
								<td width="246" valign="top">
<input name="name" 	type="text" class="formText135" id="name" onBlur="TxtTrim(this)" 	onKeyPress="charOnly('name','25')"  
value="<%=vehiclename %>" size="35">
 							  </td>
							</tr>
							...
							<tr>
								<td height="30" colspan="3" valign="top"><input
									type="hidden" name="filename" value="VehicleType" /> <input
									type="hidden" name="actionS" value="<%=actionS %>" /> <input
									type="hidden" name="id" value="<%=vechicletypeid %>" />  
								...
								<table border="0" align="center" cellpadding="1" cellspacing="1">
									<tr>
										...
										<div align="center"><input name="button" type="button"
											...
											onClick="redirect('VehicleType.jsp')">
										</div>										</td>
									</tr>
								</table>
							<td width="2">							</tr>
