...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="header"> 
  ...
  <tr>
    <td><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
          <tr   class="headerBackground" >
            <td width="290" height="25" align="center" valign="middle"><span class="boldgre">UPLOAD/ DOWNLOAD </span></td>
            <td width="330" class="text_0">&nbsp;
			<%
	...
	if( "S".equals(""+session.getAttribute("USRTYPE"))) 
            ...
            <td width="64" align="right"   class="headerBackground" ><div align="center"><span class="bold1">
  ...
  <tr   class="headerBackground" >
    <td height="25"  id="menutd"><%@ include file="upload_menu.jsp"%></td>
  </tr>
</table>
