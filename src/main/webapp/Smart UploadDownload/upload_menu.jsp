...
<jsp:useBean id="conbean1" class="DBConnection.DBCon" />
 ...
 <table width="100%"   class="headerBackground" >
	<tr>
		<td>
...
<% 	
		 ...
		 str="select CHR_MENUUPLOADDOWNLOAD from  m_user  where CHR_USRNAME='"+uname+"'" ;
	     rs=st.executeQuery(str); 
	     if(rs.next())
	     {		
	    	 mnuList=rs.getString("CHR_MENUUPLOADDOWNLOAD");
		     str="Select * from  m_menu_uploaddownload  where  INT_MENUID >0 AND INT_MENUID in ("+mnuList+") order by INT_MENUID";
