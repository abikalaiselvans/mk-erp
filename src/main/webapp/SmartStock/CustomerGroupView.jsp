...
<script language="javascript" src="../JavaScript/Stock/CustomerGroupview.js"></script>
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="LoadCustomerGroup('0')">
<%
try
{
%>
	    ...
	    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
			...
			cellpadding="0" cellspacing="0"  
			 >
              <tr class="BackGround">
                <td height="31" class="BackGround"><div align="center" class="boldThirteen">Customer Group </div></td>
              </tr>
              <tr class="BackGround">
          ...
          <tr>
			...
			cellspacing="1">
              <!--DWLayoutTable-->
              <tr>
                <td width="56" valign="top"><input type="hidden" name="filename" value="CustomerGroup" />
                    <input type="hidden" name="actionS" value="STKCustomerGroupDelete" /></td>
