          ...
          <tr>
			...
			cellpadding="0" cellspacing="0"  
			 >
              ...
              <tr class="BackGround">
                <td class="BackGround"><table width="544" border="0" align="center" cellpadding="2"
					cellspacing="2">
                    <tr>
              ...
              <tr>
                <td height="127" valign="top" class="footermenu"> 
					  <div id="DirectSaleTable" style="OVERFLOW:auto;width:100%;height:150px" class="boldEleven" /> <br>
					  <div align="center" id="totalrecord"></div>
					  <br>                  </td>
              </tr>
            </table></td>
          </tr>
