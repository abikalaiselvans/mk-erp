...
<script type="text/javascript"><!--
	...
	function insRow()
	{
		...
		x.insertCell(3).innerHTML="<input type='text' size=10    onblur='calculateValue(this)' title='Quantity' class='formText135'  name='"+s3+"' id ='"+s3+"' " +vf1+" style='text-align:right'/><div id='"+unitdiv+"'></div>";
		...
		x.insertCell(7).innerHTML="<input type='text' size=10    title='Total' class='formText135'  name='"+s7+"' id ='"+s7+"' " +vf5+"   readonly='readonly' style='text-align:right'/> <input type='hidden' name='"+s8+"' id ='"+s8+"' />";
						...
						<tr>
							...
							<table width="788" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<table>
										<tr>
											<td><input tabindex="0" name="cashpurchaseno" type="text"
												class="formText135" id="cashpurchaseno"
												onkeyup="upperMe(this)"
												    onBlur="upperMe(this)"    
												onKeyPress="" size="30" maxlength="50" /></td>
											<td>
																						</td>
									</table>
									</div>									</td>
		...
		//-->
						...
						<tr>
							...
							<table id="myTable" width="100%" border="0" cellpadding="1"
								...
								<th class="boldEleven">
								<div align="left"><strong>Item Group </strong></div>								</th>
							...
							%>
								...
								<tr>
									...
									<div align="left"><input name="ref" type="text"
										class="formText135" id="ref" size="25" maxlength="20"
										tabindex="10" />
									</div>									</td>
									<td class="boldEleven">
