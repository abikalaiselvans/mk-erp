...
<!--onload="loadCustomer()onLoad="Load()"-->
						...
						<tr>
							...
							<table width="850" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<select name="tax" class="formText135" 			id="tax" onChange="assignTotals(this)" tabindex="13">
							...
							%>
								...
								<tr>
									...
									<input name="param"
										type="hidden" id="param" value='0,' /></div>									</td>
									<td class="boldEleven">
								...
								<tr>
									<td colspan="4" class="boldEleven">
								      ...
								      <input name="Submit2" type="button"
										...
										onclick="redirect('Directsales.jsp')" /></div><div align="center"></div>
									<div align="left"></div>
									<div align="left"></div>									</td>
								</tr>
							</table>
