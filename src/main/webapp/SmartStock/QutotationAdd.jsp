...
function assignValues(ctr,pos) 
{
	...
	var url = "../Stock?actionS=INVItemProductAssignQuotation&group="+escape(group)+"&listid="+listid ;
	initRequest(url);
				...
				<tr>
					...
					<table width="850" border="0" align="center" cellpadding="1"
						...
						<tr>
							...
							</strong><%=session.getAttribute("STKBRANCH")%></div>
							</td>
						</tr>
						<tr>
							<td>
							<table width="673" border="0" align="center" cellpadding="1"
								...
								<tr>
								  <td width="123" class="boldEleven">&nbsp;</td>
									<td width="229" class="boldEleven">&nbsp;</td>
	...
	%>
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr>
									<th class="boldEleven">
										<div align="left"><strong>ItemGroup</strong></div>									</th>
							...
							%>
								...
								<tr>
									...
									<div align="left">Sale Reference <input name="filename"
										type="hidden" value="Qutotation" /> 
									<input name="actionS"
										type="hidden" value="STKQutotationAdd" /> 
									<input name="param"
				  ...
				  <a target="_blank" href="#" onclick="javascript:save() ">ghj</a>-->
								...
								<tr>
									...
									&nbsp;&nbsp; <input name="Submit2" type="button"
										...
										onclick="redirect('Quotation.jsp')" /></div>
