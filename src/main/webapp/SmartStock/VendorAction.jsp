...
function validate()
{
	...
	if( 
		checkNull("vendorname","Enter Vendor Name")
		...
		&& chkemail('email')
		&& checkNullSelect("vendorgroupid","Select Vendor Group ","0")
...
<body  onpaste="return false;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="document.getElementById('vendorname').focus()" >
<%
try
{
%>
	...
	<tr>
	  <td height="19"><form AUTOCOMPLETE="off" method="post" name="frm" id="frm" action="../SmartLoginAuth" onSubmit="return validate()">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="412"><table cellspacing="2" cellpadding="2" width="86%" align="center"
                      ...
                      <tbody>
                        <tr>
                          <td height="16" colspan="3" align="center" valign="top" 	class="boldThirteen">VENDOR 
                            <%
							String action=request.getParameter("action1");
							String branch="",vendorid="",vendorname="",legalname="",street="",city="",state="";
							String postal="",country="",areacode="",phone="",mobile="",fax="",email="",website="";
							String active="",sincefrom="",vendorgroupid="",contactmobile="",contactperson="",tin="",actionS="",value="";
							String cst="";

							String sql="";
							if("Add".equals(action))
							{
								branch="";vendorid="";vendorname="";legalname="";street="";city="";state="";
								postal="";country="";areacode="";phone="";mobile="";fax="";email="";website="";
								active="";sincefrom="";vendorgroupid="";contactmobile="";contactperson="";tin="";
								cst="";
								actionS="STKVendorAdd";
								value="Add";
							}
							else
							{
								...
								sql = " SELECT INT_BRANCHID,INT_VENDORID,CHR_VENDORNAME,CHR_LEGALNAME,CHR_STREET, ";
								sql =sql+"CHR_CITY,CHR_STATE,CHR_POSTAL,CHR_COUNTRY,CHR_AREACODE,CHR_PHONE,CHR_MOBILE,CHR_FAX,";
								sql =sql+"CHR_EMAIL,CHR_WEBSITE,INT_ACTIVE,DATE_FORMAT(DAT_SINCE,'%d-%m-%Y'),INT_VENDORGROUPID,";
								sql =sql+" CHR_CONTACTMOBILE, CHR_CONTACTPERSON,CHR_TIN,CHR_CSTNO FROM con_inv_m_vendorsinfo ";
								sql =sql+" WHERE INT_VENDORID="+vendorid;
								String data[][]=com.my.org.erp.common.CommonFunctions.QueryExecute(sql);
								branch=data[0][0];vendorid=data[0][1];vendorname=data[0][2];legalname=data[0][3];
								...
								active=data[0][15];sincefrom=data[0][16];vendorgroupid=data[0][17];contactmobile=data[0][18];
								contactperson=data[0][19];tin=data[0][20];cst=data[0][21];
								actionS="STKVendorEdit";
								value="Update";
							}
						%>			
						<input	name="vendorid" type="HIDDEN" id="vendorid" value="<%=vendorid%>">
                        <input type="hidden" name="filename" value="Vendor" />
                        ...
                        <tr>
                          <td height="17" class="boldEleven">Vendor  Name  <font
									color="ff0000">*</font></td>
                          <td colspan="2" align="left"><input name="vendorname" type="text" class="formText135" id="vendorname" value="<%=vendorname%>" size="30" maxlength="100" onKeyUp="upperMe(this)"></td>
                        </tr>
                        <tr>
		...
		//-->
                        ...
                        <tr>
                          <td height="17" class="boldEleven" valign="top">Vendor Group   <font
									color="ff0000">*</font></td>
                          <td colspan="2" align="left" valign="top">
						  <select name="vendorgroupid"  id="vendorgroupid" class="formText135" >
						  <option value="0">Select</option>
						  <%
						  String groupsql="SELECT INT_VENDORGROUPID,CHR_NAME  FROM con_inv_m_vendorsgroup   ORDER BY CHR_NAME";
						  ...
						  {
						  %>
						  <script language="javascript">setOptionValue('vendorgroupid','<%=vendorgroupid%>')</script>
						  <%
						  }
                        ...
                        <tr>
                          <td height="17" class="boldEleven" valign="top">CST Number </td>
                          <td colspan="2" align="left" valign="top"><input name="cst" type="text" class="formText135" id="cst" value="<%=cst%>" size="30" maxlength="50"></td>
                        </tr>
...
<input name="Submit" type="submit"	id="submit" class="buttonbold13" value="<%=value%>" ></td>
                                <td width="67"><div align="center">
                                  <input name="button" type="button" class="buttonbold13"  value="Close"   accesskey="c"  onClick="redirect('VendorView.jsp')">
                                </div></td>
                              </tr>
                          </table></td>
                        </tr>
