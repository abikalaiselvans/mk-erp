...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  <td height="19"><form  method="post" name="frm" id="frm">
	    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="879" height="200" border="0" align="center"
                ...
                <td height="31" class="BackGround"><table width="100%"    border='0' class='boldEleven' cellspacing=1 cellpadding=2>
                    <tr  class='BackGround'>
                      <td colspan="4" align='center'  class='bold1'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <th width="15%" scope="col"><div align="left" class="bold1">Financial Year  :: </div></th>
	...
	for(int u=0; u<bradata.length; u++)
		out.println("<option value="+bradata[u][0]+">"+bradata[u][1] +"</option>");*/
                          ...
                          <th width="16%" scope="col"><div align="left" class="bold1">Vendar Name  :: </div></th>
	...
	for(int u=0; u<itemdata.length; u++)
		out.println("<option value="+itemdata[u][0]+">"+itemdata[u][1] +"</option>");
                          ...
                          <th width="10%" scope="col"><div align="left" class="bold1">Division :: </div></th>
                          <th width="16%" scope="col"><div align="left" id="item">
                            <select name="iteml" class="boldEleven" id="iteml" onChange="LoadStock('0')">
                              <option value="0">All</option>
                                  </select>
                          </div></th>
                          <th width="8%" scope="col"><div align="left">Status :: </div></th>
              ...
              <tr>
                <td class="bolddeepblue"><div id='totalrecord' align="center"></div>
                  </td>
              </tr>
              <tr>
                <td height="127" valign="top" class="footermenu"><div id="divscroll" style="OVERFLOW:auto;width:830px;height:130px" class="boldEleven"></div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="600" border="0" align="center" cellpadding="1"
			cellspacing="1"  >
              <tr class="para">
