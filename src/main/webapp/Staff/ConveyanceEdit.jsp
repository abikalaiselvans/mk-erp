...
<table width="85%" border="0" align="center" cellpadding="0"
						...
						<TR class="MRow1">
						  ...
						  <Th align=middle  class="boldEleven">Total <input
						    ...
						    <input name="actionS" type="hidden" id="actionS"
								value="STAConveyanceStaffEdit">
						    <input name="id"
								type="hidden" id="id" value="<%=row%>"> <input
								name="opendate" type="hidden" id="opendate"
								value="<%=opendate%>">
							<input name="reentry" type="hidden" id="reentry" value="<%=data[0][17]%>"><%=data[0][17]%></Th>
						</TR>
						...
						<tr class="MRow1">
						  <td  class="boldEleven"><input name='callid' type='text' class='formText135'
							...
							<td  class="boldEleven"><input type='text'
								...
								onBlur="kmchk(this)" name='km' id='km'
								 onKeyPress=" return numeric_only(event,'km','7')"  value="<%=data[0][7]%>" /></td>
							<td  class="boldEleven"><input type='text'
								size=8 onKeyUp="upperMe(this)" class='formText135'
							...
							<td  class="boldEleven"><input type='text'
								...
								value="<%=data[0][14]%>" style='text-align:right'  onKeyPress=" return numeric_only(event,'otheramt','7')"  /></td>
							<td  class="boldEleven"><input type='text'
								size=8 class='formText135' readonly name='total'
  ...
  <tr>
    <td>&nbsp;<INPUT name='sub1' type='submit' class="tfoot" value='Submit'></td>
    <td>&nbsp;<input name="Button" type="button" class="tfoot"  value="Close"   accesskey="c"  onClick="redirect('ConveyanceModify.jsp?opendate=<%=opendate%>')"></td>
  </tr>
</table>
