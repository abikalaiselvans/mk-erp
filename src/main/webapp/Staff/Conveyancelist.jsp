	...
	<tr>
		...
		<TABLE class=fontclass1 cellSpacing=1 cellPadding=0 width="100%"
			...
			<TBODY>
				...
				String link ="ConveyanceListReportExport.jsp?fromdate="+fdt+"&todate="+tdt;
			  ...
			  if(data.length>0)
			{
				...
				out.println("<Th class='boldEleven'>Train/Bus Fare</Th>");
				...
				out.println("<td class='boldEleven'>&nbsp;</td>");
				out.println("<td class='boldEleven'>&nbsp;</td>");
				out.println("<td class='boldEleven'><a href='"+link+"'>Export </a></td>");
