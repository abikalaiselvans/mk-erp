				  ...
				  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
                      ...
                      <td colspan="2" class="bold1"><div align="center">DAILY CALLS
                        <%
							...
							int rowid=0,previousrowid=0;
								...
								sql = "SELECT a.INT_CALLID,a.INT_CUSTOMERID,d.CHR_NAME,a.CHR_NAME,c.INT_CALLTYPEID,a.CHR_DESC,DATE_FORMAT(a.DAT_START,'%d-%m-%Y %H:%i:%s'),DATE_FORMAT(a.DAT_END,'%d-%m-%Y %H:%i:%s'),a.CHR_ALLDAY,a.CHR_STATUS,DOU_VALUE FROM mkt_t_daillycalls a,mkt_m_customerinfo b,mkt_k_calltype c,mkt_m_customername d WHERE a.INT_CUSTOMERID=b.INT_CUSTOMERID AND a.CHR_CALLTYPE=c.INT_CALLTYPEID AND b.INT_CUSTOMERNAMEID =d.INT_CUSTOMERNAMEID AND a.INT_CALLID= "+id;
                        ...
                        <input type="hidden" name="filename" id="filename"  value="DaillyCalls" />
                        <input type="hidden" name="actionS"  id="actionS"   value="STADaillyCallsEdit" />
					...
					<tr>
					  ...
					  <select name="calltype" class="formText135" id="calltype" style="width:150">
						...
						%>
						</select> <script language="javascript">setOptionValue('calltype','<%=calltype%>')</script>
						</td>
                    </tr>
					<tr>
        ...
        $('#fromdate').datetimepicker('option', 'maxDate', new Date(end.getTime()) );
                    ...
                    <tr>
                      ...
                      <td class="boldEleven"><label><%
									String allday=active.trim();
									if ("Y".equals(allday))
										dbvalue=" checked='checked' ";
									else
										dbvalue=" ";
									%>	
                        <input name="active" type="checkbox" id="active" value="Y" <%=dbvalue%> >
                    ( please tick for full day work)</label></td>
                    </tr>
					<tr>
                      <td width="35%" class="boldEleven"> Call Closed <span class="spc"> *</span></td>
					 ...
					 %>											
					   ...
					   <select name="close" id="close"  class="formText135" onChange="changeState()" style="width:150">
				...
				//	{ %>
                    ...
                    <tr id="nenddate" style="visibility:hidden">
                      <td class="boldEleven" >Follows Date From To <span class="spc"> *</span></td>
                      <td class="boldEleven"><input name="ntodate" type="text" class="formText135" id="ntodate" value="" size="30" readonly />
					 
					<script language="javascript">setCurrentDateandTime('nfromdate');setCurrentDateandTime('ntodate');</script>
        ...
        $('#nfromdate').datetimepicker('option', 'maxDate', new Date(end.getTime()) );
			...
			<%//}%></td>
                     ...
                     <tr id="ncalltype" style="visibility:hidden">
                       ...
                       <script language="javascript">setOptionValue('newcalltype','<%=calltype%>')</script>
                       </td>
                    </tr>
                    <tr>
