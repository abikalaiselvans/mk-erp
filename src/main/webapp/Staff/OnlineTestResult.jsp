...
String tData[][] = CommonFunctions.QueryExecute(sql);
			...
			out.println("<tr class='MRow1'>");
			out.println("<td  class='boldEleven' colspan='10' align='right' > <a href='OnlineTestResultPrint.jsp?applicantid="+applicantid+"&testid="+testid+"'>Print</a></td>");
			out.println("</tr>");
...
%> 
	...
	<tr>
	  ...
	  <table  border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
           <td  width="56"><input class="tMLAscreenHead" type="button" name="Button"  value="Close"   accesskey="c"  onClick="redirect('Userframe.jsp')"></td>
