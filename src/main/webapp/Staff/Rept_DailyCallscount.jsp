...
sql = " SELECT  c.CHR_CALLTYPE,b.CHR_COMPANYNAME,  COUNT(*),FIND_A_EMPLOYEE_ID_NAME(a.CHR_EMPID)   ";
sql = sql + " FROM mkt_t_daillycalls a,mkt_m_customerinfo b, mkt_k_calltype c WHERE a.INT_CUSTOMERID =b.INT_CUSTOMERID  AND a.CHR_CALLTYPE=c.INT_CALLTYPEID ";
