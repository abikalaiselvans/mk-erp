...
//-->
          ...
          <tr>
            ...
            <td class="boldEleven"><input name="tdate" type="text" class="formText135" id="tdate" onKeyPress="numericHypenOnly('tdate',10)" size="12" maxlength="10" readonly tabindex="1">
              <a
