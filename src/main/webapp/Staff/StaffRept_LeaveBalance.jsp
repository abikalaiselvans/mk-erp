...
<body  onpaste="return false;" onLoad="loadAttendanceReport( ) ">
<br>
 <table border="0" align="center" cellpadding="0"
  ...
  <tr>
	...
	if(Leaves.length>0)
	{
		...
		out.println("<center>");
		out.println("<table  width='80%'  class='boldEleven' cellpadding=5 cellspacing=3 bgcolor='#9900CC' >");
		out.println("<tr bgcolor='#ffffff'><td class='boldEleven' colspan='5' align='center' ><b>LEAVE INFORMATIONS FOR CURRENT YEAR </b></td></tr>");
		out.println("<tr bgcolor='#ffffff'>  <td class='boldEleven'  ><b>S.No</b>");
		out.println("<td class='boldEleven'  ><b>Leave name</b>");
		out.println("<td class='boldEleven'  ><b>No of Leave</b>");
		out.println("<td class='boldEleven'  ><b>Leave Taken</b>");
		out.println("<td class='boldEleven'  ><b>Balance Leave</b>");
		double lc=0;
  ...
  <tr>
    <td><table width="56" align="center">
      <tr>
        <td><input name="Button" type="Button" class="buttonbold"  value="Close"   accesskey="c"  onClick="redirect('iframeStaffMain.jsp')">
        </td>
      </tr>
    </table></td>
  </tr>
