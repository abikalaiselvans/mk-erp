...
try
{
	...
	String sql="";
	int tot = com.my.org.erp.ServiceLogin.DateUtil.totalDays(Integer.parseInt(month), Integer.parseInt(year));
	...
	String mdata[][] =com.my.org.erp.common.CommonFunctions.QueryExecute(sql); 
