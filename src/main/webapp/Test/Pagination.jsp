...
<%
    ...
    conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/smartcampus","root", "mythra");
    ...
    String sqlPagination="SELECT CHR_EMPID * FROM com_m_staff limit "+iPageNo+","+iShowRows+"";
