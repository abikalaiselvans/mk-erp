	   ...
	   if (item.isFormField())
	   {
   		...
   		else
		{
			try 
			{
			   ...
			   File savedFile = new File(config.getServletContext().getRealPath("/")+"Test\\"+itemName);
	 	...
	 	<table ><tr><td width="210"></td><td> <img  border="2" src=image/<%=itemName %> width="137"  height="140"></td></tr></table>
