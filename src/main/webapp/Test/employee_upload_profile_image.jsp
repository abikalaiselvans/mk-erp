 ...
 if (!isMultipart) {
   ...
   File savedFile = new File(config.getServletContext().getRealPath("/")+"Test\\image\\"+itemName);
   item.write(savedFile);
     %><center></table>
	 
	 
	 <table ><tr><td width="210"></td><td> <img  border="2" src=image/<%=itemName %> width="137"  height="140"></td></tr></table><table border="2" width="350">
