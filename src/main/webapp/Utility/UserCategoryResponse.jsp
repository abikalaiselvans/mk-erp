...
<form name="a" method="post" action="ApplyCategoryRights.jsp" onSubmit="return formAction()">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<table width="42%" border="0" align="center" cellpadding="0"
					...
					<table width="390" height="25" border="0" align="center"
						...
						<tr>
							<td height="30" align="center" 
								class="BackGround">USER CATEGORY 
								<%
			...
			String OfficeData[][] =  CommonFunctions.QueryExecute(" SELECT b.INT_EMPLOYEECATEGORYID,b.CHR_CATEGORYNAME FROM  com_m_employeecategory  b WHERE b.INT_EMPLOYEECATEGORYID IN("+com.my.org.erp.common.CommonFunctions.QueryExecute("SELECT a.CHR_GATEGORYLIST FROM m_user a WHERE  a.CHR_EMPID='"+request.getParameter("ename")+"' ")[0][0]+" )");
