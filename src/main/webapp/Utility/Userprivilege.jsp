...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<form name="a" method="post" action="Userprivilegeresponse.jsp" onSubmit="return formAction()">
					...
					<table width="390" height="25" border="0" align="center"
						...
						<tr>
							<td height="30" align="center"
								class="BackGround">User Privilege </td>
						</tr>
						<tr>
						...
						<tr>
						  <td valign="middle" class="tabledata"><table width="200" border="0" align="center" cellpadding="5" cellspacing="5">
                            <tr>
                              <td class="boldEleven">Select Module </td>
                              <td>
							  
<select name="Rights" class="formText135"  id="Rights">
