...
<%@ page session="true" errorPage="error.jsp" import="java.util.Set,java.util.Iterator,java.util.Map,com.my.org.erp.chats.*"%>
<HTML>
<HEAD>
...
%>
<TR>
	<TD>&nbsp;<A href="<%=request.getContextPath()%>/chat/addRoom.jsp" title="Add new Room">Add new Room</A></TD>
