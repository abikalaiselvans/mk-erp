...
<%@ page errorPage="error.jsp" import="java.util.Set,java.util.Iterator,java.util.Map,com.my.org.erp.chats.*"%>
<%
...
<TD valign="top">
<form name="closing">
<input type="button" onClick="window.close()"  value="Close"   accesskey="c" >
</form>
</td>
<tr>
</table>
