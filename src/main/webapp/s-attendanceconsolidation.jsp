         ...
         <section class="content">
              ...
              <div class="row">
                    <div class="col-lg-12">
						...
						%>
                       ATTENDANCE FOR THE MONTH OF <%=dtdata[0][0] + " - " +dtdata[0][1]%></h2>
...
sql = sql + "  SUM(a.DOU_PRESENT), SUM(a.DOU_ONDUTY),SUM(a.DOU_SUNDAY),SUM(a.DOU_HOLIDAY),SUM(a.DOU_LEAVE), ";
sql = sql + "  SUM(a.DOU_ABSENT),SUM(a.INT_LATE),SUM(a.INT_PERMISSION),SUM(a.DOU_EXTRADAYS),SUM(a.DOU_TOTALDAYS)  ";
...
sql = sql + "  GROUP BY  a.CHR_MONTH,a.INT_YEAR,b.INT_OFFICEID ";
sql = sql + "  ) ";
sql = sql + "  UNION ";
sql = sql + "  ( ";
...
if(edata.length>0)
{
	...
	out.println("<th align='center'>PRESENT</th>");
	out.println("<th align='center'>ONDUTY</th>");
	out.println("<th align='center'>SUNDAY</th>");
	out.println("<th align='center'>HOLIDAY</th>");
	out.println("<th align='center'>LEAVE</th>");
	out.println("<th align='center'>ABSENT</th>");
	out.println("<th align='center'>LATE</th>");
	out.println("<th align='center'>PERMISSION</th>");
	out.println("<th align='center'>EXTRADAYS</th>");
