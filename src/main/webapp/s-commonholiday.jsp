      ...
      <div class="content-wrapper">
       <!-- Main content -->
         <section class="content">
              ...
              <div class="row">
                    <div class="col-lg-12">
                        <h2>COMMON HOLIDAY</h2>
                        <div class="table-responsive"  style="OVERFLOW:auto;width:100%;">
                        <%
String sql = "";
sql = " ";
sql = sql + " SELECT DATE_FORMAT(DT_HOLIDATE,'%d-%b-%Y'),CHR_HOLIDESC  FROM att_t_commonholiday WHERE INT_YEAR = YEAR(NOW()) ";
