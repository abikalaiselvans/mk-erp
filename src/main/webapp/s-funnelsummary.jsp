...
<%
String sql = "";
sql = " SELECT  CONCAT(MKT_FUN_GET_STAGENAME(a.INT_PERCENTAGE) ) stage,a.INT_PERCENTAGE, SUM(b.DOU_TOTAL), "; //,' ( ',a.INT_PERCENTAGE,' % )'
sql = sql +" MKT_FUN_GET_COLORCODE(a.INT_PERCENTAGE) ";
...
if(edata.length>0)
{
	...
	out.println("<th align='center'>SUM (INR)</th>");
	out.println("<th align='center'>Details</th>");
	out.println("</tr>");
	out.println("</thead>");
	...
	for(int u=0;u<edata.length;u++)
	{
		...
		out.println("<td><a href=''>Details</a></td>");
		out.println("</tr>");
	}
