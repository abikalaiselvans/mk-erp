         ...
         <section class="content">
              ...
              <div class="row">
                    <div class="col-lg-12">
                        ...
                        <%
						String sql = "";
						sql = " SELECT  YEAR(DATE_SUB(NOW(), INTERVAL 1 MONTH)) ";
						String dtdata[][] = CommonFunctions.QueryExecute(sql);
						%>
                        SALARY FOR THE YEAR OF <%=dtdata[0][0]%></h2>
...
sql = sql + "  GROUP BY a.CHR_MONTH,b.INT_OFFICEID  ";
