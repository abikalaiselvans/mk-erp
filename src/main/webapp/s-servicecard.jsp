      ...
      <div class="content-wrapper">
       ...
       <!-- Main content start-->
         ...
         <br>
             ...
             <div class="row">
                    <div class="col-lg-12">
                        <h2>Service card Approval delay</h2>
                        <div class="table-responsive"  style="OVERFLOW:auto;width:100%;">
                        <%
						String sql = "";
sql = " SELECT a.CHR_EMPID,a.CHR_STAFFNAME,a.CHR_STAFFFNAME,DATE_FORMAT(a.DT_DOB,'%d-%b-%Y'), b.CHR_COMPANYNAME,c.CHR_BRANCHNAME, d.CHR_OFFICENAME, ";
sql = sql + " e.CHR_DEPARTNAME,f.CHR_DESIGNAME,a.CHR_GENDER,   ";
sql = sql + " DATE_FORMAT(a.DT_DOJCOLLEGE,'%d-%b-%Y'), g.CHR_CATEGORYNAME,  ";
sql = sql + " DATE_FORMAT(a.DT_CREATION_DATE,'%d-%b-%Y %h:%m:%s %p'),DATEDIFF(NOW(),a.DT_CREATION_DATE) ";
...
if(ldata.length>0)
{
	...
	out.println("<th>CREATION</th>");
	out.println("<th>AGE (days)</th>");
	out.println("</tr>");
	out.println("</thead>");
	...
	for(int u=0;u<edata.length;u++)
	{
		...
		out.println("<td>"+edata[u][10]+"</td>");
		out.println("<td>"+edata[u][11]+"</td>");
		out.println("<td>"+edata[u][12]+"</td>");
		out.println("<td>"+edata[u][13]+"</td>");
