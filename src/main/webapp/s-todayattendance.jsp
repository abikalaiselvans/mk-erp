...
int day = Integer.parseInt(dtdata[0][0]);
sql =  "   SELECT  FUN_GET_OFFICENAME(b.INT_OFFICEID) Office  ,a.CHR_MORNING"+day+",a.CHR_EVENING"+day+",COUNT(*) ";
sql = sql + "   FROM att_t_register  a , com_m_staff b  ";
sql = sql + "   WHERE a.CHR_EMPID = b.CHR_EMPID  ";
sql = sql + "   AND  a.CHR_MONTH = MONTHNAME(NOW()) ";
sql = sql + "   AND a.INT_YEAR = YEAR(NOW()) ";
sql = sql + "   GROUP BY  a.CHR_MORNING"+day+",a.CHR_EVENING"+day+" ";
sql = sql + "   ORDER BY FUN_GET_OFFICENAME(b.INT_OFFICEID) ";
//out.println(sql);
...
if(edata.length>0)
{
	...
	out.println("<th align='center'>MORNING</th>");
	out.println("<th align='center'>EVENING</th>");
	...
	out.println("<center><h1><font color='red'>Attendance not found...</font></h1></center>");
