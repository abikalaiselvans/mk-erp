    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h2>DIVISION ACHEIVE</h2>
                        <div class="table-responsive">
<%
		
		
		String bdata[][] =  CommonFunctions.QueryExecute("SELECT MONTHNAME(NOW()), YEAR(NOW()), UPPER(DATE_FORMAT(now(),'%b'))");
		sql = sql + "  SELECT a.CHR_DIVICODE,  ";
		sql = sql + "  FUN_GET_DIVISION_SALES_PERCENTAGE('"+bdata[0][0]+"','"+bdata[0][1]+"',b.INT_"+bdata[0][2].toUpperCase()+",a.INT_DIVIID ) ";
		sql = sql + " FROM inv_m_division a , inv_t_targetassign_division b    ";
		sql = sql + "  WHERE a.INT_DIVIID = b.INT_DIVIID  ";
		sql = sql + "  AND  b.INT_YEAR ="+bdata[0][1];
