...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<tbody>
				...
				<tr>
					...
					<table width="384" height="172" border="0" align="center"
						...
						<!--DWLayoutTable-->
						<tr>
							<td height="30" colspan="3" align="center" valign="middle" class="BackGround">Change Password</td>
						</tr>
						<tr>
							<td width="179" height="29" class="boldEleven">User Name</td>
							<td width="189" class="tabledata">
							<% 
	...
	%> 
						...
						<tr>
							<td height="32" class="boldEleven">Old Password  </td>
							<td><input name="TxtOldpass" type="password" id="TxtOldpass" maxlength="25">
							</td>
						</tr>
						<tr>
							<td class="boldEleven">New Password</td>
							<td><input name="TxtNewPasswd" type="password"
								id="TxtNewPasswd" maxlength="8"></td>
						</tr>
						<tr>
							<td class="boldEleven">Confirm Password</td>
							<td><input name="Conpass" type="password" id="Conpass" maxlength="8"></td>
						</tr>
						<tr>
							...
							<table align="center">
								<tr>
									<td width="56"><input name="Submit" type="Submit"
										class="buttonbold" value="Submit" onClick="validate()"></td>
