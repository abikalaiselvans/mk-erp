...
<body  onpaste="return false;"  ondragstart="return false" onselectstart="return false">
...
try
{
	...
	sql = " SELECT b.CHR_STAFFNAME,f.CHR_COMPANYNAME,e.CHR_DESIGNAME,d.CHR_OFFICENAME,FIND_A_BANKNAME_NAME(c.INT_BANKID) , b.CHR_ACCNO    ";
	sql = sql + " ,b.CHR_PFNO, b.CHR_ESINO ,b.INT_SALARY,f.CHR_PFNUMBER FROM com_m_staff b,com_m_bank c, com_m_office  d,com_m_desig e ,com_m_company f ";
	sql = sql + " WHERE b.CHR_EMPID='"+staffid+"'    ";
	sql = sql + " AND c.INT_BANKID =b.CHR_BANK      ";
	...
	sql = " SELECT b.CHR_STAFFNAME,c.CHR_COMPANYNAME,d.CHR_DESIGNAME,e.CHR_OFFICENAME,FIND_A_BANKNAME_NAME(f.INT_BANKID),a.CHR_ACCNO,    ";
	sql = sql + " b.CHR_PFNO, b.CHR_ESINO ,b.INT_SALARY,c.CHR_PFNUMBER ,concat(c.CHR_PFNUMBER,b.CHR_PFNO)    ";
	sql = sql + " FROM  pay_t_salary  a ,com_m_staff b,com_m_company c,com_m_desig d,com_m_office e,com_m_bank f    ";
	...
	sql = sql + " AND a.CHR_BANK = f.INT_BANKID    ";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%" rowspan="4" valign="top" class="boldThirteen"><img
					src="../images/logo.jpg" width="159" height="49"></td>
            <td width="70%" class="boldThirteen"><div align="center"><%=cpyname%></div></td>
            <td width="15%" rowspan="4" valign="top" class="boldThirteen">&nbsp; </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" class="boldEleven"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
				  ...
				  <center><div id="Rupees">
				  	<script language="javascript">numberWord("<%=(int)((earninggross-deduction)+extraallowances)%>","Rupees") </script>
                ...
                <tr>
                  <td class="bolddeeplogin"><div align="center" class="bolddeepblue" id="Rupees">
                      <div align="center">H.O. : #481, 2nd Floor, Anna Salai, Nandanan, Chennai-600035. Tel.: 24340906(4 LINES)
                        FAX:24340835</div>
                  </div></td>
                </tr>
                <tr>
